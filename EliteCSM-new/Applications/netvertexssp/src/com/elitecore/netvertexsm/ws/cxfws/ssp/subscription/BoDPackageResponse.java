...
/**
 * <p>Java class for boDPackageResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="boDPackageResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="boDPackages" type="{http://subscription.ssp.cxfws.ws.netvertexsm.elitecore.com/}boDPackage" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "boDPackageResponse", propOrder = {
    "boDPackages",
    "parameter1",
    "parameter2",
    "responseCode",
...
public class BoDPackageResponse {

    @XmlElement(nillable = true)
    protected List<BoDPackage> boDPackages;
    ...
    /**
     * Gets the value of the boDPackages property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the boDPackages property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBoDPackages().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BoDPackage> getBoDPackages() {
        if (boDPackages == null) {
            boDPackages = new ArrayList<BoDPackage>();
        }
        return this.boDPackages;
    }
