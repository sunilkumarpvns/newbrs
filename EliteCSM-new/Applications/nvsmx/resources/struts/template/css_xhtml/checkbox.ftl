...
<div <#rt/><#if parameters.id??>id="wwgrp_${parameters.id}"<#rt/></#if> class="nv-checkbox-grp">
...
<#if parameters.labelposition?default("right") == 'left'>
<span <#rt/>
<#if parameters.id??>id="wwlbl_${parameters.id}"<#rt/></#if> class="nv-checkbox-label-div">
<label<#t/>
<#if parameters.id??>
...
<#if parameters.id??>id="wwctrl_${parameters.id}"<#rt/></#if> class="nv-checkbox-div">
