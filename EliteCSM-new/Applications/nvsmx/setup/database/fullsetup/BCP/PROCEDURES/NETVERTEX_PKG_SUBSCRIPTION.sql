...
BEGIN
  ...
  */
  FOR REC IN
  (SELECT * FROM TBLT_SUBSCRIPTION_EXPIRED WHERE ROWNUM < 5000
  )
  LOOP
    CNT := CNT + 1;
    DELETE
...
BEGIN
  ...
  1) UPDATE USAGERESETDATE IN TBLT_SUBSCRIPTION
  2) INSERT USAGE IN TBLMSESSIONUSAGECDR
  ...
  */
  FOR REC IN
  (SELECT * FROM TBLT_SUBSCRIPTION_RESET WHERE ROWNUM < 5000
  )
  LOOP
  CNT := CNT + 1;
    BEGIN
