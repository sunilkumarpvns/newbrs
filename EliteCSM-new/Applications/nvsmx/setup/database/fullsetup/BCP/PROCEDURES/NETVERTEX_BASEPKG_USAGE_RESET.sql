...
BEGIN
  /* JIRA : NETVERTEX-2028 */
  select PKG_PCRF_SCHEDULER_KPI.FUNC_CHECK_PARTITION('TBLT_USAGE_HISTORY') INTO P_CNT1 from dual;
  select PKG_PCRF_SCHEDULER_KPI.FUNC_CHECK_PARTITION('TBLT_USAGE') INTO P_CNT2 from dual;
