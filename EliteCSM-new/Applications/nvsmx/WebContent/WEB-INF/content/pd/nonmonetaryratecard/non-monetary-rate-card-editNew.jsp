...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><s:text name="nonmonetary.ratecard.create"/></h3>
    </div>
    <div class="panel-body" class="col-sm-6">
        <s:form namespace="/pd/nonmonetaryratecard" action="non-monetary-rate-card" id="nonMonetaryRateCardCreate"
                ...
                <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="col-xs-6">
                            <div class="row customized-row-margin">
                                <s:select name="nonMonetaryRateCardData.timeUom" id="nonmonetaryratecardtimeUom"
                                          elementCssClass="col-xs-12"
                                          cssClass="form-control" list="{}" tabindex="8" headerKey=" "/>
                            </div>
                        </div>
                    </div>
                    </s:else>
                    ...
                    <div class="col-xs-12">
                        <s:select tabindex="9"
                                  ...
                                  name="nonMonetaryRateCardData.proration" id="proration"
                                  elementCssClass="col-xs-12" value="@com.elitecore.corenetvertex.constants.CommonStatusValues@DISABLE.booleanValue"/>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12" align="center">
                    <s:submit cssClass="btn  btn-sm btn-primary" id="btnSubmit" type="button" role="button"
                    ...
                    <button type="button" class="btn btn-primary btn-sm" id="btnCancel" value="Cancel"
                            onclick="javascript:location.href='${pageContext.request.contextPath}/pd/rncpackage/rnc-package/${rncPackageId}'"
...
<script type="text/javascript">
    ...
    function validateForm() {
        ...
        return verifyUniquenessOnSubmit('nonmonetaryratecardName', 'create', '', 'com.elitecore.corenetvertex.pd.ratecard.RateCardData', '${rncPkgId}', '') && validateNonNegativeValue();
    }
