			...
			<div>
			    ...
			    <div class="row">
					<div class="col-xs-12" align="center">
				       <button type="submit" class="btn btn-primary btn-sm" id="btnSave"  role="submit" formaction="${pageContext.request.contextPath}/pd/currency/currency/${id}" ><span class="glyphicon glyphicon-floppy-disk"></span> <s:text name="button.save"/></button>
