...
<div class="row">
    ...
    <div class="col-xs-6">
        ...
        <s:select name="validityPeriodUnit" key="bod.package.validity.period.unit" cssClass="form-control"
                  ...
                  id="validityPeriodUnit" listKey="name()" listValue="displayValue" tabindex="9" readonly="true"/>
        ...
        <s:textfield key="bod.package.param1" name="param1" cssClass="form-control" maxLength="100"/>
        <s:textfield key="bod.package.param2" name="param2" cssClass="form-control" maxLength="100"/>
    </div>
</div>