		...
		<s:form namespace="/pd/partner" action="partner" method="post" id ="partner" cssClass="form-horizontal" validate="true" labelCssClass="col-xs-12 col-sm-4" elementCssClass="col-xs-12 col-sm-8" validator="validateForm()">
			...
			<div>
				<fieldset class="fieldSet-line">
                	...
                	<div class="col-xs-12 col-sm-6">
                		    <s:select id="countryId" name="countryId" list="countryDataList" key="partner.country" listKey="id" listValue="name" cssClass="form-control select2" onchange="onCountryChange()" tabindex="7" />
			...
			<div class="row">
            	<div class="col-xs-12" align="center">
                	<s:submit cssClass="btn  btn-sm btn-primary" type="button" id="btnSave" role="button" tabindex="22" ><span class="glyphicon glyphicon-floppy-disk"></span> <s:text name="button.save"/></s:submit>
                    <button type="button" class="btn btn-primary btn-sm"  id="btnCancel" value="Cancel" onclick="javascript:location.href='${pageContext.request.contextPath}/pd/partner/partner'"><span class="glyphicon glyphicon-backward" title="Back" tabindex="23"></span>&nbsp;<s:text name="button.list"/></button>
	            </div>
			</div>
	</s:form>
	</div>
...
<script type="text/javascript">
    ...
    function validateForm() {
 		return verifyUniquenessOnSubmit('partnerName','create','','com.elitecore.corenetvertex.pd.partner.PartnerData','','');
    	} 
</script>