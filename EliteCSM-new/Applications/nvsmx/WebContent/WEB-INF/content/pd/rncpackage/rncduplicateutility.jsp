<script type="text/javascript">
    function validateDuplicate() {
        var isValidName = verifyUniquenessOnSubmit('duplicateEntityName', 'create', '', 'com.elitecore.corenetvertex.pd.rncpackage.RncPackageData', '', '');
        if (isValidName) {
            document.forms['rncPackageCloningForm'].submit();
        }
        return false;
    }
    ...
    function clearDialog() {
        clearErrorMessages(rncPackageCloningForm);
    }
</script>