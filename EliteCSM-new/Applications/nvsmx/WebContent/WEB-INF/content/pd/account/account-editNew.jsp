...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><s:text name="account.create" /></h3>
    </div>
    <div class="panel-body">
        <s:form namespace="/pd/account" action="account" id="account" method="post" cssClass="form-horizontal" validate="true" labelCssClass="col-xs-12 col-sm-4" elementCssClass="col-xs-12 col-sm-8" validator="validateForm()">
            <s:token/>
            <s:hidden name="partnerIds"    value="%{partnerIds}" />
                ...
                <div class="row">
           			<div class="col-xs-12" align="center">
               			<button type="submit" class="btn btn-primary btn-sm" id="btnSave"  role="submit"  tabindex="9"><span class="glyphicon glyphicon-floppy-disk"></span> <s:text name="button.save"/></button>
 						<button type="button" class="btn btn-primary btn-sm"  id="btnCancel" value="Cancel" tabindex="10" onclick="javascript:location.href='${pageContext.request.contextPath}/pd/partner/partner/${partnerId}'"><span class="glyphicon glyphicon-backward" title="Back"></span>&nbsp;<s:text name="button.list"/></button>               		
 					</div>
            	</div>
    	</s:form>
	</div>
...
<script type="text/javascript">
	...
	function validateForm() {
		return verifyUniquenessOnSubmit('accountName','create','','com.elitecore.corenetvertex.pd.account.AccountData','','');
   } 
</script>