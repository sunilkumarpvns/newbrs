...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <s:form namespace="/sm/pccrulemapping" id="diameterPacketMappingCreate" action="diameter-pcc-rule-mapping" method="post" cssClass="form-horizontal" validate="true" labelCssClass="col-xs-12 col-sm-4 col-lg-3" elementCssClass="col-xs-12 col-sm-8 col-lg-9" validator="validateForm()">
            <s:token/>
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <s:textarea name="description" key="pccrule.mapping.description" cssClass="form-control"
                                rows="2" tabindex="2" id="description" value="%{@com.elitecore.nvsmx.system.util.NVSMXUtil@getDefaultDescription(request)}"/>
