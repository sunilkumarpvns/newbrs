...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <s:form namespace="/sm/pccrulemapping" id="radiusPccRuleMappingUpdate" action="radius-pcc-rule-mapping" method="post" cssClass="form-horizontal" validate="true" labelCssClass="col-xs-12 col-sm-4 col-lg-3" elementCssClass="col-xs-12 col-sm-8 col-lg-9" validator="validateForm()">
            <s:token/>
            ...
            <div class="row">
                <div class="col-xs-12" align="center">
                    <button class="btn btn-sm btn-primary" type="submit" role="button"
                            formaction="${pageContext.request.contextPath}/sm/pccrulemapping/radius-pcc-rule-mapping/${id}"><span
                    ...
                    <button type="button" id="btnCancel" class="btn btn-primary btn-sm" value="Cancel" tabindex="15"
                            onclick="javascript:location.href='${pageContext.request.contextPath}/sm/pccrulemapping/radius-pcc-rule-mapping/${id}'">
