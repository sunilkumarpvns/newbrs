...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title"><s:text name="radius.gateway.profile.service.guiding.manage.order" /></h3>
	</div>
	<div class="panel-body">
					<s:form namespace="" action="" id="radiusGwProfileServiceGuidingManageOrderForm" method="post" cssClass="form-horizontal" labelCssClass="col-xs-4 col-lg-2 text-right" elementCssClass="col-xs-8 col-lg-10"  >
						<table id="radiusGwProfileServiceGuidingManageOrderTable" style="width: 100%;" class="table table-blue dataTable no-footer" role="grid" width="100%">
							<thead>
								<tr role="row">
									<th style="width: 10px"> Order# </th>
									<th> <s:text name="radius.profile.service.guiding.name"/> </th>
									<th> <s:text name="radius.profile.service.guiding.condition"/> </th>
								</tr>
							</thead>
							<tbody>
...
<script type="text/javascript" >
    ...
    $(document).ready(function(){
        ...
        function enableDnD(){
            $("#radiusGwProfileServiceGuidingManageOrderTable").rowSorter({
                onDrop: function(tbody, row, index, oldIndex) {
                    $('#radiusGwProfileServiceGuidingManageOrderTable tr').each(function() {
        ...
        submitForm = function (){
            if(hasOrderChanged){
            	$("#radiusGwProfileServiceGuidingManageOrderForm").attr("action","${pageContext.request.contextPath}/sm/gatewayprofile/radius-gateway-profile/${id}/manageOrderForServiceGuiding")
            	$("#radiusGwProfileServiceGuidingManageOrderForm").submit();
			}else{
