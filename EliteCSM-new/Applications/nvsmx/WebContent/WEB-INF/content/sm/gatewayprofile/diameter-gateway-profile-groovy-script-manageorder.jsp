...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title"><s:text name="diameter.gateway.profile.groovy.script.manage.order" /></h3>
	</div>
	<div class="panel-body">
					<s:form namespace="" action="" id="diameterGwProfileGroovyScriptManagerOrderForm" method="post" cssClass="form-horizontal" labelCssClass="col-xs-4 col-lg-2 text-right" elementCssClass="col-xs-8 col-lg-10"  >
						<table id="diameterGwProfileGroovyScriptManageOrderTable" style="width: 100%;" class="table table-blue dataTable no-footer" role="grid" width="100%">
							<thead>
								<tr role="row">
									<th style="width: 10px"> Order# </th>
									<th> <s:text name="diameter.profile.groovy.script.name"/> </th>
									<th> <s:text name="diameter.profile.groovy.script.argument"/> </th>
								</tr>
							</thead>
							<tbody>
...
<script type="text/javascript" >
    ...
    $(document).ready(function(){
        ...
        function enableDnD(){
            $("#diameterGwProfileGroovyScriptManageOrderTable").rowSorter({
                onDrop: function(tbody, row, index, oldIndex) {
                    $('#diameterGwProfileGroovyScriptManageOrderTable tr').each(function() {
        ...
        submitForm = function (){
            if(hasOrderChanged){
            	$("#diameterGwProfileGroovyScriptManagerOrderForm").attr("action","${pageContext.request.contextPath}/sm/gatewayprofile/diameter-gateway-profile/${id}/manageOrderForGroovy")
            	$("#diameterGwProfileGroovyScriptManagerOrderForm").submit();
			}else{
