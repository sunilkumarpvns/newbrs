        ...
        <div class="nv-btn-group" align="right">
            ...
            <span class="btn-group btn-group-xs">
				<button type="button" class="btn btn-default header-btn" data-toggle="tooltip" data-placement="bottom" title="Audit History"
                        onclick="javascript:location.href='${pageContext.request.contextPath}/sm/audit/audit/${id}?auditableResourceName=${name}&refererUrl=/sm/packetmapping/radius-packet-mapping/${id}'">
                    <span class="glyphicon glyphicon-eye-open" ></span>
                </button>
			</span>
            <span class="btn-group btn-group-xs">
				<button type="button" class="btn btn-default header-btn" data-toggle="tooltip" data-placement="bottom" title="edit"
                        onclick="javascript:location.href='${pageContext.request.contextPath}/sm/packetmapping/radius-packet-mapping/${id}/edit'">
                    <span class="glyphicon glyphicon-pencil"></span>
                </button>
			</span>
            <span class="btn-group btn-group-xs" data-toggle="confirmation-singleton" onmousedown="deleteConfirm()" data-href="${pageContext.request.contextPath}/sm/packetmapping/radius-packet-mapping/${id}?_method=DELETE">
        ...
        <div class="row">
            <fieldset class="fieldSet-line">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row">
                            <s:label key="packet.mapping.description" value="%{description}" cssClass="control-label light-text" labelCssClass="col-xs-4 col-sm-6" elementCssClass="col-xs-8 col-sm-6" />
                            ...
                            <s:label key="packet.mapping.packettype" value="%{@com.elitecore.corenetvertex.constants.PacketType@valueOf(packetType).name()}" cssClass="control-label light-text" labelCssClass="col-xs-4 col-sm-6" elementCssClass="col-xs-8 col-sm-6" />
                        </div>
                    </div>
