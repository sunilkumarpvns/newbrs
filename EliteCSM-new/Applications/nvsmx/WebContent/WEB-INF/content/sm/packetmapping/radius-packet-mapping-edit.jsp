...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <s:form namespace="/sm/packetmapping" id="radiusPacketMappingUpdate" action="radius-packet-mapping" method="post" cssClass="form-horizontal" validate="true" labelCssClass="col-xs-12 col-sm-4 col-lg-3" elementCssClass="col-xs-12 col-sm-8 col-lg-9" validator="validateForm()">
            <s:token/>
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <s:select name="packetType" key="packet.mapping.packettype"
                              cssClass="form-control"  list="@com.elitecore.corenetvertex.constants.PacketType@getPacketTypeList('RADIUS')"
            ...
            <div class="row">
                <div class="col-xs-12" align="center">
                    <button class="btn btn-sm btn-primary" type="submit" role="button"
                            formaction="${pageContext.request.contextPath}/sm/packetmapping/radius-packet-mapping/${id}"><span
                    ...
                    <button type="button" id="btnCancel" class="btn btn-primary btn-sm" value="Cancel" tabindex="15"
                            onclick="javascript:location.href='${pageContext.request.contextPath}/sm/packetmapping/radius-packet-mapping/${id}'">
