...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <s:form namespace="/sm/packetmapping" id="diameterPacketMappingCreate" action="diameter-packet-mapping" method="post" cssClass="form-horizontal" validate="true" labelCssClass="col-xs-12 col-sm-4 col-lg-3" elementCssClass="col-xs-12 col-sm-8 col-lg-9" validator="validateForm()">
            <s:token/>
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <s:select name="status" key="packet.mapping.status" cssClass="form-control" list="@com.elitecore.corenetvertex.constants.ResourceStatus@values()" id="status"	 tabindex="4" />
                    <s:select name="type" key="packet.mapping.conversationtype"
                              cssClass="form-control" id="conversationType"
                              list="@com.elitecore.corenetvertex.constants.ConversionType@values()"  listValue="conversionType" onchange="getPacketTypeBasedOnDiameterProtocolAndConversationType()"
                              tabindex="3" />
