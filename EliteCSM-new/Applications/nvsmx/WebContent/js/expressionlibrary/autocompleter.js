...
Autocompleter.prototype = {
    initialize: function(model,debug,seperatorValues){
        this.statemachine = model;
        this.debug=debug;
        if(typeof seperatorValues == 'undefined' || seperatorValues=='undefined' || seperatorValues==null || $.trim(seperatorValues).length==0 || seperatorValues=="null"){
            this.seperatorValues = [" ", "=","|","&","(",")", ","];
        }else{
            this.seperatorValues = seperatorValues;
        }
    ...
    suggestions: function(value,id){
     ...
     if(typeof(id)!== 'undefined'){
       ...
       var stream = new Stream(value, this.seperatorValues);
