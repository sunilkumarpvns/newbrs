	...
	<div class="panel-heading">
		<h3 class="panel-title">
			<s:if test="%{qosProfileDetail.fupLevel == 0}">
				<s:text name="qosprofile.hsqlevel"></s:text>
				<s:set var="fuplevelheader">HSQ</s:set>
			</s:if>
			<s:elseif test="%{qosProfileDetail.fupLevel == 1}">
				<s:text name="qosprofile.fuplevel1"></s:text>
				<s:set var="fuplevelheader">FUP1</s:set>
			</s:elseif>
			<s:elseif test="%{qosProfileDetail.fupLevel == 2}">
				<s:text name="qosprofile.fuplevel2"></s:text>
				<s:set var="fuplevelheader">FUP2</s:set>
			</s:elseif>
		</h3>
	</div>
	<div class="panel-body">  
  <s:form namespace="/" action="policydesigner/qos/QosProfile/createQosDetailInformation" validate="true" id="qosProfileCreate" name="qosProfileCreateDetailForm"  method="post" cssClass="form-horizontal" labelCssClass="col-xs-4 col-sm-5 text-right" elementCssClass="col-xs-8 col-sm-7" onsubmit="return validateForm()">
  <s:token />
	  	...
	  	<div class="row">
  						<div class="col-sm-6">
  							<s:select tabindex="1" cssClass="form-control focusElement" list="@com.elitecore.corenetvertex.constants.QoSProfileAction@values()" 
  									...
  									name="qosProfileDetail.action" 
  									id="action" key="qosprofile.action" listKey="getId()" listValue="getName()" onchange="disableRestAttributes()" />
  						</div>
  						<div class="col-sm-6">
  							<s:textfield tabindex="2" name="qosProfileDetail.rejectCause" id="rejectCause" key="qosprofile.rejectcause" cssClass="form-control" maxlength="255" readonly="true"  labelCssClass="qos-detail-label col-xs-3 col-sm-5 text-right" elementCssClass="col-xs-9 col-sm-7 qos-detail-element"/>
  						</div>
  					</div>
				   ...
				   <div class="row">
				   		<div class="col-sm-6">
				   			<div class="row">
								<div class="col-xs-8">
									<s:textfield tabindex="3" name="qosProfileDetail.mbrdl"
										key="qosprofile.detail.mbrdl" cssClass="form-control" onkeypress="return isNaturalInteger(event);"
										maxlength="10" id="mbrdl" type="number"/>
									<s:textfield name="qosProfileDetail.mbrul" tabindex="5" 
										key="qosprofile.detail.mbrul" cssClass="form-control" onkeypress="return isNaturalInteger(event);"
										maxlength="10" id="mbrul" type="number" />
									<s:textfield name="qosProfileDetail.aambrdl" tabindex="7"
										key="qosprofile.detail.aambrdl" cssClass="form-control" onkeypress="return isNaturalInteger(event);"
										maxlength="10" id="aambrdl" type="number"/>
									<s:textfield name="qosProfileDetail.aambrul" tabindex="9"
										key="qosprofile.detail.aambrul" cssClass="form-control" onkeypress="return isNaturalInteger(event);"
										maxlength="10" id="aambrul" type="number"/>
								</div>
								<div class="col-xs-4">
									<s:select cssClass="form-control " tabindex="4" elementCssClass="col-xs-12"
									...
									<s:select cssClass="form-control " tabindex="6" elementCssClass="col-xs-12"
										list="@com.elitecore.corenetvertex.constants.QoSUnit@values()"
										value="@com.elitecore.corenetvertex.constants.QoSUnit@Kbps.name()"
										name="qosProfileDetail.mbrulUnit" id="mbrulUnit" />
									<s:select cssClass="form-control " tabindex="8" elementCssClass="col-xs-12"
										list="@com.elitecore.corenetvertex.constants.QoSUnit@values()"
										value="@com.elitecore.corenetvertex.constants.QoSUnit@Kbps.name()"
										name="qosProfileDetail.aambrdlUnit" id="aambrdlUnit" />
									<s:select cssClass="form-control " tabindex="10" elementCssClass="col-xs-12"
										list="@com.elitecore.corenetvertex.constants.QoSUnit@values()"
										value="@com.elitecore.corenetvertex.constants.QoSUnit@Kbps.name()"
						...
						<div class="col-sm-6">
							<s:select cssClass="form-control" tabindex="11"
								...
								name="qosProfileDetail.qci" key="qosprofile.detail.qci" value="@com.elitecore.corenetvertex.constants.QCI@getDefault().getQci()" labelCssClass="qos-detail-label col-xs-3 col-sm-5 text-right" elementCssClass="col-xs-9 col-sm-7 qos-detail-element"/>
							<s:select cssClass="form-control" tabindex="12"
								...
								key="qosprofile.detail.precapability"  labelCssClass="qos-detail-label col-xs-3 col-sm-5 text-right" elementCssClass="col-xs-9 col-sm-7 qos-detail-element"/>
							<s:select cssClass="form-control" tabindex="13"
								list="@com.elitecore.corenetvertex.constants.CommonStatusValues@values()" listKey="isBooleanValue()" listValue="getStringName()"
								name="qosProfileDetail.preVulnerability"
								key="qosprofile.detail.prevulnerability" labelCssClass="qos-detail-label col-xs-3 col-sm-5 text-right" elementCssClass="col-xs-9 col-sm-7 qos-detail-element" />
							<s:select cssClass="form-control" tabindex="14"
								...
								key="qosprofile.detail.prioritylevel" labelCssClass="qos-detail-label col-xs-3 col-sm-5 text-right" elementCssClass="col-xs-9 col-sm-7 qos-detail-element" />
			...
			<div class="row">
				<div class="col-xs-12" align="center">
					...
					<button tabindex="25" id="btnBack" class="btn btn-primary btn-sm" type="button" value="Cancel" onclick="javascript:location.href='${pageContext.request.contextPath}/policydesigner/qos/QosProfile/view?qosProfileId=${qosProfile.id}'"><span class="glyphicon glyphicon-backward" title="Back"></span> <s:text name="button.qosprofile"></s:text> </button>
					<button tabindex="26" id="btnBack" class="btn btn-primary btn-sm" type="button" value="Cancel" onclick="javascript:location.href='${pageContext.request.contextPath}/policydesigner/pkg/Pkg/view?pkgId=${qosProfile.pkgData.id}'"><span class="glyphicon glyphicon-backward" title="Back"></span> <s:text name="button.pkg"></s:text> </button>
				</div>
