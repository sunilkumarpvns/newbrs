...
<div class="panel panel-primary">
  ...
  <s:form namespace="/" action="policydesigner/emergencypkgqos/EmergencyPkgQos/createQosDetailInformation" validate="true" id="qosProfileCreate" method="post" cssClass="form-horizontal" labelCssClass="col-xs-4 col-sm-5 text-right" elementCssClass="col-xs-8 col-sm-7" onsubmit="return validateForm()">
  <s:token />
	  ...
	  <div class="row">
				   ...
				   <div class="row">
						...
						<div class="col-sm-6">
							<s:select cssClass="form-control" tabindex="11"
								...
								name="qosProfileDetail.qci" key="qosprofile.detail.qci" value="qosProfileDetail.qci" labelCssClass="qos-detail-label col-xs-3 col-sm-5 text-right" elementCssClass="col-xs-9 col-sm-7 qos-detail-element"/>
				...
				<div class="row">
				     <div class="col-sm-6">
						...
						<div class="col-xs-8" id="sliceInformation">
							...
							<s:textfield name="qosProfileDetail.sliceDownload" tabindex="18" type="number" id="sliceupload"
								key="qosProfile.detail.slicedownload" cssClass="form-control" onkeypress="return isNaturalInteger(event);"
								maxlength="18" />
							<s:textfield name="qosProfileDetail.sliceUpload" tabindex="20" type="number" id="slicedownload"
			...
			<div class="row">
				<div class="col-xs-12" align="center">
					...
					<button tabindex="26" id="btnBack" class="btn btn-primary btn-sm" type="button" value="Cancel" onclick="javascript:location.href='${pageContext.request.contextPath}/policydesigner/emergency/EmergencyPkg/view?pkgId=${qosProfile.pkgData.id}'"><span class="glyphicon glyphicon-backward" title="Back"></span> <s:text name="button.pkg"></s:text> </button>
