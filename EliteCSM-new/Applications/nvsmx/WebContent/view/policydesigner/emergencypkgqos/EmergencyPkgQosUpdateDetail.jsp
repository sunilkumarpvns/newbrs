...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<s:form namespace="/" labelCssClass="col-xs-4 col-sm-5 text-right" elementCssClass="col-xs-8 col-sm-7"
			action="policydesigner/emergencypkgqos/EmergencyPkgQos/updateQosDetailInformation"
...
<%@include file="/view/policydesigner/emergencypkgqos/EmergencyPkgQosDetailValidation.jsp"%>
