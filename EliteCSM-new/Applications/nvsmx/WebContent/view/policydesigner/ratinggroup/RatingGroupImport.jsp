...
<%
  JsonArray importRatingGroups = (JsonArray) request.getAttribute("importedRatingGroups");
%>

<s:form  id="ratignGroupImportTest" method="post" cssClass="form-vertical">
  <s:set var="entityName" value= "%{@com.elitecore.corenetvertex.constants.Discriminators@RATING_GROUP}"/>
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h3 class="panel-title">
        <s:text name="ratinggroup.import" />
      </h3>
    </div>
    ...
    <div class="panel-body">
      ...
      <nv:dataTable
              id="importRatingGroupData"
              list="<%= importRatingGroups.toString() %>"
              beanType="com.elitecore.corenetvertex.pkg.ratinggroup.RatingGroupDataExt"
              width="100%"
