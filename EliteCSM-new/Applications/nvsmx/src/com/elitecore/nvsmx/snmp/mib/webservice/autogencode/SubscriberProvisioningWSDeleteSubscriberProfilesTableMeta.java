 ...
 */
public class SubscriberProvisioningWSDeleteSubscriberProfilesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSDeleteSubscriberProfilesTableMeta".
     ...
     */
    public SubscriberProvisioningWSDeleteSubscriberProfilesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSDeleteSubscriberProfilesEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSDeleteSubscriberProfilesEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSDeleteSubscriberProfilesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSDeleteSubscriberProfilesEntry" conceptual row (SubscriberWSDeleteSubscriberProfilesEntryMeta)
     * 
     **/
    protected SubscriberWSDeleteSubscriberProfilesEntryMeta createSubscriberWSDeleteSubscriberProfilesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSDeleteSubscriberProfilesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSDeleteSubscriberProfilesEntryMetaNode("SubscriberWSDeleteSubscriberProfilesEntry", "SubscriberProvisioningWSDeleteSubscriberProfilesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSDeleteSubscriberProfilesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSDeleteSubscriberProfilesTable" + "\" must implement the \"" + 
                           "SubscriberWSDeleteSubscriberProfilesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSDeleteSubscriberProfilesEntryMBean entry = (SubscriberWSDeleteSubscriberProfilesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSDeleteSubscriberProfilesEntryMeta node;
