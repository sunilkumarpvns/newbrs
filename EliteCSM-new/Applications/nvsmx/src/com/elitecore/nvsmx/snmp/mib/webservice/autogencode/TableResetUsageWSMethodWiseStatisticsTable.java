...
public class TableResetUsageWSMethodWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableResetUsageWSMethodWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.ResetUsageWSMethodWiseEntry" + ",ResetUsageWSMethodIndex=" + _keyResetUsageWSMethodIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
