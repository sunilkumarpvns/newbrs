...
public class TableSubscriptionWSListBoDPackagesTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSListBoDPackagesTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSListBoDPackagesEntry" + ",ListBoDPackagesResultCode=" + _keyListBoDPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
