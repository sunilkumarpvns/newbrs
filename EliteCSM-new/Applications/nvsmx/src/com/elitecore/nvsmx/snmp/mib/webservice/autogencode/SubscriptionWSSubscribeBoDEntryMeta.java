...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSSubscribeBoDEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.29.1.
 */
public class SubscriptionWSSubscribeBoDEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSSubscribeBoDEntry".
     */
    public SubscriptionWSSubscribeBoDEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getSubscribeBoDResultCodeCounters());

            case 2:
                return new SnmpString(node.getSubscribeBoDResultCodeName());
     ...
     */
    protected void setInstance(SubscriptionWSSubscribeBoDEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSSubscribeBoDEntryMBean node;
