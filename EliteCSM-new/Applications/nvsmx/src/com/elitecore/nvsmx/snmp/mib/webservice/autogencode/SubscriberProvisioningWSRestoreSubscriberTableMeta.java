 ...
 */
public class SubscriberProvisioningWSRestoreSubscriberTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSRestoreSubscriberTableMeta".
     ...
     */
    public SubscriberProvisioningWSRestoreSubscriberTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSRestoreSubscriberEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSRestoreSubscriberEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSRestoreSubscriberTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSRestoreSubscriberEntry" conceptual row (SubscriberWSRestoreSubscriberEntryMeta)
     * 
     **/
    protected SubscriberWSRestoreSubscriberEntryMeta createSubscriberWSRestoreSubscriberEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSRestoreSubscriberEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSRestoreSubscriberEntryMetaNode("SubscriberWSRestoreSubscriberEntry", "SubscriberProvisioningWSRestoreSubscriberTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSRestoreSubscriberEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSRestoreSubscriberTable" + "\" must implement the \"" + 
                           "SubscriberWSRestoreSubscriberEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSRestoreSubscriberEntryMBean entry = (SubscriberWSRestoreSubscriberEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSRestoreSubscriberEntryMeta node;
