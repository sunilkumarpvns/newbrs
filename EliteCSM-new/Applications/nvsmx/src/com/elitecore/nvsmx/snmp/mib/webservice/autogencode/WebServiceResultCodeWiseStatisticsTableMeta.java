 ...
 */
public class WebServiceResultCodeWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "WebServiceResultCodeWiseStatisticsTableMeta".
     ...
     */
    public WebServiceResultCodeWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "WebServiceResultCodeWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("WebServiceResultCodeWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("WebServiceResultCodeWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "WebServiceResultCodeWiseEntry" conceptual row (WebServiceResultCodeWiseEntryMeta)
     * 
     **/
    protected WebServiceResultCodeWiseEntryMeta createWebServiceResultCodeWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new WebServiceResultCodeWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createWebServiceResultCodeWiseEntryMetaNode("WebServiceResultCodeWiseEntry", "WebServiceResultCodeWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof WebServiceResultCodeWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "WebServiceResultCodeWiseStatisticsTable" + "\" must implement the \"" + 
                           "WebServiceResultCodeWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        WebServiceResultCodeWiseEntryMBean entry = (WebServiceResultCodeWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private WebServiceResultCodeWiseEntryMeta node;
