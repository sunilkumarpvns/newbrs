 ...
 */
public class SubscriptionWSChangeTopUpSubscriptionTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSChangeTopUpSubscriptionTableMeta".
     ...
     */
    public SubscriptionWSChangeTopUpSubscriptionTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSChangeTopUpSubscriptionEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSChangeTopUpSubscriptionEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSChangeTopUpSubscriptionTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSChangeTopUpSubscriptionEntry" conceptual row (SubscriptionWSChangeTopUpSubscriptionEntryMeta)
     * 
     **/
    protected SubscriptionWSChangeTopUpSubscriptionEntryMeta createSubscriptionWSChangeTopUpSubscriptionEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSChangeTopUpSubscriptionEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSChangeTopUpSubscriptionEntryMetaNode("SubscriptionWSChangeTopUpSubscriptionEntry", "SubscriptionWSChangeTopUpSubscriptionTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSChangeTopUpSubscriptionEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSChangeTopUpSubscriptionTable" + "\" must implement the \"" + 
                           "SubscriptionWSChangeTopUpSubscriptionEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSChangeTopUpSubscriptionEntryMBean entry = (SubscriptionWSChangeTopUpSubscriptionEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSChangeTopUpSubscriptionEntryMeta node;
