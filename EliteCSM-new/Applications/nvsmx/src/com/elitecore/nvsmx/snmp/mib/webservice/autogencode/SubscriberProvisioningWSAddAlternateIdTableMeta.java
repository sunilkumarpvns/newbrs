 ...
 */
public class SubscriberProvisioningWSAddAlternateIdTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSAddAlternateIdTableMeta".
     ...
     */
    public SubscriberProvisioningWSAddAlternateIdTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSAddAlternateIdEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSAddAlternateIdEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSAddAlternateIdTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSAddAlternateIdEntry" conceptual row (SubscriberWSAddAlternateIdEntryMeta)
     * 
     **/
    protected SubscriberWSAddAlternateIdEntryMeta createSubscriberWSAddAlternateIdEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSAddAlternateIdEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSAddAlternateIdEntryMetaNode("SubscriberWSAddAlternateIdEntry", "SubscriberProvisioningWSAddAlternateIdTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSAddAlternateIdEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSAddAlternateIdTable" + "\" must implement the \"" + 
                           "SubscriberWSAddAlternateIdEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSAddAlternateIdEntryMBean entry = (SubscriberWSAddAlternateIdEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSAddAlternateIdEntryMeta node;
