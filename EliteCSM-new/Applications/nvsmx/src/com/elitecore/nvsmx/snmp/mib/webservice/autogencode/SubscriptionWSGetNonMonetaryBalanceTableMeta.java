 ...
 */
public class SubscriptionWSGetNonMonetaryBalanceTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSGetNonMonetaryBalanceTableMeta".
     ...
     */
    public SubscriptionWSGetNonMonetaryBalanceTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSGetNonMonetaryBalanceEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSGetNonMonetaryBalanceEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSGetNonMonetaryBalanceTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSGetNonMonetaryBalanceEntry" conceptual row (SubscriptionWSGetNonMonetaryBalanceEntryMeta)
     * 
     **/
    protected SubscriptionWSGetNonMonetaryBalanceEntryMeta createSubscriptionWSGetNonMonetaryBalanceEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSGetNonMonetaryBalanceEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSGetNonMonetaryBalanceEntryMetaNode("SubscriptionWSGetNonMonetaryBalanceEntry", "SubscriptionWSGetNonMonetaryBalanceTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSGetNonMonetaryBalanceEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSGetNonMonetaryBalanceTable" + "\" must implement the \"" + 
                           "SubscriptionWSGetNonMonetaryBalanceEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSGetNonMonetaryBalanceEntryMBean entry = (SubscriptionWSGetNonMonetaryBalanceEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSGetNonMonetaryBalanceEntryMeta node;
