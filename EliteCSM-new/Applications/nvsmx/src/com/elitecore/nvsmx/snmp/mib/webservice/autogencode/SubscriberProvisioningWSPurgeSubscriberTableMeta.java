 ...
 */
public class SubscriberProvisioningWSPurgeSubscriberTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSPurgeSubscriberTableMeta".
     ...
     */
    public SubscriberProvisioningWSPurgeSubscriberTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSPurgeSubscriberEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSPurgeSubscriberEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSPurgeSubscriberTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSPurgeSubscriberEntry" conceptual row (SubscriberWSPurgeSubscriberEntryMeta)
     * 
     **/
    protected SubscriberWSPurgeSubscriberEntryMeta createSubscriberWSPurgeSubscriberEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSPurgeSubscriberEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSPurgeSubscriberEntryMetaNode("SubscriberWSPurgeSubscriberEntry", "SubscriberProvisioningWSPurgeSubscriberTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSPurgeSubscriberEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSPurgeSubscriberTable" + "\" must implement the \"" + 
                           "SubscriberWSPurgeSubscriberEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSPurgeSubscriberEntryMBean entry = (SubscriberWSPurgeSubscriberEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSPurgeSubscriberEntryMeta node;
