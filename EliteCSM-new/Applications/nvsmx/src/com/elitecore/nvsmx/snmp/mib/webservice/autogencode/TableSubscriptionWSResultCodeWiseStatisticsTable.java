...
public class TableSubscriptionWSResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSResultCodeWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSResultCodeWiseEntry" + ",SubscriptionWSResultCode=" + _keySubscriptionWSResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
