...
public class TableSubscriptionWSGetBalanceTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSGetBalanceTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSGetBalanceEntry" + ",GetBalanceResultCode=" + _keyGetBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
