...
public class TableSubscriberProvisioningWSMigrateSubscriberTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSMigrateSubscriberTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSMigrateSubscriberEntry" + ",MigrateSubscriberResultCode=" + _keyMigrateSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
