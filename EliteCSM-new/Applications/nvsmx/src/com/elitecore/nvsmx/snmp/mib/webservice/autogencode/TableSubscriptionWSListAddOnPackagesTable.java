...
public class TableSubscriptionWSListAddOnPackagesTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSListAddOnPackagesTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSListAddOnPackagesEntry" + ",ListAddOnPackagesResultCode=" + _keyListAddOnPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
