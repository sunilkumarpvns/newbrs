 ...
 */
public class SubscriptionWSListTopUpSubscriptionsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListTopUpSubscriptionsTableMeta".
     ...
     */
    public SubscriptionWSListTopUpSubscriptionsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListTopUpSubscriptionsEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListTopUpSubscriptionsEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListTopUpSubscriptionsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListTopUpSubscriptionsEntry" conceptual row (SubscriptionWSListTopUpSubscriptionsEntryMeta)
     * 
     **/
    protected SubscriptionWSListTopUpSubscriptionsEntryMeta createSubscriptionWSListTopUpSubscriptionsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListTopUpSubscriptionsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListTopUpSubscriptionsEntryMetaNode("SubscriptionWSListTopUpSubscriptionsEntry", "SubscriptionWSListTopUpSubscriptionsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListTopUpSubscriptionsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListTopUpSubscriptionsTable" + "\" must implement the \"" + 
                           "SubscriptionWSListTopUpSubscriptionsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListTopUpSubscriptionsEntryMBean entry = (SubscriptionWSListTopUpSubscriptionsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListTopUpSubscriptionsEntryMeta node;
