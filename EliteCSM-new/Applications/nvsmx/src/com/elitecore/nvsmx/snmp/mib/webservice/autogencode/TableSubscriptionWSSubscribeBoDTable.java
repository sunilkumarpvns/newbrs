...
public class TableSubscriptionWSSubscribeBoDTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSSubscribeBoDTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSSubscribeBoDEntry" + ",SubscribeBoDResultCode=" + _keySubscribeBoDResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
