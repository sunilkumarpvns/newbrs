...
public class TableSubscriptionWSGetNonMonetaryBalanceTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSGetNonMonetaryBalanceTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSGetNonMonetaryBalanceEntry" + ",GetNonMonetaryBalanceResultCode=" + _keyGetNonMonetaryBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
