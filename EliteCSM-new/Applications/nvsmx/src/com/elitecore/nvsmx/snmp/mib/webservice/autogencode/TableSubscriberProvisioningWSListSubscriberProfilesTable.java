...
public class TableSubscriberProvisioningWSListSubscriberProfilesTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSListSubscriberProfilesTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSListSubscriberProfilesEntry" + ",ListSubscriberProfilesResultCode=" + _keyListSubscriberProfilesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
