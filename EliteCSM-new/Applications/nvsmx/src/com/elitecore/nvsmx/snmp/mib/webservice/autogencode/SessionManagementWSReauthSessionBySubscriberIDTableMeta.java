 ...
 */
public class SessionManagementWSReauthSessionBySubscriberIDTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SessionManagementWSReauthSessionBySubscriberIDTableMeta".
     ...
     */
    public SessionManagementWSReauthSessionBySubscriberIDTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SessionWSReauthSessionBySubscriberIDEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SessionWSReauthSessionBySubscriberIDEntry")
     * @param tableName Name of the table in which the entries are registered ("SessionManagementWSReauthSessionBySubscriberIDTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SessionWSReauthSessionBySubscriberIDEntry" conceptual row (SessionWSReauthSessionBySubscriberIDEntryMeta)
     * 
     **/
    protected SessionWSReauthSessionBySubscriberIDEntryMeta createSessionWSReauthSessionBySubscriberIDEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SessionWSReauthSessionBySubscriberIDEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSessionWSReauthSessionBySubscriberIDEntryMetaNode("SessionWSReauthSessionBySubscriberIDEntry", "SessionManagementWSReauthSessionBySubscriberIDTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SessionWSReauthSessionBySubscriberIDEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SessionManagementWSReauthSessionBySubscriberIDTable" + "\" must implement the \"" + 
                           "SessionWSReauthSessionBySubscriberIDEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SessionWSReauthSessionBySubscriberIDEntryMBean entry = (SessionWSReauthSessionBySubscriberIDEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SessionWSReauthSessionBySubscriberIDEntryMeta node;
