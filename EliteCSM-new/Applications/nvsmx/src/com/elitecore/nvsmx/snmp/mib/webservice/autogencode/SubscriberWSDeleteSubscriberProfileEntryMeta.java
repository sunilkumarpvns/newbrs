...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSDeleteSubscriberProfileEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.9.1.
 */
public class SubscriberWSDeleteSubscriberProfileEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSDeleteSubscriberProfileEntry".
     */
    public SubscriberWSDeleteSubscriberProfileEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getDeleteSubscriberProfileResultCodeCounters());

            case 2:
                return new SnmpString(node.getDeleteSubscriberProfileResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSDeleteSubscriberProfileEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSDeleteSubscriberProfileEntryMBean node;
