...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSListRnCPackagesEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.24.1.
 */
public class SubscriptionWSListRnCPackagesEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSListRnCPackagesEntry".
     */
    public SubscriptionWSListRnCPackagesEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getListRnCPackagesResultCodeCounters());

            case 2:
                return new SnmpString(node.getListRnCPackagesResultCodeName());
     ...
     */
    protected void setInstance(SubscriptionWSListRnCPackagesEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSListRnCPackagesEntryMBean node;
