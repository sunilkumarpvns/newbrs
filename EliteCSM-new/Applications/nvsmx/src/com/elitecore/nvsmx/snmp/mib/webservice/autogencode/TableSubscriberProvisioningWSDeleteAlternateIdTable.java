...
public class TableSubscriberProvisioningWSDeleteAlternateIdTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSDeleteAlternateIdTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSDeleteAlternateIdEntry" + ",DeleteAlternateIdResultCode=" + _keyDeleteAlternateIdResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
