 ...
 */
public class SubscriptionWSGetBalanceTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSGetBalanceTableMeta".
     ...
     */
    public SubscriptionWSGetBalanceTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSGetBalanceEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSGetBalanceEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSGetBalanceTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSGetBalanceEntry" conceptual row (SubscriptionWSGetBalanceEntryMeta)
     * 
     **/
    protected SubscriptionWSGetBalanceEntryMeta createSubscriptionWSGetBalanceEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSGetBalanceEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSGetBalanceEntryMetaNode("SubscriptionWSGetBalanceEntry", "SubscriptionWSGetBalanceTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSGetBalanceEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSGetBalanceTable" + "\" must implement the \"" + 
                           "SubscriptionWSGetBalanceEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSGetBalanceEntryMBean entry = (SubscriptionWSGetBalanceEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSGetBalanceEntryMeta node;
