 ...
 */
public class SubscriptionWSSubscribeTopUpTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSSubscribeTopUpTableMeta".
     ...
     */
    public SubscriptionWSSubscribeTopUpTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSSubscribeTopUpEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSSubscribeTopUpEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSSubscribeTopUpTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSSubscribeTopUpEntry" conceptual row (SubscriptionWSSubscribeTopUpEntryMeta)
     * 
     **/
    protected SubscriptionWSSubscribeTopUpEntryMeta createSubscriptionWSSubscribeTopUpEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSSubscribeTopUpEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSSubscribeTopUpEntryMetaNode("SubscriptionWSSubscribeTopUpEntry", "SubscriptionWSSubscribeTopUpTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSSubscribeTopUpEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSSubscribeTopUpTable" + "\" must implement the \"" + 
                           "SubscriptionWSSubscribeTopUpEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSSubscribeTopUpEntryMBean entry = (SubscriptionWSSubscribeTopUpEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSSubscribeTopUpEntryMeta node;
