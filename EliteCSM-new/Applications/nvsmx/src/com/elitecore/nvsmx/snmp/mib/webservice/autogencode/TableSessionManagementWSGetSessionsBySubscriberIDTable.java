...
public class TableSessionManagementWSGetSessionsBySubscriberIDTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSessionManagementWSGetSessionsBySubscriberIDTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SessionWSGetSessionsBySubscriberIDEntry" + ",GetSessionsBySubscriberIDResultCode=" + _keyGetSessionsBySubscriberIDResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
