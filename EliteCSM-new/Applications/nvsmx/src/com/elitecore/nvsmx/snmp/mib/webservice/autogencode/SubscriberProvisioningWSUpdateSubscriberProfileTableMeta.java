 ...
 */
public class SubscriberProvisioningWSUpdateSubscriberProfileTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSUpdateSubscriberProfileTableMeta".
     ...
     */
    public SubscriberProvisioningWSUpdateSubscriberProfileTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSUpdateSubscriberProfileEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSUpdateSubscriberProfileEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSUpdateSubscriberProfileTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSUpdateSubscriberProfileEntry" conceptual row (SubscriberWSUpdateSubscriberProfileEntryMeta)
     * 
     **/
    protected SubscriberWSUpdateSubscriberProfileEntryMeta createSubscriberWSUpdateSubscriberProfileEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSUpdateSubscriberProfileEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSUpdateSubscriberProfileEntryMetaNode("SubscriberWSUpdateSubscriberProfileEntry", "SubscriberProvisioningWSUpdateSubscriberProfileTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSUpdateSubscriberProfileEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSUpdateSubscriberProfileTable" + "\" must implement the \"" + 
                           "SubscriberWSUpdateSubscriberProfileEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSUpdateSubscriberProfileEntryMBean entry = (SubscriberWSUpdateSubscriberProfileEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSUpdateSubscriberProfileEntryMeta node;
