 ...
 */
public class SubscriptionWSListPackagesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListPackagesTableMeta".
     ...
     */
    public SubscriptionWSListPackagesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListPackagesEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListPackagesEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListPackagesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListPackagesEntry" conceptual row (SubscriptionWSListPackagesEntryMeta)
     * 
     **/
    protected SubscriptionWSListPackagesEntryMeta createSubscriptionWSListPackagesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListPackagesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListPackagesEntryMetaNode("SubscriptionWSListPackagesEntry", "SubscriptionWSListPackagesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListPackagesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListPackagesTable" + "\" must implement the \"" + 
                           "SubscriptionWSListPackagesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListPackagesEntryMBean entry = (SubscriptionWSListPackagesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListPackagesEntryMeta node;
