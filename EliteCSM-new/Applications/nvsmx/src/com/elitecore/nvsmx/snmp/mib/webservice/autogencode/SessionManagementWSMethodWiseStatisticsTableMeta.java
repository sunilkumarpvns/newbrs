 ...
 */
public class SessionManagementWSMethodWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SessionManagementWSMethodWiseStatisticsTableMeta".
     ...
     */
    public SessionManagementWSMethodWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SessionManagementWSMethodWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SessionManagementWSMethodWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("SessionManagementWSMethodWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SessionManagementWSMethodWiseEntry" conceptual row (SessionManagementWSMethodWiseEntryMeta)
     * 
     **/
    protected SessionManagementWSMethodWiseEntryMeta createSessionManagementWSMethodWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SessionManagementWSMethodWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSessionManagementWSMethodWiseEntryMetaNode("SessionManagementWSMethodWiseEntry", "SessionManagementWSMethodWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SessionManagementWSMethodWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SessionManagementWSMethodWiseStatisticsTable" + "\" must implement the \"" + 
                           "SessionManagementWSMethodWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SessionManagementWSMethodWiseEntryMBean entry = (SessionManagementWSMethodWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SessionManagementWSMethodWiseEntryMeta node;
