...
import com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSSubscribeBoDEntry;
import com.elitecore.nvsmx.ws.interceptor.WebServiceStatistics;
import com.sun.management.snmp.SnmpStatusException;

public class SubscriptionWSSubscribeBoDEntryImpl extends SubscriptionWSSubscribeBoDEntry {
    private static final long serialVersionUID = 1L;
    private WebServiceStatistics webServiceStatistics;
    private ResultCode resultCode;

    public SubscriptionWSSubscribeBoDEntryImpl(ResultCode resultCode, WebServiceStatistics webServiceStatistis) {
