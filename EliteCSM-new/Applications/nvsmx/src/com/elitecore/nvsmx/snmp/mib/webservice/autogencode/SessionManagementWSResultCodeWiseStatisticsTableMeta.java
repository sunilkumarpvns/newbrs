 ...
 */
public class SessionManagementWSResultCodeWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SessionManagementWSResultCodeWiseStatisticsTableMeta".
     ...
     */
    public SessionManagementWSResultCodeWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SessionWSResultCodeWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SessionWSResultCodeWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("SessionManagementWSResultCodeWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SessionWSResultCodeWiseEntry" conceptual row (SessionWSResultCodeWiseEntryMeta)
     * 
     **/
    protected SessionWSResultCodeWiseEntryMeta createSessionWSResultCodeWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SessionWSResultCodeWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSessionWSResultCodeWiseEntryMetaNode("SessionWSResultCodeWiseEntry", "SessionManagementWSResultCodeWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SessionWSResultCodeWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SessionManagementWSResultCodeWiseStatisticsTable" + "\" must implement the \"" + 
                           "SessionWSResultCodeWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SessionWSResultCodeWiseEntryMBean entry = (SessionWSResultCodeWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SessionWSResultCodeWiseEntryMeta node;
