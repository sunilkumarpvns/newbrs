...
import com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSGetMonetaryBalanceEntry;
import com.elitecore.nvsmx.ws.interceptor.WebServiceStatistics;
import com.sun.management.snmp.SnmpStatusException;

public class SubscriptionWSGetMonetaryBalanceEntryImpl extends SubscriptionWSGetMonetaryBalanceEntry {

    private static final long serialVersionUID = 1L;
    private WebServiceStatistics webServiceStatistics;
    private ResultCode resultCode;

    public SubscriptionWSGetMonetaryBalanceEntryImpl(ResultCode resultCode, WebServiceStatistics webServiceStatistis) {
