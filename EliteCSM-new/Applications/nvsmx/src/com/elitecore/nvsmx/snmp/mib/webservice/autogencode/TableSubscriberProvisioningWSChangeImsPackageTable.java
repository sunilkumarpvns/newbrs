...
public class TableSubscriberProvisioningWSChangeImsPackageTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSChangeImsPackageTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSChangeImsPackageEntry" + ",ChangeImsPackageResultCode=" + _keyChangeImsPackageResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
