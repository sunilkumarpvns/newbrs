...
public class TableSubscriberProvisioningWSResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSResultCodeWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSResultCodeWiseEntry" + ",SubscriberWSResultCode=" + _keySubscriberWSResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
