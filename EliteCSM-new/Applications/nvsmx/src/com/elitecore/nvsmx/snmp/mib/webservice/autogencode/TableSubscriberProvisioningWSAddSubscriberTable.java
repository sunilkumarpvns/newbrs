...
public class TableSubscriberProvisioningWSAddSubscriberTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSAddSubscriberTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSAddSubscriberEntry" + ",AddSubscriberResultCode=" + _keyAddSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
