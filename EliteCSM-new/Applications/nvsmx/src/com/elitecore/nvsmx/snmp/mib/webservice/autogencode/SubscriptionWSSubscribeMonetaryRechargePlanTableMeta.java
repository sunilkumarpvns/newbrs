 ...
 */
public class SubscriptionWSSubscribeMonetaryRechargePlanTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSSubscribeMonetaryRechargePlanTableMeta".
     ...
     */
    public SubscriptionWSSubscribeMonetaryRechargePlanTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSSubscribeMonetaryRechargePlanEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSSubscribeMonetaryRechargePlanEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSSubscribeMonetaryRechargePlanTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSSubscribeMonetaryRechargePlanEntry" conceptual row (SubscriptionWSSubscribeMonetaryRechargePlanEntryMeta)
     * 
     **/
    protected SubscriptionWSSubscribeMonetaryRechargePlanEntryMeta createSubscriptionWSSubscribeMonetaryRechargePlanEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSSubscribeMonetaryRechargePlanEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSSubscribeMonetaryRechargePlanEntryMetaNode("SubscriptionWSSubscribeMonetaryRechargePlanEntry", "SubscriptionWSSubscribeMonetaryRechargePlanTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSSubscribeMonetaryRechargePlanEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSSubscribeMonetaryRechargePlanTable" + "\" must implement the \"" + 
                           "SubscriptionWSSubscribeMonetaryRechargePlanEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSSubscribeMonetaryRechargePlanEntryMBean entry = (SubscriptionWSSubscribeMonetaryRechargePlanEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSSubscribeMonetaryRechargePlanEntryMeta node;
