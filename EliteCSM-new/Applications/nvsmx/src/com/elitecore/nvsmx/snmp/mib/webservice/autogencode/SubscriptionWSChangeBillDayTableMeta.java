 ...
 */
public class SubscriptionWSChangeBillDayTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSChangeBillDayTableMeta".
     ...
     */
    public SubscriptionWSChangeBillDayTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSChangeBillDayEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSChangeBillDayEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSChangeBillDayTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSChangeBillDayEntry" conceptual row (SubscriptionWSChangeBillDayEntryMeta)
     * 
     **/
    protected SubscriptionWSChangeBillDayEntryMeta createSubscriptionWSChangeBillDayEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSChangeBillDayEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSChangeBillDayEntryMetaNode("SubscriptionWSChangeBillDayEntry", "SubscriptionWSChangeBillDayTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSChangeBillDayEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSChangeBillDayTable" + "\" must implement the \"" + 
                           "SubscriptionWSChangeBillDayEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSChangeBillDayEntryMBean entry = (SubscriptionWSChangeBillDayEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSChangeBillDayEntryMeta node;
