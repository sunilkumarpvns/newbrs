...
public class TableSubscriptionWSChangeTopUpSubscriptionTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSChangeTopUpSubscriptionTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSChangeTopUpSubscriptionEntry" + ",ChangeTopUpSubscriptionResultCode=" + _keyChangeTopUpSubscriptionResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
