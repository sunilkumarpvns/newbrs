 ...
 */
public class SubscriptionWSChangeRnCAddOnSubscriptionTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSChangeRnCAddOnSubscriptionTableMeta".
     ...
     */
    public SubscriptionWSChangeRnCAddOnSubscriptionTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSChangeRnCAddOnSubscriptionEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSChangeRnCAddOnSubscriptionEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSChangeRnCAddOnSubscriptionTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSChangeRnCAddOnSubscriptionEntry" conceptual row (SubscriptionWSChangeRnCAddOnSubscriptionEntryMeta)
     * 
     **/
    protected SubscriptionWSChangeRnCAddOnSubscriptionEntryMeta createSubscriptionWSChangeRnCAddOnSubscriptionEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSChangeRnCAddOnSubscriptionEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSChangeRnCAddOnSubscriptionEntryMetaNode("SubscriptionWSChangeRnCAddOnSubscriptionEntry", "SubscriptionWSChangeRnCAddOnSubscriptionTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSChangeRnCAddOnSubscriptionEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSChangeRnCAddOnSubscriptionTable" + "\" must implement the \"" + 
                           "SubscriptionWSChangeRnCAddOnSubscriptionEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSChangeRnCAddOnSubscriptionEntryMBean entry = (SubscriptionWSChangeRnCAddOnSubscriptionEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSChangeRnCAddOnSubscriptionEntryMeta node;
