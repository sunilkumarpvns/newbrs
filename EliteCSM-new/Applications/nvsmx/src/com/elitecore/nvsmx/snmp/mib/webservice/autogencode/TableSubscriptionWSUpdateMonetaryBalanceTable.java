...
public class TableSubscriptionWSUpdateMonetaryBalanceTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSUpdateMonetaryBalanceTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSUpdateMonetaryBalanceEntry" + ",UpdateMonetaryBalanceResultCode=" + _keyUpdateMonetaryBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
