...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSListTopUpPackagesEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.15.1.
 */
public class SubscriptionWSListTopUpPackagesEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSListTopUpPackagesEntry".
     */
    public SubscriptionWSListTopUpPackagesEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getListTopUpPackagesResultCodeCounters());

            case 2:
                return new SnmpString(node.getListTopUpPackagesResultCodeName());
     ...
     */
    protected void setInstance(SubscriptionWSListTopUpPackagesEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSListTopUpPackagesEntryMBean node;
