...
public class TableSubscriptionWSMethodWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSMethodWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSMethodWiseEntry" + ",SubscriptionWSMethodIndex=" + _keySubscriptionWSMethodIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
