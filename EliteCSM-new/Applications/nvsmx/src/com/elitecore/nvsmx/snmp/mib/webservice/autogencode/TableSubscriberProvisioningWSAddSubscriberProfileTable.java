...
public class TableSubscriberProvisioningWSAddSubscriberProfileTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSAddSubscriberProfileTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSAddSubscriberProfileEntry" + ",AddSubscriberProfileResultCode=" + _keyAddSubscriberProfileResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
