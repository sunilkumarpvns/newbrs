...
public class TableSubscriberProvisioningWSAddSubscriberBulkTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSAddSubscriberBulkTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSAddSubscriberBulkEntry" + ",AddSubscriberBulkResultCode=" + _keyAddSubscriberBulkResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
