...
public class TableSubscriptionWSGetMonetaryBalanceTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSGetMonetaryBalanceTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSGetMonetaryBalanceEntry" + ",GetMonetaryBalanceResultCode=" + _keyGetMonetaryBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
