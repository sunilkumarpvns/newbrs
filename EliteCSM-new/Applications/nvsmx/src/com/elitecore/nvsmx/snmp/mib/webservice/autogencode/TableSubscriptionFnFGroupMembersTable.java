...
public class TableSubscriptionFnFGroupMembersTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionFnFGroupMembersTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionFnFGroupMembersEntry" + ",FnFGroupMembersResultCode=" + _keyFnFGroupMembersResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
