...
public class TableResetUsageWSResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableResetUsageWSResultCodeWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.ResetUsageWSResultCodeWiseEntry" + ",ResetUsageWSResultCode=" + _keyResetUsageWSResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
