...
public class TableSubscriberProvisioningWSChangeBaseProductOfferTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSChangeBaseProductOfferTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSChangeBaseProductOfferEntry" + ",ChangeBaseProductOfferResultCode=" + _keyChangeBaseProductOfferResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
