 ...
 */
public class SubscriptionWSResultCodeWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSResultCodeWiseStatisticsTableMeta".
     ...
     */
    public SubscriptionWSResultCodeWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSResultCodeWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSResultCodeWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSResultCodeWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSResultCodeWiseEntry" conceptual row (SubscriptionWSResultCodeWiseEntryMeta)
     * 
     **/
    protected SubscriptionWSResultCodeWiseEntryMeta createSubscriptionWSResultCodeWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSResultCodeWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSResultCodeWiseEntryMetaNode("SubscriptionWSResultCodeWiseEntry", "SubscriptionWSResultCodeWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSResultCodeWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSResultCodeWiseStatisticsTable" + "\" must implement the \"" + 
                           "SubscriptionWSResultCodeWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSResultCodeWiseEntryMBean entry = (SubscriptionWSResultCodeWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSResultCodeWiseEntryMeta node;
