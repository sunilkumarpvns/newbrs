...
public class TableSubscriptionWSListTopUpSubscriptionsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSListTopUpSubscriptionsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSListTopUpSubscriptionsEntry" + ",ListTopUpSubscriptionsResultCode=" + _keyListTopUpSubscriptionsResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
