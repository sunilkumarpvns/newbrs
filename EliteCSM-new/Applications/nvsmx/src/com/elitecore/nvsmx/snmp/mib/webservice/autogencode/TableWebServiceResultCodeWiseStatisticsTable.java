...
public class TableWebServiceResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableWebServiceResultCodeWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.WebServiceResultCodeWiseEntry" + ",WebServiceResultCode=" + _keyWebServiceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
