...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSUpdateSubscriberProfileEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.8.1.
 */
public class SubscriberWSUpdateSubscriberProfileEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSUpdateSubscriberProfileEntry".
     */
    public SubscriberWSUpdateSubscriberProfileEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getUpdateSubscriberProfileResultCodeCounters());

            case 2:
                return new SnmpString(node.getUpdateSubscriberProfileResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSUpdateSubscriberProfileEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSUpdateSubscriberProfileEntryMBean node;
