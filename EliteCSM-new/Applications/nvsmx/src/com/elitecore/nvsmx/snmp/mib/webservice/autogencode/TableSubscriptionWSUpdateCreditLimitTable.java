...
public class TableSubscriptionWSUpdateCreditLimitTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSUpdateCreditLimitTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSUpdateCreditLimitEntry" + ",UpdateCreditLimitResultCode=" + _keyUpdateCreditLimitResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
