 ...
 */
public class SubscriberProvisioningWSChangeImsPackageTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSChangeImsPackageTableMeta".
     ...
     */
    public SubscriberProvisioningWSChangeImsPackageTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSChangeImsPackageEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSChangeImsPackageEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSChangeImsPackageTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSChangeImsPackageEntry" conceptual row (SubscriberWSChangeImsPackageEntryMeta)
     * 
     **/
    protected SubscriberWSChangeImsPackageEntryMeta createSubscriberWSChangeImsPackageEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSChangeImsPackageEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSChangeImsPackageEntryMetaNode("SubscriberWSChangeImsPackageEntry", "SubscriberProvisioningWSChangeImsPackageTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSChangeImsPackageEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSChangeImsPackageTable" + "\" must implement the \"" + 
                           "SubscriberWSChangeImsPackageEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSChangeImsPackageEntryMBean entry = (SubscriberWSChangeImsPackageEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSChangeImsPackageEntryMeta node;
