...
public class TableSubscriberProvisioningWSUpdateAlternateIdTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSUpdateAlternateIdTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSUpdateAlternateIdEntry" + ",UpdateAlternateIdResultCode=" + _keyUpdateAlternateIdResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
