...
public class TableSubscriberProvisioningWSRestoreSubscribersTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSRestoreSubscribersTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSRestoreSubscribersEntry" + ",RestoreSubscribersResultCode=" + _keyRestoreSubscribersResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
