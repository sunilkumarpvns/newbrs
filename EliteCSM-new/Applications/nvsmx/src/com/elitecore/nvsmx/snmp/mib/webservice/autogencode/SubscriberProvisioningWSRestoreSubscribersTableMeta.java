 ...
 */
public class SubscriberProvisioningWSRestoreSubscribersTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSRestoreSubscribersTableMeta".
     ...
     */
    public SubscriberProvisioningWSRestoreSubscribersTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSRestoreSubscribersEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSRestoreSubscribersEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSRestoreSubscribersTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSRestoreSubscribersEntry" conceptual row (SubscriberWSRestoreSubscribersEntryMeta)
     * 
     **/
    protected SubscriberWSRestoreSubscribersEntryMeta createSubscriberWSRestoreSubscribersEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSRestoreSubscribersEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSRestoreSubscribersEntryMetaNode("SubscriberWSRestoreSubscribersEntry", "SubscriberProvisioningWSRestoreSubscribersTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSRestoreSubscribersEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSRestoreSubscribersTable" + "\" must implement the \"" + 
                           "SubscriberWSRestoreSubscribersEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSRestoreSubscribersEntryMBean entry = (SubscriberWSRestoreSubscribersEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSRestoreSubscribersEntryMeta node;
