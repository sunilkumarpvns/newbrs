...
public class TableSubscriberProvisioningWSPurgeAllSubscriberTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSPurgeAllSubscriberTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSPurgeAllSubscriberEntry" + ",PurgeAllSubscriberResultCode=" + _keyPurgeAllSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
