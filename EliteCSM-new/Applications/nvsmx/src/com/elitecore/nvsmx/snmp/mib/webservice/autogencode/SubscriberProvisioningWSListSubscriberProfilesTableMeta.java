 ...
 */
public class SubscriberProvisioningWSListSubscriberProfilesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSListSubscriberProfilesTableMeta".
     ...
     */
    public SubscriberProvisioningWSListSubscriberProfilesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSListSubscriberProfilesEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSListSubscriberProfilesEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSListSubscriberProfilesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSListSubscriberProfilesEntry" conceptual row (SubscriberWSListSubscriberProfilesEntryMeta)
     * 
     **/
    protected SubscriberWSListSubscriberProfilesEntryMeta createSubscriberWSListSubscriberProfilesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSListSubscriberProfilesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSListSubscriberProfilesEntryMetaNode("SubscriberWSListSubscriberProfilesEntry", "SubscriberProvisioningWSListSubscriberProfilesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSListSubscriberProfilesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSListSubscriberProfilesTable" + "\" must implement the \"" + 
                           "SubscriberWSListSubscriberProfilesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSListSubscriberProfilesEntryMBean entry = (SubscriberWSListSubscriberProfilesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSListSubscriberProfilesEntryMeta node;
