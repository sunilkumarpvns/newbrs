...
import com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSUpdateMonetaryBalanceEntry;
import com.elitecore.nvsmx.ws.interceptor.WebServiceStatistics;
import com.sun.management.snmp.SnmpStatusException;

public class SubscriptionWSUpdateMonetaryBalanceEntryImpl extends SubscriptionWSUpdateMonetaryBalanceEntry {

    private static final long serialVersionUID = 1L;
    private WebServiceStatistics webServiceStatistics;
    private ResultCode resultCode;

    public SubscriptionWSUpdateMonetaryBalanceEntryImpl(ResultCode resultCode, WebServiceStatistics webServiceStatistis) {
