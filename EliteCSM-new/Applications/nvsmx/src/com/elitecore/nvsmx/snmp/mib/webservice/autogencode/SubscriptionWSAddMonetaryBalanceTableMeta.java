 ...
 */
public class SubscriptionWSAddMonetaryBalanceTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSAddMonetaryBalanceTableMeta".
     ...
     */
    public SubscriptionWSAddMonetaryBalanceTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSAddMonetaryBalanceEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSAddMonetaryBalanceEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSAddMonetaryBalanceTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSAddMonetaryBalanceEntry" conceptual row (SubscriptionWSAddMonetaryBalanceEntryMeta)
     * 
     **/
    protected SubscriptionWSAddMonetaryBalanceEntryMeta createSubscriptionWSAddMonetaryBalanceEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSAddMonetaryBalanceEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSAddMonetaryBalanceEntryMetaNode("SubscriptionWSAddMonetaryBalanceEntry", "SubscriptionWSAddMonetaryBalanceTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSAddMonetaryBalanceEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSAddMonetaryBalanceTable" + "\" must implement the \"" + 
                           "SubscriptionWSAddMonetaryBalanceEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSAddMonetaryBalanceEntryMBean entry = (SubscriptionWSAddMonetaryBalanceEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSAddMonetaryBalanceEntryMeta node;
