...
public class TableSubscriptionWSChangeBillDayTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSChangeBillDayTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSChangeBillDayEntry" + ",ChangeBillDayResultCode=" + _keyChangeBillDayResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
