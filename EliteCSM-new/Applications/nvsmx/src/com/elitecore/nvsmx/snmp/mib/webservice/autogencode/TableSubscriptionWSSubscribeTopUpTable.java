...
public class TableSubscriptionWSSubscribeTopUpTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSSubscribeTopUpTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSSubscribeTopUpEntry" + ",SubscribeTopUpResultCode=" + _keySubscribeTopUpResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
