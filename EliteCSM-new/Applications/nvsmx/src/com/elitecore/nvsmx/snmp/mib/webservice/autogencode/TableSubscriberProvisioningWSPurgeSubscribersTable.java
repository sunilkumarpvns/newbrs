...
public class TableSubscriberProvisioningWSPurgeSubscribersTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSPurgeSubscribersTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSPurgeSubscribersEntry" + ",PurgeSubscribersResultCode=" + _keyPurgeSubscribersResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
