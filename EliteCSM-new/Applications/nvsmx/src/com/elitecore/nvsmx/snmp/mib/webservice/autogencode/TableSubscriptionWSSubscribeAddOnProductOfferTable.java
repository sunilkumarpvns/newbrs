...
public class TableSubscriptionWSSubscribeAddOnProductOfferTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSSubscribeAddOnProductOfferTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSSubscribeAddOnProductOfferEntry" + ",SubscribeAddOnProductOfferResultCode=" + _keySubscribeAddOnProductOfferResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
