 ...
 */
public class SubscriptionWSListBoDPackagesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListBoDPackagesTableMeta".
     ...
     */
    public SubscriptionWSListBoDPackagesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListBoDPackagesEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListBoDPackagesEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListBoDPackagesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListBoDPackagesEntry" conceptual row (SubscriptionWSListBoDPackagesEntryMeta)
     * 
     **/
    protected SubscriptionWSListBoDPackagesEntryMeta createSubscriptionWSListBoDPackagesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListBoDPackagesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListBoDPackagesEntryMetaNode("SubscriptionWSListBoDPackagesEntry", "SubscriptionWSListBoDPackagesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListBoDPackagesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListBoDPackagesTable" + "\" must implement the \"" + 
                           "SubscriptionWSListBoDPackagesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListBoDPackagesEntryMBean entry = (SubscriptionWSListBoDPackagesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListBoDPackagesEntryMeta node;
