 ...
 */
public class SubscriberProvisioningWSPurgeAllSubscriberTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSPurgeAllSubscriberTableMeta".
     ...
     */
    public SubscriberProvisioningWSPurgeAllSubscriberTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSPurgeAllSubscriberEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSPurgeAllSubscriberEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSPurgeAllSubscriberTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSPurgeAllSubscriberEntry" conceptual row (SubscriberWSPurgeAllSubscriberEntryMeta)
     * 
     **/
    protected SubscriberWSPurgeAllSubscriberEntryMeta createSubscriberWSPurgeAllSubscriberEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSPurgeAllSubscriberEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSPurgeAllSubscriberEntryMetaNode("SubscriberWSPurgeAllSubscriberEntry", "SubscriberProvisioningWSPurgeAllSubscriberTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSPurgeAllSubscriberEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSPurgeAllSubscriberTable" + "\" must implement the \"" + 
                           "SubscriberWSPurgeAllSubscriberEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSPurgeAllSubscriberEntryMBean entry = (SubscriberWSPurgeAllSubscriberEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSPurgeAllSubscriberEntryMeta node;
