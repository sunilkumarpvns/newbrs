 ...
 */
public class SubscriberProvisioningWSAddSubscriberBulkTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSAddSubscriberBulkTableMeta".
     ...
     */
    public SubscriberProvisioningWSAddSubscriberBulkTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSAddSubscriberBulkEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSAddSubscriberBulkEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSAddSubscriberBulkTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSAddSubscriberBulkEntry" conceptual row (SubscriberWSAddSubscriberBulkEntryMeta)
     * 
     **/
    protected SubscriberWSAddSubscriberBulkEntryMeta createSubscriberWSAddSubscriberBulkEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSAddSubscriberBulkEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSAddSubscriberBulkEntryMetaNode("SubscriberWSAddSubscriberBulkEntry", "SubscriberProvisioningWSAddSubscriberBulkTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSAddSubscriberBulkEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSAddSubscriberBulkTable" + "\" must implement the \"" + 
                           "SubscriberWSAddSubscriberBulkEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSAddSubscriberBulkEntryMBean entry = (SubscriberWSAddSubscriberBulkEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSAddSubscriberBulkEntryMeta node;
