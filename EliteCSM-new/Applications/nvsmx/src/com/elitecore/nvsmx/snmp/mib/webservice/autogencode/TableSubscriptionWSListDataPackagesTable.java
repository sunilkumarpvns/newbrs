...
public class TableSubscriptionWSListDataPackagesTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSListDataPackagesTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSListDataPackagesEntry" + ",ListDataPackagesResultCode=" + _keyListDataPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
