...
public class TableSubscriberProvisioningWSPurgeSubscriberTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSPurgeSubscriberTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberWSPurgeSubscriberEntry" + ",PurgeSubscriberResultCode=" + _keyPurgeSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
