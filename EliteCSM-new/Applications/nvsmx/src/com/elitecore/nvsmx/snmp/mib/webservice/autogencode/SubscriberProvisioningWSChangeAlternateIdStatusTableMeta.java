 ...
 */
public class SubscriberProvisioningWSChangeAlternateIdStatusTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSChangeAlternateIdStatusTableMeta".
     ...
     */
    public SubscriberProvisioningWSChangeAlternateIdStatusTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSChangeAlternateIdStatusEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSChangeAlternateIdStatusEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSChangeAlternateIdStatusTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSChangeAlternateIdStatusEntry" conceptual row (SubscriberWSChangeAlternateIdStatusEntryMeta)
     * 
     **/
    protected SubscriberWSChangeAlternateIdStatusEntryMeta createSubscriberWSChangeAlternateIdStatusEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSChangeAlternateIdStatusEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSChangeAlternateIdStatusEntryMetaNode("SubscriberWSChangeAlternateIdStatusEntry", "SubscriberProvisioningWSChangeAlternateIdStatusTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSChangeAlternateIdStatusEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSChangeAlternateIdStatusTable" + "\" must implement the \"" + 
                           "SubscriberWSChangeAlternateIdStatusEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSChangeAlternateIdStatusEntryMBean entry = (SubscriberWSChangeAlternateIdStatusEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSChangeAlternateIdStatusEntryMeta node;
