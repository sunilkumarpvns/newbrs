...
public class TableSessionManagementWSResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSessionManagementWSResultCodeWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SessionWSResultCodeWiseEntry" + ",SessionWSResultCode=" + _keySessionWSResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
