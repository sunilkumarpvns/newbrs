...
public class TableSubscriptionWSListTopUpPackagesTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriptionWSListTopUpPackagesTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriptionWSListTopUpPackagesEntry" + ",ListTopUpPackagesResultCode=" + _keyListTopUpPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
