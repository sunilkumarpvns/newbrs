...
public class TableSubscriberProvisioningWSMethodWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSubscriberProvisioningWSMethodWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SubscriberProvisioningWSMethodWiseEntry" + ",SubscriberWSMethodIndex=" + _keySubscriberWSMethodIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
