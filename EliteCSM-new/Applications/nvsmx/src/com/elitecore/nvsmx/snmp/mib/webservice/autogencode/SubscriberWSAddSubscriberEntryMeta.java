...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSAddSubscriberEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.20.1.
 */
public class SubscriberWSAddSubscriberEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSAddSubscriberEntry".
     */
    public SubscriberWSAddSubscriberEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getAddSubscriberResultCodeCounters());

            case 2:
                return new SnmpString(node.getAddSubscriberResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSAddSubscriberEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSAddSubscriberEntryMBean node;
