...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSAddSubscribersEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.21.1.
 */
public class SubscriberWSAddSubscribersEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSAddSubscribersEntry".
     */
    public SubscriberWSAddSubscribersEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getAddSubscribersResultCodeCounters());

            case 2:
                return new SnmpString(node.getAddSubscribersResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSAddSubscribersEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSAddSubscribersEntryMBean node;
