...
public class TableSessionManagementWSMethodWiseStatisticsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableSessionManagementWSMethodWiseStatisticsTable:name=com.elitecore.nvsmx.snmp.mib.webservice.autogencode.SessionManagementWSMethodWiseEntry" + ",SessionWSMethodIndex=" + _keySessionWSMethodIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
