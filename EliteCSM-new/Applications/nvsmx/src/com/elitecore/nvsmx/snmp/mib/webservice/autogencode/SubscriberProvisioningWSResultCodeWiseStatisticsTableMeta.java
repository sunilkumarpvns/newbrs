 ...
 */
public class SubscriberProvisioningWSResultCodeWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSResultCodeWiseStatisticsTableMeta".
     ...
     */
    public SubscriberProvisioningWSResultCodeWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSResultCodeWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSResultCodeWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSResultCodeWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSResultCodeWiseEntry" conceptual row (SubscriberWSResultCodeWiseEntryMeta)
     * 
     **/
    protected SubscriberWSResultCodeWiseEntryMeta createSubscriberWSResultCodeWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSResultCodeWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSResultCodeWiseEntryMetaNode("SubscriberWSResultCodeWiseEntry", "SubscriberProvisioningWSResultCodeWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSResultCodeWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSResultCodeWiseStatisticsTable" + "\" must implement the \"" + 
                           "SubscriberWSResultCodeWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSResultCodeWiseEntryMBean entry = (SubscriberWSResultCodeWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSResultCodeWiseEntryMeta node;
