...
public class DeleteSubscribersWSRequest extends SubscriberProvisioningWSRequest {
	...
	public DeleteSubscribersWSRequest(List<String> subscriberIdentities, List<String> alternateIds, String parameter1, String parameter2, String webServiceName,
