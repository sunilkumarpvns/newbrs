...
/**
 * Created by Ishani on 28/1/16.
 */
public class RestoreSubscribersWSRequest extends SubscriberProvisioningWSRequest{
    ...
    public RestoreSubscribersWSRequest(List<String> subscriberIdentities, List<String> alternateIds, String parameter1, String parameter2, String webServiceName, String webServiceMethodName) {
