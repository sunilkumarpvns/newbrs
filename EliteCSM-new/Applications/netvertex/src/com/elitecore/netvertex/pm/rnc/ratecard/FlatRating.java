...
public class FlatRating extends MonetaryRateCardVeresionDetail {

	public FlatRating(String id, String label1, String label2, Timestamp fromDate, List<RateSlab> slabs,
