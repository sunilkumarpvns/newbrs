...
public class VoiceRateCard implements RateCard {
	...
	public VoiceRateCard(String name, String accountingEffect, String keyOne, String keyTwo,
			List<RateCardVersion> rateCardVersions) {
		this.name = name;
