...
public class VoltDBScanDetailProvider extends DetailProvider {
    ...
    public VoltDBScanDetailProvider(NetVertexServerContext serverContext) {
    ...
    private String scanDataSource(DBDataSource dbDataSource) {
        ...
        List<String> dbDataSourceList = serverContext.getVoltDBClientManager().getDataSources();
        ...
        try {
            VoltDBClient voltDBClient = serverContext.getVoltDBClientManager().getVoltDBClient(dbDataSource.getDataSourceName());
            ...
            return "SCANNED SUCCESSFULLY \nCurrent Satus: " + (voltDBClient.isAlive() ? "ALIVE" : "DEAD");
