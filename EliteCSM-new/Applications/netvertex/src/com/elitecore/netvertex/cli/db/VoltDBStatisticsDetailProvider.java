...
public class VoltDBStatisticsDetailProvider extends DetailProvider {
    ...
    public VoltDBStatisticsDetailProvider(NetVertexServerContext serverContext) {
    ...
    protected Map<String, DBDataSource> getDBDatasourceMap() {
        ...
        if (dataSource.getConnectionURL().contains(CommonConstants.VOLTDB)) {
    ...
    private String displayStatistics(DBDataSource dbDataSource) {
        ...
        try {
            ...
            ESIStatistics statistics = voltDBClient.getStatistics();
