...
public class ClearCacheDetailProvider extends DetailProvider{

	private static final String CACHE = "cache";
	private HashMap<String ,DetailProvider> detailProviderMap;
	private static final String HELP = "-help";
	private static ClearCacheDetailProvider clearCacheDetailProvider;
	private ClearCacheDetailProvider(){
		detailProviderMap = new HashMap<String, DetailProvider>();
	}
	
	static {
		clearCacheDetailProvider = new ClearCacheDetailProvider();
	}
	
	public static ClearCacheDetailProvider getInstance() {
		
		return clearCacheDetailProvider;
	}
	@Override
	...
	public String getDescription() {
		return "Clears cache based on given parameter";
	}
}
