...
/**
 * The class is used for implementing the "SubscriberProvisioningWSChangeImsPackageTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.22.
 */
public class TableSubscriberProvisioningWSChangeImsPackageTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSChangeImsPackageTable".
     ...
     */
    public TableSubscriberProvisioningWSChangeImsPackageTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSChangeImsPackageTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSChangeImsPackageEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSChangeImsPackageEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSChangeImsPackageTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSChangeImsPackageEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSChangeImsPackageEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSChangeImsPackageEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSChangeImsPackageEntryMBean[] result = new SubscriberWSChangeImsPackageEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSChangeImsPackageEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyChangeImsPackageResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSChangeImsPackageTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSChangeImsPackageEntry" + ",ChangeImsPackageResultCode=" + _keyChangeImsPackageResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSChangeImsPackageEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSChangeImsPackageEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getChangeImsPackageResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSChangeImsPackageEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aChangeImsPackageResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aChangeImsPackageResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSChangeImsPackageEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSChangeImsPackageEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSChangeImsPackageEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSChangeImsPackageEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aChangeImsPackageResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSChangeImsPackageEntry entry = new SubscriberWSChangeImsPackageEntry(theMib);
        entry.ChangeImsPackageResultCode = aChangeImsPackageResultCode;
        return entry;
    }
