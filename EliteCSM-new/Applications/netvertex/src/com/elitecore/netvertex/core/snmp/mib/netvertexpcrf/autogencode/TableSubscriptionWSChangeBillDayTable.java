...
/**
 * The class is used for implementing the "SubscriptionWSChangeBillDayTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.28.
 */
public class TableSubscriptionWSChangeBillDayTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSChangeBillDayTable".
     ...
     */
    public TableSubscriptionWSChangeBillDayTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSChangeBillDayTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSChangeBillDayEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSChangeBillDayEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSChangeBillDayTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSChangeBillDayEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSChangeBillDayEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSChangeBillDayEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSChangeBillDayEntryMBean[] result = new SubscriptionWSChangeBillDayEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSChangeBillDayEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyChangeBillDayResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSChangeBillDayTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSChangeBillDayEntry" + ",ChangeBillDayResultCode=" + _keyChangeBillDayResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSChangeBillDayEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSChangeBillDayEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getChangeBillDayResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSChangeBillDayEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aChangeBillDayResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aChangeBillDayResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSChangeBillDayEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSChangeBillDayEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSChangeBillDayEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSChangeBillDayEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aChangeBillDayResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSChangeBillDayEntry entry = new SubscriptionWSChangeBillDayEntry(theMib);
        entry.ChangeBillDayResultCode = aChangeBillDayResultCode;
        return entry;
    }
