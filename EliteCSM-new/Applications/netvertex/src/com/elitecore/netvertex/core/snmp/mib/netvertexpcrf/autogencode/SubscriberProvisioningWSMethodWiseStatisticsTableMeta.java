 ...
 */
public class SubscriberProvisioningWSMethodWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSMethodWiseStatisticsTableMeta".
     ...
     */
    public SubscriberProvisioningWSMethodWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberProvisioningWSMethodWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberProvisioningWSMethodWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSMethodWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberProvisioningWSMethodWiseEntry" conceptual row (SubscriberProvisioningWSMethodWiseEntryMeta)
     * 
     **/
    protected SubscriberProvisioningWSMethodWiseEntryMeta createSubscriberProvisioningWSMethodWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberProvisioningWSMethodWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberProvisioningWSMethodWiseEntryMetaNode("SubscriberProvisioningWSMethodWiseEntry", "SubscriberProvisioningWSMethodWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberProvisioningWSMethodWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSMethodWiseStatisticsTable" + "\" must implement the \"" + 
                           "SubscriberProvisioningWSMethodWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberProvisioningWSMethodWiseEntryMBean entry = (SubscriberProvisioningWSMethodWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberProvisioningWSMethodWiseEntryMeta node;
