...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSAddSubscriberProfileEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.7.1.
 */
public class SubscriberWSAddSubscriberProfileEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSAddSubscriberProfileEntry".
     */
    public SubscriberWSAddSubscriberProfileEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getAddSubscriberProfileResultCodeCounters());

            case 2:
                return new SnmpString(node.getAddSubscriberProfileResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSAddSubscriberProfileEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSAddSubscriberProfileEntryMBean node;
