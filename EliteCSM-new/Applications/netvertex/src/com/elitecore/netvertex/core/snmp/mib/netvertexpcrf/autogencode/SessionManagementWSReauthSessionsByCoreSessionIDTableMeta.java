 ...
 */
public class SessionManagementWSReauthSessionsByCoreSessionIDTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SessionManagementWSReauthSessionsByCoreSessionIDTableMeta".
     ...
     */
    public SessionManagementWSReauthSessionsByCoreSessionIDTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SessionWSReauthSessionsByCoreSessionIDEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SessionWSReauthSessionsByCoreSessionIDEntry")
     * @param tableName Name of the table in which the entries are registered ("SessionManagementWSReauthSessionsByCoreSessionIDTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SessionWSReauthSessionsByCoreSessionIDEntry" conceptual row (SessionWSReauthSessionsByCoreSessionIDEntryMeta)
     * 
     **/
    protected SessionWSReauthSessionsByCoreSessionIDEntryMeta createSessionWSReauthSessionsByCoreSessionIDEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SessionWSReauthSessionsByCoreSessionIDEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSessionWSReauthSessionsByCoreSessionIDEntryMetaNode("SessionWSReauthSessionsByCoreSessionIDEntry", "SessionManagementWSReauthSessionsByCoreSessionIDTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SessionWSReauthSessionsByCoreSessionIDEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SessionManagementWSReauthSessionsByCoreSessionIDTable" + "\" must implement the \"" + 
                           "SessionWSReauthSessionsByCoreSessionIDEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SessionWSReauthSessionsByCoreSessionIDEntryMBean entry = (SessionWSReauthSessionsByCoreSessionIDEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SessionWSReauthSessionsByCoreSessionIDEntryMeta node;
