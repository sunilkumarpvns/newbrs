 ...
 */
public class SubscriptionWSListDataPackagesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListDataPackagesTableMeta".
     ...
     */
    public SubscriptionWSListDataPackagesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListDataPackagesEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListDataPackagesEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListDataPackagesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListDataPackagesEntry" conceptual row (SubscriptionWSListDataPackagesEntryMeta)
     * 
     **/
    protected SubscriptionWSListDataPackagesEntryMeta createSubscriptionWSListDataPackagesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListDataPackagesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListDataPackagesEntryMetaNode("SubscriptionWSListDataPackagesEntry", "SubscriptionWSListDataPackagesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListDataPackagesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListDataPackagesTable" + "\" must implement the \"" + 
                           "SubscriptionWSListDataPackagesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListDataPackagesEntryMBean entry = (SubscriptionWSListDataPackagesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListDataPackagesEntryMeta node;
