...
/**
 * The class is used for implementing the "SubscriberProvisioningWSAddSubscriberTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.20.
 */
public class TableSubscriberProvisioningWSAddSubscriberTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSAddSubscriberTable".
     ...
     */
    public TableSubscriberProvisioningWSAddSubscriberTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSAddSubscriberTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSAddSubscriberEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSAddSubscriberEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSAddSubscriberTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSAddSubscriberEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSAddSubscriberEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSAddSubscriberEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSAddSubscriberEntryMBean[] result = new SubscriberWSAddSubscriberEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSAddSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyAddSubscriberResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSAddSubscriberTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSAddSubscriberEntry" + ",AddSubscriberResultCode=" + _keyAddSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSAddSubscriberEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSAddSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getAddSubscriberResultCode());
        oids[0] = val.toOid();
    ...
    public SnmpOid buildOidFromIndexVal(Integer aAddSubscriberResultCode)
        ...
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aAddSubscriberResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSAddSubscriberEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSAddSubscriberEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSAddSubscriberEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSAddSubscriberEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aAddSubscriberResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSAddSubscriberEntry entry = new SubscriberWSAddSubscriberEntry(theMib);
        entry.AddSubscriberResultCode = aAddSubscriberResultCode;
        return entry;
    }
