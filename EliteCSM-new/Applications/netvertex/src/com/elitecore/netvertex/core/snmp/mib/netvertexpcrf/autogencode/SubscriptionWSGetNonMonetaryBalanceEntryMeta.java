...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSGetNonMonetaryBalanceEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.23.1.
 */
public class SubscriptionWSGetNonMonetaryBalanceEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSGetNonMonetaryBalanceEntry".
     */
    public SubscriptionWSGetNonMonetaryBalanceEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getGetNonMonetaryBalanceResultCodeCounters());

            case 2:
                return new SnmpString(node.getGetNonMonetaryBalanceResultCodeName());
     ...
     */
    protected void setInstance(SubscriptionWSGetNonMonetaryBalanceEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSGetNonMonetaryBalanceEntryMBean node;
