...
/**
 * The class is used for implementing the "SubscriberProvisioningWSAddAlternateIdTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.24.
 */
public class TableSubscriberProvisioningWSAddAlternateIdTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSAddAlternateIdTable".
     ...
     */
    public TableSubscriberProvisioningWSAddAlternateIdTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSAddAlternateIdTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSAddAlternateIdEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSAddAlternateIdEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSAddAlternateIdTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSAddAlternateIdEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSAddAlternateIdEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSAddAlternateIdEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSAddAlternateIdEntryMBean[] result = new SubscriberWSAddAlternateIdEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSAddAlternateIdEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyAddAlternateIdResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSAddAlternateIdTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSAddAlternateIdEntry" + ",AddAlternateIdResultCode=" + _keyAddAlternateIdResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSAddAlternateIdEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSAddAlternateIdEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getAddAlternateIdResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSAddAlternateIdEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aAddAlternateIdResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aAddAlternateIdResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSAddAlternateIdEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSAddAlternateIdEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSAddAlternateIdEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSAddAlternateIdEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aAddAlternateIdResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSAddAlternateIdEntry entry = new SubscriberWSAddAlternateIdEntry(theMib);
        entry.AddAlternateIdResultCode = aAddAlternateIdResultCode;
        return entry;
    }
