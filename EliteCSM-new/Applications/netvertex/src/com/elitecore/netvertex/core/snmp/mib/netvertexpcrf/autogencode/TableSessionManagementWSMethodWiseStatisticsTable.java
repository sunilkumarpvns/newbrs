...
/**
 * The class is used for implementing the "SessionManagementWSMethodWiseStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.11.5.
 */
public class TableSessionManagementWSMethodWiseStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSessionManagementWSMethodWiseStatisticsTable".
     ...
     */
    public TableSessionManagementWSMethodWiseStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSessionManagementWSMethodWiseStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SessionManagementWSMethodWiseEntryMBean"
            // interface.
            //
            final Object entry =
                 createSessionManagementWSMethodWiseEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SessionManagementWSMethodWiseStatisticsTable");
    }
    ...
    public synchronized void addEntry(SessionManagementWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SessionManagementWSMethodWiseEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SessionManagementWSMethodWiseEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SessionManagementWSMethodWiseEntryMBean[] result = new SessionManagementWSMethodWiseEntryMBean[array.length];
    ...
    public void removeEntry(SessionManagementWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySessionWSMethodIndex = oid.toInteger().toString();
            return new ObjectName("TableSessionManagementWSMethodWiseStatisticsTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SessionManagementWSMethodWiseEntry" + ",SessionWSMethodIndex=" + _keySessionWSMethodIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SessionManagementWSMethodWiseEntry".
     */
    public SnmpIndex buildSnmpIndex(SessionManagementWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSessionWSMethodIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SessionManagementWSMethodWiseEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSessionWSMethodIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSessionWSMethodIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SessionManagementWSMethodWiseEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SessionManagementWSMethodWiseEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SessionManagementWSMethodWiseEntryMBean"
     * interface.
    ...
    public Object createSessionManagementWSMethodWiseEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSessionWSMethodIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SessionManagementWSMethodWiseEntry entry = new SessionManagementWSMethodWiseEntry(theMib);
        entry.SessionWSMethodIndex = aSessionWSMethodIndex;
        return entry;
    }
