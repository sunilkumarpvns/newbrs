 ...
 */
public class SubscriberProvisioningWSDeleteSubscriberProfileTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSDeleteSubscriberProfileTableMeta".
     ...
     */
    public SubscriberProvisioningWSDeleteSubscriberProfileTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSDeleteSubscriberProfileEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSDeleteSubscriberProfileEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSDeleteSubscriberProfileTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSDeleteSubscriberProfileEntry" conceptual row (SubscriberWSDeleteSubscriberProfileEntryMeta)
     * 
     **/
    protected SubscriberWSDeleteSubscriberProfileEntryMeta createSubscriberWSDeleteSubscriberProfileEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSDeleteSubscriberProfileEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSDeleteSubscriberProfileEntryMetaNode("SubscriberWSDeleteSubscriberProfileEntry", "SubscriberProvisioningWSDeleteSubscriberProfileTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSDeleteSubscriberProfileEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSDeleteSubscriberProfileTable" + "\" must implement the \"" + 
                           "SubscriberWSDeleteSubscriberProfileEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSDeleteSubscriberProfileEntryMBean entry = (SubscriberWSDeleteSubscriberProfileEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSDeleteSubscriberProfileEntryMeta node;
