...
/**
 * The class is used for implementing the "ResetUsageWSMethodWiseStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.12.5.
 */
public class TableResetUsageWSMethodWiseStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableResetUsageWSMethodWiseStatisticsTable".
     ...
     */
    public TableResetUsageWSMethodWiseStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableResetUsageWSMethodWiseStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "ResetUsageWSMethodWiseEntryMBean"
            // interface.
            //
            final Object entry =
                 createResetUsageWSMethodWiseEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("ResetUsageWSMethodWiseStatisticsTable");
    }
    ...
    public synchronized void addEntry(ResetUsageWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(ResetUsageWSMethodWiseEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized ResetUsageWSMethodWiseEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        ResetUsageWSMethodWiseEntryMBean[] result = new ResetUsageWSMethodWiseEntryMBean[array.length];
    ...
    public void removeEntry(ResetUsageWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyResetUsageWSMethodIndex = oid.toInteger().toString();
            return new ObjectName("TableResetUsageWSMethodWiseStatisticsTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.ResetUsageWSMethodWiseEntry" + ",ResetUsageWSMethodIndex=" + _keyResetUsageWSMethodIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "ResetUsageWSMethodWiseEntry".
     */
    public SnmpIndex buildSnmpIndex(ResetUsageWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getResetUsageWSMethodIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "ResetUsageWSMethodWiseEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aResetUsageWSMethodIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aResetUsageWSMethodIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "ResetUsageWSMethodWiseEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "ResetUsageWSMethodWiseEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "ResetUsageWSMethodWiseEntryMBean"
     * interface.
    ...
    public Object createResetUsageWSMethodWiseEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aResetUsageWSMethodIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        ResetUsageWSMethodWiseEntry entry = new ResetUsageWSMethodWiseEntry(theMib);
        entry.ResetUsageWSMethodIndex = aResetUsageWSMethodIndex;
        return entry;
    }
