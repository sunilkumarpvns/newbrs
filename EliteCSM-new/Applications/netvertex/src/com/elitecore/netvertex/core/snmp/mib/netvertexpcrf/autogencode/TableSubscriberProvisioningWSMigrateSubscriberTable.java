...
/**
 * The class is used for implementing the "SubscriberProvisioningWSMigrateSubscriberTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.19.
 */
public class TableSubscriberProvisioningWSMigrateSubscriberTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSMigrateSubscriberTable".
     ...
     */
    public TableSubscriberProvisioningWSMigrateSubscriberTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSMigrateSubscriberTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSMigrateSubscriberEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSMigrateSubscriberEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSMigrateSubscriberTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSMigrateSubscriberEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSMigrateSubscriberEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSMigrateSubscriberEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSMigrateSubscriberEntryMBean[] result = new SubscriberWSMigrateSubscriberEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSMigrateSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyMigrateSubscriberResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSMigrateSubscriberTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSMigrateSubscriberEntry" + ",MigrateSubscriberResultCode=" + _keyMigrateSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSMigrateSubscriberEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSMigrateSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getMigrateSubscriberResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSMigrateSubscriberEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aMigrateSubscriberResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aMigrateSubscriberResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSMigrateSubscriberEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSMigrateSubscriberEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSMigrateSubscriberEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSMigrateSubscriberEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aMigrateSubscriberResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSMigrateSubscriberEntry entry = new SubscriberWSMigrateSubscriberEntry(theMib);
        entry.MigrateSubscriberResultCode = aMigrateSubscriberResultCode;
        return entry;
    }
