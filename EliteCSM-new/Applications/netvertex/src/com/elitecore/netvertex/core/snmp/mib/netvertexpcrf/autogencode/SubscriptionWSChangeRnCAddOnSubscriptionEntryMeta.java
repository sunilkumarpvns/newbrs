...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSChangeRnCAddOnSubscriptionEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.20.1.
 */
public class SubscriptionWSChangeRnCAddOnSubscriptionEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSChangeRnCAddOnSubscriptionEntry".
     */
    public SubscriptionWSChangeRnCAddOnSubscriptionEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getChangeRnCAddOnSubscriptionResultCodeCounters());

            case 2:
                return new SnmpString(node.getChangeRnCAddOnSubscriptionResultCodeName());
     ...
     */
    protected void setInstance(SubscriptionWSChangeRnCAddOnSubscriptionEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSChangeRnCAddOnSubscriptionEntryMBean node;
