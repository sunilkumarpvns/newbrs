 ...
 */
public class SubscriptionWSGetMonetaryBalanceTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSGetMonetaryBalanceTableMeta".
     ...
     */
    public SubscriptionWSGetMonetaryBalanceTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSGetMonetaryBalanceEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSGetMonetaryBalanceEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSGetMonetaryBalanceTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSGetMonetaryBalanceEntry" conceptual row (SubscriptionWSGetMonetaryBalanceEntryMeta)
     * 
     **/
    protected SubscriptionWSGetMonetaryBalanceEntryMeta createSubscriptionWSGetMonetaryBalanceEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSGetMonetaryBalanceEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSGetMonetaryBalanceEntryMetaNode("SubscriptionWSGetMonetaryBalanceEntry", "SubscriptionWSGetMonetaryBalanceTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSGetMonetaryBalanceEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSGetMonetaryBalanceTable" + "\" must implement the \"" + 
                           "SubscriptionWSGetMonetaryBalanceEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSGetMonetaryBalanceEntryMBean entry = (SubscriptionWSGetMonetaryBalanceEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSGetMonetaryBalanceEntryMeta node;
