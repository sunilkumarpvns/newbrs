...
/**
 * The class is used for implementing the "SubscriptionWSListTopUpPackagesTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.15.
 */
public class TableSubscriptionWSListTopUpPackagesTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSListTopUpPackagesTable".
     ...
     */
    public TableSubscriptionWSListTopUpPackagesTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSListTopUpPackagesTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSListTopUpPackagesEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSListTopUpPackagesEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSListTopUpPackagesTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSListTopUpPackagesEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSListTopUpPackagesEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSListTopUpPackagesEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSListTopUpPackagesEntryMBean[] result = new SubscriptionWSListTopUpPackagesEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSListTopUpPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyListTopUpPackagesResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSListTopUpPackagesTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSListTopUpPackagesEntry" + ",ListTopUpPackagesResultCode=" + _keyListTopUpPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSListTopUpPackagesEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSListTopUpPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getListTopUpPackagesResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSListTopUpPackagesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aListTopUpPackagesResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aListTopUpPackagesResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSListTopUpPackagesEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSListTopUpPackagesEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSListTopUpPackagesEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSListTopUpPackagesEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aListTopUpPackagesResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSListTopUpPackagesEntry entry = new SubscriptionWSListTopUpPackagesEntry(theMib);
        entry.ListTopUpPackagesResultCode = aListTopUpPackagesResultCode;
        return entry;
    }
