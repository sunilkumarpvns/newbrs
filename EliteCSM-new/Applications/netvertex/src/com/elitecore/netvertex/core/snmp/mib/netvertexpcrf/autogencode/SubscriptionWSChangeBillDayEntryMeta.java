...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSChangeBillDayEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.28.1.
 */
public class SubscriptionWSChangeBillDayEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSChangeBillDayEntry".
     */
    public SubscriptionWSChangeBillDayEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getChangeBillDayResultCodeCounters());

            case 2:
                return new SnmpString(node.getChangeBillDayResultCodeName());
     ...
     */
    protected void setInstance(SubscriptionWSChangeBillDayEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSChangeBillDayEntryMBean node;
