 ...
 */
public class SubscriptionWSListAddOnSubscriptionsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListAddOnSubscriptionsTableMeta".
     ...
     */
    public SubscriptionWSListAddOnSubscriptionsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListAddOnSubscriptionsEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListAddOnSubscriptionsEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListAddOnSubscriptionsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListAddOnSubscriptionsEntry" conceptual row (SubscriptionWSListAddOnSubscriptionsEntryMeta)
     * 
     **/
    protected SubscriptionWSListAddOnSubscriptionsEntryMeta createSubscriptionWSListAddOnSubscriptionsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListAddOnSubscriptionsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListAddOnSubscriptionsEntryMetaNode("SubscriptionWSListAddOnSubscriptionsEntry", "SubscriptionWSListAddOnSubscriptionsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListAddOnSubscriptionsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListAddOnSubscriptionsTable" + "\" must implement the \"" + 
                           "SubscriptionWSListAddOnSubscriptionsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListAddOnSubscriptionsEntryMBean entry = (SubscriptionWSListAddOnSubscriptionsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListAddOnSubscriptionsEntryMeta node;
