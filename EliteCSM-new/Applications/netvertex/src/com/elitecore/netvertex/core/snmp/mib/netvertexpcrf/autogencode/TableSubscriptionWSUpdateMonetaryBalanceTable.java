 ...
 */
public class TableSubscriptionWSUpdateMonetaryBalanceTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSUpdateMonetaryBalanceTable".
     ...
     */
    public TableSubscriptionWSUpdateMonetaryBalanceTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSUpdateMonetaryBalanceTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSUpdateMonetaryBalanceEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSUpdateMonetaryBalanceEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSUpdateMonetaryBalanceTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSUpdateMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSUpdateMonetaryBalanceEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSUpdateMonetaryBalanceEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSUpdateMonetaryBalanceEntryMBean[] result = new SubscriptionWSUpdateMonetaryBalanceEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSUpdateMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyUpdateMonetaryBalanceResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSUpdateMonetaryBalanceTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSUpdateMonetaryBalanceEntry" + ",UpdateMonetaryBalanceResultCode=" + _keyUpdateMonetaryBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSUpdateMonetaryBalanceEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSUpdateMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getUpdateMonetaryBalanceResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSUpdateMonetaryBalanceEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aUpdateMonetaryBalanceResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aUpdateMonetaryBalanceResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSUpdateMonetaryBalanceEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSUpdateMonetaryBalanceEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSUpdateMonetaryBalanceEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSUpdateMonetaryBalanceEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aUpdateMonetaryBalanceResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSUpdateMonetaryBalanceEntry entry = new SubscriptionWSUpdateMonetaryBalanceEntry(theMib);
        entry.UpdateMonetaryBalanceResultCode = aUpdateMonetaryBalanceResultCode;
        return entry;
    }
