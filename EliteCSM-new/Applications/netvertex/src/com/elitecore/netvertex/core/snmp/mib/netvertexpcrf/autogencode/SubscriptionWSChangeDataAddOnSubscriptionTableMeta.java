 ...
 */
public class SubscriptionWSChangeDataAddOnSubscriptionTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSChangeDataAddOnSubscriptionTableMeta".
     ...
     */
    public SubscriptionWSChangeDataAddOnSubscriptionTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSChangeDataAddOnSubscriptionEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSChangeDataAddOnSubscriptionEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSChangeDataAddOnSubscriptionTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSChangeDataAddOnSubscriptionEntry" conceptual row (SubscriptionWSChangeDataAddOnSubscriptionEntryMeta)
     * 
     **/
    protected SubscriptionWSChangeDataAddOnSubscriptionEntryMeta createSubscriptionWSChangeDataAddOnSubscriptionEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSChangeDataAddOnSubscriptionEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSChangeDataAddOnSubscriptionEntryMetaNode("SubscriptionWSChangeDataAddOnSubscriptionEntry", "SubscriptionWSChangeDataAddOnSubscriptionTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSChangeDataAddOnSubscriptionEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSChangeDataAddOnSubscriptionTable" + "\" must implement the \"" + 
                           "SubscriptionWSChangeDataAddOnSubscriptionEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSChangeDataAddOnSubscriptionEntryMBean entry = (SubscriptionWSChangeDataAddOnSubscriptionEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSChangeDataAddOnSubscriptionEntryMeta node;
