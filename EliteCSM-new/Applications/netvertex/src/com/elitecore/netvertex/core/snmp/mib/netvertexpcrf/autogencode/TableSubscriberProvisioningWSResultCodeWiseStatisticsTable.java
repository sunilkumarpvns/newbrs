...
/**
 * The class is used for implementing the "SubscriberProvisioningWSResultCodeWiseStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.6.
 */
public class TableSubscriberProvisioningWSResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSResultCodeWiseStatisticsTable".
     ...
     */
    public TableSubscriberProvisioningWSResultCodeWiseStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSResultCodeWiseStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSResultCodeWiseEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSResultCodeWiseEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSResultCodeWiseStatisticsTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSResultCodeWiseEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSResultCodeWiseEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSResultCodeWiseEntryMBean[] result = new SubscriberWSResultCodeWiseEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySubscriberWSResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSResultCodeWiseStatisticsTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSResultCodeWiseEntry" + ",SubscriberWSResultCode=" + _keySubscriberWSResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSResultCodeWiseEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSubscriberWSResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSResultCodeWiseEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSubscriberWSResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSubscriberWSResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSResultCodeWiseEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSResultCodeWiseEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSResultCodeWiseEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSResultCodeWiseEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSubscriberWSResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSResultCodeWiseEntry entry = new SubscriberWSResultCodeWiseEntry(theMib);
        entry.SubscriberWSResultCode = aSubscriberWSResultCode;
        return entry;
    }
