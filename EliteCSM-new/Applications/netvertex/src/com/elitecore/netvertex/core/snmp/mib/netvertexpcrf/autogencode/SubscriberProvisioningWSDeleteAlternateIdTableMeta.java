 ...
 */
public class SubscriberProvisioningWSDeleteAlternateIdTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSDeleteAlternateIdTableMeta".
     ...
     */
    public SubscriberProvisioningWSDeleteAlternateIdTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSDeleteAlternateIdEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSDeleteAlternateIdEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSDeleteAlternateIdTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSDeleteAlternateIdEntry" conceptual row (SubscriberWSDeleteAlternateIdEntryMeta)
     * 
     **/
    protected SubscriberWSDeleteAlternateIdEntryMeta createSubscriberWSDeleteAlternateIdEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSDeleteAlternateIdEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSDeleteAlternateIdEntryMetaNode("SubscriberWSDeleteAlternateIdEntry", "SubscriberProvisioningWSDeleteAlternateIdTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSDeleteAlternateIdEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSDeleteAlternateIdTable" + "\" must implement the \"" + 
                           "SubscriberWSDeleteAlternateIdEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSDeleteAlternateIdEntryMBean entry = (SubscriberWSDeleteAlternateIdEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSDeleteAlternateIdEntryMeta node;
