...
/**
 * The class is used for representing SNMP metadata for the "SessionWSGetSessionsBySubscriberIDEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.11.7.1.
 */
public class SessionWSGetSessionsBySubscriberIDEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SessionWSGetSessionsBySubscriberIDEntry".
     */
    public SessionWSGetSessionsBySubscriberIDEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getGetSessionsBySubscriberIDResultCodeCounters());

            case 2:
                return new SnmpString(node.getGetSessionsBySubscriberIDResultCodeName());
     ...
     */
    protected void setInstance(SessionWSGetSessionsBySubscriberIDEntryMBean var) {
        node = var;
    }
    ...
    protected SessionWSGetSessionsBySubscriberIDEntryMBean node;
