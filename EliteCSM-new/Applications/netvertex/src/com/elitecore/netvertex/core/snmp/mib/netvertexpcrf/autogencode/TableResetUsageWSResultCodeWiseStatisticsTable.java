...
/**
 * The class is used for implementing the "ResetUsageWSResultCodeWiseStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.12.6.
 */
public class TableResetUsageWSResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableResetUsageWSResultCodeWiseStatisticsTable".
     ...
     */
    public TableResetUsageWSResultCodeWiseStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableResetUsageWSResultCodeWiseStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "ResetUsageWSResultCodeWiseEntryMBean"
            // interface.
            //
            final Object entry =
                 createResetUsageWSResultCodeWiseEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("ResetUsageWSResultCodeWiseStatisticsTable");
    }
    ...
    public synchronized void addEntry(ResetUsageWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(ResetUsageWSResultCodeWiseEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized ResetUsageWSResultCodeWiseEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        ResetUsageWSResultCodeWiseEntryMBean[] result = new ResetUsageWSResultCodeWiseEntryMBean[array.length];
    ...
    public void removeEntry(ResetUsageWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyResetUsageWSResultCode = oid.toInteger().toString();
            return new ObjectName("TableResetUsageWSResultCodeWiseStatisticsTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.ResetUsageWSResultCodeWiseEntry" + ",ResetUsageWSResultCode=" + _keyResetUsageWSResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "ResetUsageWSResultCodeWiseEntry".
     */
    public SnmpIndex buildSnmpIndex(ResetUsageWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getResetUsageWSResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "ResetUsageWSResultCodeWiseEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aResetUsageWSResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aResetUsageWSResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "ResetUsageWSResultCodeWiseEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "ResetUsageWSResultCodeWiseEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "ResetUsageWSResultCodeWiseEntryMBean"
     * interface.
    ...
    public Object createResetUsageWSResultCodeWiseEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aResetUsageWSResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        ResetUsageWSResultCodeWiseEntry entry = new ResetUsageWSResultCodeWiseEntry(theMib);
        entry.ResetUsageWSResultCode = aResetUsageWSResultCode;
        return entry;
    }
