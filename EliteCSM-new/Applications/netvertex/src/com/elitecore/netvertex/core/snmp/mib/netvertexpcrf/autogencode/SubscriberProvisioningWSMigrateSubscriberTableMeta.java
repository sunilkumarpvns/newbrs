 ...
 */
public class SubscriberProvisioningWSMigrateSubscriberTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSMigrateSubscriberTableMeta".
     ...
     */
    public SubscriberProvisioningWSMigrateSubscriberTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSMigrateSubscriberEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSMigrateSubscriberEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSMigrateSubscriberTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSMigrateSubscriberEntry" conceptual row (SubscriberWSMigrateSubscriberEntryMeta)
     * 
     **/
    protected SubscriberWSMigrateSubscriberEntryMeta createSubscriberWSMigrateSubscriberEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSMigrateSubscriberEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSMigrateSubscriberEntryMetaNode("SubscriberWSMigrateSubscriberEntry", "SubscriberProvisioningWSMigrateSubscriberTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSMigrateSubscriberEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSMigrateSubscriberTable" + "\" must implement the \"" + 
                           "SubscriberWSMigrateSubscriberEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSMigrateSubscriberEntryMBean entry = (SubscriberWSMigrateSubscriberEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSMigrateSubscriberEntryMeta node;
