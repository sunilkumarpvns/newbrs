 ...
 */
public class SubscriberProvisioningWSGetSubscriberProfileByIDTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSGetSubscriberProfileByIDTableMeta".
     ...
     */
    public SubscriberProvisioningWSGetSubscriberProfileByIDTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSGetSubscriberProfileByIDEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSGetSubscriberProfileByIDEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSGetSubscriberProfileByIDTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSGetSubscriberProfileByIDEntry" conceptual row (SubscriberWSGetSubscriberProfileByIDEntryMeta)
     * 
     **/
    protected SubscriberWSGetSubscriberProfileByIDEntryMeta createSubscriberWSGetSubscriberProfileByIDEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSGetSubscriberProfileByIDEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSGetSubscriberProfileByIDEntryMetaNode("SubscriberWSGetSubscriberProfileByIDEntry", "SubscriberProvisioningWSGetSubscriberProfileByIDTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSGetSubscriberProfileByIDEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSGetSubscriberProfileByIDTable" + "\" must implement the \"" + 
                           "SubscriberWSGetSubscriberProfileByIDEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSGetSubscriberProfileByIDEntryMBean entry = (SubscriberWSGetSubscriberProfileByIDEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSGetSubscriberProfileByIDEntryMeta node;
