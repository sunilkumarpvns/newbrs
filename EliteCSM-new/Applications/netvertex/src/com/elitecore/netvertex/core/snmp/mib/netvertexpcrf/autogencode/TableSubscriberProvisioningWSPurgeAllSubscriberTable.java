...
/**
 * The class is used for implementing the "SubscriberProvisioningWSPurgeAllSubscriberTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.16.
 */
public class TableSubscriberProvisioningWSPurgeAllSubscriberTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSPurgeAllSubscriberTable".
     ...
     */
    public TableSubscriberProvisioningWSPurgeAllSubscriberTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSPurgeAllSubscriberTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSPurgeAllSubscriberEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSPurgeAllSubscriberEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSPurgeAllSubscriberTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSPurgeAllSubscriberEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSPurgeAllSubscriberEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSPurgeAllSubscriberEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSPurgeAllSubscriberEntryMBean[] result = new SubscriberWSPurgeAllSubscriberEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSPurgeAllSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyPurgeAllSubscriberResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSPurgeAllSubscriberTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSPurgeAllSubscriberEntry" + ",PurgeAllSubscriberResultCode=" + _keyPurgeAllSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSPurgeAllSubscriberEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSPurgeAllSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getPurgeAllSubscriberResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSPurgeAllSubscriberEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aPurgeAllSubscriberResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aPurgeAllSubscriberResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSPurgeAllSubscriberEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSPurgeAllSubscriberEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSPurgeAllSubscriberEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSPurgeAllSubscriberEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aPurgeAllSubscriberResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSPurgeAllSubscriberEntry entry = new SubscriberWSPurgeAllSubscriberEntry(theMib);
        entry.PurgeAllSubscriberResultCode = aPurgeAllSubscriberResultCode;
        return entry;
    }
