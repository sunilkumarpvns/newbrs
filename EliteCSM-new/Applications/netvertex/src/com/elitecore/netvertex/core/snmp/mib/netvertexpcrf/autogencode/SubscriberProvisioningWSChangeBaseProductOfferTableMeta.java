 ...
 */
public class SubscriberProvisioningWSChangeBaseProductOfferTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSChangeBaseProductOfferTableMeta".
     ...
     */
    public SubscriberProvisioningWSChangeBaseProductOfferTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSChangeBaseProductOfferEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSChangeBaseProductOfferEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSChangeBaseProductOfferTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSChangeBaseProductOfferEntry" conceptual row (SubscriberWSChangeBaseProductOfferEntryMeta)
     * 
     **/
    protected SubscriberWSChangeBaseProductOfferEntryMeta createSubscriberWSChangeBaseProductOfferEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSChangeBaseProductOfferEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSChangeBaseProductOfferEntryMetaNode("SubscriberWSChangeBaseProductOfferEntry", "SubscriberProvisioningWSChangeBaseProductOfferTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSChangeBaseProductOfferEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSChangeBaseProductOfferTable" + "\" must implement the \"" + 
                           "SubscriberWSChangeBaseProductOfferEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSChangeBaseProductOfferEntryMBean entry = (SubscriberWSChangeBaseProductOfferEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSChangeBaseProductOfferEntryMeta node;
