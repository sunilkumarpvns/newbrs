 ...
 */
public class SubscriptionWSSubscribeAddOnProductOfferTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSSubscribeAddOnProductOfferTableMeta".
     ...
     */
    public SubscriptionWSSubscribeAddOnProductOfferTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSSubscribeAddOnProductOfferEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSSubscribeAddOnProductOfferEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSSubscribeAddOnProductOfferTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSSubscribeAddOnProductOfferEntry" conceptual row (SubscriptionWSSubscribeAddOnProductOfferEntryMeta)
     * 
     **/
    protected SubscriptionWSSubscribeAddOnProductOfferEntryMeta createSubscriptionWSSubscribeAddOnProductOfferEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSSubscribeAddOnProductOfferEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSSubscribeAddOnProductOfferEntryMetaNode("SubscriptionWSSubscribeAddOnProductOfferEntry", "SubscriptionWSSubscribeAddOnProductOfferTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSSubscribeAddOnProductOfferEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSSubscribeAddOnProductOfferTable" + "\" must implement the \"" + 
                           "SubscriptionWSSubscribeAddOnProductOfferEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSSubscribeAddOnProductOfferEntryMBean entry = (SubscriptionWSSubscribeAddOnProductOfferEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSSubscribeAddOnProductOfferEntryMeta node;
