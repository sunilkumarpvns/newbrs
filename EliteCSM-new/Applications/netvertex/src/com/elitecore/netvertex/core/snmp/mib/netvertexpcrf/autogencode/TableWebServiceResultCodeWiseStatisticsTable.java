...
/**
 * The class is used for implementing the "WebServiceResultCodeWiseStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.8.
 */
public class TableWebServiceResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableWebServiceResultCodeWiseStatisticsTable".
     ...
     */
    public TableWebServiceResultCodeWiseStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableWebServiceResultCodeWiseStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "WebServiceResultCodeWiseEntryMBean"
            // interface.
            //
            final Object entry =
                 createWebServiceResultCodeWiseEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("WebServiceResultCodeWiseStatisticsTable");
    }
    ...
    public synchronized void addEntry(WebServiceResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(WebServiceResultCodeWiseEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized WebServiceResultCodeWiseEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        WebServiceResultCodeWiseEntryMBean[] result = new WebServiceResultCodeWiseEntryMBean[array.length];
    ...
    public void removeEntry(WebServiceResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyWebServiceResultCode = oid.toInteger().toString();
            return new ObjectName("TableWebServiceResultCodeWiseStatisticsTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.WebServiceResultCodeWiseEntry" + ",WebServiceResultCode=" + _keyWebServiceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "WebServiceResultCodeWiseEntry".
     */
    public SnmpIndex buildSnmpIndex(WebServiceResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getWebServiceResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "WebServiceResultCodeWiseEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aWebServiceResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aWebServiceResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "WebServiceResultCodeWiseEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "WebServiceResultCodeWiseEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "WebServiceResultCodeWiseEntryMBean"
     * interface.
    ...
    public Object createWebServiceResultCodeWiseEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aWebServiceResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        WebServiceResultCodeWiseEntry entry = new WebServiceResultCodeWiseEntry(theMib);
        entry.WebServiceResultCode = aWebServiceResultCode;
        return entry;
    }
