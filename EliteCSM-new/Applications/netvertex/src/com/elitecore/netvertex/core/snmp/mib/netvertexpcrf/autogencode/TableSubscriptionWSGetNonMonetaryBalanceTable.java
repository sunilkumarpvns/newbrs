...
/**
 * The class is used for implementing the "SubscriptionWSGetNonMonetaryBalanceTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.23.
 */
public class TableSubscriptionWSGetNonMonetaryBalanceTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSGetNonMonetaryBalanceTable".
     ...
     */
    public TableSubscriptionWSGetNonMonetaryBalanceTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSGetNonMonetaryBalanceTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSGetNonMonetaryBalanceEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSGetNonMonetaryBalanceEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSGetNonMonetaryBalanceTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSGetNonMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSGetNonMonetaryBalanceEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSGetNonMonetaryBalanceEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSGetNonMonetaryBalanceEntryMBean[] result = new SubscriptionWSGetNonMonetaryBalanceEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSGetNonMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyGetNonMonetaryBalanceResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSGetNonMonetaryBalanceTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSGetNonMonetaryBalanceEntry" + ",GetNonMonetaryBalanceResultCode=" + _keyGetNonMonetaryBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSGetNonMonetaryBalanceEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSGetNonMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getGetNonMonetaryBalanceResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSGetNonMonetaryBalanceEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aGetNonMonetaryBalanceResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aGetNonMonetaryBalanceResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSGetNonMonetaryBalanceEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSGetNonMonetaryBalanceEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSGetNonMonetaryBalanceEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSGetNonMonetaryBalanceEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aGetNonMonetaryBalanceResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSGetNonMonetaryBalanceEntry entry = new SubscriptionWSGetNonMonetaryBalanceEntry(theMib);
        entry.GetNonMonetaryBalanceResultCode = aGetNonMonetaryBalanceResultCode;
        return entry;
    }
