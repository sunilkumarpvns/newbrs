...
/**
 * The class is used for implementing the "SubscriberProvisioningWSDeleteAlternateIdTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.27.
 */
public class TableSubscriberProvisioningWSDeleteAlternateIdTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSDeleteAlternateIdTable".
     ...
     */
    public TableSubscriberProvisioningWSDeleteAlternateIdTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSDeleteAlternateIdTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSDeleteAlternateIdEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSDeleteAlternateIdEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSDeleteAlternateIdTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSDeleteAlternateIdEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSDeleteAlternateIdEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSDeleteAlternateIdEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSDeleteAlternateIdEntryMBean[] result = new SubscriberWSDeleteAlternateIdEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSDeleteAlternateIdEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyDeleteAlternateIdResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSDeleteAlternateIdTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSDeleteAlternateIdEntry" + ",DeleteAlternateIdResultCode=" + _keyDeleteAlternateIdResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSDeleteAlternateIdEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSDeleteAlternateIdEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getDeleteAlternateIdResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSDeleteAlternateIdEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aDeleteAlternateIdResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aDeleteAlternateIdResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSDeleteAlternateIdEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSDeleteAlternateIdEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSDeleteAlternateIdEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSDeleteAlternateIdEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aDeleteAlternateIdResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSDeleteAlternateIdEntry entry = new SubscriberWSDeleteAlternateIdEntry(theMib);
        entry.DeleteAlternateIdResultCode = aDeleteAlternateIdResultCode;
        return entry;
    }
