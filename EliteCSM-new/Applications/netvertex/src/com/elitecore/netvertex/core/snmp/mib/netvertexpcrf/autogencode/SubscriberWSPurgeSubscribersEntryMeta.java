...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSPurgeSubscribersEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.15.1.
 */
public class SubscriberWSPurgeSubscribersEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSPurgeSubscribersEntry".
     */
    public SubscriberWSPurgeSubscribersEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getPurgeSubscribersResultCodeCounters());

            case 2:
                return new SnmpString(node.getPurgeSubscribersResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSPurgeSubscribersEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSPurgeSubscribersEntryMBean node;
