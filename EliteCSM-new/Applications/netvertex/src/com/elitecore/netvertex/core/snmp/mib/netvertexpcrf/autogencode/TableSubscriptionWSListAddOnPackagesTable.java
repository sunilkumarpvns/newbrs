...
/**
 * The class is used for implementing the "SubscriptionWSListAddOnPackagesTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.7.
 */
public class TableSubscriptionWSListAddOnPackagesTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSListAddOnPackagesTable".
     ...
     */
    public TableSubscriptionWSListAddOnPackagesTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSListAddOnPackagesTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSListAddOnPackagesEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSListAddOnPackagesEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSListAddOnPackagesTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSListAddOnPackagesEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSListAddOnPackagesEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSListAddOnPackagesEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSListAddOnPackagesEntryMBean[] result = new SubscriptionWSListAddOnPackagesEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSListAddOnPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyListAddOnPackagesResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSListAddOnPackagesTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSListAddOnPackagesEntry" + ",ListAddOnPackagesResultCode=" + _keyListAddOnPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSListAddOnPackagesEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSListAddOnPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getListAddOnPackagesResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSListAddOnPackagesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aListAddOnPackagesResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aListAddOnPackagesResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSListAddOnPackagesEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSListAddOnPackagesEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSListAddOnPackagesEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSListAddOnPackagesEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aListAddOnPackagesResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSListAddOnPackagesEntry entry = new SubscriptionWSListAddOnPackagesEntry(theMib);
        entry.ListAddOnPackagesResultCode = aListAddOnPackagesResultCode;
        return entry;
    }
