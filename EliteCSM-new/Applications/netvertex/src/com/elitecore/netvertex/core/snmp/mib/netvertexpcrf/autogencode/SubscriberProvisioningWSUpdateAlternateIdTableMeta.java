 ...
 */
public class SubscriberProvisioningWSUpdateAlternateIdTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSUpdateAlternateIdTableMeta".
     ...
     */
    public SubscriberProvisioningWSUpdateAlternateIdTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSUpdateAlternateIdEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSUpdateAlternateIdEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSUpdateAlternateIdTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSUpdateAlternateIdEntry" conceptual row (SubscriberWSUpdateAlternateIdEntryMeta)
     * 
     **/
    protected SubscriberWSUpdateAlternateIdEntryMeta createSubscriberWSUpdateAlternateIdEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSUpdateAlternateIdEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSUpdateAlternateIdEntryMetaNode("SubscriberWSUpdateAlternateIdEntry", "SubscriberProvisioningWSUpdateAlternateIdTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSUpdateAlternateIdEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSUpdateAlternateIdTable" + "\" must implement the \"" + 
                           "SubscriberWSUpdateAlternateIdEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSUpdateAlternateIdEntryMBean entry = (SubscriberWSUpdateAlternateIdEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSUpdateAlternateIdEntryMeta node;
