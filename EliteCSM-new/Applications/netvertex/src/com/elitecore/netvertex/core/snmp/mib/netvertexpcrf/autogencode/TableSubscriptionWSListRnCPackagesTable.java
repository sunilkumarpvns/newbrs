...
/**
 * The class is used for implementing the "SubscriptionWSListRnCPackagesTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.24.
 */
public class TableSubscriptionWSListRnCPackagesTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSListRnCPackagesTable".
     ...
     */
    public TableSubscriptionWSListRnCPackagesTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSListRnCPackagesTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSListRnCPackagesEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSListRnCPackagesEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSListRnCPackagesTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSListRnCPackagesEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSListRnCPackagesEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSListRnCPackagesEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSListRnCPackagesEntryMBean[] result = new SubscriptionWSListRnCPackagesEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSListRnCPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyListRnCPackagesResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSListRnCPackagesTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSListRnCPackagesEntry" + ",ListRnCPackagesResultCode=" + _keyListRnCPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSListRnCPackagesEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSListRnCPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getListRnCPackagesResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSListRnCPackagesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aListRnCPackagesResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aListRnCPackagesResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSListRnCPackagesEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSListRnCPackagesEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSListRnCPackagesEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSListRnCPackagesEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aListRnCPackagesResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSListRnCPackagesEntry entry = new SubscriptionWSListRnCPackagesEntry(theMib);
        entry.ListRnCPackagesResultCode = aListRnCPackagesResultCode;
        return entry;
    }
