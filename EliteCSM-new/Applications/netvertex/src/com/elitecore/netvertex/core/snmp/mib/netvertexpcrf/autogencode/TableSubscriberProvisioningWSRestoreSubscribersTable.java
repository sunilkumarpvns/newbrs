...
/**
 * The class is used for implementing the "SubscriberProvisioningWSRestoreSubscribersTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.18.
 */
public class TableSubscriberProvisioningWSRestoreSubscribersTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSRestoreSubscribersTable".
     ...
     */
    public TableSubscriberProvisioningWSRestoreSubscribersTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSRestoreSubscribersTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSRestoreSubscribersEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSRestoreSubscribersEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSRestoreSubscribersTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSRestoreSubscribersEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSRestoreSubscribersEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSRestoreSubscribersEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSRestoreSubscribersEntryMBean[] result = new SubscriberWSRestoreSubscribersEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSRestoreSubscribersEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyRestoreSubscribersResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSRestoreSubscribersTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSRestoreSubscribersEntry" + ",RestoreSubscribersResultCode=" + _keyRestoreSubscribersResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSRestoreSubscribersEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSRestoreSubscribersEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getRestoreSubscribersResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSRestoreSubscribersEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aRestoreSubscribersResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aRestoreSubscribersResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSRestoreSubscribersEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSRestoreSubscribersEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSRestoreSubscribersEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSRestoreSubscribersEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aRestoreSubscribersResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSRestoreSubscribersEntry entry = new SubscriberWSRestoreSubscribersEntry(theMib);
        entry.RestoreSubscribersResultCode = aRestoreSubscribersResultCode;
        return entry;
    }
