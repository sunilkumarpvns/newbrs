...
/**
 * The class is used for representing SNMP metadata for the "ResetUsageWSMethodWiseEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.12.5.1.
 */
public class ResetUsageWSMethodWiseEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "ResetUsageWSMethodWiseEntry".
     */
    public ResetUsageWSMethodWiseEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpCounter(node.getResetUsageWSMethodAvgTPS());

            case 5:
                return new SnmpCounter(node.getResetUsageWSMethodLastMinuteTotalRequests());

            case 4:
                return new SnmpCounter(node.getResetUsageWSMethodTotalResponses());

            case 3:
                return new SnmpCounter(node.getResetUsageWSMethodTotalRequests());

            case 2:
                return new SnmpString(node.getResetUsageWSMethodName());
     ...
     */
    protected void setInstance(ResetUsageWSMethodWiseEntryMBean var) {
        node = var;
    }
    ...
    protected ResetUsageWSMethodWiseEntryMBean node;
