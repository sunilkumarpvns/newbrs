 ...
 */
public class SubscriberProvisioningWSAddSubscriberProfileTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSAddSubscriberProfileTableMeta".
     ...
     */
    public SubscriberProvisioningWSAddSubscriberProfileTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSAddSubscriberProfileEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSAddSubscriberProfileEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSAddSubscriberProfileTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSAddSubscriberProfileEntry" conceptual row (SubscriberWSAddSubscriberProfileEntryMeta)
     * 
     **/
    protected SubscriberWSAddSubscriberProfileEntryMeta createSubscriberWSAddSubscriberProfileEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSAddSubscriberProfileEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSAddSubscriberProfileEntryMetaNode("SubscriberWSAddSubscriberProfileEntry", "SubscriberProvisioningWSAddSubscriberProfileTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSAddSubscriberProfileEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSAddSubscriberProfileTable" + "\" must implement the \"" + 
                           "SubscriberWSAddSubscriberProfileEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSAddSubscriberProfileEntryMBean entry = (SubscriberWSAddSubscriberProfileEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSAddSubscriberProfileEntryMeta node;
