 ...
 */
public class SubscriptionWSListRnCPackagesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListRnCPackagesTableMeta".
     ...
     */
    public SubscriptionWSListRnCPackagesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListRnCPackagesEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListRnCPackagesEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListRnCPackagesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListRnCPackagesEntry" conceptual row (SubscriptionWSListRnCPackagesEntryMeta)
     * 
     **/
    protected SubscriptionWSListRnCPackagesEntryMeta createSubscriptionWSListRnCPackagesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListRnCPackagesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListRnCPackagesEntryMetaNode("SubscriptionWSListRnCPackagesEntry", "SubscriptionWSListRnCPackagesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListRnCPackagesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListRnCPackagesTable" + "\" must implement the \"" + 
                           "SubscriptionWSListRnCPackagesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListRnCPackagesEntryMBean entry = (SubscriptionWSListRnCPackagesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListRnCPackagesEntryMeta node;
