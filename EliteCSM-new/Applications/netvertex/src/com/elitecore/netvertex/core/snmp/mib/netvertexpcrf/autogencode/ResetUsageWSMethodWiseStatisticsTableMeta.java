 ...
 */
public class ResetUsageWSMethodWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "ResetUsageWSMethodWiseStatisticsTableMeta".
     ...
     */
    public ResetUsageWSMethodWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "ResetUsageWSMethodWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("ResetUsageWSMethodWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("ResetUsageWSMethodWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "ResetUsageWSMethodWiseEntry" conceptual row (ResetUsageWSMethodWiseEntryMeta)
     * 
     **/
    protected ResetUsageWSMethodWiseEntryMeta createResetUsageWSMethodWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new ResetUsageWSMethodWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createResetUsageWSMethodWiseEntryMetaNode("ResetUsageWSMethodWiseEntry", "ResetUsageWSMethodWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof ResetUsageWSMethodWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "ResetUsageWSMethodWiseStatisticsTable" + "\" must implement the \"" + 
                           "ResetUsageWSMethodWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        ResetUsageWSMethodWiseEntryMBean entry = (ResetUsageWSMethodWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private ResetUsageWSMethodWiseEntryMeta node;
