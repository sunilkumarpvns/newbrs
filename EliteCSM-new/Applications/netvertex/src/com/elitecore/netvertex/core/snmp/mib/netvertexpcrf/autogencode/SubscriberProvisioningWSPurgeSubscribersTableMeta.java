 ...
 */
public class SubscriberProvisioningWSPurgeSubscribersTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSPurgeSubscribersTableMeta".
     ...
     */
    public SubscriberProvisioningWSPurgeSubscribersTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSPurgeSubscribersEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSPurgeSubscribersEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSPurgeSubscribersTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSPurgeSubscribersEntry" conceptual row (SubscriberWSPurgeSubscribersEntryMeta)
     * 
     **/
    protected SubscriberWSPurgeSubscribersEntryMeta createSubscriberWSPurgeSubscribersEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSPurgeSubscribersEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSPurgeSubscribersEntryMetaNode("SubscriberWSPurgeSubscribersEntry", "SubscriberProvisioningWSPurgeSubscribersTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSPurgeSubscribersEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSPurgeSubscribersTable" + "\" must implement the \"" + 
                           "SubscriberWSPurgeSubscribersEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSPurgeSubscribersEntryMBean entry = (SubscriberWSPurgeSubscribersEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSPurgeSubscribersEntryMeta node;
