...
/**
 * The class is used for implementing the "SubscriptionWSAddMonetaryBalanceTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.18.
 */
public class TableSubscriptionWSAddMonetaryBalanceTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSAddMonetaryBalanceTable".
     ...
     */
    public TableSubscriptionWSAddMonetaryBalanceTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSAddMonetaryBalanceTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSAddMonetaryBalanceEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSAddMonetaryBalanceEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSAddMonetaryBalanceTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSAddMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSAddMonetaryBalanceEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSAddMonetaryBalanceEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSAddMonetaryBalanceEntryMBean[] result = new SubscriptionWSAddMonetaryBalanceEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSAddMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyAddMonetaryBalanceResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSAddMonetaryBalanceTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSAddMonetaryBalanceEntry" + ",AddMonetaryBalanceResultCode=" + _keyAddMonetaryBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSAddMonetaryBalanceEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSAddMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getAddMonetaryBalanceResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSAddMonetaryBalanceEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aAddMonetaryBalanceResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aAddMonetaryBalanceResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSAddMonetaryBalanceEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSAddMonetaryBalanceEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSAddMonetaryBalanceEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSAddMonetaryBalanceEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aAddMonetaryBalanceResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSAddMonetaryBalanceEntry entry = new SubscriptionWSAddMonetaryBalanceEntry(theMib);
        entry.AddMonetaryBalanceResultCode = aAddMonetaryBalanceResultCode;
        return entry;
    }
