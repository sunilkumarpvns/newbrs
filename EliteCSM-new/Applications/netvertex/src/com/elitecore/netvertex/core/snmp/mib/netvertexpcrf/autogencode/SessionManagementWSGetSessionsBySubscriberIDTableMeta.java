 ...
 */
public class SessionManagementWSGetSessionsBySubscriberIDTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SessionManagementWSGetSessionsBySubscriberIDTableMeta".
     ...
     */
    public SessionManagementWSGetSessionsBySubscriberIDTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SessionWSGetSessionsBySubscriberIDEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SessionWSGetSessionsBySubscriberIDEntry")
     * @param tableName Name of the table in which the entries are registered ("SessionManagementWSGetSessionsBySubscriberIDTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SessionWSGetSessionsBySubscriberIDEntry" conceptual row (SessionWSGetSessionsBySubscriberIDEntryMeta)
     * 
     **/
    protected SessionWSGetSessionsBySubscriberIDEntryMeta createSessionWSGetSessionsBySubscriberIDEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SessionWSGetSessionsBySubscriberIDEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSessionWSGetSessionsBySubscriberIDEntryMetaNode("SessionWSGetSessionsBySubscriberIDEntry", "SessionManagementWSGetSessionsBySubscriberIDTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SessionWSGetSessionsBySubscriberIDEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SessionManagementWSGetSessionsBySubscriberIDTable" + "\" must implement the \"" + 
                           "SessionWSGetSessionsBySubscriberIDEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SessionWSGetSessionsBySubscriberIDEntryMBean entry = (SessionWSGetSessionsBySubscriberIDEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SessionWSGetSessionsBySubscriberIDEntryMeta node;
