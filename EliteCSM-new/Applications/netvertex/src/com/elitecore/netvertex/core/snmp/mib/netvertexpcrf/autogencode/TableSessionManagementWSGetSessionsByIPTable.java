...
/**
 * The class is used for implementing the "SessionManagementWSGetSessionsByIPTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.11.8.
 */
public class TableSessionManagementWSGetSessionsByIPTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSessionManagementWSGetSessionsByIPTable".
     ...
     */
    public TableSessionManagementWSGetSessionsByIPTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSessionManagementWSGetSessionsByIPTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SessionWSGetSessionsByIPEntryMBean"
            // interface.
            //
            final Object entry =
                 createSessionWSGetSessionsByIPEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SessionManagementWSGetSessionsByIPTable");
    }
    ...
    public synchronized void addEntry(SessionWSGetSessionsByIPEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SessionWSGetSessionsByIPEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SessionWSGetSessionsByIPEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SessionWSGetSessionsByIPEntryMBean[] result = new SessionWSGetSessionsByIPEntryMBean[array.length];
    ...
    public void removeEntry(SessionWSGetSessionsByIPEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyGetSessionsByIPResultCode = oid.toInteger().toString();
            return new ObjectName("TableSessionManagementWSGetSessionsByIPTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SessionWSGetSessionsByIPEntry" + ",GetSessionsByIPResultCode=" + _keyGetSessionsByIPResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SessionWSGetSessionsByIPEntry".
     */
    public SnmpIndex buildSnmpIndex(SessionWSGetSessionsByIPEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getGetSessionsByIPResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SessionWSGetSessionsByIPEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aGetSessionsByIPResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aGetSessionsByIPResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SessionWSGetSessionsByIPEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SessionWSGetSessionsByIPEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SessionWSGetSessionsByIPEntryMBean"
     * interface.
    ...
    public Object createSessionWSGetSessionsByIPEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aGetSessionsByIPResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SessionWSGetSessionsByIPEntry entry = new SessionWSGetSessionsByIPEntry(theMib);
        entry.GetSessionsByIPResultCode = aGetSessionsByIPResultCode;
        return entry;
    }
