 ...
 */
public class SubscriptionWSUpdateCreditLimitTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSUpdateCreditLimitTableMeta".
     ...
     */
    public SubscriptionWSUpdateCreditLimitTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSUpdateCreditLimitEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSUpdateCreditLimitEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSUpdateCreditLimitTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSUpdateCreditLimitEntry" conceptual row (SubscriptionWSUpdateCreditLimitEntryMeta)
     * 
     **/
    protected SubscriptionWSUpdateCreditLimitEntryMeta createSubscriptionWSUpdateCreditLimitEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSUpdateCreditLimitEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSUpdateCreditLimitEntryMetaNode("SubscriptionWSUpdateCreditLimitEntry", "SubscriptionWSUpdateCreditLimitTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSUpdateCreditLimitEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSUpdateCreditLimitTable" + "\" must implement the \"" + 
                           "SubscriptionWSUpdateCreditLimitEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSUpdateCreditLimitEntryMBean entry = (SubscriptionWSUpdateCreditLimitEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSUpdateCreditLimitEntryMeta node;
