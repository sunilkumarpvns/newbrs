...
/**
 * The class is used for implementing the "SubscriberProvisioningWSAddSubscriberBulkTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.11.
 */
public class TableSubscriberProvisioningWSAddSubscriberBulkTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSAddSubscriberBulkTable".
     ...
     */
    public TableSubscriberProvisioningWSAddSubscriberBulkTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSAddSubscriberBulkTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSAddSubscriberBulkEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSAddSubscriberBulkEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSAddSubscriberBulkTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSAddSubscriberBulkEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSAddSubscriberBulkEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSAddSubscriberBulkEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSAddSubscriberBulkEntryMBean[] result = new SubscriberWSAddSubscriberBulkEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSAddSubscriberBulkEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyAddSubscriberBulkResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSAddSubscriberBulkTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSAddSubscriberBulkEntry" + ",AddSubscriberBulkResultCode=" + _keyAddSubscriberBulkResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSAddSubscriberBulkEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSAddSubscriberBulkEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getAddSubscriberBulkResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSAddSubscriberBulkEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aAddSubscriberBulkResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aAddSubscriberBulkResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSAddSubscriberBulkEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSAddSubscriberBulkEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSAddSubscriberBulkEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSAddSubscriberBulkEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aAddSubscriberBulkResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSAddSubscriberBulkEntry entry = new SubscriberWSAddSubscriberBulkEntry(theMib);
        entry.AddSubscriberBulkResultCode = aAddSubscriberBulkResultCode;
        return entry;
    }
