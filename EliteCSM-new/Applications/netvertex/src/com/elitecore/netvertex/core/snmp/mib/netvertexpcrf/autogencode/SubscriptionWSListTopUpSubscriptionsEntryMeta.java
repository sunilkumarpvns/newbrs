...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSListTopUpSubscriptionsEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.10.1.
 */
public class SubscriptionWSListTopUpSubscriptionsEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSListTopUpSubscriptionsEntry".
     */
    public SubscriptionWSListTopUpSubscriptionsEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getListTopUpSubscriptionsResultCodeCounters());

            case 2:
                return new SnmpString(node.getListTopUpSubscriptionsResultCodeName());
     ...
     */
    protected void setInstance(SubscriptionWSListTopUpSubscriptionsEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSListTopUpSubscriptionsEntryMBean node;
