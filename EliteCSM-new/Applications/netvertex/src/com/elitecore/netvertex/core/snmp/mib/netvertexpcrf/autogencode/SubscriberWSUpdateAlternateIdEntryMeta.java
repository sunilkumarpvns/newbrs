...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSUpdateAlternateIdEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.25.1.
 */
public class SubscriberWSUpdateAlternateIdEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSUpdateAlternateIdEntry".
     */
    public SubscriberWSUpdateAlternateIdEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getUpdateAlternateIdResultCodeCounters());

            case 2:
                return new SnmpString(node.getUpdateAlternateIdResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSUpdateAlternateIdEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSUpdateAlternateIdEntryMBean node;
