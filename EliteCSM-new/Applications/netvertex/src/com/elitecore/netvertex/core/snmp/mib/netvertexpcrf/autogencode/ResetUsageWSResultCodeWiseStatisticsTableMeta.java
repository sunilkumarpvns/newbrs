 ...
 */
public class ResetUsageWSResultCodeWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "ResetUsageWSResultCodeWiseStatisticsTableMeta".
     ...
     */
    public ResetUsageWSResultCodeWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "ResetUsageWSResultCodeWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("ResetUsageWSResultCodeWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("ResetUsageWSResultCodeWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "ResetUsageWSResultCodeWiseEntry" conceptual row (ResetUsageWSResultCodeWiseEntryMeta)
     * 
     **/
    protected ResetUsageWSResultCodeWiseEntryMeta createResetUsageWSResultCodeWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new ResetUsageWSResultCodeWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createResetUsageWSResultCodeWiseEntryMetaNode("ResetUsageWSResultCodeWiseEntry", "ResetUsageWSResultCodeWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof ResetUsageWSResultCodeWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "ResetUsageWSResultCodeWiseStatisticsTable" + "\" must implement the \"" + 
                           "ResetUsageWSResultCodeWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        ResetUsageWSResultCodeWiseEntryMBean entry = (ResetUsageWSResultCodeWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private ResetUsageWSResultCodeWiseEntryMeta node;
