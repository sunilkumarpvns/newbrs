...
/**
 * The class is used for implementing the "SubscriptionWSResultCodeWiseStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.6.
 */
public class TableSubscriptionWSResultCodeWiseStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSResultCodeWiseStatisticsTable".
     ...
     */
    public TableSubscriptionWSResultCodeWiseStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSResultCodeWiseStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSResultCodeWiseEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSResultCodeWiseEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSResultCodeWiseStatisticsTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSResultCodeWiseEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSResultCodeWiseEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSResultCodeWiseEntryMBean[] result = new SubscriptionWSResultCodeWiseEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySubscriptionWSResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSResultCodeWiseStatisticsTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSResultCodeWiseEntry" + ",SubscriptionWSResultCode=" + _keySubscriptionWSResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSResultCodeWiseEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSResultCodeWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSubscriptionWSResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSResultCodeWiseEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSubscriptionWSResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSubscriptionWSResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSResultCodeWiseEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSResultCodeWiseEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSResultCodeWiseEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSResultCodeWiseEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSubscriptionWSResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSResultCodeWiseEntry entry = new SubscriptionWSResultCodeWiseEntry(theMib);
        entry.SubscriptionWSResultCode = aSubscriptionWSResultCode;
        return entry;
    }
