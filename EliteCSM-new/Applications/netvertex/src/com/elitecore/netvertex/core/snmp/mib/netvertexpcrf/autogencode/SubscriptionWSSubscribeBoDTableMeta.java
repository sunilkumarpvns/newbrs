 ...
 */
public class SubscriptionWSSubscribeBoDTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSSubscribeBoDTableMeta".
     ...
     */
    public SubscriptionWSSubscribeBoDTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSSubscribeBoDEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSSubscribeBoDEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSSubscribeBoDTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSSubscribeBoDEntry" conceptual row (SubscriptionWSSubscribeBoDEntryMeta)
     * 
     **/
    protected SubscriptionWSSubscribeBoDEntryMeta createSubscriptionWSSubscribeBoDEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSSubscribeBoDEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSSubscribeBoDEntryMetaNode("SubscriptionWSSubscribeBoDEntry", "SubscriptionWSSubscribeBoDTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSSubscribeBoDEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSSubscribeBoDTable" + "\" must implement the \"" + 
                           "SubscriptionWSSubscribeBoDEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSSubscribeBoDEntryMBean entry = (SubscriptionWSSubscribeBoDEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSSubscribeBoDEntryMeta node;
