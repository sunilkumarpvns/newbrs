 ...
 */
public class SubscriptionWSListTopUpPackagesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListTopUpPackagesTableMeta".
     ...
     */
    public SubscriptionWSListTopUpPackagesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListTopUpPackagesEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListTopUpPackagesEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListTopUpPackagesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListTopUpPackagesEntry" conceptual row (SubscriptionWSListTopUpPackagesEntryMeta)
     * 
     **/
    protected SubscriptionWSListTopUpPackagesEntryMeta createSubscriptionWSListTopUpPackagesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListTopUpPackagesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListTopUpPackagesEntryMetaNode("SubscriptionWSListTopUpPackagesEntry", "SubscriptionWSListTopUpPackagesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListTopUpPackagesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListTopUpPackagesTable" + "\" must implement the \"" + 
                           "SubscriptionWSListTopUpPackagesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListTopUpPackagesEntryMBean entry = (SubscriptionWSListTopUpPackagesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListTopUpPackagesEntryMeta node;
