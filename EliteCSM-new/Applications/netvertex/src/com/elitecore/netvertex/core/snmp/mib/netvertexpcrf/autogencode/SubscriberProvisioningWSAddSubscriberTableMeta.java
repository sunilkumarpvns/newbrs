 ...
 */
public class SubscriberProvisioningWSAddSubscriberTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSAddSubscriberTableMeta".
     ...
     */
    public SubscriberProvisioningWSAddSubscriberTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSAddSubscriberEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSAddSubscriberEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSAddSubscriberTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSAddSubscriberEntry" conceptual row (SubscriberWSAddSubscriberEntryMeta)
     * 
     **/
    protected SubscriberWSAddSubscriberEntryMeta createSubscriberWSAddSubscriberEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSAddSubscriberEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSAddSubscriberEntryMetaNode("SubscriberWSAddSubscriberEntry", "SubscriberProvisioningWSAddSubscriberTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSAddSubscriberEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSAddSubscriberTable" + "\" must implement the \"" + 
                           "SubscriberWSAddSubscriberEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSAddSubscriberEntryMBean entry = (SubscriberWSAddSubscriberEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSAddSubscriberEntryMeta node;
