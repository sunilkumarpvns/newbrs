...
/**
 * The class is used for representing SNMP metadata for the "SubscriptionWSMethodWiseEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.5.1.
 */
public class SubscriptionWSMethodWiseEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriptionWSMethodWiseEntry".
     */
    public SubscriptionWSMethodWiseEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpCounter(node.getSubscriptionWSMethodAvgTPS());

            case 5:
                return new SnmpCounter(node.getSubscriptionWSMethodLastMinuteTotalRequests());

            case 4:
                return new SnmpCounter(node.getSubscriptionWSMethodTotalResponses());

            case 3:
                return new SnmpCounter(node.getSubscriptionWSMethodTotalRequests());

            case 2:
                return new SnmpString(node.getSubscriptionWSMethodName());
     ...
     */
    protected void setInstance(SubscriptionWSMethodWiseEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriptionWSMethodWiseEntryMBean node;
