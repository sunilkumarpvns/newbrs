 ...
 */
public class ResetUsageWSResetBillingCycleTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "ResetUsageWSResetBillingCycleTableMeta".
     ...
     */
    public ResetUsageWSResetBillingCycleTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "ResetUsageWSResetBillingCycleResultCodeEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("ResetUsageWSResetBillingCycleResultCodeEntry")
     * @param tableName Name of the table in which the entries are registered ("ResetUsageWSResetBillingCycleTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "ResetUsageWSResetBillingCycleResultCodeEntry" conceptual row (ResetUsageWSResetBillingCycleResultCodeEntryMeta)
     * 
     **/
    protected ResetUsageWSResetBillingCycleResultCodeEntryMeta createResetUsageWSResetBillingCycleResultCodeEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new ResetUsageWSResetBillingCycleResultCodeEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createResetUsageWSResetBillingCycleResultCodeEntryMetaNode("ResetUsageWSResetBillingCycleResultCodeEntry", "ResetUsageWSResetBillingCycleTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof ResetUsageWSResetBillingCycleResultCodeEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "ResetUsageWSResetBillingCycleTable" + "\" must implement the \"" + 
                           "ResetUsageWSResetBillingCycleResultCodeEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        ResetUsageWSResetBillingCycleResultCodeEntryMBean entry = (ResetUsageWSResetBillingCycleResultCodeEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private ResetUsageWSResetBillingCycleResultCodeEntryMeta node;
