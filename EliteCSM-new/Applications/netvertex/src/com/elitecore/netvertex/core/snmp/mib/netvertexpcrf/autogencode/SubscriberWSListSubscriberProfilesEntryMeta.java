...
/**
 * The class is used for representing SNMP metadata for the "SubscriberWSListSubscriberProfilesEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.13.1.
 */
public class SubscriberWSListSubscriberProfilesEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SubscriberWSListSubscriberProfilesEntry".
     */
    public SubscriberWSListSubscriberProfilesEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getListSubscriberProfilesResultCodeCounters());

            case 2:
                return new SnmpString(node.getListSubscriberProfilesResultCodeName());
     ...
     */
    protected void setInstance(SubscriberWSListSubscriberProfilesEntryMBean var) {
        node = var;
    }
    ...
    protected SubscriberWSListSubscriberProfilesEntryMBean node;
