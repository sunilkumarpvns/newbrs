 ...
 */
public class SubscriptionWSGetRnCBalanceTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSGetRnCBalanceTableMeta".
     ...
     */
    public SubscriptionWSGetRnCBalanceTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSGetRnCBalanceEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSGetRnCBalanceEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSGetRnCBalanceTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSGetRnCBalanceEntry" conceptual row (SubscriptionWSGetRnCBalanceEntryMeta)
     * 
     **/
    protected SubscriptionWSGetRnCBalanceEntryMeta createSubscriptionWSGetRnCBalanceEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSGetRnCBalanceEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSGetRnCBalanceEntryMetaNode("SubscriptionWSGetRnCBalanceEntry", "SubscriptionWSGetRnCBalanceTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSGetRnCBalanceEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSGetRnCBalanceTable" + "\" must implement the \"" + 
                           "SubscriptionWSGetRnCBalanceEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSGetRnCBalanceEntryMBean entry = (SubscriptionWSGetRnCBalanceEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSGetRnCBalanceEntryMeta node;
