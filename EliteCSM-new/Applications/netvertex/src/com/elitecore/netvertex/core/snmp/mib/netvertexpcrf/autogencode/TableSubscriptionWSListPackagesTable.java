...
/**
 * The class is used for implementing the "SubscriptionWSListPackagesTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.8.
 */
public class TableSubscriptionWSListPackagesTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSListPackagesTable".
     ...
     */
    public TableSubscriptionWSListPackagesTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSListPackagesTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSListPackagesEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSListPackagesEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSListPackagesTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSListPackagesEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSListPackagesEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSListPackagesEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSListPackagesEntryMBean[] result = new SubscriptionWSListPackagesEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSListPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyListPackagesResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSListPackagesTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSListPackagesEntry" + ",ListPackagesResultCode=" + _keyListPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSListPackagesEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSListPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getListPackagesResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSListPackagesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aListPackagesResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aListPackagesResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSListPackagesEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSListPackagesEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSListPackagesEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSListPackagesEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aListPackagesResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSListPackagesEntry entry = new SubscriptionWSListPackagesEntry(theMib);
        entry.ListPackagesResultCode = aListPackagesResultCode;
        return entry;
    }
