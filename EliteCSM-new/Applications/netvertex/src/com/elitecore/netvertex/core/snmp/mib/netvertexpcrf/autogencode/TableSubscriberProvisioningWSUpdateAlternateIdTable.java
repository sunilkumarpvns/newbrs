...
/**
 * The class is used for implementing the "SubscriberProvisioningWSUpdateAlternateIdTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.25.
 */
public class TableSubscriberProvisioningWSUpdateAlternateIdTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSUpdateAlternateIdTable".
     ...
     */
    public TableSubscriberProvisioningWSUpdateAlternateIdTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSUpdateAlternateIdTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSUpdateAlternateIdEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSUpdateAlternateIdEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSUpdateAlternateIdTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSUpdateAlternateIdEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSUpdateAlternateIdEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSUpdateAlternateIdEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSUpdateAlternateIdEntryMBean[] result = new SubscriberWSUpdateAlternateIdEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSUpdateAlternateIdEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyUpdateAlternateIdResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSUpdateAlternateIdTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSUpdateAlternateIdEntry" + ",UpdateAlternateIdResultCode=" + _keyUpdateAlternateIdResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSUpdateAlternateIdEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSUpdateAlternateIdEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getUpdateAlternateIdResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSUpdateAlternateIdEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aUpdateAlternateIdResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aUpdateAlternateIdResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSUpdateAlternateIdEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSUpdateAlternateIdEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSUpdateAlternateIdEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSUpdateAlternateIdEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aUpdateAlternateIdResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSUpdateAlternateIdEntry entry = new SubscriberWSUpdateAlternateIdEntry(theMib);
        entry.UpdateAlternateIdResultCode = aUpdateAlternateIdResultCode;
        return entry;
    }
