...
/**
 * The class is used for implementing the "SubscriberProvisioningWSMethodWiseStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.5.
 */
public class TableSubscriberProvisioningWSMethodWiseStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSMethodWiseStatisticsTable".
     ...
     */
    public TableSubscriberProvisioningWSMethodWiseStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSMethodWiseStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberProvisioningWSMethodWiseEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberProvisioningWSMethodWiseEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSMethodWiseStatisticsTable");
    }
    ...
    public synchronized void addEntry(SubscriberProvisioningWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberProvisioningWSMethodWiseEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberProvisioningWSMethodWiseEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberProvisioningWSMethodWiseEntryMBean[] result = new SubscriberProvisioningWSMethodWiseEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberProvisioningWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySubscriberWSMethodIndex = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSMethodWiseStatisticsTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberProvisioningWSMethodWiseEntry" + ",SubscriberWSMethodIndex=" + _keySubscriberWSMethodIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberProvisioningWSMethodWiseEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberProvisioningWSMethodWiseEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSubscriberWSMethodIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberProvisioningWSMethodWiseEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSubscriberWSMethodIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSubscriberWSMethodIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberProvisioningWSMethodWiseEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberProvisioningWSMethodWiseEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberProvisioningWSMethodWiseEntryMBean"
     * interface.
    ...
    public Object createSubscriberProvisioningWSMethodWiseEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSubscriberWSMethodIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberProvisioningWSMethodWiseEntry entry = new SubscriberProvisioningWSMethodWiseEntry(theMib);
        entry.SubscriberWSMethodIndex = aSubscriberWSMethodIndex;
        return entry;
    }
