...
/**
 * The class is used for implementing the "SubscriptionWSSubscribeTopUpTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.16.
 */
public class TableSubscriptionWSSubscribeTopUpTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSSubscribeTopUpTable".
     ...
     */
    public TableSubscriptionWSSubscribeTopUpTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSSubscribeTopUpTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSSubscribeTopUpEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSSubscribeTopUpEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSSubscribeTopUpTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSSubscribeTopUpEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSSubscribeTopUpEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSSubscribeTopUpEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSSubscribeTopUpEntryMBean[] result = new SubscriptionWSSubscribeTopUpEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSSubscribeTopUpEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySubscribeTopUpResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSSubscribeTopUpTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSSubscribeTopUpEntry" + ",SubscribeTopUpResultCode=" + _keySubscribeTopUpResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSSubscribeTopUpEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSSubscribeTopUpEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSubscribeTopUpResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSSubscribeTopUpEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSubscribeTopUpResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSubscribeTopUpResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSSubscribeTopUpEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSSubscribeTopUpEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSSubscribeTopUpEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSSubscribeTopUpEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSubscribeTopUpResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSSubscribeTopUpEntry entry = new SubscriptionWSSubscribeTopUpEntry(theMib);
        entry.SubscribeTopUpResultCode = aSubscribeTopUpResultCode;
        return entry;
    }
