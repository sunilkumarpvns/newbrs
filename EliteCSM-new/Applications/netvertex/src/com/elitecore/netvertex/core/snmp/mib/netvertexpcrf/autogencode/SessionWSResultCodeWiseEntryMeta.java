...
/**
 * The class is used for representing SNMP metadata for the "SessionWSResultCodeWiseEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.11.6.1.
 */
public class SessionWSResultCodeWiseEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SessionWSResultCodeWiseEntry".
     */
    public SessionWSResultCodeWiseEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter(node.getSessionWSResultCodeCounters());

            case 2:
                return new SnmpString(node.getSessionWSResultCodeName());
     ...
     */
    protected void setInstance(SessionWSResultCodeWiseEntryMBean var) {
        node = var;
    }
    ...
    protected SessionWSResultCodeWiseEntryMBean node;
