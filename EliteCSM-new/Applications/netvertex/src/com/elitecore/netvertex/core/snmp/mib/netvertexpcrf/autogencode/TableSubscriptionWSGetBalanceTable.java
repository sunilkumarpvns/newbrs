...
/**
 * The class is used for implementing the "SubscriptionWSGetBalanceTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.14.
 */
public class TableSubscriptionWSGetBalanceTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSGetBalanceTable".
     ...
     */
    public TableSubscriptionWSGetBalanceTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSGetBalanceTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSGetBalanceEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSGetBalanceEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSGetBalanceTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSGetBalanceEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSGetBalanceEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSGetBalanceEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSGetBalanceEntryMBean[] result = new SubscriptionWSGetBalanceEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSGetBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyGetBalanceResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSGetBalanceTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSGetBalanceEntry" + ",GetBalanceResultCode=" + _keyGetBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSGetBalanceEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSGetBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getGetBalanceResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSGetBalanceEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aGetBalanceResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aGetBalanceResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSGetBalanceEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSGetBalanceEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSGetBalanceEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSGetBalanceEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aGetBalanceResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSGetBalanceEntry entry = new SubscriptionWSGetBalanceEntry(theMib);
        entry.GetBalanceResultCode = aGetBalanceResultCode;
        return entry;
    }
