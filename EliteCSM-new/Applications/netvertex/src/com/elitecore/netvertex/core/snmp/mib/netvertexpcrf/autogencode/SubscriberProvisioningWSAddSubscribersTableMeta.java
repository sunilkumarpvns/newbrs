 ...
 */
public class SubscriberProvisioningWSAddSubscribersTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriberProvisioningWSAddSubscribersTableMeta".
     ...
     */
    public SubscriberProvisioningWSAddSubscribersTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriberWSAddSubscribersEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriberWSAddSubscribersEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriberProvisioningWSAddSubscribersTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriberWSAddSubscribersEntry" conceptual row (SubscriberWSAddSubscribersEntryMeta)
     * 
     **/
    protected SubscriberWSAddSubscribersEntryMeta createSubscriberWSAddSubscribersEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriberWSAddSubscribersEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriberWSAddSubscribersEntryMetaNode("SubscriberWSAddSubscribersEntry", "SubscriberProvisioningWSAddSubscribersTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriberWSAddSubscribersEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriberProvisioningWSAddSubscribersTable" + "\" must implement the \"" + 
                           "SubscriberWSAddSubscribersEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriberWSAddSubscribersEntryMBean entry = (SubscriberWSAddSubscribersEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriberWSAddSubscribersEntryMeta node;
