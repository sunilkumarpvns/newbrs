...
/**
 * The class is used for implementing the "SubscriberProvisioningWSPurgeSubscribersTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.15.
 */
public class TableSubscriberProvisioningWSPurgeSubscribersTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSPurgeSubscribersTable".
     ...
     */
    public TableSubscriberProvisioningWSPurgeSubscribersTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSPurgeSubscribersTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSPurgeSubscribersEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSPurgeSubscribersEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSPurgeSubscribersTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSPurgeSubscribersEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSPurgeSubscribersEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSPurgeSubscribersEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSPurgeSubscribersEntryMBean[] result = new SubscriberWSPurgeSubscribersEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSPurgeSubscribersEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyPurgeSubscribersResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSPurgeSubscribersTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSPurgeSubscribersEntry" + ",PurgeSubscribersResultCode=" + _keyPurgeSubscribersResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSPurgeSubscribersEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSPurgeSubscribersEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getPurgeSubscribersResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSPurgeSubscribersEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aPurgeSubscribersResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aPurgeSubscribersResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSPurgeSubscribersEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSPurgeSubscribersEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSPurgeSubscribersEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSPurgeSubscribersEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aPurgeSubscribersResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSPurgeSubscribersEntry entry = new SubscriberWSPurgeSubscribersEntry(theMib);
        entry.PurgeSubscribersResultCode = aPurgeSubscribersResultCode;
        return entry;
    }
