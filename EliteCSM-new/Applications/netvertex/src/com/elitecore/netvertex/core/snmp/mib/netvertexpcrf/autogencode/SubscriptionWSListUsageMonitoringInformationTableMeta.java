 ...
 */
public class SubscriptionWSListUsageMonitoringInformationTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSListUsageMonitoringInformationTableMeta".
     ...
     */
    public SubscriptionWSListUsageMonitoringInformationTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSListUsageMonitoringInformationEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSListUsageMonitoringInformationEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSListUsageMonitoringInformationTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSListUsageMonitoringInformationEntry" conceptual row (SubscriptionWSListUsageMonitoringInformationEntryMeta)
     * 
     **/
    protected SubscriptionWSListUsageMonitoringInformationEntryMeta createSubscriptionWSListUsageMonitoringInformationEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSListUsageMonitoringInformationEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSListUsageMonitoringInformationEntryMetaNode("SubscriptionWSListUsageMonitoringInformationEntry", "SubscriptionWSListUsageMonitoringInformationTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSListUsageMonitoringInformationEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSListUsageMonitoringInformationTable" + "\" must implement the \"" + 
                           "SubscriptionWSListUsageMonitoringInformationEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSListUsageMonitoringInformationEntryMBean entry = (SubscriptionWSListUsageMonitoringInformationEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSListUsageMonitoringInformationEntryMeta node;
