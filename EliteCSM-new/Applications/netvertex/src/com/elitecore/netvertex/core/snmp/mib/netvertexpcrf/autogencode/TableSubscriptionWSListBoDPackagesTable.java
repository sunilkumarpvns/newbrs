...
/**
 * The class is used for implementing the "SubscriptionWSListBoDPackagesTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.30.
 */
public class TableSubscriptionWSListBoDPackagesTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSListBoDPackagesTable".
     ...
     */
    public TableSubscriptionWSListBoDPackagesTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSListBoDPackagesTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSListBoDPackagesEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSListBoDPackagesEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSListBoDPackagesTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSListBoDPackagesEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSListBoDPackagesEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSListBoDPackagesEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSListBoDPackagesEntryMBean[] result = new SubscriptionWSListBoDPackagesEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSListBoDPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyListBoDPackagesResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSListBoDPackagesTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSListBoDPackagesEntry" + ",ListBoDPackagesResultCode=" + _keyListBoDPackagesResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSListBoDPackagesEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSListBoDPackagesEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getListBoDPackagesResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSListBoDPackagesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aListBoDPackagesResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aListBoDPackagesResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSListBoDPackagesEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSListBoDPackagesEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSListBoDPackagesEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSListBoDPackagesEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aListBoDPackagesResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSListBoDPackagesEntry entry = new SubscriptionWSListBoDPackagesEntry(theMib);
        entry.ListBoDPackagesResultCode = aListBoDPackagesResultCode;
        return entry;
    }
