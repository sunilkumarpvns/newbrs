...
/**
 * The class is used for implementing the "SubscriberProvisioningWSPurgeSubscriberTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.14.
 */
public class TableSubscriberProvisioningWSPurgeSubscriberTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSPurgeSubscriberTable".
     ...
     */
    public TableSubscriberProvisioningWSPurgeSubscriberTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSPurgeSubscriberTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSPurgeSubscriberEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSPurgeSubscriberEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSPurgeSubscriberTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSPurgeSubscriberEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSPurgeSubscriberEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSPurgeSubscriberEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSPurgeSubscriberEntryMBean[] result = new SubscriberWSPurgeSubscriberEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSPurgeSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyPurgeSubscriberResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSPurgeSubscriberTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSPurgeSubscriberEntry" + ",PurgeSubscriberResultCode=" + _keyPurgeSubscriberResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSPurgeSubscriberEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSPurgeSubscriberEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getPurgeSubscriberResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSPurgeSubscriberEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aPurgeSubscriberResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aPurgeSubscriberResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSPurgeSubscriberEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSPurgeSubscriberEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSPurgeSubscriberEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSPurgeSubscriberEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aPurgeSubscriberResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSPurgeSubscriberEntry entry = new SubscriberWSPurgeSubscriberEntry(theMib);
        entry.PurgeSubscriberResultCode = aPurgeSubscriberResultCode;
        return entry;
    }
