...
/**
 * The class is used for implementing the "SubscriberProvisioningWSAddSubscriberProfileTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.10.7.
 */
public class TableSubscriberProvisioningWSAddSubscriberProfileTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriberProvisioningWSAddSubscriberProfileTable".
     ...
     */
    public TableSubscriberProvisioningWSAddSubscriberProfileTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriberProvisioningWSAddSubscriberProfileTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriberWSAddSubscriberProfileEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriberWSAddSubscriberProfileEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriberProvisioningWSAddSubscriberProfileTable");
    }
    ...
    public synchronized void addEntry(SubscriberWSAddSubscriberProfileEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriberWSAddSubscriberProfileEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriberWSAddSubscriberProfileEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriberWSAddSubscriberProfileEntryMBean[] result = new SubscriberWSAddSubscriberProfileEntryMBean[array.length];
    ...
    public void removeEntry(SubscriberWSAddSubscriberProfileEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyAddSubscriberProfileResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriberProvisioningWSAddSubscriberProfileTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriberWSAddSubscriberProfileEntry" + ",AddSubscriberProfileResultCode=" + _keyAddSubscriberProfileResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriberWSAddSubscriberProfileEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriberWSAddSubscriberProfileEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getAddSubscriberProfileResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriberWSAddSubscriberProfileEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aAddSubscriberProfileResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aAddSubscriberProfileResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriberWSAddSubscriberProfileEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriberWSAddSubscriberProfileEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriberWSAddSubscriberProfileEntryMBean"
     * interface.
    ...
    public Object createSubscriberWSAddSubscriberProfileEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aAddSubscriberProfileResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriberWSAddSubscriberProfileEntry entry = new SubscriberWSAddSubscriberProfileEntry(theMib);
        entry.AddSubscriberProfileResultCode = aAddSubscriberProfileResultCode;
        return entry;
    }
