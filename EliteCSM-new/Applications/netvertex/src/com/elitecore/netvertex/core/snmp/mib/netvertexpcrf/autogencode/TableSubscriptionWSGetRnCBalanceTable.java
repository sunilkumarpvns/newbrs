...
/**
 * The class is used for implementing the "SubscriptionWSGetRnCBalanceTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.19.
 */
public class TableSubscriptionWSGetRnCBalanceTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSGetRnCBalanceTable".
     ...
     */
    public TableSubscriptionWSGetRnCBalanceTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSGetRnCBalanceTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSGetRnCBalanceEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSGetRnCBalanceEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSGetRnCBalanceTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSGetRnCBalanceEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSGetRnCBalanceEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSGetRnCBalanceEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSGetRnCBalanceEntryMBean[] result = new SubscriptionWSGetRnCBalanceEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSGetRnCBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyGetRnCBalanceResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSGetRnCBalanceTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSGetRnCBalanceEntry" + ",GetRnCBalanceResultCode=" + _keyGetRnCBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSGetRnCBalanceEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSGetRnCBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getGetRnCBalanceResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSGetRnCBalanceEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aGetRnCBalanceResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aGetRnCBalanceResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSGetRnCBalanceEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSGetRnCBalanceEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSGetRnCBalanceEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSGetRnCBalanceEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aGetRnCBalanceResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSGetRnCBalanceEntry entry = new SubscriptionWSGetRnCBalanceEntry(theMib);
        entry.GetRnCBalanceResultCode = aGetRnCBalanceResultCode;
        return entry;
    }
