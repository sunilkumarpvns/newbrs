 ...
 */
public class SessionManagementWSGetSessionsByIPTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SessionManagementWSGetSessionsByIPTableMeta".
     ...
     */
    public SessionManagementWSGetSessionsByIPTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SessionWSGetSessionsByIPEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SessionWSGetSessionsByIPEntry")
     * @param tableName Name of the table in which the entries are registered ("SessionManagementWSGetSessionsByIPTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SessionWSGetSessionsByIPEntry" conceptual row (SessionWSGetSessionsByIPEntryMeta)
     * 
     **/
    protected SessionWSGetSessionsByIPEntryMeta createSessionWSGetSessionsByIPEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SessionWSGetSessionsByIPEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSessionWSGetSessionsByIPEntryMetaNode("SessionWSGetSessionsByIPEntry", "SessionManagementWSGetSessionsByIPTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SessionWSGetSessionsByIPEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SessionManagementWSGetSessionsByIPTable" + "\" must implement the \"" + 
                           "SessionWSGetSessionsByIPEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SessionWSGetSessionsByIPEntryMBean entry = (SessionWSGetSessionsByIPEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SessionWSGetSessionsByIPEntryMeta node;
