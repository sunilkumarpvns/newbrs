...
/**
 * The class is used for implementing the "SubscriptionWSGetMonetaryBalanceTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.4.1.3.9.21.
 */
public class TableSubscriptionWSGetMonetaryBalanceTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSubscriptionWSGetMonetaryBalanceTable".
     ...
     */
    public TableSubscriptionWSGetMonetaryBalanceTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSubscriptionWSGetMonetaryBalanceTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SubscriptionWSGetMonetaryBalanceEntryMBean"
            // interface.
            //
            final Object entry =
                 createSubscriptionWSGetMonetaryBalanceEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SubscriptionWSGetMonetaryBalanceTable");
    }
    ...
    public synchronized void addEntry(SubscriptionWSGetMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SubscriptionWSGetMonetaryBalanceEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SubscriptionWSGetMonetaryBalanceEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SubscriptionWSGetMonetaryBalanceEntryMBean[] result = new SubscriptionWSGetMonetaryBalanceEntryMBean[array.length];
    ...
    public void removeEntry(SubscriptionWSGetMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyGetMonetaryBalanceResultCode = oid.toInteger().toString();
            return new ObjectName("TableSubscriptionWSGetMonetaryBalanceTable:name=com.elitecore.netvertex.core.snmp.mib.netvertexpcrf.autogencode.SubscriptionWSGetMonetaryBalanceEntry" + ",GetMonetaryBalanceResultCode=" + _keyGetMonetaryBalanceResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "SubscriptionWSGetMonetaryBalanceEntry".
     */
    public SnmpIndex buildSnmpIndex(SubscriptionWSGetMonetaryBalanceEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getGetMonetaryBalanceResultCode());
        oids[0] = val.toOid();
     ...
     * Build index for "SubscriptionWSGetMonetaryBalanceEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aGetMonetaryBalanceResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aGetMonetaryBalanceResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "SubscriptionWSGetMonetaryBalanceEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "SubscriptionWSGetMonetaryBalanceEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SubscriptionWSGetMonetaryBalanceEntryMBean"
     * interface.
    ...
    public Object createSubscriptionWSGetMonetaryBalanceEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aGetMonetaryBalanceResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SubscriptionWSGetMonetaryBalanceEntry entry = new SubscriptionWSGetMonetaryBalanceEntry(theMib);
        entry.GetMonetaryBalanceResultCode = aGetMonetaryBalanceResultCode;
        return entry;
    }
