 ...
 */
public class SubscriptionWSMethodWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SubscriptionWSMethodWiseStatisticsTableMeta".
     ...
     */
    public SubscriptionWSMethodWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SubscriptionWSMethodWiseEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SubscriptionWSMethodWiseEntry")
     * @param tableName Name of the table in which the entries are registered ("SubscriptionWSMethodWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SubscriptionWSMethodWiseEntry" conceptual row (SubscriptionWSMethodWiseEntryMeta)
     * 
     **/
    protected SubscriptionWSMethodWiseEntryMeta createSubscriptionWSMethodWiseEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SubscriptionWSMethodWiseEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSubscriptionWSMethodWiseEntryMetaNode("SubscriptionWSMethodWiseEntry", "SubscriptionWSMethodWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SubscriptionWSMethodWiseEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SubscriptionWSMethodWiseStatisticsTable" + "\" must implement the \"" + 
                           "SubscriptionWSMethodWiseEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SubscriptionWSMethodWiseEntryMBean entry = (SubscriptionWSMethodWiseEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SubscriptionWSMethodWiseEntryMeta node;
