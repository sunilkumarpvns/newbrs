...
public class DiameterToPCCAttributeMapping implements DiameterToPCCPacketMapping {
    private static final String MODULE = "DIAMETER-TO-PCC-ATTRIBUTE-MAPPING";
    @Nonnull public final String attributeId;
    ...
    public DiameterToPCCAttributeMapping(@Nonnull String attributeId,
    ...
    private String getValue(PCRFRequestMappingValueProvider valueProvider)  {
