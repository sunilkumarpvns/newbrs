...
public class TableRadiusAuthClientTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableRadiusAuthClientTable:name=com.elitecore.netvertex.gateway.radius.snmp.auth.autogen.RadiusAuthClientEntry" + ",RadiusAuthClientIndex=" + _keyRadiusAuthClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
