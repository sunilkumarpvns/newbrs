...
/**
 * The class is used for representing SNMP metadata for the "RadiusAccClientEntry" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.67.2.1.1.1.14.1.
 */
public class RadiusAccClientEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "RadiusAccClientEntry".
     */
    public RadiusAccClientEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 9:
                return new SnmpCounter(node.getRadiusAccServMalformedRequests());

            case 8:
                return new SnmpCounter(node.getRadiusAccServBadAuthenticators());

            case 7:
                return new SnmpCounter(node.getRadiusAccServResponses());

            case 6:
                return new SnmpCounter(node.getRadiusAccServDupRequests());

            case 5:
                return new SnmpCounter(node.getRadiusAccServRequests());

            case 4:
                return new SnmpCounter(node.getRadiusAccServPacketsDropped());

            case 3:
                return new SnmpString(node.getRadiusAccClientID());

            case 2:
                return new SnmpIpAddress(node.getRadiusAccClientAddress());

            case 11:
                return new SnmpCounter(node.getRadiusAccServUnknownTypes());

            case 10:
                return new SnmpCounter(node.getRadiusAccServNoRecords());
     ...
     */
    protected void setInstance(RadiusAccClientEntryMBean var) {
        node = var;
    }
    ...
    protected RadiusAccClientEntryMBean node;
