 ...
 */
public class TableRadiusDynAuthServerTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableRadiusDynAuthServerTable".
     ...
     */
    public TableRadiusDynAuthServerTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableRadiusDynAuthServerTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "RadiusDynAuthServerEntryMBean"
            // interface.
            //
            final Object entry =
                 createRadiusDynAuthServerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("RadiusDynAuthServerTable");
    }
    ...
    public synchronized void addEntry(RadiusDynAuthServerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized RadiusDynAuthServerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        RadiusDynAuthServerEntryMBean[] result = new RadiusDynAuthServerEntryMBean[array.length];
    ...
    public void removeEntry(RadiusDynAuthServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyRadiusDynAuthServerIndex = oid.toInteger().toString();
            return new ObjectName("TableRadiusDynAuthServerTable:name=com.elitecore.netvertex.gateway.radius.snmp.dynaauth.autogen.RadiusDynAuthServerEntry" + ",RadiusDynAuthServerIndex=" + _keyRadiusDynAuthServerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "RadiusDynAuthServerEntry".
     */
    public SnmpIndex buildSnmpIndex(RadiusDynAuthServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getRadiusDynAuthServerIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "RadiusDynAuthServerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aRadiusDynAuthServerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aRadiusDynAuthServerIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "RadiusDynAuthServerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "RadiusDynAuthServerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "RadiusDynAuthServerEntryMBean"
     * interface.
    ...
    public Object createRadiusDynAuthServerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aRadiusDynAuthServerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        RadiusDynAuthServerEntry entry = new RadiusDynAuthServerEntry(theMib);
        entry.RadiusDynAuthServerIndex = aRadiusDynAuthServerIndex;
        return entry;
    }
