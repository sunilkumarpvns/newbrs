...
/**
 * The class is used for implementing the "RadiusAccClientTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.67.2.1.1.1.14.
 */
public class TableRadiusAccClientTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableRadiusAccClientTable".
     ...
     */
    public TableRadiusAccClientTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableRadiusAccClientTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "RadiusAccClientEntryMBean"
            // interface.
            //
            final Object entry =
                 createRadiusAccClientEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("RadiusAccClientTable");
    }
    ...
    public synchronized void addEntry(RadiusAccClientEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized RadiusAccClientEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        RadiusAccClientEntryMBean[] result = new RadiusAccClientEntryMBean[array.length];
    ...
    public void removeEntry(RadiusAccClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyRadiusAccClientIndex = oid.toInteger().toString();
            return new ObjectName("TableRadiusAccClientTable:name=com.elitecore.netvertex.gateway.radius.snmp.acct.autogen.RadiusAccClientEntry" + ",RadiusAccClientIndex=" + _keyRadiusAccClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "RadiusAccClientEntry".
     */
    public SnmpIndex buildSnmpIndex(RadiusAccClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getRadiusAccClientIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "RadiusAccClientEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aRadiusAccClientIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aRadiusAccClientIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "RadiusAccClientEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "RadiusAccClientEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "RadiusAccClientEntryMBean"
     * interface.
    ...
    public Object createRadiusAccClientEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aRadiusAccClientIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        RadiusAccClientEntry entry = new RadiusAccClientEntry(theMib);
        entry.RadiusAccClientIndex = aRadiusAccClientIndex;
        return entry;
    }
