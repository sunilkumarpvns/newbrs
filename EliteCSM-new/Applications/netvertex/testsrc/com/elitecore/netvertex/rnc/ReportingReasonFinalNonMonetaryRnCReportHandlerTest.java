...
public class ReportingReasonFinalNonMonetaryRnCReportHandlerTest {
    ...
    public class OnlyNonMonetaryBalance {
        ...
        public void execute() {
            ...
            getLogger().debug(ReportingReasonFinalNonMonetaryRnCReportHandlerTest.class.getSimpleName(), "Non-Monetary Balance is:" + nonMonetoryBalance);
            getLogger().debug(ReportingReasonFinalNonMonetaryRnCReportHandlerTest.class.getSimpleName(), "Quota Reservation is:" + response.getQuotaReservation());
            getLogger().debug(ReportingReasonFinalNonMonetaryRnCReportHandlerTest.class.getSimpleName(), "Reported Quota is:" + request.getReportedMSCCs());
        }
        ...
        public class UnAccountedQuotaIsNull {
            ...
            public void execute() {
                ...
                getLogger().debug(ReportingReasonFinalNonMonetaryRnCReportHandlerTest.class.getSimpleName(), "Non-Monetary Balance after reporting is:" + response.getCurrentRnCNonMonetaryBalance().getBalanceById(nonMonetoryBalance.getId()));
                getLogger().debug(ReportingReasonFinalNonMonetaryRnCReportHandlerTest.class.getSimpleName(), "Accounted Non-Monetary Balance after reporting is:" + response.getAccountedRnCNonMonetaryBalance().getBalanceById(nonMonetoryBalance.getId()));
            }
        ...
        public class UnAccountedQuotaIsNotNull {
            ...
            public void execute() {
                ...
                getLogger().debug(ReportingReasonFinalNonMonetaryRnCReportHandlerTest.class.getSimpleName(), "UnAccounted Quota:" + unAccountedQuota);
                reportHandler.process(request, response, executionContext);
