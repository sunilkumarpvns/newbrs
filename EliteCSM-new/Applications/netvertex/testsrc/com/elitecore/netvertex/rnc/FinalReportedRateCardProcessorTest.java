...
public class FinalReportedRateCardProcessorTest {
    ...
    public class MonetaryBalances {
        ...
        public class rateOnTime {
            ...
            public void setUp() {
                ...
                monetaryBalance = FinalReportedRateCardProcessorTest.createMonetaryBalance(request.getSPRInfo().getSubscriberIdentity());
                ...
                request.getReportedMSCCs().get(0).setReportingReason(ReportingReason.FINAL);
            }
            ...
            public class UnAccountedQuotaIsNull {
                ...
                @Test
                public void deductMonetaryBalanceFromCurrentBalance() {
