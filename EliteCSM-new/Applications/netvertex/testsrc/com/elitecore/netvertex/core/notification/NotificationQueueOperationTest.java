...
public class NotificationQueueOperationTest {
    ...
    private static final String SELECT_COUNT_QUERY = "SELECT COUNT(1) COUNT FROM TBLT_NOTIFICATION_QUEUE ";
    ...
    public class NoNotificationWillbeInsertedToDBWhen{
        ...
        public void transactionFactoryIsNotAlive() throws TransactionException, SQLException {
            ...
            notificationAgentDBOperation.insertIntoNotificationQueue(createNotification());
            notificationExecutor.tick();
    ...
    public void notInsertsNotificationIntoDBWhenIOExceptionOccurWhilePreparingBatch() throws TransactionException, SQLException {
        ...
        notificationAgentDBOperation.insertIntoNotificationQueue(createNotification(pcrfResponseWritable));
        notificationExecutor.tick();
        verifyTransactionMustEnd(transaction);
        verifyNoInsertionInDB();
    }
