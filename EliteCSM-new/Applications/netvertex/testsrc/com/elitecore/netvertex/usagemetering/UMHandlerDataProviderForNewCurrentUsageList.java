...
public class UMHandlerDataProviderForNewCurrentUsageList {/*
	...
	public static void setUp() {
		...
		executionContext = new ExecutionContext(new UMHandlerTest.TestableSubscriberRepository(null, null, null, policyRepository), pcrfReq, pcrfRes);
...

				{
						...
						Arrays.asList(
								...
								new SubscriberUsageBuilder(DEFAULT_SERVICE_ID, SUBSCRIBER_IDENTITY, SERVICE_ID_SUFFICS + 1, QUOTA_PROFILE_SUFFICS + 1, BASE_PACKAGE_ID_SUFFICS + 1)
										...
										.withWeeklyResetTime(executionContext.getCurrentTime().getTimeInMillis() + 100)
										.build(),
								new SubscriberUsageBuilder(SubscriberUsage.NEW_ID, SUBSCRIBER_IDENTITY, DEFAULT_SERVICE_ID, QUOTA_PROFILE_SUFFICS + 2, BASE_PACKAGE_ID_SUFFICS + 1)
										.withAllTypeUsage(100, 100, 100, 100).build(),

								new SubscriberUsageBuilder(SubscriberUsage.NEW_ID, SUBSCRIBER_IDENTITY, SERVICE_ID_SUFFICS + 2, QUOTA_PROFILE_SUFFICS + 2, BASE_PACKAGE_ID_SUFFICS + 1)
										.withAllTypeUsage(100, 100, 100, 100).build()
								)
						,
