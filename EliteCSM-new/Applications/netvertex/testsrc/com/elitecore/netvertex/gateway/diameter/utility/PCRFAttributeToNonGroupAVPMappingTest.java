...
public class PCRFAttributeToNonGroupAVPMappingTest {


	private static final Compiler DEFAULT_COMPILER = Compiler.getDefaultCompiler();
	private PCRFAttributeToNonGroupAVPMapping nonGroupAVPMapping;
	...
	public class ValueMappingProvidedAndValueFound {
		...
		public void setUp() throws InvalidExpressionException {
			...
			nonGroupAVPMapping = new PCRFAttributeToNonGroupAVPMapping("0:1", parseExpression("REQ_TYPE")
					,"REQ_TYPE",Maps.newLinkedHashMap(Entry.newEntry("1", "INITIAL"))
	...
	public class ValueMappingNotProvidedAndValueFound {
		...
		public void setUp() throws InvalidExpressionException {
			...
			nonGroupAVPMapping = new PCRFAttributeToNonGroupAVPMapping("0:1", parseExpression("REQ_TYPE"), "REQ_TYPE", null, "INITIAL", attributeFactory);
	...
	public class ValueNotFound {
		...
		public void test_apply_use_defaultValue_when_provided() throws InvalidExpressionException {
			...
			nonGroupAVPMapping = new PCRFAttributeToNonGroupAVPMapping("0:1", parseExpression("REQ_TYPE"), "REQ_TYPE", null, "DEFAULT", attributeFactory);
		...
		public void test_apply_notaddAVP_when_defaultValueNotProvided() throws InvalidExpressionException {
			...
			nonGroupAVPMapping = new PCRFAttributeToNonGroupAVPMapping("0:1", parseExpression("REQ_TYPE"), "REQ_TYPE", null, null, attributeFactory);
	...
	public void test_apply_should_not_store_diameterAVP_if_not_found_from_factory() throws InvalidExpressionException {
		nonGroupAVPMapping = new PCRFAttributeToNonGroupAVPMapping("0:1", parseExpression("REQ_TYPE")
				,  "REQ_TYPE",null , null, AttributeFactories.newFactory().create());
	...
	public void test_apply_should_not_store_diameterAVP_if_AVP_is_grouped() throws InvalidExpressionException {
		nonGroupAVPMapping = new PCRFAttributeToNonGroupAVPMapping("0:10", parseExpression("REQ_TYPE")
				, "REQ_TYPE",null , null,AttributeFactories.newFactory().addGroupedAvp(0, 10).create());
		nonGroupAVPMapping.apply(valueProvider, null);
	}
