package com.elitecore.netvertex.pm.qos.rncbaseqosprofile.PreTopUp
...
class PreTopupWithBasePackageQuotaAndPCCRule extends Specification {
    ...
    def "Fully Applied when TopUp Balance balance available"() {
    ...
    def "Fully Applied And Base Balance Considered When TopUp Balance not available"() {
    ...
    def "For multiple subscriptions balance of TopUp with valid Applicable PCC Profile will be considered "() {
    ...
    def createPackageAndSubscription(){
        ...
        quotaTopUpWithNoApplicablePccProfiles = dummyPolicyRepository.mockQuotaTopUp().withPackageType(TopUpType.TOP_UP);
        quotaTopUpWithTestAsApplicablePCCProfile = dummyPolicyRepository.mockQuotaTopUp(Arrays.asList(PCC_PROFILE_NAME)).withPackageType(TopUpType.TOP_UP);
        quotaTopUpWithUnknownApplicablePccProfile = dummyPolicyRepository.mockQuotaTopUp(Arrays.asList(PCC_PROFILE_NAME+UNKNOWN)).withPackageType(TopUpType.TOP_UP);
