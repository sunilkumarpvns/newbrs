...
public class PCCRuleFactory {
	...
	public static PCCRuleBuilder createPCCRuleWithRandomQoS() {
		...
		RatingGroup ratingGroup = new RatingGroup("1", "defaultRatingGroup", "", 0);
		//String serviceDataFlow = new String("allow", "tcp", "any", "0", "any", "0");
		DataServiceType dataServiceType = new DataServiceType(CommonConstants.ALL_SERVICE_ID, "default", 1, Arrays.asList(""), Arrays.asList(ratingGroup));
