...
import com.elitecore.netvertex.pm.PromotionalPackage;
...
public class MockPromotionalPackage extends PromotionalPackage {
    ...
    public MockPromotionalPackage(String id, String name, QuotaProfileType quotaProfileType, PkgStatus availabilityStatus, List<QoSProfile> qosProfiles, UsageNotificationScheme usageNotificationScheme, PkgMode packageMode, String description, Double price, Timestamp availabilityStartDate, Timestamp availabilityEndDate, String eligibleGroupIds, boolean preferPromotionalQoS, PolicyStatus status, @Nullable String failReason, @Nullable String partialFailReason, @Nullable String param1, @Nullable String param2, List<GroupManageOrder> groupOrderConfs) {
