...
public class AcctGroupsSynchronousCommunicationHandlerTest {
	...
	@Mock RadAcctServiceContext authServiceContext;
	...
	public void setUp() throws Exception {
		...
		handler = new AcctGroupsSynchronousCommunicationHandler(authServiceContext, handlerData);
		handler.init();
	...
	public void entryWillApplicableIfConfiguredRuleSetIsSatisfied() throws InvalidAttributeIdException {
		request = radAcctRequestBuilder.addAttribute(RadiusAttributeConstants.USER_NAME_STR, "test").build();

		RadiusRequestExecutor<RadAcctRequest, RadAcctResponse> executor = new RadiusRequestExecutor<RadAcctRequest, RadAcctResponse>(handler, request, response);
		...
		verify(authServiceContext).submitAsyncRequest(Mockito.any(RadAcctRequest.class), Mockito.any(RadAcctResponse.class), Mockito.any(AsyncRequestExecutor.class));
	}

	@Test
	public void entryWillSkippedIfConfiguredRuleSetIsNotSatisfied() throws InvalidAttributeIdException {
		request = radAcctRequestBuilder.addAttribute(RadiusAttributeConstants.USER_NAME_STR, "test1").build();
	...
	private void createRequestAndResponse() throws Exception {
		...
		radAcctRequestBuilder = new RadAcctRequestBuilder()
				.packetType(RadiusConstants.ACCESS_REQUEST_MESSAGE);

		request = new RadAcctRequestBuilder()
				.packetType(RadiusConstants.ACCOUNTING_REQUEST_MESSAGE).build();
