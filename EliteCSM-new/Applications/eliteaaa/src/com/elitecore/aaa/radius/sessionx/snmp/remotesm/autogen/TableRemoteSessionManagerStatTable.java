...
/**
 * The class is used for implementing the "RemoteSessionManagerStatTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.1.2.2.2.
 */
public class TableRemoteSessionManagerStatTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableRemoteSessionManagerStatTable".
     ...
     */
    public TableRemoteSessionManagerStatTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableRemoteSessionManagerStatTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "RemoteSessionManagerEntryMBean"
            // interface.
            //
            final Object entry =
                 createRemoteSessionManagerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("RemoteSessionManagerStatTable");
    }
    ...
    public synchronized void addEntry(RemoteSessionManagerEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(RemoteSessionManagerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized RemoteSessionManagerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        RemoteSessionManagerEntryMBean[] result = new RemoteSessionManagerEntryMBean[array.length];
    ...
    public void removeEntry(RemoteSessionManagerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyClientIndex = oid.toInteger().toString();
            return new ObjectName("TableRemoteSessionManagerStatTable:name=com.elitecore.aaa.radius.sessionx.snmp.remotesm.autogen.RemoteSessionManagerEntry" + ",ClientIndex=" + _keyClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "RemoteSessionManagerEntry".
     */
    public SnmpIndex buildSnmpIndex(RemoteSessionManagerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getClientIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "RemoteSessionManagerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aClientIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aClientIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "RemoteSessionManagerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "RemoteSessionManagerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "RemoteSessionManagerEntryMBean"
     * interface.
    ...
    public Object createRemoteSessionManagerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aClientIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        RemoteSessionManagerEntry entry = new RemoteSessionManagerEntry(theMib);
        entry.ClientIndex = aClientIndex;
        return entry;
    }
