...
/**
 * The class is used for implementing the "LocalSessionManagerStatsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.1.6.1.1.
 */
public class TableLocalSessionManagerStatsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableLocalSessionManagerStatsTable".
     ...
     */
    public TableLocalSessionManagerStatsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableLocalSessionManagerStatsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "LocalSessionManagerEntryMBean"
            // interface.
            //
            final Object entry =
                 createLocalSessionManagerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("LocalSessionManagerStatsTable");
    }
    ...
    public synchronized void addEntry(LocalSessionManagerEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(LocalSessionManagerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized LocalSessionManagerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        LocalSessionManagerEntryMBean[] result = new LocalSessionManagerEntryMBean[array.length];
    ...
    public void removeEntry(LocalSessionManagerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySmIndex = oid.toInteger().toString();
            return new ObjectName("TableLocalSessionManagerStatsTable:name=com.elitecore.aaa.radius.sessionx.snmp.localsm.autogen.LocalSessionManagerEntry" + ",SmIndex=" + _keySmIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "LocalSessionManagerEntry".
     */
    public SnmpIndex buildSnmpIndex(LocalSessionManagerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSmIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "LocalSessionManagerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSmIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSmIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "LocalSessionManagerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "LocalSessionManagerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "LocalSessionManagerEntryMBean"
     * interface.
    ...
    public Object createLocalSessionManagerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSmIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        LocalSessionManagerEntry entry = new LocalSessionManagerEntry(theMib);
        entry.SmIndex = aSmIndex;
        return entry;
    }
