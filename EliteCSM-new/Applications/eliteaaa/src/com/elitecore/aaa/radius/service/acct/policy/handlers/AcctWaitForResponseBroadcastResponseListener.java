...
public class AcctWaitForResponseBroadcastResponseListener implements BroadcastResponseListener<RadAcctRequest, RadAcctResponse> {
	private static final String MODULE = "ACCT-BROADCAST-WAIT-RES-LSTNR";
	
	private final RadAcctServiceContext serviceContext;
	@GuardedBy("request")
	private int receivedCount = 0;
	private List<OrderedAsyncRequestExecutor<RadAcctRequest, RadAcctResponse>> executors = Collectionz.newArrayList();
	private final RadAcctResponse response;
	private final RadAcctRequest request;
	/*
	...
	public AcctWaitForResponseBroadcastResponseListener(RadAcctServiceContext serviceContext,
	...
	@Override
	@GuardedBy("this")
	public synchronized void addAsyncRequestExecutor(OrderedAsyncRequestExecutor<RadAcctRequest, RadAcctResponse> executor) {
	...
	class BroadcastAsyncRequestExecutor implements AsyncRequestExecutor<RadAcctRequest, RadAcctResponse> {
		...
		public void handleServiceRequest(RadAcctRequest serviceRequest, RadAcctResponse serviceResponse) {
			...
			for (AsyncRequestExecutor<RadAcctRequest, RadAcctResponse> executor : executors) {
