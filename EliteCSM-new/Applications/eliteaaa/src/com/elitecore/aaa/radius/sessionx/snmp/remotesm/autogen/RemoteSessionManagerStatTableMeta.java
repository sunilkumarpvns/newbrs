 ...
 */
public class RemoteSessionManagerStatTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "RemoteSessionManagerStatTableMeta".
     ...
     */
    public RemoteSessionManagerStatTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "RemoteSessionManagerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("RemoteSessionManagerEntry")
     * @param tableName Name of the table in which the entries are registered ("RemoteSessionManagerStatTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "RemoteSessionManagerEntry" conceptual row (RemoteSessionManagerEntryMeta)
     * 
     **/
    protected RemoteSessionManagerEntryMeta createRemoteSessionManagerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new RemoteSessionManagerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createRemoteSessionManagerEntryMetaNode("RemoteSessionManagerEntry", "RemoteSessionManagerStatTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof RemoteSessionManagerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "RemoteSessionManagerStatTable" + "\" must implement the \"" + 
                           "RemoteSessionManagerEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        RemoteSessionManagerEntryMBean entry = (RemoteSessionManagerEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private RemoteSessionManagerEntryMeta node;
