 ...
 */
public class LocalSessionManagerStatsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "LocalSessionManagerStatsTableMeta".
     ...
     */
    public LocalSessionManagerStatsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "LocalSessionManagerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("LocalSessionManagerEntry")
     * @param tableName Name of the table in which the entries are registered ("LocalSessionManagerStatsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "LocalSessionManagerEntry" conceptual row (LocalSessionManagerEntryMeta)
     * 
     **/
    protected LocalSessionManagerEntryMeta createLocalSessionManagerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new LocalSessionManagerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createLocalSessionManagerEntryMetaNode("LocalSessionManagerEntry", "LocalSessionManagerStatsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof LocalSessionManagerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "LocalSessionManagerStatsTable" + "\" must implement the \"" + 
                           "LocalSessionManagerEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        LocalSessionManagerEntryMBean entry = (LocalSessionManagerEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private LocalSessionManagerEntryMeta node;
