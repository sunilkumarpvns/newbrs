...
public class RadiusSrcKeyword extends TranslationKeyword{

	private static String MODULE = "RADIUS-SRC-KEYWORD";
	public RadiusSrcKeyword(String keyword,KeywordContext context) {
