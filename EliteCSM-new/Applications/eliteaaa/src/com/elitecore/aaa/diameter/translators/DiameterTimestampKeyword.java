...
public class DiameterTimestampKeyword extends TimeStampKeyword {

	private static final String MODULE = "DIA-TMSTMP-KYWRD";

	public DiameterTimestampKeyword(String name, KeywordContext context) {
		super(name, context);
	}
