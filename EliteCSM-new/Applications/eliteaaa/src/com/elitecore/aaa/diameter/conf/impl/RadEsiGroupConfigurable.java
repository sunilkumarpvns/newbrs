...
public class RadEsiGroupConfigurable extends Configurable {
	...
	private Map<String, RadEsiGroupData> groupIdToGroup = new HashMap<String, RadEsiGroupData>();
		...
		ResultSet resultSet = null;
			...
			try {
				...
				while(resultSet.next()) {
					...
					radEsiGroupData.setId(resultSet.getString("ESIGROUPID"));
	...
	public @Nullable RadEsiGroupData getRadEsiGroup(String groupId) {
	...
	public void postReloadProcessing() {
		/**
		 * Empty because this configurable is not reloaded.
		 */
	}
