...
public class DiameterNASServicePolicyContainer extends DiameterServicePolicyContainer {

	public DiameterNASServicePolicyContainer(ServiceContext serviceContext,Map<String,DiameterServicePolicyConfiguration> policyConfMap, 
	...
	protected ServicePolicy<ApplicationRequest> getPolicyObject(ServiceContext serviceContext, String policyId, 
			@Nullable DiameterSessionManager diameterSessionManager) {
		return new NasAppPolicy((DiameterServiceContext)serviceContext, policyId, diameterSessionManager);
	}
