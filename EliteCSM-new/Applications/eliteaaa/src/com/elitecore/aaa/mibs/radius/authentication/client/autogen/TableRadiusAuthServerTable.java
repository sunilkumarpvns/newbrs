...
/**
 * The class is used for implementing the "RadiusAuthServerTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.67.1.2.1.1.3.
 */
public class TableRadiusAuthServerTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableRadiusAuthServerTable".
     ...
     */
    public TableRadiusAuthServerTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableRadiusAuthServerTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "RadiusAuthServerEntryMBean"
            // interface.
            //
            final Object entry =
                 createRadiusAuthServerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("RadiusAuthServerTable");
    }
    ...
    public synchronized void addEntry(RadiusAuthServerEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(RadiusAuthServerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized RadiusAuthServerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        RadiusAuthServerEntryMBean[] result = new RadiusAuthServerEntryMBean[array.length];
    ...
    public void removeEntry(RadiusAuthServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyRadiusAuthServerIndex = oid.toInteger().toString();
            return new ObjectName("TableRadiusAuthServerTable:name=com.elitecore.aaa.mibs.radius.authentication.client.autogen.RadiusAuthServerEntry" + ",RadiusAuthServerIndex=" + _keyRadiusAuthServerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "RadiusAuthServerEntry".
     */
    public SnmpIndex buildSnmpIndex(RadiusAuthServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getRadiusAuthServerIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "RadiusAuthServerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aRadiusAuthServerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aRadiusAuthServerIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "RadiusAuthServerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "RadiusAuthServerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "RadiusAuthServerEntryMBean"
     * interface.
    ...
    public Object createRadiusAuthServerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aRadiusAuthServerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        RadiusAuthServerEntry entry = new RadiusAuthServerEntry(theMib);
        entry.RadiusAuthServerIndex = aRadiusAuthServerIndex;
        return entry;
    }
