...
/**
 * The class is used for implementing the "ChargingServerStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.1.8.2.2.1.
 */
public class TableChargingServerStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableChargingServerStatisticsTable".
     ...
     */
    public TableChargingServerStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableChargingServerStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "ChargingServerEntryMBean"
            // interface.
            //
            final Object entry =
                 createChargingServerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("ChargingServerStatisticsTable");
    }
    ...
    public synchronized void addEntry(ChargingServerEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(ChargingServerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized ChargingServerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        ChargingServerEntryMBean[] result = new ChargingServerEntryMBean[array.length];
    ...
    public void removeEntry(ChargingServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyChargingServerIndex = oid.toInteger().toString();
            return new ObjectName("TableChargingServerStatisticsTable:name=com.elitecore.aaa.mibs.rm.charging.client.snmp.autogen.ChargingServerEntry" + ",ChargingServerIndex=" + _keyChargingServerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "ChargingServerEntry".
     */
    public SnmpIndex buildSnmpIndex(ChargingServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getChargingServerIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "ChargingServerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aChargingServerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aChargingServerIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "ChargingServerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "ChargingServerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "ChargingServerEntryMBean"
     * interface.
    ...
    public Object createChargingServerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aChargingServerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        ChargingServerEntry entry = new ChargingServerEntry(theMib);
        entry.ChargingServerIndex = aChargingServerIndex;
        return entry;
    }
