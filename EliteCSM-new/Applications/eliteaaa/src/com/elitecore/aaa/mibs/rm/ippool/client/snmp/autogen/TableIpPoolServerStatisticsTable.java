...
/**
 * The class is used for implementing the "IpPoolServerStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.1.7.2.101.
 */
public class TableIpPoolServerStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableIpPoolServerStatisticsTable".
     ...
     */
    public TableIpPoolServerStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableIpPoolServerStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "IpPoolServerEntryMBean"
            // interface.
            //
            final Object entry =
                 createIpPoolServerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("IpPoolServerStatisticsTable");
    }
    ...
    public synchronized void addEntry(IpPoolServerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized IpPoolServerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        IpPoolServerEntryMBean[] result = new IpPoolServerEntryMBean[array.length];
    ...
    public void removeEntry(IpPoolServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyIpPoolServerIndex = oid.toInteger().toString();
            return new ObjectName("TableIpPoolServerStatisticsTable:name=com.elitecore.aaa.mibs.rm.ippool.client.snmp.autogen.IpPoolServerEntry" + ",IpPoolServerIndex=" + _keyIpPoolServerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "IpPoolServerEntry".
     */
    public SnmpIndex buildSnmpIndex(IpPoolServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getIpPoolServerIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "IpPoolServerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aIpPoolServerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aIpPoolServerIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "IpPoolServerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "IpPoolServerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "IpPoolServerEntryMBean"
     * interface.
    ...
    public Object createIpPoolServerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aIpPoolServerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        IpPoolServerEntry entry = new IpPoolServerEntry(theMib);
        entry.IpPoolServerIndex = aIpPoolServerIndex;
        return entry;
    }
