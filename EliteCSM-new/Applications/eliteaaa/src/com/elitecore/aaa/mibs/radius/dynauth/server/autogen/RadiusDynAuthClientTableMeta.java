 ...
 */
public class RadiusDynAuthClientTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "RadiusDynAuthClientTableMeta".
     ...
     */
    public RadiusDynAuthClientTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "RadiusDynAuthClientEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("RadiusDynAuthClientEntry")
     * @param tableName Name of the table in which the entries are registered ("RadiusDynAuthClientTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "RadiusDynAuthClientEntry" conceptual row (RadiusDynAuthClientEntryMeta)
     * 
     **/
    protected RadiusDynAuthClientEntryMeta createRadiusDynAuthClientEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new RadiusDynAuthClientEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createRadiusDynAuthClientEntryMetaNode("RadiusDynAuthClientEntry", "RadiusDynAuthClientTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof RadiusDynAuthClientEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "RadiusDynAuthClientTable" + "\" must implement the \"" + 
                           "RadiusDynAuthClientEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        RadiusDynAuthClientEntryMBean entry = (RadiusDynAuthClientEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private RadiusDynAuthClientEntryMeta node;
