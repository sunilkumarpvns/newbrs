 ...
 */
public class RadiusAuthClientTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "RadiusAuthClientTableMeta".
     ...
     */
    public RadiusAuthClientTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "RadiusAuthClientEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("RadiusAuthClientEntry")
     * @param tableName Name of the table in which the entries are registered ("RadiusAuthClientTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "RadiusAuthClientEntry" conceptual row (RadiusAuthClientEntryMeta)
     * 
     **/
    protected RadiusAuthClientEntryMeta createRadiusAuthClientEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new RadiusAuthClientEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createRadiusAuthClientEntryMetaNode("RadiusAuthClientEntry", "RadiusAuthClientTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof RadiusAuthClientEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "RadiusAuthClientTable" + "\" must implement the \"" + 
                           "RadiusAuthClientEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        RadiusAuthClientEntryMBean entry = (RadiusAuthClientEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private RadiusAuthClientEntryMeta node;
