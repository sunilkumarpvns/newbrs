 ...
 */
public class RadiusAccClientTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "RadiusAccClientTableMeta".
     ...
     */
    public RadiusAccClientTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "RadiusAccClientEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("RadiusAccClientEntry")
     * @param tableName Name of the table in which the entries are registered ("RadiusAccClientTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "RadiusAccClientEntry" conceptual row (RadiusAccClientEntryMeta)
     * 
     **/
    protected RadiusAccClientEntryMeta createRadiusAccClientEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new RadiusAccClientEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createRadiusAccClientEntryMetaNode("RadiusAccClientEntry", "RadiusAccClientTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof RadiusAccClientEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "RadiusAccClientTable" + "\" must implement the \"" + 
                           "RadiusAccClientEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        RadiusAccClientEntryMBean entry = (RadiusAccClientEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private RadiusAccClientEntryMeta node;
