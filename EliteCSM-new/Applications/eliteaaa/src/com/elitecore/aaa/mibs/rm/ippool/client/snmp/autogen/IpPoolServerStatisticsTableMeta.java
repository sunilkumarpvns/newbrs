 ...
 */
public class IpPoolServerStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "IpPoolServerStatisticsTableMeta".
     ...
     */
    public IpPoolServerStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "IpPoolServerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("IpPoolServerEntry")
     * @param tableName Name of the table in which the entries are registered ("IpPoolServerStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "IpPoolServerEntry" conceptual row (IpPoolServerEntryMeta)
     * 
     **/
    protected IpPoolServerEntryMeta createIpPoolServerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new IpPoolServerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createIpPoolServerEntryMetaNode("IpPoolServerEntry", "IpPoolServerStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof IpPoolServerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "IpPoolServerStatisticsTable" + "\" must implement the \"" + 
                           "IpPoolServerEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        IpPoolServerEntryMBean entry = (IpPoolServerEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private IpPoolServerEntryMeta node;
