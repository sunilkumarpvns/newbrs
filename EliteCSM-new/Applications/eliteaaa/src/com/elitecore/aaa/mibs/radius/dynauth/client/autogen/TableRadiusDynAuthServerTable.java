...
public class TableRadiusDynAuthServerTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableRadiusDynAuthServerTable:name=com.elitecore.aaa.mibs.radius.dynauth.client.autogen.RadiusDynAuthServerEntry" + ",RadiusDynAuthServerIndex=" + _keyRadiusDynAuthServerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
