...
/**
 * The class is used for implementing the "RadiusAuthClientTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.67.1.1.1.1.15.
 */
public class TableRadiusAuthClientTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableRadiusAuthClientTable".
     ...
     */
    public TableRadiusAuthClientTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableRadiusAuthClientTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "RadiusAuthClientEntryMBean"
            // interface.
            //
            final Object entry =
                 createRadiusAuthClientEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("RadiusAuthClientTable");
    }
    ...
    public synchronized void addEntry(RadiusAuthClientEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized RadiusAuthClientEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        RadiusAuthClientEntryMBean[] result = new RadiusAuthClientEntryMBean[array.length];
    ...
    public void removeEntry(RadiusAuthClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyRadiusAuthClientIndex = oid.toInteger().toString();
            return new ObjectName("TableRadiusAuthClientTable:name=com.elitecore.aaa.mibs.radius.authentication.server.autogen.RadiusAuthClientEntry" + ",RadiusAuthClientIndex=" + _keyRadiusAuthClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "RadiusAuthClientEntry".
     */
    public SnmpIndex buildSnmpIndex(RadiusAuthClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getRadiusAuthClientIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "RadiusAuthClientEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aRadiusAuthClientIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aRadiusAuthClientIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "RadiusAuthClientEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "RadiusAuthClientEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "RadiusAuthClientEntryMBean"
     * interface.
    ...
    public Object createRadiusAuthClientEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aRadiusAuthClientIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        RadiusAuthClientEntry entry = new RadiusAuthClientEntry(theMib);
        entry.RadiusAuthClientIndex = aRadiusAuthClientIndex;
        return entry;
    }
