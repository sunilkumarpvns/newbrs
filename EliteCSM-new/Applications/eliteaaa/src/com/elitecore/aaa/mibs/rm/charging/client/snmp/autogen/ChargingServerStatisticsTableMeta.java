 ...
 */
public class ChargingServerStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "ChargingServerStatisticsTableMeta".
     ...
     */
    public ChargingServerStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "ChargingServerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("ChargingServerEntry")
     * @param tableName Name of the table in which the entries are registered ("ChargingServerStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "ChargingServerEntry" conceptual row (ChargingServerEntryMeta)
     * 
     **/
    protected ChargingServerEntryMeta createChargingServerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new ChargingServerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createChargingServerEntryMetaNode("ChargingServerEntry", "ChargingServerStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof ChargingServerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "ChargingServerStatisticsTable" + "\" must implement the \"" + 
                           "ChargingServerEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        ChargingServerEntryMBean entry = (ChargingServerEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private ChargingServerEntryMeta node;
