 ...
 */
public class RadiusAuthServerTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "RadiusAuthServerTableMeta".
     ...
     */
    public RadiusAuthServerTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "RadiusAuthServerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("RadiusAuthServerEntry")
     * @param tableName Name of the table in which the entries are registered ("RadiusAuthServerTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "RadiusAuthServerEntry" conceptual row (RadiusAuthServerEntryMeta)
     * 
     **/
    protected RadiusAuthServerEntryMeta createRadiusAuthServerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new RadiusAuthServerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createRadiusAuthServerEntryMetaNode("RadiusAuthServerEntry", "RadiusAuthServerTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof RadiusAuthServerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "RadiusAuthServerTable" + "\" must implement the \"" + 
                           "RadiusAuthServerEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        RadiusAuthServerEntryMBean entry = (RadiusAuthServerEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private RadiusAuthServerEntryMeta node;
