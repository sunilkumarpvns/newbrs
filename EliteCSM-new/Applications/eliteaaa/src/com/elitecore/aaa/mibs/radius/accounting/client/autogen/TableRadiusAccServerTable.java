 ...
 */
public class TableRadiusAccServerTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableRadiusAccServerTable".
     ...
     */
    public TableRadiusAccServerTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableRadiusAccServerTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "RadiusAccServerEntryMBean"
            // interface.
            //
            final Object entry =
                 createRadiusAccServerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("RadiusAccServerTable");
    }
    ...
    public synchronized void addEntry(RadiusAccServerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized RadiusAccServerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        RadiusAccServerEntryMBean[] result = new RadiusAccServerEntryMBean[array.length];
    ...
    public void removeEntry(RadiusAccServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyRadiusAccServerIndex = oid.toInteger().toString();
            return new ObjectName("TableRadiusAccServerTable:name=com.elitecore.aaa.mibs.radius.accounting.client.autogen.RadiusAccServerEntry" + ",RadiusAccServerIndex=" + _keyRadiusAccServerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "RadiusAccServerEntry".
     */
    public SnmpIndex buildSnmpIndex(RadiusAccServerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getRadiusAccServerIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "RadiusAccServerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aRadiusAccServerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aRadiusAccServerIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "RadiusAccServerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "RadiusAccServerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "RadiusAccServerEntryMBean"
     * interface.
    ...
    public Object createRadiusAccServerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aRadiusAccServerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        RadiusAccServerEntry entry = new RadiusAccServerEntry(theMib);
        entry.RadiusAccServerIndex = aRadiusAccServerIndex;
        return entry;
    }
