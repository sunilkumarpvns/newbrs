...
/**
 * The class is used for representing SNMP metadata for the "RadiusDynAuthServerScalars" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.146.1.1.
 */
public class RadiusDynAuthServerScalarsMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "RadiusDynAuthServerScalars".
     */
    public RadiusDynAuthServerScalarsMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpString(node.getRadiusDynAuthServerIdentifier());

            case 2:
                return new SnmpCounter(node.getRadiusDynAuthServerCoAInvalidClientAddresses());

            case 1:
                return new SnmpCounter(node.getRadiusDynAuthServerDisconInvalidClientAddresses());
     ...
     */
    protected void setInstance(RadiusDynAuthServerScalarsMBean var) {
        node = var;
    }
    ...
    protected RadiusDynAuthServerScalarsMBean node;
