...
public class TableRadiusAccClientTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableRadiusAccClientTable:name=com.elitecore.aaa.mibs.radius.accounting.server.autogen.RadiusAccClientEntry" + ",RadiusAccClientIndex=" + _keyRadiusAccClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
