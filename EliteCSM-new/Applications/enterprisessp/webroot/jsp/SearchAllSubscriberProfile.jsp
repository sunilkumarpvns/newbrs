...
<html:form action="/searchSubscriberProfiler" method="post" styleId="displayTableForm">
	...
	<table width="97%" cellpadding="0" cellspacing="0" border="0" class="main-table" style="height:50px" >
			...
			<tr>
			 	<td>			 		
			 		<display:table name="subscriberProfileDataList" requestURI="/searchSubscriberProfiler.do"  pagesize="10" style="width:100%;" id="subscribeData">
			 			<!-- href="childAccountInfo.do" paramId="subscriberIdentity" paramProperty="subscriberIdentity" -->	 		
	    				<display:column headerClass="paging-table-column" style="text-align:center" title="<input type='checkbox' id='mainCb' onclick='checkAll()'/>"><input type="checkbox" value='<bean:write name="subscribeData" property="subscriberID" />' name="selectall" /></display:column>
