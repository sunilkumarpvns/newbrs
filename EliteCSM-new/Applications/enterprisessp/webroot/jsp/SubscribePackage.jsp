		...
		if(!validateStartTime()){
			...
			if(agree){
				...
				$("input:checkbox[name=select]:checked").each(function(){
		   			$("#subscribeBodForm").append("<input type='hidden' name='select' value='"+$(this).val()+"'>");
		    	});
				
				document.getElementById("bodPackageId").value=bodPackageID;
				document.getElementById("subscribeBodForm").submit();		    	
			}	    			
		}
	}
...
<div>
	<table width="97%" cellpadding="0" cellspacing="0" border="0" class="main-table" >
		...
		<html:form action="/subscribeBod" method="post" styleId="subscribeBodForm">
		<html:hidden property="bodPackageId" styleId="bodPackageId" value=""/>
		...
		<bean:define id="bodPackageObj" name="subscribePackageForm" property="bodPackageData"  type="com.elitecore.netvertexsm.ws.cxfws.ssp.subscription.BoDPackage"/>				
		<tr>   		
   			<td colspan="3" >
   				<table width="100%" cellpadding="0" cellspacing="0" border="0">   							
					...
					<tr class="table-gray" height="20px">
						<td class="table-column" width="160px">
							<bean:write name="bodPackageObj" property="bodPackageName" />
						</td>
					...
					<tr class="table-white">				
						...
						<td align="left">								
							<html:text property="startTime"  styleId="startTime" value="<%=com.elitecore.ssp.util.constants.BaseConstant.DATETIME_FORMATTER.format(new Date())%>" maxlength="19" />							
						</td>
					...
					<tr class="table-white">
						...
						<td align="left" ><html:text property="duration" styleClass=""  styleId="duration" onblur="" value="1" maxlength="19" /></td>
						<td>
