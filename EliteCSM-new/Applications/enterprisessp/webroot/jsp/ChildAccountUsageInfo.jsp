...
<div class="border">
	...
	<table width="97%" cellpadding="0" cellspacing="0" border="0" class="main-table" >			
		...
		<tr class="table-org" >   		
   			<td class="table-org-column" align="left" colspan="3"><bean:message key="parentalcontrol.usageinfo"/></td>    		
		</tr>
		...
		<tr class="table-white">	   				
	   		...
	   		<td class="table-column" align="right" width="30%">
	   		...
	   		<td class="table-column" align="left" style="padding-left: 20px" width="30%">
		...
		<tr class="table-org" >   		
   			<td class="table-org-column" align="left" colspan="3"><bean:message key="childaccount.usageinfoperservice"/></td>    		
		</tr>
		...
		<tr>
			<td colspan="3" align="left" valign="top">
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr height="20px">
						<td class="multi-col-table" width="170px">
							<bean:message key="parentalcontrol.serviceperiod"/>
						</td>
						<td class="table-org-column" style="text-align: center;" width="120px" colspan="2">
							<bean:message key="parentalcontrol.usageinfo.lastday"/>
						</td>
						<td class="table-org-column" style="text-align: center;" width="120px" colspan="2">
							<bean:message key="parentalcontrol.usageinfo.lastweek"/>
					...
					<%int i=0;%>									
						<logic:iterate id="serviceUsageInfoData" name="childAccountUsageInfoForm" property="serviceUsageInfoDataList" type="com.elitecore.ssp.web.parentalcontrol.ServiceUsageInfo">						
							<tr height="18px" >
								...
								<td valign="center" style="text-align: right;" class="<%=(i%2==0)?"table-white":"table-gray"%>">
								...
								<td valign="center" style="text-align: right;" class="<%=(i%2==0)?"table-gray":"table-white"%>">
