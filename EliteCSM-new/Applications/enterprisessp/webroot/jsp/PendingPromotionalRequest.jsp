...
<div class="border" >
	...
	<table width="97%" cellpadding="0" cellspacing="0" border="0" style="margin-right:10px;margin-left: 10px;margin-top: 10px;margin-bottom: 10px" >
						...
						<logic:iterate id="requestAddonData" name="promotionalForm" property="pendingPromotionalReqData" type="AddOnSubRequestData">
			   				<tr class="<%=(++i%2==0)?"table-white":"table-gray"%>">
								<td valign="center" style="text-align: left: ;" class="table-column">
									<bean:write name="requestAddonData" property="addOnSubReqID" />&nbsp;
								</td>										   				
								...
								<td valign="center" class="table-column" style="text-align: center;">
									${ADDONMAP[requestAddonData.addOnID].price} &nbsp;
								</td>			   				
								<td valign="center" class="table-column" style="text-align: center;">
									${ADDONMAP[requestAddonData.addOnID].validityPeriod}
								</td>			   				
								<td valign="center" class="table-column" style="text-align: center;">
									--&nbsp;
								</td>		   				
		...
		<tr>   		
   			<td colspan="6" class="smallgap" >&nbsp;<hr/></td>   		
		</tr>				
		<tr>   		
		...
		<tr>  
			...
			<html:hidden property="selectedPortal" value="enterprise"/>
				<table width="100%" cellpadding="0" cellspacing="0" border="0" >
					<tr class="table-org" height="30px" >   		
	   					<td class="table-org-column" align="left" colspan="3"><bean:message key="parentalcontrol.prmoffer.promosubscription"/></td>
						<td colspan="3"  class="table-org-column" align="right" >
							View :
	   						<select id="historyStatusSelect" onchange="onStatusSelection('<%= request.getContextPath()%>/childPromotional.do?' , this.value)" >
						...
						<td>
				    		...
				    		<c:forEach var="subscriptionHistoryData" begin="<%=begin%>" end="<%=end%>" items="<%=promotionalOfferForm.getSubscriptionHistoriesList()%>">
				    			...
				    			<tr class="<%=(i%2==0)?"table-white":"table-gray"%>">
				    				...
				    				<c:if test="${not empty subscriptionHistoryData.subscriptionStartTime and subscriptionHistoryData.subscriptionStartTime ne 0}">
					...
					<tr class="table-column">
						...
						<td align="right" class="table-org-column" colspan="3">
							...
							<%}%>
							&nbsp;
							<% for(double pageNo = startLink ; pageNo <= endLink && possiblePages != 1 && pageNo <= possiblePages; pageNo ++){
