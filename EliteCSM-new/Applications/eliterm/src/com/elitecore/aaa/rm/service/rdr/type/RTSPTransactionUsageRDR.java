...
public class RTSPTransactionUsageRDR extends BaseRDR {
	public void read(InputStream is){
		...
		addField(RDRConstants.RTSP_SESSION_ID.typeID,getTLV(is));
		addField(RDRConstants.RTSP_URL.typeID,getTLV(is));
		addField(RDRConstants.RESPONSE_DATE.typeID,getTLV(is));
		addField(RDRConstants.TOTAL_ENCODING_RATE.typeID,getTLV(is));
		addField(RDRConstants.NUMBER_OF_VIDEO_STREAMS.typeID,getTLV(is));
		addField(RDRConstants.NUMBER_OF_AUDIO_STREAMS.typeID,getTLV(is));
		addField(RDRConstants.SESSION_TITLE.typeID,getTLV(is));
		addField(RDRConstants.SERVER_NAME.typeID,getTLV(is));
	}
}
