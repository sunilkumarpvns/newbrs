...
public class VirtualLinksUsageRDR extends BaseRDR {
	public void read(InputStream is){
		
		addField(RDRConstants.VLINK_ID.typeID,getTLV(is));
		addField(RDRConstants.VLINK_DIRECTION.typeID,getTLV(is));
