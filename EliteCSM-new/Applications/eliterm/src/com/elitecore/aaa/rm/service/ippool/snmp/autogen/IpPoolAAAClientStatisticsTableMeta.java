 ...
 */
public class IpPoolAAAClientStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "IpPoolAAAClientStatisticsTableMeta".
     ...
     */
    public IpPoolAAAClientStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "IpPoolAAAClientEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("IpPoolAAAClientEntry")
     * @param tableName Name of the table in which the entries are registered ("IpPoolAAAClientStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "IpPoolAAAClientEntry" conceptual row (IpPoolAAAClientEntryMeta)
     * 
     **/
    protected IpPoolAAAClientEntryMeta createIpPoolAAAClientEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new IpPoolAAAClientEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createIpPoolAAAClientEntryMetaNode("IpPoolAAAClientEntry", "IpPoolAAAClientStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof IpPoolAAAClientEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "IpPoolAAAClientStatisticsTable" + "\" must implement the \"" + 
                           "IpPoolAAAClientEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        IpPoolAAAClientEntryMBean entry = (IpPoolAAAClientEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private IpPoolAAAClientEntryMeta node;
