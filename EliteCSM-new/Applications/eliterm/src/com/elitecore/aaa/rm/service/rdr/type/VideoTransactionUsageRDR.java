...
public class VideoTransactionUsageRDR extends BaseRDR {
	public void read(InputStream is){
		...
		addField(RDRConstants.TITLE.typeID,getTLV(is));
		addField(RDRConstants.DURATION.typeID,getTLV(is));
		addField(RDRConstants.ENCODING_RATE.typeID,getTLV(is));
		addField(RDRConstants.RESOLUTION.typeID,getTLV(is));
		addField(RDRConstants.REFERER.typeID,getTLV(is));
	}
}
