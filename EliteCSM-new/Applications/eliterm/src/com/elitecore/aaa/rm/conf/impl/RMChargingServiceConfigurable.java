...
@XmlType(propOrder = {})
@XmlRootElement(name = "rm-charging-service")
@ConfigurationProperties(moduleName ="RM_CHARGIN_CONFIGURABLE",readWith = XMLReader.class, reloadWith = XMLReader.class, synchronizeKey ="RM_CHGR_SER")
@XMLProperties(name = "rm-charging-service", schemaDirectories = {"system","schema"}, configDirectories = {"conf","services"})
public class RMChargingServiceConfigurable extends RadiusServiceConfigurable {
		
	private static final String MODULE = "RM_CHARGIN_CONFIGURABLE";
	...
	private String serviceAddress = "0.0.0.0:1924";
	...
	public RMChargingServiceConfigurable(){
	...
	@XmlElement(name = "service-address",type = String.class,defaultValue ="0.0.0.0:1924")
