 ...
 */
public class ChargingClientStatsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "ChargingClientStatsTableMeta".
     ...
     */
    public ChargingClientStatsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "ChargingClientEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("ChargingClientEntry")
     * @param tableName Name of the table in which the entries are registered ("ChargingClientStatsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "ChargingClientEntry" conceptual row (ChargingClientEntryMeta)
     * 
     **/
    protected ChargingClientEntryMeta createChargingClientEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new ChargingClientEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createChargingClientEntryMetaNode("ChargingClientEntry", "ChargingClientStatsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof ChargingClientEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "ChargingClientStatsTable" + "\" must implement the \"" + 
                           "ChargingClientEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        ChargingClientEntryMBean entry = (ChargingClientEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private ChargingClientEntryMeta node;
