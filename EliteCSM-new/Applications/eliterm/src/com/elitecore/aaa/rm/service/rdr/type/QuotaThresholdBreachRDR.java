...
public class QuotaThresholdBreachRDR extends BaseRDR {
	public void read(InputStream is){
		...
		addField(RDRConstants.THRESHOLD_SIZE_IN.typeID,getTLV(is));
		addField(RDRConstants.THRESHOLD_SIZE_OUT.typeID,getTLV(is));
	}
}
