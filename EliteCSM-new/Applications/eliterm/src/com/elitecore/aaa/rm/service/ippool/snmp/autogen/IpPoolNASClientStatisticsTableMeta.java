 ...
 */
public class IpPoolNASClientStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "IpPoolNASClientStatisticsTableMeta".
     ...
     */
    public IpPoolNASClientStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "IpPoolNASClientEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("IpPoolNASClientEntry")
     * @param tableName Name of the table in which the entries are registered ("IpPoolNASClientStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "IpPoolNASClientEntry" conceptual row (IpPoolNASClientEntryMeta)
     * 
     **/
    protected IpPoolNASClientEntryMeta createIpPoolNASClientEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new IpPoolNASClientEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createIpPoolNASClientEntryMetaNode("IpPoolNASClientEntry", "IpPoolNASClientStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof IpPoolNASClientEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "IpPoolNASClientStatisticsTable" + "\" must implement the \"" + 
                           "IpPoolNASClientEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        IpPoolNASClientEntryMBean entry = (IpPoolNASClientEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private IpPoolNASClientEntryMeta node;
