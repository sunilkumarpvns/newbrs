...
public class AnonymizedHTTPTransactionUsageRDR extends BaseRDR {
	public void read(InputStream is){
		addField(RDRConstants.HASHED_SUBSCRIBER_ID.typeID,getTLV(is));
		...
		addField(RDRConstants.HOST.typeID,getTLV(is));
		addField(RDRConstants.URL.typeID,getTLV(is));
		...
		addField(RDRConstants.HASHED_SUBSCRIBER_IP.typeID,getTLV(is));
		addField(RDRConstants.USER_AGENT.typeID,getTLV(is));
		addField(RDRConstants.HTTP_REFERER.typeID,getTLV(is));
		addField(RDRConstants.HTTP_COOKIE.typeID,getTLV(is));
	}
}
