...
/**
 * The class is used for implementing the "ChargingClientStatsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.1.8.1.101.
 */
public class TableChargingClientStatsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableChargingClientStatsTable".
     ...
     */
    public TableChargingClientStatsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableChargingClientStatsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "ChargingClientEntryMBean"
            // interface.
            //
            final Object entry =
                 createChargingClientEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("ChargingClientStatsTable");
    }
    ...
    public synchronized void addEntry(ChargingClientEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(ChargingClientEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized ChargingClientEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        ChargingClientEntryMBean[] result = new ChargingClientEntryMBean[array.length];
    ...
    public void removeEntry(ChargingClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyChargingClientIndex = oid.toInteger().toString();
            return new ObjectName("TableChargingClientStatsTable:name=com.elitecore.aaa.rm.service.chargingservice.snmp.autogen.ChargingClientEntry" + ",ChargingClientIndex=" + _keyChargingClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "ChargingClientEntry".
     */
    public SnmpIndex buildSnmpIndex(ChargingClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getChargingClientIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "ChargingClientEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aChargingClientIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aChargingClientIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "ChargingClientEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "ChargingClientEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "ChargingClientEntryMBean"
     * interface.
    ...
    public Object createChargingClientEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aChargingClientIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        ChargingClientEntry entry = new ChargingClientEntry(theMib);
        entry.ChargingClientIndex = aChargingClientIndex;
        return entry;
    }
