...
/**
 * The class is used for implementing the "IpPoolNASClientStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.1.7.1.102.
 */
public class TableIpPoolNASClientStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableIpPoolNASClientStatisticsTable".
     ...
     */
    public TableIpPoolNASClientStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableIpPoolNASClientStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "IpPoolNASClientEntryMBean"
            // interface.
            //
            final Object entry =
                 createIpPoolNASClientEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("IpPoolNASClientStatisticsTable");
    }
    ...
    public synchronized void addEntry(IpPoolNASClientEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(IpPoolNASClientEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized IpPoolNASClientEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        IpPoolNASClientEntryMBean[] result = new IpPoolNASClientEntryMBean[array.length];
    ...
    public void removeEntry(IpPoolNASClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyIpPoolNASClientIndex = oid.toInteger().toString();
            return new ObjectName("TableIpPoolNASClientStatisticsTable:name=com.elitecore.aaa.rm.service.ippool.snmp.autogen.IpPoolNASClientEntry" + ",IpPoolNASClientIndex=" + _keyIpPoolNASClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "IpPoolNASClientEntry".
     */
    public SnmpIndex buildSnmpIndex(IpPoolNASClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getIpPoolNASClientIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "IpPoolNASClientEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aIpPoolNASClientIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aIpPoolNASClientIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "IpPoolNASClientEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "IpPoolNASClientEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "IpPoolNASClientEntryMBean"
     * interface.
    ...
    public Object createIpPoolNASClientEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aIpPoolNASClientIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        IpPoolNASClientEntry entry = new IpPoolNASClientEntry(theMib);
        entry.IpPoolNASClientIndex = aIpPoolNASClientIndex;
        return entry;
    }
