...
/**
 * The class is used for implementing the "IpPoolAAAClientStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.1.7.1.101.
 */
public class TableIpPoolAAAClientStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableIpPoolAAAClientStatisticsTable".
     ...
     */
    public TableIpPoolAAAClientStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableIpPoolAAAClientStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "IpPoolAAAClientEntryMBean"
            // interface.
            //
            final Object entry =
                 createIpPoolAAAClientEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("IpPoolAAAClientStatisticsTable");
    }
    ...
    public synchronized void addEntry(IpPoolAAAClientEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(IpPoolAAAClientEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized IpPoolAAAClientEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        IpPoolAAAClientEntryMBean[] result = new IpPoolAAAClientEntryMBean[array.length];
    ...
    public void removeEntry(IpPoolAAAClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyIpPoolAAAClientIndex = oid.toInteger().toString();
            return new ObjectName("TableIpPoolAAAClientStatisticsTable:name=com.elitecore.aaa.rm.service.ippool.snmp.autogen.IpPoolAAAClientEntry" + ",IpPoolAAAClientIndex=" + _keyIpPoolAAAClientIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "IpPoolAAAClientEntry".
     */
    public SnmpIndex buildSnmpIndex(IpPoolAAAClientEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getIpPoolAAAClientIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "IpPoolAAAClientEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aIpPoolAAAClientIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aIpPoolAAAClientIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "IpPoolAAAClientEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "IpPoolAAAClientEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "IpPoolAAAClientEntryMBean"
     * interface.
    ...
    public Object createIpPoolAAAClientEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aIpPoolAAAClientIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        IpPoolAAAClientEntry entry = new IpPoolAAAClientEntry(theMib);
        entry.IpPoolAAAClientIndex = aIpPoolAAAClientIndex;
        return entry;
    }
