...
public class RMAlertConfigurable extends BaseAlertConfigurable{
	
	public RMAlertConfigurable() {
		// TODO Auto-generated constructor stub
	}

	@Override
	public AlertListnersDetail getAlertListnersDetail() {
		RMServerConfigurable aaaServerConfigurable = getConfigurationContext().get(RMServerConfigurable.class);
