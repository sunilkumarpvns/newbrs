...
REM NETVERTEX-2284 Daily Partition growth in TBLM_USAGE_HISTORY is almost equal to total count of TBLM_USAGE	
...
FROM
  ...
  WHERE TABLESPACE_NAME IN
    ...
    AND SEGMENT_NAME IN ('TBLM_USAGE_HISTORY','TBLM_SUBSCRIPTION_HISTORY')
    )
  ) DBADF,
  (SELECT FILE_ID,
