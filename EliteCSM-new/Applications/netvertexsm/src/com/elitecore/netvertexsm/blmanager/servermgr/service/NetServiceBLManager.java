package com.elitecore.netvertexsm.blmanager.servermgr.service;
...
import com.elitecore.netvertexsm.util.EliteServerAssert;
...
public class NetServiceBLManager extends BaseServerBLManager {
	 ...
	 * @purpose This method is generated to get the object of INetServerInstanceData
	 */
	public INetServerInstanceData getNetServerInstance(long netServerId, IDataManagerSession session) throws DataManagerException{
		EliteAssert.greaterThanZero(netServerId,"netServerId must be greater than zero.");
	 ...
	 */
	public INetServiceInstanceData getNetServiceInstance(long netServiceId) throws DataManagerException{
	 ...
	 */
	public void deleteService(List<Long> lstnetServiceId,long netserverId) throws DataManagerException{
		...
		try {
			...
			for ( long netServiceId : lstnetServiceId ) {
	...
	public void deleteNetService(long netServiceId,IDataManagerSession session) throws DataManagerException{
	...
	public byte[] getServiceConfigurationStream(long serviceId, String configId) throws DataManagerException {
		EliteAssert.notNull(configId);
	 ...
	 * @throws DataManagerException
	 */
	public void saveNetConfigurationValues(List<INetConfigurationValuesData> lstValueData,long configInstanceId,long serviceInstanceId)throws DataManagerException {
	...
	public List getServiceConfigurationInstance(long serviceInstanceId)throws DataManagerException{
		EliteAssert.greaterThanZero(serviceInstanceId,"serviceInstanceId");
	...
	private List getRecursiveNewNetConfParameterData(INetConfigurationParameterData netConfParamData,List lstParameters, long configInstanceId, String instanceId, HashMap map){
	...
	private void removeEmptyNetServiceInstanceServerConfiguration(NetServiceDataManager serviceDataManager, long netServerId,IDataManagerSession session) throws DataManagerException{
	...
	private List getRecursiveNetConfigurationParameterValues( INetConfigurationParameterData netConfParamData , long configInstanceId , List lstParameters , List parentInstanceList ) {
		...
		if (itrConfigParamValues != null && itrConfigParamValues.hasNext()) {
			while (itrConfigParamValues.hasNext()) {
				...
				if (netConfigParamValues.getConfigInstanceId()==configInstanceId) {
	...
	private List getRecursiveNetConfigurationParameterValues( INetConfigurationParameterData netConfParamData , long configInstanceId , List lstParameters , List parentInstanceList ,IDataManagerSession session)  throws DataManagerException{
	...
	public void updateServiceDetails(long netServiceId, EliteNetServiceData eliteNetServiceData, long staffId,String isInSync)throws DataManagerException{

		EliteAssert.greaterThanZero(netServiceId,"netServiceId");
		EliteAssert.notNull(eliteNetServiceData);
		EliteAssert.greaterThanZero(staffId,"staffId");
	 ...
	 */ 
	public void addNewServiceConfiguration(long netserviceIntanceId) throws DataManagerException {
		IDataManagerSession session = null;
	 ...
	 * @throws  DataManagerException
	 */
	public void markServiceisInSync(long netServiceIntanceId) throws DataManagerException {
		EliteAssert.greaterThanZero(netServiceIntanceId,"netServiceIntanceId");
	...
	public void upgradeNetService( long netServiceInstanceId,INetServerInstanceData netServerIntanceData, String targetedServerVersion,IDataManagerSession session ) throws DataManagerException {
	 ...
	 */
	public List<INetServiceConfigMapData> getNetServiceConfigMapList( String netServerTypeId , long netServerId ) throws DataManagerException {
		IDataManagerSession session = null;
		try {
			session = DataManagerSessionFactory.getInstance().getDataManagerSession();
			NetServiceDataManager serverDataManager = getNetServiceDataManager(session);
	 ...
	 * @author kaushik vira
	 */
	private void createNetServiceConfigurationInstance( String configTypeId , long netServiceInstanceId , IDataManagerSession session ) throws DataManagerException {
	...
	/* @author kaushik vira
	 */
	private void deleteNetServiceConfigurationInstance( long configInstanceId , IDataManagerSession session ) throws DataManagerException {
	...
	private void deleteNetServiceInstanceServerConfiguration(NetServiceDataManager servermgrDataManager,long netServiceId)throws DataManagerException{
