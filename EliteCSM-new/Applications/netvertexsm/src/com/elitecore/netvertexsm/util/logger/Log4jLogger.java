...
public class Log4jLogger implements ILogger {
	...
	public Log4jLogger(){
		...
		logger.trace("[ " + dateToString(new Date()) + " ]" + " [ WARN ] "+ "["+ MODULE +"]"  +"  :  Here is some TRACE");
		logger.debug("[ " + dateToString(new Date()) + " ]" + " [ WARN ] "+ "["+ MODULE +"]"  +"  :  Here is some DEBUG");
		logger.info("[ " + dateToString(new Date()) + " ]" +  " [ WARN ] "+ "["+ MODULE +"]"  +"  :  Here is some INFO");
		logger.warn("[ " + dateToString(new Date()) + " ]" +  " [ WARN ] "+ "["+ MODULE +"]"  +"  :  Here is some WARN");
		logger.error("[ " + dateToString(new Date()) + " ]" + " [ WARN ] "+ "["+ MODULE +"]"  +"  :  Here is some ERROR");
		logger.fatal("[ " + dateToString(new Date()) + " ]" + " [ WARN ] "+ "["+ MODULE +"]"  +"  :  Here is some FATAL");
	}
