 ...
 * ModualName com.elitecore.netvertexsm.util.exception
...
public abstract class EliteAssert {
    ...
    public static void greaterThanZero(long longValue) throws InvalidArrguementsException{
        if(longValue<=0){
        	throw new InvalidArrguementsException("[Assertion failed] - "+" The argument must be greater than zero.");
        }
    }
    public static void greaterThanZero(long longValue,String message) throws InvalidArrguementsException{
        if(longValue<=0){
