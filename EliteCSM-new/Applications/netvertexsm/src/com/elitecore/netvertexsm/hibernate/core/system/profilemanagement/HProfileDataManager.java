package com.elitecore.netvertexsm.hibernate.core.system.profilemanagement;
...
import com.elitecore.netvertexsm.datamanager.core.system.profilemanagement.data.ConfigurationProfileScriptData;
...
import com.elitecore.netvertexsm.datamanager.core.system.profilemanagement.data.SubBISModuleTypeData;
...
public class HProfileDataManager extends HBaseDataManager implements ProfileDataManager{
	 ...
	 */
	public List getActionList(IActionData actionData) throws DataManagerException{
		List lstActionList = null;
