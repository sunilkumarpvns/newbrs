 ...
 *
 */
public class DiameterDictionaryParamDetailData implements Serializable{
	...
	public String toString(){
		...
		writer.println("encryption	                           :"+encryption);
		writer.println("mandatory	  					       :"+mandatory);
		writer.println("strProtected	                       :"+strProtected);
		writer.println("fixedGroupedAttribute                  :+"+fixedGroupedAttribute);
		writer.println("requiredGroupedAttribute               :+"+requiredGroupedAttribute);
		writer.println("optionalGroupedAttribute               :+"+optionalGroupedAttribute);
