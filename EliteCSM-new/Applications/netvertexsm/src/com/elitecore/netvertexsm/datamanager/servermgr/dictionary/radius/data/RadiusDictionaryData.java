...
public class RadiusDictionaryData extends BaseData implements IRadiusDictionaryData, Comparable<RadiusDictionaryData> {
    ...
    private List<RadiusDictionaryParamDetailData> dictionaryParameterDetailList;
    private IStaffData lastModifiedByStaff;
    private IStaffData createdByStaff;
    
    public RadiusDictionaryData() {
     dictionaryNumber = -1;
     vendorId=-1;
    }
	...
	public int compareTo(RadiusDictionaryData dictionaryData) {
