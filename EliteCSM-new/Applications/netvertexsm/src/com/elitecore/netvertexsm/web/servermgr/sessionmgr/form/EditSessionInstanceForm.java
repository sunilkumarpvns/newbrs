...
public class EditSessionInstanceForm extends ActionForm {
...
//	Rx Session Instance Conf
	private long rxSessionInstanceId;
	...
	public long getRxSessionInstanceId() {
		return rxSessionInstanceId;
	}
	public void setRxSessionInstanceId(long rxSessionInstanceId) {
		this.rxSessionInstanceId = rxSessionInstanceId;
	}
