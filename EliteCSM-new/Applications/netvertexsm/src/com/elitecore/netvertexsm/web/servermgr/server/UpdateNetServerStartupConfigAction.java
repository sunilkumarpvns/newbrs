...
import com.elitecore.netvertexsm.web.servermgr.server.form.UpdateNetServerStartupConfigForm;
...
public class UpdateNetServerStartupConfigAction extends BaseWebAction {
    ...
    public void formToBean(UpdateNetServerStartupConfigForm updateNetServerStartupConfigForm ,
        ...
        icreateNetServerStartupConfigForm.setLastModifiedByStaffId(Long.parseLong(((SystemLoginForm)request.getSession().getAttribute("radiusLoginForm")).getUserId()));
