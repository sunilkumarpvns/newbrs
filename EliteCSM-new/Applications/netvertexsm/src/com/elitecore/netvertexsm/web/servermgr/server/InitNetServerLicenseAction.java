...
import com.elitecore.netvertexsm.web.servermgr.server.form.InitNetServerLicenseForm;
import com.elitecore.passwordutil.PasswordEncryption;

/**
 * @author kaushikvira
 */
public class InitNetServerLicenseAction extends BaseWebAction {
    ...
    public ActionForward execute( ActionMapping mapping ,
    	...
    	try {
    		...
    		if (netServerId != null && netServerId>0) {
    			...
    			request.setAttribute("lstLicenseData", lstLicenseData);
