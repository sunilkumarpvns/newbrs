...
public class SignalServerReloadConfigurationAction  extends BaseWebAction{
    private static final String SUCCESS_FORWARD = "success";	
    private static final String FAILURE_FORWARD = "failure";
    private static final String MODULE = "NETSERVER RELOAD CONFIG";
    private static final String SUB_MODULE_ACTIONALIAS = ConfigConstant.SIGNAL_SERVER_RELOAD_CONFIGURATION_ACTION;
