...
import com.elitecore.netvertexsm.datamanager.core.exceptions.datavalidation.FormatInvalidException;
import com.elitecore.netvertexsm.datamanager.core.exceptions.datavalidation.InvalidFileExtensionException;
...
import com.elitecore.netvertexsm.datamanager.core.exceptions.environmentsupport.EnvironmentNotSupportedException;
...
import com.elitecore.netvertexsm.web.servermgr.server.form.UploadLicenseForm;
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (uploadLicForm.getAction() == null || uploadLicForm.getAction().equalsIgnoreCase("")) {
                ...
                Long netserverId = uploadLicForm.getNetServerId();
