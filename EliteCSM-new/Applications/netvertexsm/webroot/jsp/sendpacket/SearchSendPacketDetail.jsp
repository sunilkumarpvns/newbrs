...
<%@page import="com.elitecore.corenetvertex.test.diameter.jaxb.DiameterPacketConfigurationData" %>
<%@page import=" com.elitecore.netvertexsm.web.sendpacket.form.SendPacketForm" %>
...
<%
	...
	List sendPacketConfigList = sendPacketForm.getLstSendPacketData();
	String action = sendPacketForm.getAction();
	Integer pageSize = Integer.parseInt(ConfigManager.get("TOTAL_ROW"));
	String status;
	
	long pageNo = sendPacketForm.getPageNumber();
	long totalPages = sendPacketForm.getTotalPages();
	long totalRecord = sendPacketForm.getTotalRecords();
	int count = 1;
	
	String strPageNumber = String.valueOf(pageNo);     
	String strTotalPages = String.valueOf(totalPages);
	String strTotalRecords = String.valueOf(totalRecord);
	String strName=sendPacketForm.getName() != null ? sendPacketForm.getName() :"";
	String paramString="name="+strName;
	
%>
<script>
function validateSearch(){
	document.forms[0].action = "searchSendPacket.do?netserverid=<%=request.getSession().getAttribute("netserverid") %>";
...
function removeData(){
    ...
    if(selectVar == false){
        ...
        var msg;
        msg = '<bean:message bundle="alertMessageResources" key="alert.sendpacket.diameter.delete.query"/>';              
...
<html:form action="/searchSendPacket" >
<html:hidden name="sendPacketForm" styleId="action"
		property="action" />
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td cellpadding="0" cellspacing="0" border="0" width="100%"
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									<td class="table-header" colspan="5"><bean:message bundle="servermgrResources" key="servermgr.sendpacket.search"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td align="left" class="captiontext" valign="top" width="18%">
										<bean:message bundle="servermgrResources" 
											key="servermgr.sendpacket.packetname" />
								...
								<tr>
									<td align="left" class="labeltext" colspan="5" valign="top">
										<table cellSpacing="0" cellPadding="0" width="99%" border="0">
											<tr>
												<td class="table-header" width="50%">Diameter Sent Packet Configuration List</td>
											...
											<tr>
												<td class="btns-td" valign="middle">&nbsp; 
													<input type="button" name="Create" value="   Create   "  class="light-btn" onclick="javascript:location.href='<%=basePath%>/initCreateSendPacket.do?action=create'"/>
												...
												<td class="btns-td" valign="middle" colspan="2">
													<table width="100%" border="0" cellpadding="0"
														...
														<tr>
															...
															%>
															<logic:iterate id="obj" name="sendPacketForm"
																...
																<tr>
																	...
																	<td align="left" class="tblrows"><a href="<%=basePath%>/initEditSendPacket.do?packetName=<%=obj.getName()%>">
