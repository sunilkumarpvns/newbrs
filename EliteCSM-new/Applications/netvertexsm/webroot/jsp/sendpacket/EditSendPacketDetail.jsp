<%@page
	import="com.elitecore.corenetvertex.test.diameter.jaxb.DiameterPacketConfigurationData"%>
<%@page
	import="com.elitecore.corenetvertex.test.diameter.jaxb.DiameterPacketConfigurationData"%>
<%@page
...
var result;
 function isValidJson(json) {
	try {
       ...
       alert("Invalid JSON Format For Packet Detail" + result);
       document.forms[0].jsoneditorRequest.focus();
    	return false;
    }
} 
...
<html:form action="/editSendPacket">
	<html:hidden name="sendPacketForm" styleId="action" style="action"
		property="action" />
	<html:hidden name="sendPacketForm" styleId="packetName"
		style="packetName" property="name"
		value="<%=sendPacketForm.getName()%>" />
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td class="table-header" colspan="5"><bean:message
								bundle="servermgrResources" key="servermgr.sendpacket.update" />
						</td>
					</tr>
