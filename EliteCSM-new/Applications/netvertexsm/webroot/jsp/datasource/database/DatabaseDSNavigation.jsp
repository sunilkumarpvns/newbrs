					...
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="subLinks">
										<a href="<%=updateDatabaseDS%>" tabindex="11"><bean:message bundle="datasourceResources" key="database.datasource.updateDatabaseDatasource" /></a>
									</td>
								</tr>
							</table>
						</div>
					...
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="subLinks">
										<a href="<%=viewDatabaseDS%>" tabindex="12"><bean:message  bundle="datasourceResources" key="database.datasource.viewDatabaseDatasource" /></a>
									</td>
								</tr>								
							</table>
						</div>
