...
<%
	String strStaffName = ((SystemLoginForm)request.getSession().getAttribute("radiusLoginForm")).getUserName();
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" <%-- onLoad="MM_preloadImages('<%=basePath%>/images/print.jpg','<%=basePath%>/images/aboutus.jpg','<%=basePath%>/images/help.jpg','<%=basePath%>/images/home-hover.jpg','<%=basePath%>/images/back-hover.jpg','<%=basePath%>/images/forward-hover.jpg','<%=basePath%>/images/refresh-hover.jpg','<%=basePath%>/images/stop-hover.jpg','<%=basePath%>/images/print-hover.jpg','<%=basePath%>/images/aboutus-hover.jpg','<%=basePath%>/images/help-hover.jpg','<%=basePath%>/images/home-hover.jpg','<%=basePath%>/images/forward-hover.jpg','<%=basePath%>/images/refresh-hover.jpg','<%=basePath%>/images/stop-hover.jpg','<%=basePath%>/images/print-hover.jpg','<%=basePath%>/images/aboutus-hover.jpg','<%=basePath%>/images/help-hover.jpg')" onhelp="openHelpPage();return false;" --%>>
  ...
  <tr> 
    ...
    <td background="<%=basePath%>/images/header-curve-bkgd.jpg" width="222" height="20"> 
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <%-- <td align="center"><a href="<%=basePath%>/jsp/core/system/login/Welcome.jsp" TARGET=mainFrame ><img src="<%=basePath%>/images/home.jpg" alt="Home" border="0" name="Image1" onMouseOver="MM_swapImage('Image1','','<%=basePath%>/images/home-hover.jpg',1)" onMouseOut="MM_swapImgRestore()" ></a></td> --%>
          <td align="center"><a href="<%=basePath%>/serverGroupManagement.do?method=initSearch" TARGET=mainFrame ><img src="<%=basePath%>/images/home.jpg" alt="Home" border="0" name="Image1" onMouseOver="MM_swapImage('Image1','','<%=basePath%>/images/home-hover.jpg',1)" onMouseOut="MM_swapImgRestore()" ></a></td>
          ...
          <%--td><a href="javascript:void(0)" ><img src="<%=basePath%>/images/stop.jpg" alt="Stop" border="0" name="Image5" onMouseOver="MM_swapImage('Image5','','<%=basePath%>/images/stop-hover.jpg',1)" onMouseOut="MM_swapImgRestore()"></a></td--%>
