...
<html:hidden name="changeStaffStatusForm" styleId="action" 	property="action"/>
<html:hidden name="changeStaffStatusForm" styleId="staffId" property="staffId"/>   
<html:hidden name="changeStaffStatusForm" styleId="status" 	property="status"/>      
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" align="right">
          	<tr> 
				<td class="tblheader-bold" colspan="3" ><bean:message key="staff.statusinformation" /></td>
			</tr>
			<tr> 
	          	<logic:equal name="changeStaffStatusForm" property="status" value="CST01">
    	        	<td width="30%" height="20%" class="labeltext" valign="top"><bean:message key="staff.active" /></td>
        	    </logic:equal>
            	<logic:notEqual name="changeStaffStatusForm" property="status" value="CST01">
            		<td width="30%" height="20%" class="labeltext" valign="top"><bean:message key="staff.inactive" /></td>
	            </logic:notEqual>
