...
<%
	GatewayData gatewayData1 = (GatewayData)request.getAttribute("gatewayData");
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<bean:define id="gatewayDataBean" name="gatewayData" scope="request" type="com.elitecore.netvertexsm.datamanager.gateway.gateway.data.GatewayData"/>
	
	<tr>
		<td align="right" class="labeltext" valign="top"> 
		<table cellpadding="0" cellspacing="0" border="0" width="97%" align="right" >
			<tr>
				<td class="tblheader-bold"  valign="top" colspan="3"  ><bean:message bundle="gatewayResources" key="gateway.associations"/></td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <tr>
			     <td class="tblheader-bold" colspan="4"><bean:message bundle="gatewayResources" key="gateway.diameter.associations" /></td>
			  </tr>	
	          <tr>
				<td> 
						    <%int i=0; %>
							<display:table   id="gatewayData" name="gatewayData.gatewaySet" cellpadding="0" cellspacing="0" requestURI="/viewGateway.do?viewAssociations=true&gatewayId=${gatewayData1.gatewayId}"  pagesize="<%=pageSize%>"  style="width:100%;margin:0px 0 0px 0">										
			  				...
			  				<a href="<%=basePath%>/viewGateway.do?gatewayId=<bean:write name="gatewayData" property="gatewayId"/>&<%=gatewayData1.getCommProtocol()%> "> 
