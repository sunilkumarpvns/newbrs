<%@ page import="com.elitecore.netvertexsm.datamanager.servermgr.data.INetServerConfigMapData" %>
<%@ page import="com.elitecore.netvertexsm.datamanager.servermgr.data.INetServerStartupConfigData" %>
               ...
               <tr> 
					<td class="tblheader-bold" colspan="4"><bean:message bundle="servermgrResources" key="servermgr.server.connectiondetail"/></td>
											  ...
											  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" align="right">
											   ...
											   <tr> 
												<td class="tblheader-bold" colspan="5"><bean:message bundle="servermgrResources" key="servermgr.liveserverdetails"/></td>
											   </tr> 
											  ...
											  <td align="left" class="tblcol" valign="top"><bean:message bundle="servermgrResources" key="servermgr.server.send"/> </td>
											  <td align="left" class="tblfirstcol" valign="top"><bean:message bundle="servermgrResources" key="servermgr.server.send.8"/> </td>
											  </tr>
											  </table>
                                              ...
                                              <tr >
                                                 ...
                                                 <td class="btns-td" valign="middle" colspan="2" >
                                                     ...
                                                     <input type="reset" name="c_btnDeletePolicy" onclick="javascript:location.href='<%=localBasePath%>'"   value="Cancel" class="light-btn"> 
                                                 </td> 
                                              </tr> 
