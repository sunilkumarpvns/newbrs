...
<jsp:directive.page import="com.elitecore.netvertexsm.web.servermgr.server.form.SearchCDRForm"/>
  	 ...
  	 <html:hidden styleId="checkAction" property="checkAction" />
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
		  		...
		  		<tr>
					...
					<td colspan="2">
			   			<table width="60%" name="c_tblCrossProductList" id="c_tblCrossProductList" align="left" border="0" >
				    		<tr>
								<td align="left" class="labeltext" valign="top" width="10%">Search Criteria</td>
								<td align="left" class="labeltext" valign="top" width="18%" ><html:text styleId="searchCriteria" property="searchCriteria" size="30"/></td>
						  	</tr>
						  	<tr>
						  	...
						  	<tr>
								<td align="left" class="labeltext" valign="top" width="10%">File Name</td>
								<td align="left" class="labeltext" valign="top" width="32%" ><html:text styleId="fileName" property="fileName" size="30"/></td>
						  	</tr>
						  	<tr>
								<td align="left" class="labeltext" valign="top" width="10%">Status</td>
								<td align="left" class="labeltext" valign="top" width="32%" >
									<html:select styleId="status" property="status" style="width:100;">
						  	...
						  	<tr>
								<td align="left" class="labeltext" valign="top" width="10%">Distribution Status</td>
								<td align="left" class="labeltext" valign="top" width="32%" >
									<html:select styleId="distributionStatus" property="distributionStatus" style="width:100;">
										<html:option value="ALL">All</html:option>
						  	...
						  	<tr>
								...
								<td align="left" class="labeltext" valign="top" width="16%" >
									From:&nbsp;<html:text styleId="dateFrom" property="dateFrom" size="8" maxlength="15" readonly="true"/>
									...
									To:&nbsp;<html:text styleId="dateTo" property="dateTo" size="8" maxlength="15" readonly="true"/>
						  	...
						  	<tr>
								<td align="left" class="labeltext" valign="top" width="15%">Hide Checked Out CDR?</td>
								<td align="left" class="labeltext" valign="top" width="32%" >
									<html:radio styleId="hideCheckedOut" property="hideCheckedOut" value="Yes" />&nbsp; Yes
									<html:radio styleId="hideCheckedOut" property="hideCheckedOut" value="No" />&nbsp; No
								</td>
						  	</tr>
						...
						<table cellSpacing="0" cellPadding="0" border="1" align="center">
							<tr class="grey-bkgd">
								<td colspan="2"  align="left" class="labeltext" valign="top"><strong>Save Search</strong></td>
		  					</tr>
		  					
		  					<tr>
								<td align="center" class="labeltext">&nbsp;&nbsp;&nbsp;Name:&nbsp; <html:text styleId="searchName" property="searchName" size="25"/>
								<br>
									<input class="light-btn" type="button" name="Save" value="  Save  " onclick="save()"/>
								</td>
		  					</tr>
						</table>
					</td>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr  class="grey-bkgd">
					<td align="left" valign="top" class="labeltext" width="95%"><strong>Advance Search</strong></td>
					<td align="center" valign="top" class="labeltext" width="5%"><img id="img_id" src="<%=basePath%>/images/bottom-level.jpg" border="0" onclick="show()"/></td>
				</tr>
			</table>
					...
					<td width="23" class="small-gap">&nbsp;</td>
								<td>
									<div id="advanceSearch_Id" style="display:none;">
										<table width="100%">
											<tr>
												<td align="left" class="labeltext" valign="top" width="10%">Field Name</td>
												<td align="left" class="labeltext" valign="top" width="32%" >
											...
											<tr>
												...
												<td align="left" class="labeltext" valign="top" width="32%" ><html:text styleId="value" property="value" size="30"/></td>
											</tr>
											<tr>
												<td align="left" class="labeltext" valign="top" width="10%">&nbsp;</td>
												<td align="left" class="labeltext" valign="top" width="32%" ><input type="button" name="add" value="Add Field" onclick="addParam()"/></td>
											</tr>
											<tr>
												<td align="left" class="labeltext" valign="top" width="10%">Logical Connector</td>
												<td align="left" class="labeltext" valign="top" width="32%" >
													<html:radio styleId="logicalConnector" property="logicalConnector" value="And" />&nbsp; And
													<html:radio styleId="logicalConnector" property="logicalConnector" value="Or" />&nbsp; Or
												</td>
											</tr>
										</table>
										...
										<table width="100%" border="1" cellSpacing="0" cellPadding="0">
											<tr class="grey-bkgd">
												<td align="left" class="labeltext"  valign="top" width="5%" >Sr. No.</td>
												<td align="left"  class="labeltext"  valign="top" width="10%" >Field Name</td>
												<td align="left"  class="labeltext"  valign="top" width="10%" >Operator</td>
												<td align="left"  class="labeltext"  valign="top" width="10%" >Value</td>
											...
											<tr>
												<td align="left" class="tblfirstcol"><%=(index+1)%></td>
								  				...
								  				<td align="left" class="tblrows"><img src="<%=basePath%>/images/minus.jpg" onclick="remove('<%=index%>')" border="0"/></td>
											</tr>
							...
							<tr>
								<td width="23" class="small-gap">&nbsp;</td>
								<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="button" name="search" value=" Search  " class="light-btn" onclick="return validateSearch()"/>
									&nbsp;&nbsp;
									<input type="button" name="reset" value="   Reset   " class="light-btn" onclick="clearData()"/>
								</td>
								<td width="23" class="small-gap">&nbsp;</td>
							</tr>
			</table>
			...
			<table width="100%" border="0" cellSpacing="0" cellPadding="0" >
					<tr>
								...
								<td align="left"  valign="top" width="5%" class="tblheader-bold">Sr. No.</td>
					...
					<% if(cdrDataList != null && cdrDataList.size() > 0) {
					 ...
					 %>
					<tr>
								<td align="left" class="tblfirstcol"><input type="checkbox" name="select" value="<%=cdrId%>"/></td>
								<td align="left" class="tblfirstcol"><%=(index+1)%></td>
				  				...
				  				<td align="left" class="tblrows" valign="center">
									<a href="" onclick="return popup('<%=basePath%>/viewCDRInfo.do?cdrId=<%=cdrId%>&netserverid=<bean:write name="searchCDRForm" property="serverId"/>','notes')"><img  src="<%=basePath%>/images/view-info.jpg"  alt="View"  border="0" ></a>
								</td>
					</tr>
					<% } %>
					<tr>
					...
					<tr>
				  				<td colspan="7" align="center" class="tblfirstcol">
				  					<input type="button" name="reprocess_btn" value="Mark For Reprocess" class="light-btn" onclick="markForReprocess()"/>
				  					<input type="button" name="update_btn" value="Update" class="light-btn" onclick="update()"/>
				  					<input type="button" name="checkOutSelected_btn" value="Check Out" class="light-btn" onclick="checkOutSelected()"/>
				  					<input type="button" name="checkedOutAll_btn" value="Checked Out All" class="light-btn" onclick="checkedOutAll()"/>
				  				</td>
					</tr>
					<tr>
						<td align="right" class="tblfirstcol" colspan="7">
							<a href="searchCDRSummary.do?netserverid=<bean:write name="searchCDRForm" property="serverId"/>">View Summary Information</a>
						</td>
					</tr>
					<% } else { %>
					<tr>
						<td colspan="7" align="center" class="tblfirstcol">No Records Found...</td>
					</tr>
					<% } %>
			</table>
			<% } %>
