...
//        msg = "All Services and its Details within this Server would be Updated. Do you like to continue ? "
        ...
        if(agree){
            javascript:location.href='<%=localBasePath1%>/synchronizeNetServerConfig.do?netserverid=<bean:write name="netServerInstanceBean" property="netServerId"/>';
...
//        msg = "All Services and its Details within this Server would be Updated. Do you like to continue ? "
        var agree = confirm(msg);
        if(agree){
            javascript:location.href='<%=localBasePath1%>/synchronizeBackNetServerConfig.do?netserverid=<bean:write name="netServerInstanceBean" property="netServerId"/>';
    		//document.forms[0].submit();
        }
	}
</script>
...
<html:hidden name="updateNetServerSynchronizeConfigDetailForm" styleId="action" property="action" />
<html:hidden name="updateNetServerSynchronizeConfigDetailForm" styleId="netServerId" property="netServerId"/>
   ...
   <bean:define id="netServerInstanceBean" name="netServerInstanceData" scope="request" type="com.elitecore.netvertexsm.datamanager.servermgr.data.INetServerInstanceData" />
    <tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" >
			...
			<tr> 
			  <td class="tblheader-bold" colspan="2"><bean:message bundle="servermgrResources" key="servermgr.synchronizeserverdetails"/></td>
			</tr>
			<tr> 
	...
	<tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" align="right">
		  <tr>         
      		<td class="small-text-grey">Note : All Services and its Details within this Server would be Updated.</td>
      	  </tr>
      	</table>
      </td>
    </tr>
	<tr> 
      ...
      <td class="btns-td" valign="middle"  >
         ...
         <input type="reset" name="c_btnDeletePolicy" onclick="javascript:location.href='<%=localBasePath1%>/viewNetServerInstance.do?netserverid=<bean:write name="netServerInstanceBean" property="netServerId"/>'" value="Cancel" class="light-btn"> 
      </td>
	</tr>
	<tr> 
      <td>&nbsp;</td>
