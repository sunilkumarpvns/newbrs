   ...
   <tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" >
		  ...
		  <tr> 
			<td class="tblheader-bold" colspan="3"><bean:message bundle="servermgrResources" key="servermgr.listcdrdetails"/></td>
		  </tr>
		</table>
	  </td>
	</tr>
...
%>
           ...
           <tr>
			  ...
			  <% } %>  
			   <td align="center" class="tblheader" valign="top" width="5%"><bean:message bundle="servermgrResources" key="servermgr.edit"/>
		   </tr>
		   <%
...
<%--			   <td align="center" class="tblrows"><a href="<%=basePath%>/initViewCDRRecords.do"> <img src="<%=basePath%>/images/edit.jpg" border="0" /> </a></td>  
				   ...
				   <td align="center" class="tblrows"><img src="<%=localBasePath1%>/images/edit.jpg" border="0" onclick="editCDRRecords(<%=j%>)"/></td> 
		   </tr>
		  <%
				}
		  %>
