    ...
    <td colspan="2"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td background="<%=basePath%>/images/header-gradient.jpg" width="133" rowspan="2" class="page-header"><bean:message bundle="servermgrResources" key="servermgr.header"/></td>
  ...
  <tr height=380px>
    ...
    <td  width="773" valign="top" class="box" >
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		  <td valign="top">
			<%@ include file="ServerEnvironment.jsp"%>
		  </td>
		</tr>
      </table>
    </td>	
