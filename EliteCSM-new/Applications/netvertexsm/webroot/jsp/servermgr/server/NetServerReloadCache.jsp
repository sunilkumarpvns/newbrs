   ...
   <bean:define id="netServerInstanceBean" name="netServerInstanceData" scope="request" type="com.elitecore.netvertexsm.datamanager.servermgr.data.INetServerInstanceData" />
    <tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" >
			...
			<tr> 
			  <td class="tblheader-bold" colspan="2"><bean:message bundle="servermgrResources" key="servermgr.reloadcachedetails"/></td>
			</tr>
			<tr> 
	...
	<tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" align="right">
		  <tr>         
      		<td class="small-text-grey">Note : This operation will result into Server cache to be Reloaded.</td>
      	  </tr>
      	</table>
      </td>
    </tr>
	<tr> 
      ...
      <td class="btns-td" valign="middle" >
      	<input type="button" name="c_btnReloadCache"  onclick="javascript:location.href='<%=localBasePath%>/signalServerReloadCache.do?netServerId=<%=netServerId %>'"  id="c_btnReloadCache"  value="Reload Cache"  class="light-btn" />                                           
