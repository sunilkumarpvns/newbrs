...
<%@ page import="com.elitecore.netvertexsm.web.servermgr.server.form.ViewNetServerServicesForm" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%">
    ...
    <tr>
     <td width="100%" valign="right" colspan="3" >
        <table width="97%" cellpadding="0" cellspacing="0" border="0" align="right" >
          <tr>
...
%>
               <logic:iterate id="netServiceInstanceData" name="viewNetServerServiesForm" property="listServices" type="com.elitecore.netvertexsm.datamanager.servermgr.data.INetServiceInstanceData">
                <tr>
				  ...
				  <td align="left" class="tblrows">
 				  ...
 				  <td align="left" class="tblcol"><bean:write name="netServiceInstanceData" property="description"/>&nbsp;</td>
                </tr>
<% iIndex += 1; %>
				 </logic:iterate>
<%
