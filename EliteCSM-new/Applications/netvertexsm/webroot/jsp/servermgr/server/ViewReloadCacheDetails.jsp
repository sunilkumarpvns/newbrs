...
<%@ page import="com.elitecore.netvertexsm.web.servermgr.server.form.ViewReloadCacheDetailsForm"%>
			...
			<td valign="top" align="right">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<logic:equal name="viewReloadCacheDetailsForm" property="errorCode" value="0">
					    ...
					    <logic:iterate id="cacheDetailBean" name="lstCacheDetails" type="com.elitecore.netvertexsm.web.servermgr.server.form.CacheDetailBean">
							<%
							iIndex++;
							%>
							<tr>
