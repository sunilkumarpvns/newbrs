...
<script>
    function startServer(){    
        ...
        if(agree){
            javascript:location.href='<%=localBasePath1%>/startNetServerInstance.do?netServerId=<%=netServerId%>';  
        }
    }
   ...
   <bean:define id="netServerInstanceBean" name="netServerInstanceData" scope="request" type="com.elitecore.netvertexsm.datamanager.servermgr.data.INetServerInstanceData" />
    <tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" >
			...
			<tr> 
			  <td class="tblheader-bold" colspan="2"><bean:message bundle="servermgrResources" key="servermgr.reloadconfigurationdetails"/></td>
			</tr>
			<tr> 
	...
	<tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" align="right">
		  <tr>         
      		<td class="small-text-grey">Note : This operation will result into Server configuration to be Reloaded.</td>
      	  </tr>
      	</table>
      </td>
    </tr>
	<tr> 
      ...
      <td class="btns-td" valign="middle" >
      	<input type="button" name="c_btnReloadConfig"  onclick="javascript:location.href='<%=localBasePath1%>/signalServerReloadConfiguration.do?netServerId=<%=netServerId %>'"  id="c_btnReloadConfig"  value="Reload Configuration"  class="light-btn" />                               
      	 <input type="reset" name="c_btnDeletePolicy" value="Cancel" class="light-btn" onclick="javascript:location.href='<%=localBasePath1%>/viewNetServerInstance.do?netserverid=<%=netServerId %>'">  
