...
<script>
    function stopServer(){    
        ...
        if(agree){
            ...
            javascript:location.href='<%=localBasePath%>/signalServerShutDown.do?netServerId=<%=netServerId%>';
        }
    }
    ...
    <tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" >
			...
			<tr> 
			  <td class="tblheader-bold" colspan="2"><bean:message bundle="servermgrResources" key="servermgr.stopserverdetails"/></td>
			</tr>
			<tr> 
	...
	<tr> 
      <td valign="top" align="right"> 
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" align="right">
		  <tr>         
      		<td class="small-text-grey">Note : This operation will terminate the Server.</td>
      	  </tr>
      	</table>
      </td>
    </tr>
