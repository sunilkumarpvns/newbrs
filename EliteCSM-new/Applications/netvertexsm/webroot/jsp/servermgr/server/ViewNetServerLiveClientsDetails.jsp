...
<%@ page import="com.elitecore.netvertexsm.web.servermgr.server.form.ViewNetServerLiveClientsDetailsForm"%>
			...
			<tr>
				<td valign="top" align="right">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<logic:iterate id="clientData" name="activeClientList" type="com.elitecore.netvertexsm.web.servermgr.server.form.ClientDetailBean">
							<%
							iIndex++;
							%>
							<tr>
								...
								<td align="left" class="tblrows">
									...
									<table width="100%" class="box" cellpadding="0" cellspacing="0" border="0">
										...
										<tr>
											<td class="tblfirstcol"><bean:message bundle="radiusResources" key="radius.clientprofile.framedpool" /></td>
											<td class="tblrows"><bean:write name="clientData" property="clientProfileData.framedPool"/>&nbsp;</td>
										</tr>
										<tr>
			...
			<tr>
				<td valign="top" align="right">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<logic:iterate id="clientData" name="unsupportedVendorClientList" type="com.elitecore.netvertexsm.web.servermgr.server.form.ClientDetailBean">
							<%
							iIndex++;
							%>
							<tr>
				...
				<td valign="top" align="right">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<logic:iterate id="clientData" name="licenseExceededClientList"
							type="com.elitecore.netvertexsm.web.servermgr.server.form.ClientDetailBean">
							<%
							iIndex++;
							%>
								<td align="left" class="tblfirstcol">
