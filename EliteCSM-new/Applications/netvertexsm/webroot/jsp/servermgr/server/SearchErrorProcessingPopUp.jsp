		...
		<tr>
	    	...
	    	<td width="100%" colspan="3" valign="top" class="box">
	    		<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	    			...
	    			<tr>
	    				<td class="table-header" valign="bottom" colspan="3"><bean:message bundle="servermgrResources" key="servermgr.fileinformation.searchFileInformation"/></td>
	    			</tr>
	    			<tr>
					...
					<tr>
						...
						<form action="#" name="seachErrorProcessingPopup"></form>
							<table align="right" width="97%" border="0" cellspacing="0" cellpadding="0">
								<tr>
	    							<td class="tblheader-bold" valign="bottom" colspan="4">File List</td>
	    						</tr>
	    						
	    						<logic:notEmpty name="errorProcessingFileList"  scope="request" >
	    						<tr>
	    							<td class="tblheader-bold" valign="bottom">No.</td>
	    							<td class="tblheader-bold" valign="bottom">&nbsp;&nbsp;File Name</td>
								...
								<logic:iterate id="keyValueBean" indexId="i" name="errorProcessingFileList"  scope="request" >
								  <tr>
								  <td class="tblfirstcol" width="5%"> 
										   <%=i+1%>
									</td>
									<td class="tblrows"> 
										   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="validateInsert('<bean:write name="keyValueBean" property="value"/>')"><bean:write name="keyValueBean" property="value"/></a>
									</td>
									<td class="tblrows" align="center"> 
										   <bean:write name="keyValueBean" property="filed1"/>
									</td>
									<td class="tblcol" align="center"> 
										  	<bean:write name="keyValueBean" property="filed2"/>
									</td>
								  </tr>
								</logic:iterate>
								...
								<logic:empty name="errorProcessingFileList"  scope="request" >
								  <tr>
								  <td class="tblfirstcol" colspan="4" width="5%"> 
										   No records Found.
									</td>
								  </tr>
								</logic:empty>
