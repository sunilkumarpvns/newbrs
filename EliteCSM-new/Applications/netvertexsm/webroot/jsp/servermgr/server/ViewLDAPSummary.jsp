...
{  
	  ...
	  xmlHttp.onreadystatechange=function()
      {
        ...
        {	
			 refreshTime = document.viewLDAPSummaryForm.refreshTime.value;
             renderImage();
        }
      }                                                                         
	  xmlHttp.open("POST",'<%=localBasePath%>/viewLDAPSummary.do?netserverid=<%=netServerId%>&status='+defaultId,true);
      xmlHttp.send(null);  
}
...
{	
	defaultId = document.viewLDAPSummaryForm.status.value;   
	if(timerID == null)
	{
...
<html:form action="/viewLDAPSummary">
        ...
        <table width="97%" border="0" cellspacing="0" cellpadding="0" height="15%" >
    	     <tr>
		    	...
		    	<td align="left" valign="top" width="20%">
		    		&nbsp;
			    	<html:select name="viewLDAPSummaryForm" styleId="status" property="status" onchange="refreshImage()">
		    	...
		    	<td align="left" valign="top" width="20%">
		    		&nbsp;
				 	...
				 	<html:select name="viewLDAPSummaryForm" styleId="refreshTime" property="refreshTime" onchange="refreshImage()" value="30">
			    		<% for(int i=1;i<=30;i++) { %>
