...
<%@ page import="com.elitecore.netvertexsm.web.servermgr.server.form.ViewGraphForm"%>
<%
								...
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
									   ...
									   %>
									   	...
									   	<logic:iterate id="liveGraphdata" name="viewGraphForm" property="listEntity" type="com.elitecore.netvertexsm.web.servermgr.server.form.LiveGraphData">
											<tr>
