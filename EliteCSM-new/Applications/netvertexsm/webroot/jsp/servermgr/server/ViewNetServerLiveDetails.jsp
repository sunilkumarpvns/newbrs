...
<%@ page import="com.elitecore.core.util.mbean.data.live.EliteNetvertexServerDetails"%>
...
<%
	EliteNetvertexServerDetails liveDetailsBean = (EliteNetvertexServerDetails)request.getAttribute("eliteLiveServerDetails");
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="tblheader-bold" colspan="4">
							<bean:message bundle="servermgrResources" key="servermgr.liveserverdetails" />
						</td>
					</tr>
					<logic:equal name="viewNetServerLiveDetailsForm"
						...
						<tr>
							<td align="left" class="tblfirstcol" valign="top" width="20%">
								<bean:message bundle="servermgrResources" key="servermgr.serveridentification" />
							</td>
							<td align="left" class="tblcol" valign="top" width="30%">
							<bean:write name="eliteLiveServerDetails" property="identification" />
								&nbsp;
							</td>
							<td align="left" class="tblfirstcol" valign="top" width="20%">
								<bean:message bundle="servermgrResources" key="servermgr.serverversion" />
							</td>
							<td align="left" class="tblcol" valign="top" width="30%">
						...
						<tr>
							<td align="left" class="tblfirstcol" valign="top">
								<bean:message bundle="servermgrResources" key="servermgr.server.serverstartupdatetime" />
							</td>
							...
							<td align="left" class="tblfirstcol" valign="top">
								<bean:message bundle="servermgrResources" key="servermgr.server.policyreloadtime" />
							</td>
							<td align="left" class="tblcol" valign="top">
								<%=EliteUtility.dateToString(liveDetailsBean.getPolicyReloadTime(),ConfigManager.get(ConfigConstant.DATE_FORMAT))%>
								&nbsp;
							</td>
						</tr>
						<tr>
							<td align="left" class="tblfirstcol" valign="top">
								<bean:message bundle="servermgrResources" key="servermgr.server.cachereloaddatetime" />
							</td>
							<td align="left" class="tblcol" valign="top">
							...
							<td align="left" class="tblfirstcol" valign="top">
								<bean:message bundle="servermgrResources" key="servermgr.server.serverreloaddatetime" />
							</td>
							<td align="left" class="tblcol" valign="top">
			...
			<tr>
				<td valign="top" align="right">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td align="left" class="tblheader" valign="top" width="5%"><bean:message bundle="servermgrResources" key="servermgr.serialnumber" /></td>
							<td align="left" class="tblheader" valign="top" width="25%"><bean:message bundle="servermgrResources" key="servermgr.instancename" /></td>
							<td align="left" class="tblheader" valign="top" width="20%"> <bean:message bundle="servermgrResources" key="servermgr.serviceip" /> - 
							    <bean:message bundle="servermgrResources" key="servermgr.serviceport" /></td>
							<td align="left" class="tblheader" valign="top" width="15%"><bean:message bundle="servermgrResources" key="servermgr.server.serverstartupdatetime" /></td>
							<td align="left" class="tblheader" valign="top" width="10%"><bean:message bundle="servermgrResources" key="servermgr.status" /></td>
							<td align="left" class="tblheader" valign="top" width="20%"><bean:message bundle="servermgrResources" key="servermgr.remark" />
							</td>
						</tr>

						<bean:define id="listServiceDetails" name="eliteLiveServerDetails" property="serviceSummaryList"></bean:define>
						<%
						int iIndex = 0;
						String remarks=null;
						%>
					 <logic:iterate id="serviceData" name="listServiceDetails"
						...
						<%
							...
							<tr>
								...
								<td align="left" class="tblrows" valign="top"><bean:write name="serviceData" property="instanceName" />&nbsp;</td>
								<td align="left" class="tblrows" valign="top"><%=ipAddress%>&nbsp;</td>
								<td align="left" class="tblrows" valign="top"><%=EliteUtility.dateToString(startupTime,dateFormat)%>&nbsp;</td>
								<td align="left" class="tblrows" valign="top"><bean:write name="serviceData" property="status" />&nbsp;</td>
								<td align="left" class="tblrows" valign="top"><%=remarks%>&nbsp;</td>
							</tr>
