...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	 <tr> 
    	 <td valign="top" class="box" colspan="2"> 
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				   <tr> 
					      ...
					      <td background="<%=localBasePath%>/images/popup-btn-bkgd.jpg" width="20px">&nbsp;</td>
      			   </tr>
				   <tr> 
		 				  <td colspan="8"> 
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  						 <tr> 
        									...
        									<td width="38%" class="blue-text-bold" valign="bottom">Description</td>
			  								<td class="blue-text-bold" width="43%"><a href="#"><img src="<%=localBasePath%>/images/pdf.jpg" name="Image21" onMouseOver="MM_swapImage('Image21','','<%=localBasePath%>/images/pdf-hover.jpg',1)" border="0" alt="Save as PDF"></a><a href="#"><img src="<%=localBasePath%>/images/html.jpg" name="Image31" onMouseOver="MM_swapImage('Image31','','<%=localBasePath%>/images/html-hover.jpg',1)" border="0" alt="Save as HTML"></a></td>
	 ...
	 <tr> 
		    <td bgcolor="#00477F" class="small-gap" >&nbsp;</td>
		    <td class="small-gap" width="20px"><img src="<%=localBasePath%>/images/pbtm-line-end.jpg"></td>
	</tr>
</table>
