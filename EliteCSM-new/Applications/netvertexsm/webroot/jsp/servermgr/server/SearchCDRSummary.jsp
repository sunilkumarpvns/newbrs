...
<html:form action="/searchCDRSummary">
	<html:hidden styleId="checkAction" property="checkAction" name="searchCDRSummaryForm"/>
	<html:hidden styleId="serverId" property="serverId" name="searchCDRSummaryForm"/>
				...
				<td valign="top" align="right">
					...
					<tr>
						<td align="left" class="labeltext" width="10%">
							...
							<html:select styleId="groupField" property="groupField" name="searchCDRSummaryForm">
					...
					<tr>
						<td colspan="3">
							<table border="1" cellSpacing="0" cellPadding="0">
								...
								<% } else {  %>
								<tr>
									<td align="center" class="tblrows" colspan="14">
										No Records Found...
									</td>
								</tr>
								<% } %>
