...
<%@ page import="com.elitecore.netvertexsm.datamanager.radius.dictionary.data.IDictionaryParameterDetailData" %>

<%@ page import="com.elitecore.netvertexsm.datamanager.radius.dictionary.data.IDictionaryData" %>
<%@ page import="com.elitecore.netvertexsm.web.servermgr.server.form.SearchDictionaryPopUpForm" %>
...
<html:hidden name="searchDictionaryPopUpForm" styleId="action" property="action" value="Insert"/>
<html:hidden name="searchDictionaryPopUpForm" styleId="fieldValue" property="fieldValue"/>
...
<table name="MainTable" id="MainTable" cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<tr>
	    	...
	    	<td width="100%" colspan="3" valign="top" class="box">
	    		<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	    			...
	    			<tr>
	    				<td class="table-header" valign="bottom" colspan="3"><bean:message bundle="servermgrResources" key="netRadiusDictionary.dictionaryList.header" /></td>
	    			</tr>
	    			<tr>
					...
					<tr>
						<td colspan="3">
							<table width="97%" align="right" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td align="left" class="labeltext" valign="top" width="10%"><bean:message bundle="servermgrResources" key="netRadiusDictionary.dictionaryList.comboLabel" /></td>
									<td align="left" class="labeltext" valign="top" width="32%">
										<%if(dictionaryListInCombo!=null && !dictionaryListInCombo.isEmpty()){%>
										<html:select name="searchDictionaryPopUpForm" styleId="dictionaryId" property="dictionaryId">
											<html:option value=""><bean:message bundle="servermgrResources" key="netRadiusDictionary.dictionaryList.comboSelectLabel" /></html:option>
												<%
								...
								<tr>
									<td align="left" class="labeltext" valign="top" width="10%"><bean:message bundle="servermgrResources" key="netRadiusDictionary.name.label" />
									</td>
									<td align="left" class="labeltext" valign="top" width="32%">
										<html:text name="searchDictionaryPopUpForm" styleId="searchByName" property="searchByName" styleClass="flatfields" />
									</td>
								</tr>
								...
								<tr>
									...
									--%><td align="left" class="labeltext" valign="top" width="5%">
									    <input type="button" name="Search" width="5%" onclick="validateSearch()"  value="   Search   " class="light-btn" />         
...
<%--  Here to divide the rows	--%>							
							    ...
							    %>
	    									...
	    									<tr>
	    										<td class="table-header" valign="bottom" colspan="8"><bean:message bundle="servermgrResources" key="netRadiusDictionary.listByCriteria.header" /></td>
	    									</tr>
											<tr>
										              <td width="50%" colspan="2" class="small-gap">&nbsp;</td>
										    </tr>
	    						...
	    						<tr>
	    							<td colspan="8">
	    								<table width="97%" border="0"border="0" cellpadding="0" cellspacing="0" align="right">
	    									
	    									<tr>
												<td align="left" class="labeltext" valign="top" colspan="3">
													<input type="button" name="Insert" onclick="validateInsert()" value="   Insert   " class="light-btn" />         
												</td>
											</tr>	
	    									...
	    									<tr>
				    							<td align="left" class="tblheader" valign="top" width="1%"><bean:message bundle="servermgrResources" key="netRadiusDictionary.listByCriteria.radio.label" /></td>
										        <td align="left" class="tblheader" valign="top" width="1%"><bean:message bundle="servermgrResources" key="netRadiusDictionary.listByCriteria.serial.label" /></td>
										        <td align="left" class="tblheader" valign="top" ><bean:message bundle="servermgrResources" key="netRadiusDictionary.listByCriteria.dictionary.name.label" /></td>
								        	</tr>
								        	
								        	<%
	    										if(dictionaryListByCriteria != null && dictionaryListByCriteria.size() > 0){
											%>
						  						<logic:iterate id="searchDictionaryPopUpBean" name="searchDictionaryPopUpForm" property="dictionaryListByCriteria" type="com.elitecore.netvertexsm.datamanager.radius.dictionary.data.IDictionaryParameterDetailData">
...
--%>														<input type="radio" name="selected" id="<%=(iIndex+1) %>" value="<%=searchDictionaryPopUpBean.getVendorId()+":"+searchDictionaryPopUpBean.getVendorParameterId()%>"/>
											...
											<tr>
													<td align="left" class="labeltext" valign="top" width="5%">
														<input type="button" name="Insert" width="5%" onclick="validateInsert()" value="   Insert   " class="light-btn" />         
													</td>
											</tr>	
