    ...
    <tr>
      ...
      <td width="821" colspan="2" >
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
          <tr>
            <td width="26" rowspan="2" valign="top" ><img  src="<%=basePath%>/images/left-curve.jpg"  border="0" ></td>
            <td width="133" align="center" class="page-header" background="<%=basePath%>/images/header-gradient.jpg" rowspan="2" >Server Configuration</td>
            <td width="32" rowspan="2" ><img  src="<%=basePath%>/images/right-curve.jpg"  border="0" ></td>
          </tr>
          <tr>
            <td width="633" valign="bottom" ><img  src="<%=basePath%>/images/line.jpg"  border="0" ></td>
          </tr>
        </table>
      </td>
    </tr>
			...
			<tr>
				...
				<td width="100%" colspan="2" valign="top" class="box">
					...
					<table cellSpacing="0" cellPadding="0" width="100%" border="0">
						<tr>
							<td class="table-header" colspan="5">Search Networ Services<img src="<%=basePath%>/images/open.jpg" border="0" name="closeopen"></td> 
						</tr>
					    <tr>
							...
							<td colspan="3">
								<table width="97%" name="c_tblCrossProductList" id="c_tblCrossProductList" align="right" border="0" >
									...
									<tr>
										...
										<td align="left" class="labeltext" valign="top" width="5%">
										    <input type="button" name="Search" width="5%" name="RadiusPolicyName" Onclick="validateSearch(document.searchRadiusForm,'list')" value="   Search   " class="light-btn" />       
							 			...
							 			<td class="btns-td" valign="middle" colspan="9" > 
			    			 				<table width="100%" border="0" cellpadding="0" cellspacing="0" id="listTable"  > 
						                        ...
						                        <tr>
						                          ...
						                          <td align="left" class="tblrows" valign="top" ><a href='<%=basePath%>/jsp/servermgr/ServiceContainer.jsp'>IPPool Service</a></td>
						                          <td align="left" class="tblrows" valign="top" >ip_pool_service</td>
						                          <td align="left" class="tblrows" valign="top" >Description : IPPool Service</td>
						                        </tr>
						                        <tr>
						                          <td align="right" class="tblfirstcol" valign="top" >2</td>
						                          <td align="left" class="tblrows" valign="top" >Parlay Charging Service</td>
						                          <td align="left" class="tblrows" valign="top" >parlay-charging-service</td>
						                          <td align="left" class="tblrows" valign="top" >Description : Parlay Charging Service</td>
						                        </tr>
											</table>
										</td>
									</tr>
