...
<html:hidden name="exportNetServiceConfigurationForm" styleId="netServiceId" property="netServiceId"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td class="btns-td" valign="middle">
      <input type="button" name="c_btnSynchronize"  onclick="javascript:location.href='<%=localBasePath1%>/jsp/servermgr/ServiceContainer.jsp'"  id="c_btnSynchronize"  value=" Export "  class="light-btn">                   
