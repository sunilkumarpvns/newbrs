<%@ page import="com.elitecore.netvertexsm.web.servermgr.service.form.ViewNetServiceLiveDetailsForm" %>
...
<%
    ...
    List lstServiceDetails = (List)liveDetailsForm.getBasicDetails();
%>
