...
<%
	...
	String updateLDAPSPInterfaceData = request.getContextPath()
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr id=header1>
					...
					<td class="subLinksHeader" width="13%">
						<a href="javascript:void(0)" ><img src="<%=request.getContextPath()%>/images/sublinks-dnarrow.jpg" border="0" name="arrow"></a>
					</td>
				</tr>
				<tr valign="top">
					<td colspan="2" id="backgr1">
						<div>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="subLinks">
										<a href="<%=updateLDAPSPInterfaceData%>" tabindex="9"><bean:message bundle="driverResources" key="spinterface.update" /></a>
									</td>
								</tr>
							</table>
						</div>
				...
				<tr id=header1>
					...
					<td class="subLinksHeader" width="13%">
						<a href="javascript:void(0)" onClick="STB('ViewRadiusPolicy');swapImages()"><img src="<%=request.getContextPath()%>/images/sublinks-dnarrow.jpg" border="0" name="arrow"></a>
					</td>
				</tr>
				<tr valign="top">
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="subLinks">
										<a href="<%=viewDriverInstance%>" tabindex="10"><bean:message bundle="driverResources" key="spinterface.view" /></a> 
									</td>
								</tr>
							</table>
						</div>
