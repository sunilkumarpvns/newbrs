...
<script language="javascript">
  ...
  function verifyFormat (){
    ...
    callVerifyValidFormat({instanceType:'<%=InstanceTypeConstants.SERVER_GROUP_MANAGEMENT%>',searchName:searchName,mode:'create',id:''},'verifyNameDiv');
  }
  function verifyName() {
    var searchName = document.getElementById("name").value;
    isValidName = verifyInstanceName({instanceType:'<%=InstanceTypeConstants.SERVER_GROUP_MANAGEMENT%>',searchName:searchName,mode:'create',id:''},'verifyNameDiv');
  }

</script>

<html:form action="/serverGroupManagement.do?method=create" onsubmit="return validate();">
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
          <tr>
            <td class="table-header" colspan="5">
              <bean:message bundle="serverGroupDataMgmtResources" key="group.create.title"/>
            </td>
          </tr>
          <tr>
