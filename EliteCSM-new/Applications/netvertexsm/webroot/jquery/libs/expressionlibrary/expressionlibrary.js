var functions = {"getPackageUsage(\"Volume/Time\",\"PackageName\",\"DAILY/WEEKLY/MONTHLY\")":"Looks up the value from db. Supports 3 arguments."
				,"getUsage(\"Usage Type\", \"Service Name\" ,\"Aggregate Key\",\"[Volume Usage Type]\")":"Looks up the value from db. Supports 3/4 arguments."
                ,"tolower(arg1)":"Converts to lowercase. Supports one argument."
