...
@Path("/")
public class CrestelChargingOCSV2DriverController {
	private static final String CRESTEL_OCSV2_DRIVER = "Crestel OCSV2 Driver";
	...
	public Response create(@Valid DriverInstanceData driverInstance) throws DataManagerException {
		...
		driverInstance.setDriverTypeId(DriverTypeConstants.CRESTEL_OCSv2_DRIVER);
		...
		return Response.ok(RestUtitlity.getResponse("Crestel OCSV2 Driver created successfully")).build();
	}
	...
	public Response create(@Valid ListWrapper<DriverInstanceData> driverInstanceList, @Context UriInfo uri) throws DataManagerException {
		...
		return Response.ok(RestUtitlity.getResponse(CRESTEL_OCSV2_DRIVER, "(s) created successfully", responseMap,
	...
	@QueryParam(value = "name") String name) throws DataManagerException {
		...
		return Response.ok(RestUtitlity.getResponse("Crestel OCSV2 Driver updated successfully")).build();
	}
	...
	public Response	deleteByQueryParam(@NotEmpty(message = RestValidationMessages.NAME_NOT_FOUND_QUERY_PARAMETER) 
		...
		return Response.ok(RestUtitlity.getResponse("Crestel OCSV2 Driver(s) deleted successfully")).build();
	}
	...
	public Response getHelp() throws FileNotFoundException, IllegalArgumentException, IOException{
		return RestUtitlity.getHelp(RestHelpConstant.CRESTEL_OCS_V2);
	}
}
