...
@XmlType(propOrder = {"serverName","domainName","serviceTypes","aaaDatasourceDetail","loggerDetail","snmpAddress","snmpCommunity","internalSchedulerMaxThread",
		"filterResponseAttributes","alertListnersDetail","webServiceConfiguration","rfcNaiDetail","kpiServiceConfiguration"})
@XmlRootElement(name = "elite-aaa-server")
public class AAAServerConfigurationData{
	...
	public AAAServerConfigurationData(){
		...
		rfcNaiDetail = new RFCNaiDetailData();
	...
	public void setRfcNaiDetail(RFCNaiDetailData rfcNai) {
