package com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.resourcemanager.diameterstack.data;
...
import com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.elitecsmserver.diameterstack.data.DiameterPluginsDetailData;
import com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.elitecsmserver.diameterstack.data.DiameterSessionCleanupDetailData;
import com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.elitecsmserver.diameterstack.data.DiameterWebServiceConfigurationDetailData;
import com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.elitecsmserver.diameterstack.data.PeerSecurityParametersData;
import com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.elitecsmserver.diameterstack.data.RFCNaiDetailData;
import com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.elitecsmserver.diameterstack.data.SelectedPeerConfDetailData;
import com.elitecore.elitesm.ws.rest.serverconfig.server.configurations.elitecsmserver.diameterstack.data.ServiceLoggerDetailData;
...
@XmlType(propOrder = {"diameterStackEnabled","serviceAddress","socketReceiveBufferSize","socketSendBufferSize","maxRequestQueueSize",
		...
		"securityStandard","duplicateRequestDetectionEnabled","dupicateRequestQueuePurgeInterval",
...
public class DiameterStackConfigurationData implements Validator {
	...
	public DiameterStackConfigurationData() {
		...
		this.securityParameters = new PeerSecurityParametersData();
		// default value
	...
	@Pattern(regexp = RestValidationMessages.REGEX_TRUE_FALSE, message = "Invalid Value of Diameter Stack Enable(it could be true or false)")
	...
	@Pattern(regexp = RestValidationMessages.REGEX_TRUE_FALSE, message = "Invalid Value of Duplicate Request Detection Enable(it could be true or false)")
