...
@XmlType(propOrder = {"serviceAddress", "socketReceiveBufferSize", "socketSendBufferSize", "queueSize", "minimumThread", 
		...
		"servicePolicies", "logger", "externalDataBaseDetail", "pluginsDetails" })
@ValidObject
public class RadDynAuthServiceData implements Validator  {
	
	private static final String RAD_DYNA_AUTH_SERVICE_POLICY = "Radius Dyanamic Authentication Service Policy";
	...
	public RadDynAuthServiceData(){
		...
		setServiceAddress("0.0.0.0:3799");
	...
	public boolean validate(ConstraintValidatorContext context) {
		...
		isValid = ServiceRestUtility.validateRadiusService(context, this.servicePolicies, this.pluginsDetails, DynAuthPolicyInstData.class, ServiceRestUtility.RAD_DYNAUTH, RAD_DYNA_AUTH_SERVICE_POLICY, isValid );
