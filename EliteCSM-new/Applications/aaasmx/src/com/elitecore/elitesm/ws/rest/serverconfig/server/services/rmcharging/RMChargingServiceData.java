...
@XmlType(propOrder = {"serviceAddress", "socketReceiveBufferSize", "socketSendBufferSize", "queueSize", "minimumThread", 
		...
		"servicePolicies", "logger", "pluginsDetails"})
@ValidObject
public class RMChargingServiceData implements Validator  {
	
	private static final String RM_CHARGING_SERVICE_POLICY = "Charging Service Policy";
	...
	public boolean validate(ConstraintValidatorContext context) {
		...
		isValid = ServiceRestUtility.validateRadiusService(context, this.servicePolicies, this.pluginsDetails, CGPolicyData.class, ServiceRestUtility.RM_CHARGING_SERVICE, RM_CHARGING_SERVICE_POLICY, isValid );
