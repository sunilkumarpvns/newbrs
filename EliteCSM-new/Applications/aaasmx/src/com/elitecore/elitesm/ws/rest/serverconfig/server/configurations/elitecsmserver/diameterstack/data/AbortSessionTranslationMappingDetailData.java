...
@XmlType(propOrder = {})
public class AbortSessionTranslationMappingDetailData {

	@NotEmpty(message="Diameter Abort Session Ws Mapping Name must be specified")
	private String translationMapping;

	public AbortSessionTranslationMappingDetailData() {
	}
