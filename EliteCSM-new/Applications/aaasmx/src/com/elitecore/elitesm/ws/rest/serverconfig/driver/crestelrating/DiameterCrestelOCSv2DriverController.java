...
@Path("/")
public class DiameterCrestelOCSv2DriverController {
	private static final String CRESTEL_OCS_V2_TRANSLATION_DRIVER = "Crestel OCS-V2 Translation Driver";
	...
	public Response create(@Valid DriverInstanceData driverInstance) throws DataManagerException {
		...
		driverInstance.setDriverTypeId(DriverTypeConstants.DIAMETER_CRESTEL_OCSv2_DRIVER);
		...
		return Response.ok(RestUtitlity.getResponse("Crestel OCS-V2 Translation Driver created successfully")).build();
	}
	...
	public Response create(@Valid ListWrapper<DriverInstanceData> driverInstanceList, @Context UriInfo uri) throws DataManagerException {
		...
		return Response.ok(RestUtitlity.getResponse(CRESTEL_OCS_V2_TRANSLATION_DRIVER, "(s) created successfully",
	...
	@QueryParam(value = "name") String name) throws DataManagerException {
		...
		return Response.ok(RestUtitlity.getResponse("Crestel OCS-V2 Translation Driver updated successfully")).build();
	}
	
	@PUT
	@Path("/{name}")
	public Response updateByPathParam(@PathParam(value = "name") String driverName, @Valid DriverInstanceData driverInstance) throws DataManagerException {
		return updateByQueryParam(driverInstance, driverName);
	}
	...
	public Response	deleteByQueryParam(@NotEmpty(message = RestValidationMessages.NAME_NOT_FOUND_QUERY_PARAMETER) 
		...
		return Response.ok(RestUtitlity.getResponse("Crestel OCS-V2 Translation Driver(s) deleted successfully")).build();
	}
	...
	public Response getHelp() throws FileNotFoundException, IllegalArgumentException, IOException{
		return RestUtitlity.getHelp(RestHelpConstant.DIAMETER_CRESTEL_OCS_V2);
	}
