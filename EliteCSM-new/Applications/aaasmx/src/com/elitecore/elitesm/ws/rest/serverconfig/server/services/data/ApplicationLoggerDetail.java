...
@XmlType(propOrder = {"serviceLoggerEnabled", "logLevel", "rollingType", "rollingUnit", "maxRolledUnit", 
		"compressRolledUnit", "logLocation", "sysLogConfiguration"})
...
public class ApplicationLoggerDetail {
	...
	@XmlElement(name = "application-logger-enabled")
