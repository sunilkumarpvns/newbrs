...
public class RadiusMapGWAuthDriverController {

	private static final String RADIUS_MAP_GATE_WAY_AUTH_DRIVER = "Radius Map GateWay Auth Driver";
	...
	public Response create(@Valid DriverInstanceData driverInstance) throws DataManagerException {
		...
		driverInstance.setDriverTypeId(DriverTypeConstants.RADIUS_MAPGATEWAY_AUTH_DRIVER);
		...
		return Response.ok(RestUtitlity.getResponse("Radius Map GateWay Auth Driver created successfully")).build();
	}
	...
	public Response create(@Valid ListWrapper<DriverInstanceData> driverInstanceDataList, @Context UriInfo uri) throws DataManagerException {
		...
		return Response.ok(RestUtitlity.getResponse(RADIUS_MAP_GATE_WAY_AUTH_DRIVER, "(s) created successfully",
	...
	@QueryParam(value = "name") String name) throws DataManagerException {
		...
		return Response.ok(RestUtitlity.getResponse("Radius Map Gateway Auth Driver(s) updated successfully")).build();
	}
	...
	public Response	deleteByQueryParam(@NotEmpty(message = RestValidationMessages.NAME_NOT_FOUND_QUERY_PARAMETER) 
		...
		return Response.ok(RestUtitlity.getResponse("Radius Map Gateway Auth Driver(s) deleted successfully")).build();
	}
	...
	public Response getHelp() throws FileNotFoundException, IllegalArgumentException, IOException{
		return RestUtitlity.getHelp(RestHelpConstant.RADIUS_MAP_GW_AUTH);
	}
