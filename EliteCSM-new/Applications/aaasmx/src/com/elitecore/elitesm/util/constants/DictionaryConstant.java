...
public class DictionaryConstant extends BaseConstant {
	...
	/*
	 * Diameter Dictionary Constants
	 */

	public static final long DIAMETER_RFC_DICTIONARY_PARAMETER_ID_FOR_VSA =26L;
	...
	public static final String ATTR_LENGTH_FORMAT = "length-format";
	public static final String ATTR_PADDING_TYPE = "padding-type";
