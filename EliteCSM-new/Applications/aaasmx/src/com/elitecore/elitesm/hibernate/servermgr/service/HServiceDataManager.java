...
package com.elitecore.elitesm.hibernate.servermgr.service;
...
public class HServiceDataManager extends HBaseDataManager implements NetServiceDataManager {
     ...
     * @throws  DataManagerException
     */
    public List<NetServiceInstanceData> getNetserviceInstanceList( String netServerId ) throws DataManagerException {
    ...
    public void deleteNetServiceInstance( String netServiceId ) throws DataManagerException {
        ...
        try {
			...
			cve.printStackTrace();
			throw new DataManagerException("Failed to delete Net Service Instance, Reason: "+ EliteExceptionUtils.extractConstraintName(cve.getSQLException()), cve);
		} catch (HibernateException hExp) {
			hExp.printStackTrace();
			throw new DataManagerException("Failed to delete Net Service Instance, Reason: "+ hExp.getMessage(), hExp);
		} catch (Exception exp) {
			exp.printStackTrace();
			throw new DataManagerException("Failed to delete Net Service Instance, Reason: "+ exp.getMessage(), exp);
		}
    }
    ...
    public NetServiceInstanceData getServiceDetailByServiceNameAndServerInstanceId(String serviceName, String serverInstanceId) throws DataManagerException{
        ...
        try {
            Session session = getSession();
            Criteria criteria = session.createCriteria(NetServiceInstanceData.class).add(Restrictions.eq("name", serviceName)).add(Restrictions.eq("netServerId", serverInstanceId));
            
            netServiceInstanceData = (NetServiceInstanceData)criteria.uniqueResult();
            
            if(netServiceInstanceData == null){
            	throw new DataManagerException(serviceName + "Service not found for given server Instance Id");
            }
           
        }
        catch (HibernateException hExp) {
        	hExp.printStackTrace();
            throw new DataManagerException("Failed to retrive Service data from service name and server instance id, Reason: " + hExp.getMessage(), hExp);
        }catch (Exception exp) {
        	exp.printStackTrace();
        	throw new DataManagerException("Failed to retrive Service data from service name and server instance id, Reason: " + exp.getMessage(), exp);
        }
    ...
    public void deleteNetConfigurationInstance( String configInstanceId ) throws DataManagerException {
        ...
        try {
        	...
        	hExp.printStackTrace();
        	throw new DataManagerException("Failed to delete Net Configuration, Reason: " + hExp.getMessage(), hExp);
        }catch (Exception exp) {
        	exp.printStackTrace();
        	throw new DataManagerException("Failed to delete Net Configuration, Reason: " + exp.getMessage(), exp);
        }
    }
    ...
    public void deleteNetServiceInstanceConfMap( String configIntanceId ) throws DataManagerException {
        ...
        try {
        	...
        	hExp.printStackTrace();
        	throw new DataManagerException("Failed to delete Net Service Instance Configuration Map, Reason: " + hExp.getMessage(), hExp);
        } catch (Exception exp){
        	exp.printStackTrace();
        	throw new DataManagerException("Failed to delete Net Service Instance Configuration Map, Reason: " + exp.getMessage(), exp);
        }
    }
    ...
    public INetServiceInstanceData createServiceInstance( INetServiceInstanceData netServiceInstanceData ) throws DataManagerException {
        try {
			...
			cve.printStackTrace();
			throw new DataManagerException("Failed to add "+ netServiceInstanceData.getName()+ " Service, Reason: "+ EliteExceptionUtils.extractConstraintName(cve.getSQLException()), cve);
		} catch (HibernateException hExp) {
			hExp.printStackTrace();
			throw new DataManagerException("Failed to add "+ netServiceInstanceData.getName() + " Service, Reason: "+ hExp.getMessage(), hExp);
		} catch (Exception exp) {
			exp.printStackTrace();
			throw new DataManagerException("Failed to add "+ netServiceInstanceData.getName() + " Service, Reason: "+ exp.getMessage(), exp);
		}
        return netServiceInstanceData;
    }
     ...
     */
    public List<NetConfigurationInstanceData> getNetServiceConfigInstanceList( String netServiceId ) throws DataManagerException {
     ...
     * @purpose This method is generated to give list of ServiceInstnaceConfMapData by using configInstanceId
     */
    public List<NetConfigurationInstanceData> getNetServiceConfigInstanceList( String netServiceId , String netConfigMapTypeId ) throws DataManagerException {
        List<NetConfigurationInstanceData> lstNetServiceConfig = new ArrayList<NetConfigurationInstanceData>();
     ...
     * @throws DataManagerException
     */
    private String getNetConfigurationId( String configInstanceId ) throws DataManagerException {
    ...
    private String getNetServiceName( String netServiceId ) throws DataManagerException {
        String strNetServiceName = null;
        try {
            Session session = getSession();
    ...
    public INetServiceTypeData getNetServiceType( String serviceTypeId ) throws DataManagerException {
        ...
        try {
			...
			throw new DataManagerException("Failed to retrive " + serviceTypeId + " Reason:" + hExp.getMessage(), hExp);
        } catch (Exception exp) {
			throw new DataManagerException("Failed to retrive " + serviceTypeId + " Reason:" + exp.getMessage(), exp);
        }
    ...
    public List<INetConfigurationValuesData> getNetConfigParameterValueList( String configInstanceId , String parameterId ) throws DataManagerException {
    ...
    public void deleteNetConfValuesData( List lstValueData ) throws DataManagerException {
        try {
        	...
        	hExp.printStackTrace();
        	throw new DataManagerException("Failed to delete Net Service Configuration Value Data, Reason: " + hExp.getMessage(), hExp);
        }catch (Exception exp) {
        	exp.printStackTrace();
        	throw new DataManagerException("Failed to delete Net Service Configuration Value Data, Reason: " + exp.getMessage(), exp);
        }
    ...
    private INetServerVersionData getCompatibleVersion( String netServerInstanceId ) throws DataManagerException {
	...
	public List<INetConfigurationParameterData> getNetConfigParameterDataList( INetServiceInstanceData netServiceInstanceData, String alias) throws DataManagerException {
		 List<INetConfigurationParameterData> netConfigurationParameterDataList = null;
	        try {
	            Session session = getSession();
	            
	            /* Getting ServerVersion Instance to get server version */
	            Criteria  criteria = session.createCriteria(NetServerInstanceData.class);
	            criteria.add(Restrictions.eq("netServerId",netServiceInstanceData.getNetServerId()));
	            NetServerInstanceData netServerInstanceData = (NetServerInstanceData) criteria.uniqueResult();
	            ...
	            /* Get All the ServiceConfigMapData for Service Type*/
	            criteria = session.createCriteria(NetServiceConfigMapData.class);
	            criteria.add(Restrictions.eq("netServiceTypeId",netServiceInstanceData.getNetServiceTypeId()));
	            List<NetServiceConfigMapData> lstServiceConfigMapData = criteria.list();
	            ...
	            for ( String configId : lstServiceConfigMapWithVersionFilter ) {
	                ...
	                netConfigurationParameterDataList = (List<INetConfigurationParameterData>) criteria.list();
	            }
	        }
	        catch(DataManagerException e) {
	            throw e;
	        ...
	        return netConfigurationParameterDataList;
	}
	...
	public String getNetServiceTypeIdByName(String serviceName) throws DataManagerException {
		  String strNetServiceName = null;
	        try {
	            Session session = getSession();
	            Criteria criteria = session.createCriteria(NetServiceTypeData.class).add(Restrictions.eq("name", serviceName));
	            NetServiceTypeData netServiceInstanceData = (NetServiceTypeData) criteria.uniqueResult();
	            strNetServiceName = netServiceInstanceData.getNetServiceTypeId();
	        }
	        catch (HibernateException hExp) {
	            throw new DataManagerException(hExp.getMessage(), hExp);
	        }
	...
	public String getConfigIdByServiceTypeId(String serviceTypeId) throws DataManagerException  {
		NetServiceConfigMapData serviceConfigMap = null;
		try {
			Session session  = getSession();
			Criteria criteria = session.createCriteria(NetServiceConfigMapData.class).add(Restrictions.eq("netServiceTypeId", serviceTypeId));
			serviceConfigMap = (NetServiceConfigMapData) criteria.uniqueResult();
			if (serviceConfigMap == null) {
				throw new DataManagerException("Net service config map data not found.");
			}
		} catch (HibernateException hExp) {
			hExp.printStackTrace();
			throw new DataManagerException("Failed to get Config Id, Reason: " + hExp.getMessage(), hExp);
		}
		catch (Exception exp) {
			exp.printStackTrace();
			throw new DataManagerException("Failed to get Config Id, Reason: " + exp.getMessage(), exp);
		}
		return serviceConfigMap.getNetConfigId();
}
}
