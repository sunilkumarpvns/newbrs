package com.elitecore.elitesm.datamanager.servermgr.server;
...
public interface NetServerDataManager extends DataManager{
     ...
     */
    public INetServerInstanceData getNetServerInstance(String  netServetInstanceId) throws DataManagerException;
     ...
     */
    public List<INetServerInstanceConfMapData> getNetServerInstanceConfMap(String netServerId) throws DataManagerException;
     ...
     * @return  Returns List
     * @purpose This method is generated to update staus (show/hide).
     */
	...
	public String getNetServerIdByName(String netServerTypeName)throws DataManagerException;
	...
	public String getServiceTypeAliasNameFromServiceTypeId(String serverTypeId) throws DataManagerException;
