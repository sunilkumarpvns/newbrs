...
public class NASPolicyAcctPluginConfig extends BaseData implements  Serializable,Differentiable{

	private static final long serialVersionUID = 1L;
	private String policyConfId;
	private String nasPolicyId;
	
	@NotEmpty(message = "Plugin name must be specified in accouting")
