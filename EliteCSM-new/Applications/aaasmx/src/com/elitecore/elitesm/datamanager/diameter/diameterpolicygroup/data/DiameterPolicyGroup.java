package com.elitecore.elitesm.datamanager.diameter.diameterpolicygroup.data;
...
@XmlRootElement(name="diameter-policy-group")
@XmlType(propOrder = { "policyName", "expression" })
public class DiameterPolicyGroup extends BaseData implements Differentiable {
	
	@NotEmpty(message="Diameter Policy Group Name must be specified")
