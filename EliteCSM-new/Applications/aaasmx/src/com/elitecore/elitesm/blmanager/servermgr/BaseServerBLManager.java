 ...
 * ModualName com.elitecore.elitesm.blmanager.servermgr                                      
 * Created on Mar 15, 2008
 * Last Modified on                                     
 * @author :  kaushikvira
 */
package com.elitecore.elitesm.blmanager.servermgr;
...
public abstract class BaseServerBLManager extends BaseBLManager{
    ...
    protected List<INetConfigurationValuesData> generateInstanceId( String netConfigurationInstanceId , String netConfigId , IDataManagerSession session ) throws DataManagerException {
    ...
    private void generateInstanceIdRev( INetConfigurationParameterData configParamData , List<INetConfigurationValuesData> lstConfigParameterValue , String configurationInstanceId , String oldInstanceId, String newInstanceId ) {
        int indexCount = 0;
        for ( INetConfigurationValuesData netConfigurationValuesData : configParamData.getNetConfigParamValues() ) {
            
            if(netConfigurationValuesData.getConfigInstanceId().equals(configurationInstanceId)
    ...
    protected List<INetConfigurationValuesData> getRecursiveNetConfigurationParameterValues( INetConfigurationParameterData netConfParamData , String configInstanceId , List<INetConfigurationValuesData> lstParameters ) throws DataValidationException {
    ...
    protected byte[] createOutputStream(INetConfigurationData netConfigurationData, String instanceId)throws DataManagerException{
    ...
    protected Document generateXMLParseNode(INetConfigurationParameterData netConfigRootData, Document xmlDoc, Element rootNode, String configInstanceId, String rootInstanceId)throws DataManagerException{
            ...
            if(netConfigRootData.getNetConfigParamValues() != null && netConfigRootData.getNetConfigParamValues().size() > 0 && netConfigRootData.getNetConfigChildParameters() != null){
                ...
                while(itrChildIterator.hasNext()){
                    ...
                    while(itrChildValueIterator.hasNext()){
                        ...
                        if(netChildValueData.getConfigInstanceId().equals(configInstanceId) && 
	...
	protected INetConfigurationParameterData generateDataObjectParseNode(INetConfigurationParameterData configParamData, Node currentNode, String configInstanceId, String instanceId) throws DataManagerException {
    ...
    public PluginDataManager getPluginDataManager(IDataManagerSession session) {
        return   (PluginDataManager) DataManagerFactory.getInstance().getDataManager(PluginDataManager.class, session);
