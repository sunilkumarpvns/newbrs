...
public class MiscDictionaryAction extends BaseDictionaryAction {
    
	private static final String SUCCESS_FORWARD = "success";
    private static final String LIST_FORWARD    = "listDictionary";
    private static final String FAILURE_FORWARD = "failure";
    private static final String ACTION_ALIAS = ConfigConstant.CHANGE_DICTIONARY_STATUS_ACTION;
	private static final String ACTION_ALIAS_DELETE = ConfigConstant.DELETE_DICTIONARY_ACTION;
	private static final String DOWNLOAD_DICTIONARY=ConfigConstant.DOWNLOAD_DICTIONARY;
    			...
    			if (lstForm.getAction() != null) {
    				...
    				if (strSelectedIds != null) {
    					...
    					if (lstForm.getAction().equalsIgnoreCase("download")) {
    						...
    						downloadAsXml(request, response, (IDictionaryData) lstDictionaries.get(0));
    						doAuditing(staffData, DOWNLOAD_DICTIONARY);
    						...
    						ActionMessage message = new ActionMessage("radius.dictionary.delete.success");
    ...
    private void downloadAsXml( HttpServletRequest request ,
    	...
    	try{
    		...
    		RadiusDictionaryBLManager dictionaryBLManger = new RadiusDictionaryBLManager();
