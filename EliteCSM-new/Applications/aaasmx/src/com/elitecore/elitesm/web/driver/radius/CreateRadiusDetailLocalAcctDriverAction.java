...
import com.elitecore.elitesm.web.driver.radius.forms.CreateRadiusDetailLocalAcctDriverForm;
import com.elitecore.passwordutil.PasswordEncryption;

public class CreateRadiusDetailLocalAcctDriverAction extends BaseWebAction{

	private static final String SUCCESS_FORWARD = "success";
	private static final String FAILURE_FORWARD = "failure";
	private static final String ACTION_ALIAS = ConfigConstant.CREATE_DRIVER;
	private static final String MODULE = CreateRadiusDetailLocalAcctDriverAction.class.getSimpleName();
	private static final String CREATE = "cRadiusDetailLocalAcctDriver";
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		try{
			...
			CreateRadiusDetailLocalAcctDriverForm detailLocalDriverForm = (CreateRadiusDetailLocalAcctDriverForm)form;
	...
	private void convertFromFormToBean(CreateRadiusDetailLocalAcctDriverForm detailLocalDriverForm,DetailLocalAcctDriverData detailLocalDriverData,DriverInstanceData driverInstanceData) {
