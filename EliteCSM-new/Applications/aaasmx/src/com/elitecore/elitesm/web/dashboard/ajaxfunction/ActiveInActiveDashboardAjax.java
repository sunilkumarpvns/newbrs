 ...
 */
public class ActiveInActiveDashboardAjax extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String MODULE="CheckPasswordValidity";

   
    public ActiveInActiveDashboardAjax() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if(isActive != null && dashboardId != null){
				...
				//blManager.makeActiveInActive(isActive,Long.parseLong(dashboardId));
			}
		}catch(Exception e){
