 ...
 *
 */
public class CreateRadiusTransactionLoggerAction extends BaseWebAction{

	private static final String ACTION_ALIAS = ConfigConstant.CREATE_PLUGIN;
	private static final String MODULE = CreateRadiusTransactionLoggerAction.class.getSimpleName();
	private static final String CREATE_FORWARD = "radiusTransactionLogger";
