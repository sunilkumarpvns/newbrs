 ...
 * FileName   ViewNetServerLogReportSummaryAction.java                            
 * ModualName Server                                      
 ...
 *
 */
public class ViewNetServerLogReportSummaryAction extends BaseDictionaryAction {
    
    private static final String MODULE          = "VIEW LOGREPORT SUMMARY";
    
    private static final String VIEW_FORWARD    = "viewLogReportSummary";
    ...
    public ActionForward execute( ActionMapping mapping , ActionForm form , HttpServletRequest request , HttpServletResponse response ) throws Exception {
        ...
        try {
            ...
            Map resultMap = (HashMap) remoteCommunicationManager.execute("Elitecore:type=EliteAdmin", "getSummaryLoginAttemptsReport", objArgValues, strArgTypes);
            ...
            LogManager.getLogger().debug(MODULE,resultMap.toString());
            ...
            ActionMessage message = new ActionMessage("servermgr.server.view.logreport.failure","Summary");
