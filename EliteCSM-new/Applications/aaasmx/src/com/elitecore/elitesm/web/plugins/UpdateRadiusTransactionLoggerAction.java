 ...
 *
 */
public class UpdateRadiusTransactionLoggerAction extends BaseWebAction{

	private static final String UPDATE_ACTION_ALIAS = ConfigConstant.UPDATE_PLUGIN;
	private static final String MODULE = UpdateRadiusTransactionLoggerAction.class.getSimpleName();
	private static final String VIEW_ACTION_ALIAS = ConfigConstant.VIEW_PLUGIN;
	private static final String OPEN_FORWARD = "radiusTransactionLogger";
