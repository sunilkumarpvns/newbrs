...
public class SignalServiceReloadCacheAction extends BaseDictionaryAction{
	private static final String SUCCESS_FORWARD = "success";
	private static final String FAILURE_FORWARD = "failure";
	private static final String MODULE = "SERVICE RELOAD CACHE ACTION";
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		try {
			...
			if(netServerId != null && netServiceName != null && netServiceInstance != null ){
				...
				mbeanServerConnection.invoke(objName,"reloadServiceCache",argValue,argType);
				jmxConnector.close();*/
				...
				remoteCommunicationManager.execute("Elitecore:type=EliteAdmin","reloadServiceCache",argValue,argType);
