...
import com.elitecore.elitesm.web.plugins.forms.CreateUniversalAcctPluginForm;

/**
 * @author nayana.rathod
 *
 */
public class CreateUniversalAcctPluginAction extends BaseWebAction{

	private static final String ACTION_ALIAS = ConfigConstant.CREATE_PLUGIN;
	private static final String MODULE = CreateUniversalAcctPluginAction.class.getSimpleName();
	private static final String CREATE_FORWARD = "cUniversalAcctPlugin";
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		try{
			...
			CreateUniversalAcctPluginForm createUniversalAcctPluginForm = (CreateUniversalAcctPluginForm)form;
			...
			if("create".equals(createUniversalAcctPluginForm.getAction())){
				try{
					IStaffData staffData = getStaffObject(((SystemLoginForm)request.getSession().getAttribute("radiusLoginForm")));
					
					String universalPluginPolicyJSON=createUniversalAcctPluginForm.getUniversalPluginPolicyJson();
					...
					convertFromFormToData(createUniversalAcctPluginForm,pluginInstData);
				...
				if(createUniversalAcctPluginForm.getPluginType() == null || createUniversalAcctPluginForm.getPluginName() == null || createUniversalAcctPluginForm.getDescription() == null){
					createUniversalAcctPluginForm.setPluginName((String)request.getAttribute("name"));
					createUniversalAcctPluginForm.setDescription((String)request.getAttribute("description"));
					String pluginTypeId =(String)request.getAttribute("pluginTypeId");
					createUniversalAcctPluginForm.setPluginType(pluginTypeId.toString());
					createUniversalAcctPluginForm.setStatus((String)request.getAttribute("status"));	
				}
	...
	private void convertFromFormToData( CreateUniversalAcctPluginForm createUniversalAcctPluginForm, PluginInstData pluginInstData) {
		pluginInstData.setName(createUniversalAcctPluginForm.getPluginName());
		pluginInstData.setDescription(createUniversalAcctPluginForm.getDescription());
		pluginInstData.setPluginTypeId(createUniversalAcctPluginForm.getPluginType());		
		pluginInstData.setCreateDate(getCurrentTimeStemp());
		
		if(BaseConstant.SHOW_STATUS.equals(createUniversalAcctPluginForm.getStatus())){
