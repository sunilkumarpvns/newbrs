...
public class CreateRadiusDBAcctDriverForm extends BaseWebForm{
	
	private Long openDbAcctId;	
	private String databaseId;
	private String datasourceType;
	//private Long datasourceScantime = 2L;
	private String cdrTablename = "tblradiuscdr";
	private String interimTablename="tblradiusinterimcdr";
	...
	public List<DBAcctFeildMapData> getDefaultmapping(){
		...
		String[] dbFiledList ={"USER_NAME","CALLING_STATION_ID","NAS_IP_ADDRESS","NAS_IDENTIFIER","NAS_PORT","NAS_PORT_ID"
				,"ACCT_SESSION_ID","ACCT_MULTI_SESSION_ID","ACCT_STATUS_TYPE","ACCT_SESSION_TIME","ACCT_INPUT_OCTETS"
				,"ACCT_OUTPUT_OCTETS","ACCT_INPUT_GIGAWORDS","ACCT_OUTPUT_GIGAWORDS","ACCT_INPUT_PACKETS","ACCT_OUTPUT_PACKETS"
				,"ACCT_DELAY_TIME","EVENT_TIMESTAMP"};	
