...
import com.elitecore.elitesm.web.servermgr.server.forms.CacheDetailBean;
import com.elitecore.elitesm.web.servermgr.server.forms.ViewReloadCacheDetailsForm;
import com.elitecore.passwordutil.PasswordEncryption;

public class ViewReloadCacheDetailsAction  extends BaseDictionaryAction{
        ...
        try {
           // checkActionPermission(request,SUB_MODULE_ACTIONALIAS);
            ...
            if(netServerId != null){
                ...
                List<Map> cacheDetailsList=(List<Map>) remoteCommunicationManager.execute(MBeanConstants.CONFIGURATION,"retriveReloadedCacheDetails",null,null);
