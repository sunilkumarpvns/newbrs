...
public class UpdateEAPPolicyBasicDetailAction  extends BaseWebAction{
	private static final String ACTION_ALIAS = ConfigConstant.UPDATE_DIAMETER_EAP_POLICY;
	private static final String UPDATE_BASIC_DETAILS = "updateEAPPolicyBasicDetail";
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,HttpServletResponse response){
		try{
			...
			if("update".equals(updateEAPPolicyForm.getAction())){
				...
				eapPolicyData.setDefaultResponseBehaviorArgument(updateEAPPolicyForm.getDefaultResponseBehaviorArgument());
				eapPolicyData.setDefaultResponseBehaviour(updateEAPPolicyForm.getDefaultResponseBehavior());
				...
				/*Update in DataBase*/
				blManager.updateBasicDetails(eapPolicyData, staffData, ACTION_ALIAS);
				...
				return mapping.findForward(UPDATE_BASIC_DETAILS);
			}
	...
	private void convertBeanToForm(EAPPolicyData eapPolicyData, UpdateEAPPolicyForm updateEAPPolicyForm){
		...
		updateEAPPolicyForm.setDescription(eapPolicyData.getDescription());
		updateEAPPolicyForm.setRuleSet(eapPolicyData.getRuleSet());
		updateEAPPolicyForm.setSessionManagement(eapPolicyData.getSessionManagement());
		updateEAPPolicyForm.setRequestType(eapPolicyData.getRequestType());
		updateEAPPolicyForm.setAuditUId(eapPolicyData.getAuditUId());
		updateEAPPolicyForm.setDefaultResponseBehaviorArgument(eapPolicyData.getDefaultResponseBehaviorArgument());
		updateEAPPolicyForm.setDefaultResponseBehavior(eapPolicyData.getDefaultResponseBehaviour());
	}
	...
	private void convertFormToBean(UpdateEAPPolicyForm updateEAPPolicyForm, EAPPolicyData eapPolicyData){
		...
		eapPolicyData.setDescription(updateEAPPolicyForm.getDescription());
		eapPolicyData.setRuleSet(updateEAPPolicyForm.getRuleSet());
		eapPolicyData.setSessionManagement(updateEAPPolicyForm.getSessionManagement());
		eapPolicyData.setRequestType(updateEAPPolicyForm.getRequestType());
