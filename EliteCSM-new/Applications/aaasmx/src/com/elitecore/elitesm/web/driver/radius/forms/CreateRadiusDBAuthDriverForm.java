...
public class CreateRadiusDBAuthDriverForm extends BaseWebForm{
	...
	public List<DBAuthFieldMapData> getDefaultmapping(){
		...
		String[] fieldMap = {"USERNAME","CUI","PASSWORD","PASSWORDCHECK","ENCRYPTIONTYPE","CUSTOMERSTATUS","CALLINGSTATIONID","RADIUSPOLICY"
