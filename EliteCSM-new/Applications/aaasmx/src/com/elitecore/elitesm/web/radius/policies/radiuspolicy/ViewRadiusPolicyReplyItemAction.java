...
import com.elitecore.elitesm.web.radius.policies.radiuspolicy.forms.ViewRadiusPolicyReplyItemForm;

public class ViewRadiusPolicyReplyItemAction extends BaseDictionaryAction{
	private static final String SUCCESS_FORWARD = "success";	
	private static final String VIEW_FORWARD = "viewRadiusPolicyItems";	
	private static final String FAILURE_FORWARD = "failure";
	private static final String strViewReplyItems = "viewReplyItems";
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		if(checkAccess(request, ACTION_ALIAS)){
			...
			ViewRadiusPolicyReplyItemForm viewRadiusPolicyReplyItemForm = (ViewRadiusPolicyReplyItemForm)form;
			...
			try{
				...
				if(Strings.isNullOrBlank(radiusPolicyId) == false){
					...
					viewRadiusPolicyReplyItemForm.setStatus(radiusPolicyData.getCommonStatusId());
					viewRadiusPolicyReplyItemForm.setReplyItem(radiusPolicyData.getReplyItem());
					request.setAttribute("action",strViewReplyItems);
					request.setAttribute("replyItem",radiusPolicyData.getReplyItem());
					return mapping.findForward(VIEW_FORWARD);
				}
				else
				{
	               	Logger.logTrace(MODULE, "  ViewRadiusPolicyReplyItem: radiusPolicyId = "+radiusPolicyId);
