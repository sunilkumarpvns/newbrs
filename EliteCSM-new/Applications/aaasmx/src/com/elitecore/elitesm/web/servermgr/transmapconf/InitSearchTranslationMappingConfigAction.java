...
public class InitSearchTranslationMappingConfigAction extends BaseWebAction{

	private static final String SUCCESS_FORWARD = "searchtranslationmappingconf";
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		try{
			...
			SearchTranslationMappingConfigForm configForm = (SearchTranslationMappingConfigForm)form;
