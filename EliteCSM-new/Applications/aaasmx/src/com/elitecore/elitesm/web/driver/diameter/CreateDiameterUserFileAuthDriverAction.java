...
import com.elitecore.elitesm.web.driver.diameter.forms.CreateDiameterUserFileAuthDriverForm;

public class CreateDiameterUserFileAuthDriverAction extends BaseWebAction{
	...
	private static final String MODULE = CreateDiameterUserFileAuthDriverAction.class.getSimpleName();
	private static final String CREATE = "cDiameterUserFileAuthDriver";
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		try{
			...
			CreateDiameterUserFileAuthDriverForm driverForm = (CreateDiameterUserFileAuthDriverForm)form;
	...
	private void convertFromFormToData(CreateDiameterUserFileAuthDriverForm driverForm,UserFileAuthDriverData userfileDriverData,DriverInstanceData driverInstance) {
