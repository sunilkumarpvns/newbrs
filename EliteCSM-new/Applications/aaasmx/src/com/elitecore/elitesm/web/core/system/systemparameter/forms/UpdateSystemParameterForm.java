package com.elitecore.elitesm.web.core.system.systemparameter.forms;
...
public class UpdateSystemParameterForm extends BaseWebForm{
	...
	private String maxHistoricalPassword;
	...
	public void setParameterId(int index,String parameterId) {
		...
		((SystemParameterData)lstParameterValue.get(index)).setParameterId(parameterId);
	}
	...
	public void setPasswordSelectionConfigData(
			PasswordPolicyConfigData passwordSelectionConfigData) {
	...
	public String getMaxHistoricalPassword() {
		return maxHistoricalPassword;
	}
	public void setMaxHistoricalPassword(String maxHistoricalPassword) {
		this.maxHistoricalPassword = maxHistoricalPassword;
	}
}
