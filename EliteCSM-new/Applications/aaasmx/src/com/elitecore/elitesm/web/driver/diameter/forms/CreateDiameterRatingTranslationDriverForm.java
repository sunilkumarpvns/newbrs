...
public class CreateDiameterRatingTranslationDriverForm extends BaseWebForm{
	...
	private List<RatingDriverPropsData> defaultRatingDriverPropsDataList;
	...
	public List<RatingDriverPropsData> getDefaultRatingDriverPropsDataList() {
		return defaultRatingDriverPropsDataList;
	}
	public void setDefaultRatingDriverPropsDataList(
			List<RatingDriverPropsData> defaultRatingDriverPropsDataList) {
		this.defaultRatingDriverPropsDataList = defaultRatingDriverPropsDataList;
	}
