...
public class ViewEAPPolicyDetailsAction extends BaseWebAction {
	private static final String VIEW_FORWARD = "viewEAPPolicyDetails";
			...
			try{
				...
				if( Strings.isNullOrBlank(eapPolicyId) == false){
					...
					if( eapPolicyInstData.getAdditionalDiameterConcurrency() != null ){
						additionalDiameterConcurrencyData = blManager.getDiameterConcurrencyDataById(eapPolicyInstData.getAdditionalDiameterConcurrency().toString());
					}
