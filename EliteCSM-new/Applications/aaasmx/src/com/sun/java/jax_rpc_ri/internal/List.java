...
public class List  implements java.io.Serializable {
    ...
    /**
     * Gets the collection value for this List.
     * 
     * @return collection
     */
    ...
    /**
     * Sets the collection value for this List.
     * 
     * @param collection
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://java.sun.com/jax-rpc-ri/internal", "list"));
    }
