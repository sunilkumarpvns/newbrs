...
(function (d) {
    d.widget("ui.menu", {
        _create: function () {
            var e = this;
            this.element.addClass("ui-menu ui-widget ui-corner-all").attr({
                role: "listbox",
    ...
    d.widget("ui.tabs", {
        ...
        _tabify: function (b) {
            ...
            this.anchors.each(function (g, f) {
                ...
                if (h.test(i)) a.panels = a.panels.add(a.element.find(a._sanitizeSelector(i)));
                    ...
                    f = a.element.find("#" + i);
                    if (!f.length) {
                        f = d(c.panelTemplate).attr("id", i).addClass("ui-tabs-panel ui-corner-bottom").insertAfter(a.panels[g - 1] || a.list);
            ...
            if (b) {
                ...
                this.panels.addClass("ui-tabs-panel  ui-corner-bottom");
                if (c.selected === p) {
        ...
        destroy: function () {
            ...
            this.lis.unbind(".tabs").add(this.panels).each(function () {
                d.data(this, "destroy.tabs") ? d(this).remove() : d(this).removeClass("ui-state-default ui-corner-top ui-tabs-selected ui-state-active ui-state-hover ui-state-focus ui-state-disabled ui-tabs-panel ui-corner-bottom ui-tabs-hide")
            });
