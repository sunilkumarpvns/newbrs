...
//	email :	fuushikaden@yahoo.com
	...
	var	img	= new Array()
	var maxYear=yearNow+2; //required to restrict the upper limit of the year
	var minYear=yearNow-100; //required to restrict the lower limit of the year
    ...
    */
	...
	// ORGINAL ARRAY var	monthName2 = new Array("Jan,","Feb,","Mar,","Apr,","May,","Jun,","Jul,","Aug,","Sep,","Oct,","Nov,","Dec,") 
	...
	function incYear() {
		//remove the if condition in order to remove the restriction of limited years
		//if(nStartingYear<maxYear)
		//{
			for	(i=0; i<7; i++){
	...
	function jsPopUpCalendar(ctl,	ctl2, datestyle) {
		var	leftpos=0
		var	toppos=0
		if (datestyle=="")
		{
...
*/
		...
		{
			init()
			jsPopUpCalendar(ctl,	ctl2, format)
		}
	}
	...
	function setContextPathForImageDir(contextPath)
	{
			requestContextPath = contextPath;
			imgDir = requestContextPath + imgDir;
			if (dom)
			{
				...
				document.write ("<div onclick='bShow=true' id='calendar' class='div-style'><table width="+((showWeekNumber==1)?250:220)+" cellspacing='0' cellpadding='0' class='table-style'><tr class='title-background-style' ><td><table cellspacing='0' cellpadding='0'  width='"+((showWeekNumber==1)?248:218)+"'><tr height='24'><td class='title-style'><B><span id='caption'></span></B></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' BORDER='0' ALT='Close the Calendar'></a></td></tr></table></td></tr><tr><td class='body-style'><span id='content'></span></td></tr>")
