            ...
            var s = $(r),
                ...
                f = {
                        ...
                        for (var t = 0; t < f.files.length; t++) {
                            var x = f.files[t].name.split(".").pop().toLowerCase(),
                                ...
                                m = {
                                    ...
                                    lastModifiedDate :  f._assets.convertDateToStringFormat(file.lastModifiedDate),
                                    type: file.type,
                                    ext: x
                                };
                        ...
                        create: function(i) {
                            var file = f.files[i],
                                ...
                                opts = {
                                    ...
                                    lastModifiedDate : f._assets.convertDateToStringFormat(lastModifiedDate),
                                    type: type,
                                    extension: ext,
                    ...
                    _upload: function(i) {
                        ...
                        formData.append("lastModified",f._itFc.file.lastModified);
                    ...
                    _assets: {
                        ...
                        text2Color: function(str) {
                            ...
                            return colour;
                        },convertDateToStringFormat : function(str){
                        	var str =  dateFormat(str, "mm/dd/yyyy, h:MM:ss TT");
                        	return str;
                        }
                    },
