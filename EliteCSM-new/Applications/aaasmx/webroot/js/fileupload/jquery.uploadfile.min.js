...
! function(e) {
    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        var w = e.extend({
            ...
            dragDropStr: "<span><b>Or Drag & Drop Groovy Files</b></span>",
            uploadStr: "Upload",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
        ...
        e(b).addClass(w.uploadButtonClass),
            function F() {
                if (e.fn.ajaxForm) {
                    if (w.dragDrop) {
                        var a = e('<div class="' + w.dragDropContainerClass + '" style="vertical-align:top;background-color:white;height:150px;"></div>').width(w.dragdropWidth);
