	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="searchTextBox" placeholder="search here.."/>') :
			  sSearchStr==="" ? '<input type="text" class="searchTextBox" placeholder="search here.."/>' : sSearchStr+' <input type="text" class="searchTextBox" placeholder="search here.."/>';
			...
			if ( !oSettings.aanFeatures.f )
			{
				...
				$("#"+nFilter.id).css("text-align", "center");
			}
