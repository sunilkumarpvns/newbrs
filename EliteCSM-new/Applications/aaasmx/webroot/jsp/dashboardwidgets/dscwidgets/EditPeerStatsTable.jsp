	...
	<td align="left">
		<!-- <form action="#" method="post" id="d"  > -->
				<table style="width: 100%" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td align="right">
							<label class="dashboardLabel">Peer Host Names :</label>
						</td>
						<td align="left" style="padding-top: 5px;padding-left: 5px;">
					...
					<tr>
						...
						<td align="left" style="padding-left: 5px;">	
							<label class="dashboardHelpTag">
								Specify comma separated peer names or * for all peers
							 </label>	
						</td>
					</tr>
					<tr>
						<td align="right">
							<label class="dashboardLabel">Peer Addresses :</label>
						</td>
						<td align="left" style="padding-top: 5px;padding-left: 5px;">
								<textarea rows="2" cols="40"></textarea>
						</td>
					...
					<tr>
						...
						<td align="left" style="padding-left: 5px;">	
							<label class="dashboardHelpTag">Specify comma separated peer address or peer ranges or peer network address or * for all peers
							</label>	
						</td>
					</tr>
					<tr>
