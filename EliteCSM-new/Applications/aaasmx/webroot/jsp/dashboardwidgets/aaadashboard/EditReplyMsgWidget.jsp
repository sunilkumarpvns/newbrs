...
<script type="text/javascript">
 $('#submitReplyMsg').click(function () {
	 /* alert($(this).find(".widgetcontent").parent().attr('id'));
	 $('#widget1').find(".widgetcontent").load("jsp/dashboardwidgets/aaadashboard/ReplyMsgStatsWidget.jsp"); */
}); 
	...
	<td align="left">
				<table style="width: 100%" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td align="left" style="padding-top: 5px;padding-left: 5px;">
							<input type="text" id="d-fname" name="d-fname" title="To date" class="dashboardTextClass" value="90" placeholder="No of Days">
						</td>
					</tr>
					<tr>
						<td align="right">
					...
					<tr>
						...
						<td align="left" style="padding-left: 10px;padding-top: 10px;">
					            <input class="light-btn" type="submit" value="Save" id="submitReplyMsg">&nbsp;&nbsp;&nbsp;
