...
<% 
    ...
    List<String> lstCipherSuits=(List<String>) request.getAttribute("cipherSuitList");
%>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top" align="right">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td><%@ include file="ViewDiameterPeerProfile.jsp"%>
											</td>
										</tr>
										<tr>
											<td valign="top" align="right"><%@ include
													file="UpdateDiameterPeerProfile.jsp"%>
											</td>
										</tr>
									</table>
								</td>
								<td width="168" class="grey-bkgd" valign="top"><%@ include
										file="DiameterPeerProfileNavigation.jsp"%>
								</td>
							</tr>
						</table>
					</td>
