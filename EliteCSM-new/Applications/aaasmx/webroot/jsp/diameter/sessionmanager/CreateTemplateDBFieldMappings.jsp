...
<%  		
	...
	String  mappingName = request.getParameter("defaultTemplateValue") != null ? request.getParameter("defaultTemplateValue") : StringUtils.EMPTY; 
%>
...
<table style="display:none;" id="dbFieldMappingTemplate<%=index%>">
	<tr>
		...
		<td class="tblrows">
			<select class="dataType" name="dataType<%=index%>" id="dataType<%=index%>" size="1" value="<%=Integer.toString(FieldMapping.STRING_TYPE)%>" style="width: 100%;">
