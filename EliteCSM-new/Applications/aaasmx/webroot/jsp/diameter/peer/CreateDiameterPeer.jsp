...
function customValidate(form)
{
		...
		if(isNull(document.forms[0].name.value)){
			...
			return false;
		}else if(isNaN(Number($("#requestTimeout").val()))){
	...
	function verifyName() {
		...
		isValidName = verifyInstanceName('<%=InstanceTypeConstants.DIAMETER_PEER%>',searchName,'create','','verifyNameDiv');
}

	function verifyHostIdentity() {
		var searchHostIdentity = document.getElementById("hostIdentity").value;
		isValidHostIdentity = verifyHostIdentityName('<%=InstanceTypeConstants.DIAMETER_HOST_IDENTITY%>',searchHostIdentity,'create','','verifyHostIdentityDiv');
	}
	
	function checkRequestTimeOutValue(){
		var requestTimeoutVal=$("#requestTimeout").val();
		var reqTimeout=parseInt(requestTimeoutVal);
		if(reqTimeout != 0 && ((reqTimeout < 1000) || (reqTimeout > 10000) )){
			return false;
		}
		return true;
	}
...
<html:form action="/createDiameterPeer" onsubmit="return customValidate(this);">
	<html:hidden name="createDiameterPeerForm" styleId="action"
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<tr>
									<td class="table-header"><bean:message
											bundle="diameterResources" key="diameterpeer.createpeer" />
									</td>
								</tr>
								<tr>
										...
										<table width="60%" name="c_tblCreateDiameterPeer" id="c_tblCreateDiameterPeer" align="left" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												...
												<td align="left" class="labeltext" valign="top" nowrap="nowrap">
													<html:text name="diameterPeerForm" tabindex="1" styleId="name" property="name" size="30" maxlength="256" onblur="verifyName();" style="width:250px" />
											...
											<tr>
												...
												<td align="left" class="labeltext" valign="top" nowrap="nowrap">
													<html:text name="diameterPeerForm"  styleId="hostIdentity" tabindex="2" onblur="verifyHostIdentity();" property="hostIdentity" size="30" maxlength="256" style="width:250px" />
													<font color="#FF0000"> *</font>
													<div id="verifyHostIdentityDiv" class="labeltext">
													</div>
												</td>
											</tr>
											<tr>
												...
												<td align="left" class="labeltext" valign="top" nowrap="nowrap">
													<html:text name="diameterPeerForm" tabindex="3" styleId="realmName" property="realmName" size="30" maxlength="256" style="width:250px" />
													<font color="#FF0000"> *</font>
												</td>
											</tr>
											<tr>
												...
												<td align="left" class="labeltext" valign="top" nowrap="nowrap">
													<html:text name="diameterPeerForm" tabindex="4" styleId="remoteAddress" property="remoteAddress" size="30" maxlength="100" style="width:250px" />
												</td>
											</tr>
											<tr>
												<td align="left" class="labeltext" valign="top" width="25%">
												...
												<td align="left" class="labeltext" valign="top" nowrap="nowrap">
													<html:text name="diameterPeerForm" tabindex="5" styleId="localAddress" property="localAddress" size="30" maxlength="100" style="width:250px" />
												</td>
											</tr>
											<tr>
												<td align="left" class="labeltext" valign="top" width="25%">
											...
											<tr>
												...
												<td align="left" class="labeltext" valign="top" nowrap="nowrap">
													...
													<html:select name="diameterPeerForm" tabindex="10" styleId="peerProfileId" property="peerProfileId" size="1"  style="min-width:120px;">
														...
														<html:options collection="profileList" property="peerProfileId" labelProperty="profileName" />
													</html:select> 
													<font color="#FF0000"> *</font>
												</td>
											</tr>
											...
											<tr>
												...
												<td class="btns-td" valign="middle" colspan="2">
													<!--   <input type="submit" name="c_btnCreate"  value="  Create  "  class="light-btn">&nbsp;&nbsp;  -->
													<html:submit styleClass="light-btn" tabindex="11" value="  Create  "></html:submit>&nbsp;&nbsp; 
													<input type="button" name="c_btnCancelPeer" tabindex="12" onclick="javascript:location.href='initSearchDiameterPeer.do'" value="  Cancel  " class="light-btn">
												</td>
											</tr>
										</table>
									</td>
