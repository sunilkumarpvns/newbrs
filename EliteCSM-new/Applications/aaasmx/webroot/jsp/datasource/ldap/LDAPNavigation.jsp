...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	String viewLDAPDSHistory         = navigationBasePath+"/viewLDAPDSHistory.do?ldapDsId="+ldapDatasourceData1.getLdapDsId()+"&auditUid="+ldapDatasourceData1.getAuditUId()+"&name="+ldapDatasourceData1.getName();
				...
				<tr valign="top">
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="subLinks"><a href="<%=updateLDAPDS%>"><bean:message
												bundle="datasourceResources" key="ldap.update.ldap" /></a></td>
								</tr>
							</table>
						</div>
					</td>
				...
				<tr valign="top">
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="subLinks"><a href="<%=viewLDAPDS%>"><bean:message
												bundle="datasourceResources" key="ldap.view.ldap" /></a></td>
								</tr>
							</table>
						</div>
					</td>
