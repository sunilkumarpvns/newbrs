			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td width="96%" lign="left" class="tbl-header-bold" valign="top">
						<input type="text" id="broadcastHandlerName<%=widgetId%>" name="handlerName" class="handler-name-txt" size="25" value="<bean:message bundle="servicePolicyProperties" key="servicepolicy.proxypolicy.broadcastcommunication" />" onkeyup="expand(this);" onload="expand(this);" disabled="disabled"/>
					</td>
					<td width="1%" align="left" valign="middle" class="tbl-header-bold" style="padding-right: 2px;line-height: 9px;">
						<div class="switch">
						  <input id="toggle-broadcasthandler_<%=widgetId%>" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" disabled="disabled"/>
...
<table id="broadcastCommunicationTemplate_<%=widgetId%>" style="display: none">
	<tr class="proxy-row">
		<td class='proxy-table-firstcol' width="15.34%" valign="middle">
			<input class="ruleset" type="text" name="ruleset" style="width: 150px;" maxlength="2000" disabled="disabled"/>
		</td>
				...
				<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="broadcastServer" class="box broadcastServer">
			    	...
			    	<tr class="esi-data">
						<td align="left" class="labeltext" valign="top" width="55%" id="tbl_attrid">
							...
							<input type="hidden" name="oNumber" value="1" disabled="disabled"/>
						</td>
