...
<script type="text/javascript">
	...
	function removeData(componentId,checkboxid,currentObj){
		...
		$(id).each(function(){
			 ...
			 var rowid="#addDriver"+widgetId +" #row"+checkboxid+strippedVal;
			 var cacheRowId="#addCacheDriver"+widgetId+" #cacherow"+"driverDataRadioId"+widgetId+strippedVal;
		     var addtionalId ="#additionalDriver"+widgetId+" #additionalrow"+"additionalDriverCheckBoxId"+widgetId+strippedVal; 
	...
	function removeCacheData(componentId,checkboxid,currentObj){
		 ...
		 $(id).each(function(){
			 var mainValue = $(this).attr('id');
			 var strippedVal = mainValue;
		     var rowid="#addCacheDriver"+widgetId+" #cacherow"+checkboxid+strippedVal;
		     var primaryRowId="#addDriver"+widgetId+" #row"+"driverDataCheckBoxId"+widgetId+strippedVal;
		     var addtionalId = "#additionalDriver"+widgetId+" #additionalrow"+"additionalDriverCheckBoxId"+widgetId+strippedVal;
		     $(rowid).show();
		     $(primaryRowId).show();
		     $(addtionalId).show();
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td width="96%" align="left" class="tbl-header-bold" valign="top">
									<input type="text" id="handlerName_<%=widgetId%>" name="handlerName" class="handler-name-txt" size="17" value="<bean:message bundle="servicePolicyProperties" key="servicepolicy.proxypolicy.profilelookupdriver" />" onkeyup="expand(this);" onkeypress="keyPressedForHandler(event,this);" onload="expand(this);" disabled="disabled"/>
						...
						<td align="left" class="captiontext" valign="top" style="padding-top:10px;" width="50%">
							<table  width="100%" border="0" style="background-color: white;" cellspacing="0" cellpadding="0">
												...
												<td align="left" class="labeltext" valign="top">
													<table width="100%" cellspacing="0" cellpadding="0" border="0">
														<tr>
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<select class="stripIdentity labeltext" id="stripIdentity" name="stripIdentity" style="width:100px;">
														...
														<tr>
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<input class="separator" type="text" name="separator" id="separator" size="5" maxlength="1" style="width:100px;"/> 
															</td>
														</tr>
														<tr>
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<select id="selectCase" name="selectCase" style="width:100px;" class="selectCase labeltext">
														...
														<tr>
															<td align="left" class="labeltext" valign="top" colspan="2" style="padding-top:5px;">
																<input class="trimUserIdentity" type="checkbox" id="trimUserIdentity" name="trimUserIdentity" value="true"/> 
																<bean:message bundle="servicePolicyProperties" key="servicepolicy.authpolicy.trimuid" />
															</td>
														</tr>
														<tr>
															<td align="left" class="labeltext" valign="top" colspan="2" style="padding-top:5px;">
																<input type="checkbox" id="trimPassword" name="trimPassword" value="true" class="trimPassword"/> 
								...
								<tr>
									...
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;" width="60%">
										<input class="anonymousProfileIdentity" type="text" id="anonymousProfileIdentity" name="anonymousProfileIdentity" size="25" style="width: 250px" maxlength="300"/>
									</td>
								</tr>
							</table>
						</td>
							...
							<table  width="100%" border="0" style="background-color: white;" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="labeltext" valign="top" style="padding-top: 10px;padding-left: 5px;">
										<input class="driverScript scriptInstAutocomplete" type="text" name="driverScript" id="driverScript" size="30" style="width:200px" maxlength="255"/>
									</td>
								</tr>
							</table>
						</td>
