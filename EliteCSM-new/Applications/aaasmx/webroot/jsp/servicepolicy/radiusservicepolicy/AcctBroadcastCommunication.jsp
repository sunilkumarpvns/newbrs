			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td width="96%" lign="left" class="tbl-header-bold" valign="top">
						<input type="text" id="handlerName_<%=widgetId%>" name="handlerName" class="handler-name-txt" size="25" value="<bean:message bundle="servicePolicyProperties" key="servicepolicy.proxypolicy.broadcastcommunication" />" onkeyup="expand(this);" onkeypress="keyPressedForHandler(event,this);" onload="expand(this);" disabled="disabled"/>
					...
					<td width="1%" align="left" class="tbl-header-bold" valign="middle" style="padding-right: 2px;line-height: 9px;">
						<div class="switch">
						  <input id="toggle-acctbroadcasthandler_<%=widgetId%>" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);"/>
					...
					<%-- <td width="1%" style="padding-right: 5px" class="tbl-header-bold" valign="middle">
						<img alt="Copy" title="Copy" class="copy_class"  src="<%=request.getContextPath()%>/images/copy_proxy.png" onclick="copyHandler(this);" height="14" width="14" style="cursor: pointer;"/>
					</td> --%>
					<td width="1%" style="padding-right: 5px" class="tbl-header-bold" valign="middle">
				...
				<table name="tblmBroadcastingComm" width="100%" border="0" style="background-color: white;" class="" cellspacing="0" cellpadding="0">
					<tr>
						<td align="left" class="captiontext left-border right-border" valign="top" id="button" style="padding-top: 10px;">
							<input type="button" onclick="addBroadCastingRow('broadcastCommunicationTemplate_<%=widgetId%>','broadcastCommunicationTbl_<%=widgetId%>',this)" value=" Add Broadcasting Communication " class="light-btn broadcast-com-btn" style="size: 140px" tabindex="3"> 
						</td>
					</tr>
					<tr>
...
<table id="broadcastCommunicationTemplate_<%=widgetId%>" style="display: none">
	<tr>
		<td class='proxy-table-firstcol' width="15.34%" valign="middle">
			<input class="ruleset" type="text" name="ruleset" style="width: 100%;" maxlength="2000"/>
		</td>
