...
<table name="tblmBroadCastCommunication" width="100%" border="0" style="background-color: white;" class="handler-class tblmBroadCastCommunication" cellspacing="0" cellpadding="0">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td width="96%" lign="left" class="tbl-header-bold" valign="top">
						<input type="text" id="acctBroadcastHandlerName<%=widgetId%>" name="handlerName" class="handler-name-txt" size="25" value="<bean:message bundle="servicePolicyProperties" key="servicepolicy.proxypolicy.broadcastcommunication" />" onkeyup="expand(this);" onload="expand(this);" disabled="disabled"/>
					</td>
					<td width="1%" align="left" valign="middle" class="tbl-header-bold" style="padding-right: 2px;line-height: 9px;">
						<div class="switch">
						  <input id="toggle-acctbroadcasthandler_<%=widgetId%>" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" disabled="disabled"/>
	...
	<tr>
		<td>
			<div id="broadcastingCommunicationDiv" class="toggleDivs" style="display: block;">
				<table name="tblmBroadcastingComm" width="100%" border="0" style="background-color: white;" class="" cellspacing="0" cellpadding="0">
					<tr>
						<td align="left" class="captiontext left-border right-border" valign="top" id="button" style="padding-top: 10px;">
							<input type="button" onclick="addBroadCastingRow('broadcastCommunicationTemplate_<%=widgetId%>','broadcastCommunicationTbl_<%=widgetId%>')" value=" Add Broadcasting Communication " class="light-btn proxy-com-btn" style="size: 140px" tabindex="3" disabled="disabled"> 
						</td>
					</tr>
					<tr>
				...
				<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="broadcastServer" class="box broadcastServer">
					<tr>
						<td align="left" class="tblheader-policy" valign="top" width="55%" id="name">
							...
							&nbsp;<span title="Add Server" class="add-proxy-server"></span>
						</td>
