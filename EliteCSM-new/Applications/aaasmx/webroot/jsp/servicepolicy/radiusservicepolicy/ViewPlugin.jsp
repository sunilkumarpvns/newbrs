...
<table name="tblmPlugin" width="100%" border="0" style="background-color: white;" class="handler-class" cellspacing="0" cellpadding="0">
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td width="96%" lign="left" class="tbl-header-bold" valign="top">
									<input type="text" id="pluginHandlerName<%=widgetId%>" name="handlerName" class="handler-name-txt" size="17" value="<bean:message bundle="servicePolicyProperties" key="servicepolicy.proxypolicy.plugin" />" onkeyup="expand(this);" onload="expand(this);" disabled="disabled"/>
								</td>
								<td width="1%" align="left" valign="middle" class="tbl-header-bold" style="padding-right: 2px;line-height: 9px;">
									<div class="switch">
									  <input id="toggle-pluginhandler_<%=widgetId%>" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" disabled="disabled"/>
	...
	<tr>
		<td>
			<div id="pluginDivIds" class="toggleDivs" style="display: block;">
				<table name="tblmPlugin" width="100%" border="0" style="background-color: white;" class="" cellspacing="0" cellpadding="0">
					<tr>
						<td align="left" class="captiontext left-border right-border" valign="top" id="button" style="padding-top: 10px;">
							<input type="button" onclick='addNewPluginRow("pluginTemplate_<%=widgetId%>","mappingtblplugin_<%=widgetId%>");' value=" Add Plugin " class="light-btn" style="size: 140px" tabindex="3" disabled="disabled"> 
						</td>
					</tr>
					<tr>
...
<table id="pluginTemplate_<%=widgetId%>" style="display: none">
	<tr>
		...
		<td class="tblrows" width="23.75%">
			<input type="text" id="pluginName_<%=widgetId%>" name="pluginName" class="noborder plugin" onfocus="setAutoCompleteDataforPlugin(this);" style="width: 100%;" onblur="setPluginData(this);" disabled="disabled"/>
		</td>
			<td class="tblrows" width="23.75%">
			<input type="text" id="pluginArgument_<%=widgetId%>" name="pluginArgument" class="noborder pluginArgument" style="width: 100%;" maxlength="4000" disabled="disabled"/>
		</td>
		<td class="tblrows" width="23.75%">
			<select name="requestType" id="requestType_<%=widgetId%>" class="noborder requestType" style="width:120px" disabled="disabled">
