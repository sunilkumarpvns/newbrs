											...
											<table cellspacing="0" cellpadding="0" border="0" width="100%">
												<tr>
													<td  colspan="4" style="padding-top: 10px;">
														<input type="button" onclick='addAttributeMappingRow("coaDMGenAttribTemplate_<%=widgetId%>","coaDmGeneration_<%=widgetId%>");'  value=" Add Attribute Mapping " class="light-btn" style="size: 140px" tabindex="3"> 
													</td>
