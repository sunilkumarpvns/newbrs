        	...
        	if(key === 'primaryDriverRelDataList'){
        		...
        		$.each(value, function(key1,value1){
        			...
        			$.each(driverListArray, function(driverKey,driverValue){
        				if(driverValue.driverName == value1.driverInstanceId){
        		...
        		$.each(value, function(key1,value1){
        			...
        			var cacheDriverName = '';
        			$.each(driverListArray, function(driverKey,driverValue){
        				if(driverValue.driverName == value1.secondaryDriverInstId){
        					driverName=driverValue.driverName;
        				}
        				if(driverValue.driverName == value1.cacheDriverInstId){
        					cacheDriverName=driverValue.driverName;
        				}
        			});
        			
        			var optionvalue = value1.secondaryDriverInstId +"-"+value1.cacheDriverInstId;
        			if(value1.cacheDriverInstId == 0 && cacheDriverName == ''){
        				cacheDriverName="--None--";
        			}
        			var optionDisplayValue = driverName +"("+cacheDriverName +")";
        			var optionTag = "<option id='"+value1.secondaryDriverInstId+"' value='"+optionvalue+"'>"+optionDisplayValue+"</option>";
...
<table width="100%" border="0" style="background-color: white;" class="handler-class" cellspacing="0" cellpadding="0">
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td width="96%" align="left" class="tbl-header-bold" valign="top">
									<input type="text" id="profileLookUphandlerName<%=widgetId%>" name="handlerName" class="handler-name-txt" size="17" value="<bean:message bundle="servicePolicyProperties" key="servicepolicy.proxypolicy.profilelookupdriver" />" onkeyup="expand(this);" onload="expand(this);" disabled="disabled"/>
								</td>
								<td width="1%" align="left" valign="middle" class="tbl-header-bold" style="padding-right: 2px;line-height: 9px;">
									<div class="switch">
									  <input id="toggle-profilelookup_<%=widgetId%>" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" disabled="disabled"/>
	...
	<tr>
		<td>
			<div id="profileLookUpDriver" class="toggleDivs" style="display: block;">
						...
						<td align="left" class="captiontext" valign="top" style="padding-top:10px;" width="50%">
							<table  width="100%" border="0" cellspacing="0" cellpadding="0">
												...
												<td align="left" class="labeltext" valign="top">
													<table width="100%" cellspacing="0" cellpadding="0" border="0">
														<tr>
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<select class="stripIdentity labeltext" id="stripIdentity<%=widgetId%>" name="stripIdentity" style="width:100px;" disabled="disabled">
														...
														<tr>
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<input type="text" class="separator" name="separator" id="separator<%=widgetId%>" size="5" maxlength="1" style="width:100px;" disabled="disabled"/> 
															</td>
														</tr>
														<tr>
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<select id="selectCase<%=widgetId%>" name="selectCase" style="width:100px;" class="selectCase labeltext" disabled="disabled">
														...
														<tr>
															<td align="left" class="labeltext" valign="top" colspan="2" style="padding-top:5px;">
																<input type="checkbox" class="trimUserIdentity" id="trimUserIdentity<%=widgetId%>" name="trimUserIdentity" value="true" disabled="disabled"/> 
																<bean:message bundle="servicePolicyProperties" key="servicepolicy.authpolicy.trimuid" />
															</td>
														</tr>
														<tr>
															<td align="left" class="labeltext" valign="top" colspan="2" style="padding-top:5px;">
																<input type="checkbox" id="trimPassword<%=widgetId%>" name="trimPassword" value="true" class="trimPassword" disabled="disabled"/> 
								...
								<tr>
									...
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;" width="60%">
										<input class="anonymousProfileIdentity" type="text" id="anonymousProfileIdentity<%=widgetId%>" name="anonymousProfileIdentity" size="25" style="width: 250px" maxlength="300" disabled="disabled"/>
									</td>
								</tr>
							</table>
						</td>
							...
							<table  width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;">
										<table width="50%" cellspacing="0" cellpadding="0" border="0">
											<tr>
												<td align="left" class="labeltext" valign="top"> 
													<select class="labeltext select-box-style selecteddriverIds" name="selecteddriverIds" id="selecteddriverIds<%=widgetId%>" multiple="multiple" size="3" style="width: 200;" tabindex="1" disabled="disabled">
													</select>
												</td>
												<td align="left" class="labeltext" valign="top">
													<table cellspacing="0" cellpadding="0" border="0" width="20%">
														<tr>
															<td>
																<input type="button" id="addBtn_<%=widgetId%>" value="Add " onClick="driverpopup(this);" class="light-btn driver-popup" style="width: 75px" tabindex="2" disabled="disabled"/><br />
															</td>
														</tr>
														<tr>
															<td style="padding-top: 5px;">
																<input type="button" id="removeBtn_<%=widgetId%>"  value="Remove " onclick="removeData('selecteddriverIds<%=widgetId%>','driverDataCheckBoxId<%=widgetId%>',this);" class="light-btn" style="width: 75px" tabindex="3" disabled="disabled" />
															</td>
														</tr>
													</table>
												</td>
								...
								<tr>
									...
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;">
										<table width="50%" cellspacing="0" cellpadding="0" border="0">
											<tr>
												<td align="left" class="labeltext" valign="top"> 
													<select class="labeltext select-box-style selectedCacheDriverIds" name="selectedCacheDriverIds" id="selectedCacheDriverIds<%=widgetId%>" multiple="multiple" size="3" style="width: 200;" tabindex="7" disabled="disabled">
													</select>
												</td>
												<td align="left" class="labeltext" valign="top">
													<table cellspacing="0" cellpadding="0" border="0" width="20%">
														<tr>
															<td>
																<input type="button" id="addCacheBtn_<%=widgetId%>" value="Add " onClick="cacheDriverpopup(this);" class="light-btn" style="width: 75px" tabindex="5" disabled="disabled"/><br />
															</td>
														</tr>
														<tr>
															<td style="padding-top: 5px;">
																<input type="button" id="removeCacheBtn_<%=widgetId%>" value="Remove " onclick="removeCacheData('selectedCacheDriverIds<%=widgetId%>','driverDataRadioId<%=widgetId%>',this);" class="light-btn" style="width: 75px" tabindex="6" disabled="disabled"/>
															</td>
														</tr>
													</table>
												</td>
								...
								<tr>
									...
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;">
										<table width="50%" cellspacing="0" cellpadding="0" border="0">
											<tr>
												<td align="left" class="labeltext" valign="top"> 
													<select class="labeltext select-box-style selectedAdditionalDriverIds" name="selectedAdditionalDriverIds" id="selectedAdditionalDriverIds<%=widgetId%>" multiple="multiple" size="3" style="width: 200px;" tabindex="7" disabled="disabled">
												</td>
												<td align="left" class="labeltext" valign="top" >
													<table cellspacing="0" cellpadding="0" border="0" width="20%">
														<tr>
															<td>
																<input type="button" value="Add " id="addAdditionalBtn_<%=widgetId%>" onClick="additionalDriverpopup(this);" class="light-btn" style="width: 75px" tabindex="8" disabled="disabled"/> 
															</td>
														</tr>
														<tr>
															<td style="padding-top: 5px;">
																<input type="button" value="Remove " id="removeAdditionalBtn_<%=widgetId%>" onclick="removeAdditionalDriverData('selectedAdditionalDriverIds<%=widgetId%>','additionalDriverCheckBoxId<%=widgetId%>',this);" class="light-btn" style="width: 75px;" tabindex="9" disabled="disabled"/>
															</td>
														</tr>
													</table>
												</td>
								...
								<tr>
									...
									<td class="labeltext" valign="top" style="padding-top: 10px;padding-left: 5px;">
										<input class="driverScript" type="text" name="driverScript" id="driverScript<%=widgetId%>" size="30" style="width:200px" maxlength="255" disabled="disabled"/>
									</td>
								</tr>
							</table>
						</td>
