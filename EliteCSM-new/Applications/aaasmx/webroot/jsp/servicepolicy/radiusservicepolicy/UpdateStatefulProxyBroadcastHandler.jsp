...
<form id="form_stateful_broadcast_proxycomm_<%=widgetId%>" name="form_stateful_broadcast_proxycomm_<%=widgetId%>" class="form_statefulproxybroadcastcommunication">
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                        <td width="96%" lign="left" class="tbl-header-bold" valign="top">
                            <input type="text" id="statefulProxyBroadcasthandlerName<%=widgetId%>" name="handlerName" class="handler-name-txt" size="32" value="<bean:message bundle="servicePolicyProperties" key="radiusservicepolicy.stateful.proxy.broadcast.handler" />" onkeyup="expand(this);" onkeypress="keyPressedForHandler(event,this);" onload="expand(this);" disabled="disabled"/>
                            <input type="hidden" id="statefulProxyCommucnicationHiddenHandlerName_<%=widgetId%>" name="hiddenHandlerName" class="hidden-handler-name" value="<bean:message bundle="servicePolicyProperties" key="radiusservicepolicy.stateful.proxy.broadcast.handler" />" />
                            <input type="hidden" id="statefulProxyBroadcastCommunicationHandlerType_<%=widgetId%>" name="handlerType" class="handlerType" value="StatefulProxyBroadcastCommunication" />
                        </td>
                        ...
                        <td width="1%" align="left" valign="middle" class="tbl-header-bold" style="padding-right: 2px;line-height: 9px;">
                            <div class="switch">
                                <input id="toggle-statefulproxybroadcasthandler_<%=widgetId%>" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" />
                    ...
                    <table name="tblmStatefulProxyBroadcastCommunication" width="100%" border="0" style="background-color: white;" class="" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="left" class="captiontext left-border right-border" valign="top" id="button" style="padding-top: 10px;">
                                <input type="button" onclick="addStatefulProxyPolicyRow('statefulProxyBroadcastCommunicationTemplate_<%=widgetId%>','statefulProxyBroadcastCommunicationTbl_<%=widgetId%>');" value=" Add Stateful Proxy Communication " class="light-btn proxy-com-btn" style="size: 140px" tabindex="3">
                            </td>
                        </tr>
                        <tr>
...
<table id="statefulProxyBroadcastCommunicationTemplate_<%=widgetId%>" style="display: none">
    <tr>
        ...
        <td align="left" class="tblrows" valign="top" width="16%">
            <select id="serverGroupName" name="serverGroupName" style="width:100%;" class="corRadEsiClass" onchange="setStatefulProxyHandlerDropDown(this);">
