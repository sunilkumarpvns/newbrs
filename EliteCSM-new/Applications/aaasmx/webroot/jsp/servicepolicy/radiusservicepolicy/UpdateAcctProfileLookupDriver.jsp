...
<% String widgetId=request.getParameter("widgetId");
   ...
   System.out.println("Profile Lookup json data : " +jsonData);
		 ...
		 if($(element).length > 0 && $(element).is("input:checkbox")){
        	...
        	if(key === 'primaryDriverRelDataList'){
        		...
        		$.each(value, function(key1,value1){
        			...
        			var optionTag = "<option value='"+optionvalue+"' selected='selected'>"+optionDisplayValue+"</option>";
        		...
        		$.each(value, function(key1,value1){
        			...
        			$.each(driverListArray, function(driverKey,driverValue){
        				...
        				if(driverValue.driverInstanceId == value1.cacheDriverInstId){
							...
							<table  width="100%" border="0" style="background-color: white;" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;" width="60%">
										<input	type="text" id="userIdentityAttribute<%=widgetId%>" name="userIdentityAttribute" size="30" autocomplete="off" onkeyup="setColumnsOnMultipleUIdTextFields();" style="width: 250px" value="0:1" tabindex="13" /> 
									</td>
								</tr>
								<tr>
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;" width="40%">
												...
												<td align="left" class="labeltext" valign="top">
													<table width="100%" cellspacing="0" cellpadding="0" border="0">
														<tr>
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<select class="labeltext" id="stripIdentity<%=widgetId%>" name="stripIdentity" style="width:100px;">
														...
														<tr>
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<input type="text" name="separator" id="separator<%=widgetId%>" size="5" maxlength="1" style="width:100px;"/> 
															</td>
														</tr>
														<tr>
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
															...
															<td align="left" class="labeltext" valign="top" style="padding-top:5px;">
																<select id="selectCase<%=widgetId%>" name="selectCase" style="width:100px;" class="labeltext">
														...
														<tr>
															<td align="left" class="labeltext" valign="top" colspan="2" style="padding-top:5px;">
																<input type="checkbox" id="trimUserIdentity<%=widgetId%>" name="trimUserIdentity" value="true"/> 
																<bean:message bundle="servicePolicyProperties" key="servicepolicy.authpolicy.trimuid" />
															</td>
														</tr>
														<tr>
															<td align="left" class="labeltext" valign="top" colspan="2" style="padding-top:5px;">
																<input type="checkbox" id="trimPassword<%=widgetId%>" name="trimPassword" value="true"/> 
								...
								<tr>
									...
									<td align="left" class="labeltext" valign="top" style="padding-top:10px;" width="60%">
										<input type="text" id="anonymousProfileIdentity<%=widgetId%>" name="anonymousProfileIdentity" size="25" style="width: 250px" maxlength="300"/>
									</td>
								</tr>
							</table>
						</td>
							...
							<table  width="100%" border="0" style="background-color: white;" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="labeltext" valign="top" style="padding-top: 10px;padding-left: 5px;">
										<input type="text" name="driverScript" id="driverScript<%=widgetId%>" size="30" style="width:200px" maxlength="255"/>
									</td>
								</tr>
							</table>
						</td>
