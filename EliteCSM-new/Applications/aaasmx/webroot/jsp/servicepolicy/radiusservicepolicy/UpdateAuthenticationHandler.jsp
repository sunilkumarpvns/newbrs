	...
	if($(element).length > 0 && $(element).is("input")) {
		if( key == 'handlerName'){
			if( value.length > 0 ){
				...
				$('#authhiddenHandlerName_<%=widgetId%>').val(value);
			}
		}else{
			 $(element).val(value);
		}
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								<td width="96%" lign="left" class="tbl-header-bold" valign="top">
									<input type="text" id="authentication-handlerName<%=widgetId%>" name="handlerName" class="handler-name-txt" size="17" value="<bean:message bundle="servicePolicyProperties" key="servicepolicy.proxypolicy.authenticationhandler" />" onkeyup="expand(this);" onkeypress="keyPressedForHandler(event,this);" onload="expand(this);" disabled="disabled"/>
								...
								<td width="1%" align="left" valign="middle" class="tbl-header-bold" style="padding-right: 2px;line-height: 9px;">
									<div class="switch">
									  <input id="toggle-authhandler_<%=widgetId%>" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);"/>
			...
			<div id="authenticationHandlerDiv" class="toggleDivs">
											...
											<table width="100%" cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td align="left" class="labeltext" width="80%" >
														 <select id="digestConfigId<%=widgetId%>" class="labeltext" name="digestConfigId" style="width: 200px;">
										...
										<td align="left" class="labeltext" valign="top" width="85%">
											<table width="100%" cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td align="left" class="labeltext" width="80%" >
														 <select id="eapConfigId<%=widgetId%>" name="eapConfigId" style="width: 200px;" >
															<option value="0">-Select-</option>
				...
				<tr>
					...
					<td align="left" class="labeltext right-border" valign="top" style="padding-top: 5px;">
						<select id="userName<%=widgetId%>" name="userName" class="labeltext advanced-username" style="width: 200px;" onchange="setUsernameExpression(this);">
				...
				<tr>
					...
					<td align="left" class="labeltext right-border" valign="top" style="padding-top: 5px;">
						<input type="text" id="userNameExpression<%=widgetId%>" name="userNameExpression" class="userNameExpression" size="30" readonly="true" style="width: 200px" tabindex="24" />
					</td>
				</tr>
				<tr>
					...
					<td align="left" class="labeltext right-border bottom-border" valign="top" style="padding-top: 5px;">
						<input type="text" id="userNameResponseAttribs<%=widgetId%>" class="userNameResponseAttribs" name="userNameResponseAttribs" size="30" autocomplete="off" onkeyup="setColumnsOnUserNameRespAttrTextFields();" style="width: 200px" tabindex="24" />
					</td>
				</tr>
			</table>
		</div>
