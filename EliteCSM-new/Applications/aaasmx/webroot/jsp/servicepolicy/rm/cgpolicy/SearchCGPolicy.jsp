...
<%@ page import="com.elitecore.elitesm.datamanager.servicepolicy.rm.cgpolicy.data.*"%>
<%@ page import="com.elitecore.elitesm.web.servicepolicy.rm.cgpolicy.forms.SearchCGPolicyForm"%>
...
<%
	...
	SearchCGPolicyForm policyForm = (SearchCGPolicyForm)request.getAttribute("searchCGPolicyForm");
...
<html:form action="/searchCGPolicy">

	<html:hidden styleId="action" property="action" />
	<html:hidden name="searchCGPolicyForm" styleId="pageNumber"
		property="pageNumber" value="<%=strPageNumber%>" />
	<html:hidden name="searchCGPolicyForm" styleId="totalPages"
		property="totalPages" value="<%=strTotalPages%>" />
	<html:hidden name="searchCGPolicyForm" styleId="totalRecords"
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<tr>
									<td class="table-header" colspan="4"><bean:message
											...
											key="servicepolicy.cgpolicy.search" /></td>
								</tr>
								<tr>
								...
								<tr>
									<td align="left" class="captiontext" valign="top" width="18%">
										<bean:message bundle="servicePolicyProperties"
											key="servicepolicy.cgpolicy.name" />
									</td>
								...
								<tr>
									...
									<td align="left" class="labeltext" valign="top" width="5%">
										<html:radio name="searchCGPolicyForm" styleId="status"
								...
								<tr>
									...
									<td class="labeltext" valign="middle" colspan="2"><input
										...
										tabindex="5"> <%-- <input type="reset" name="c_btnDeletePolicy" onclick="javascript:location.href='<%=basePath%>/initSearchCGPolicy.do?/>'"
					 	value="Cancel" class="light-btn"> --%> <input type="button"
										name="c_btn_manage"
										onclick="javascript:location.href='<%=basePath%>/manageCGPolicyOrder.do?/>'"
										value="Manage Order" class="light-btn" tabindex="6"> <input
										type="button" name="Create" value="   Create   "
										class="light-btn"
										onclick="javascript:navigatePageWithStatus('initCreateCGPolicy.do','name');"
										tabindex="7"></td>
								</tr>
									...
									<td align="left" class="labeltext" colspan="5" valign="top">
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<td class="table-header" width="50%"><bean:message
														bundle="servicePolicyProperties"
														key="servicepolicy.cgpolicylst" /></td>
											...
											<tr>
												...
												<td class="btns-td" align="right">
													...
													href="searchCGPolicy.do?<%=paramString%>&action=list&pageNo=<%= pageNo+1%>"><img
													...
													<a
													href="searchCGPolicy.do?<%=paramString%>&action=list&pageNo=<%= totalPages+1%>"><img
													...
													<a
													href="searchCGPolicy.do?<%=paramString%>&action=list&pageNo=<%=1%>"><img
												...
												<td class="btns-td" valign="middle" colspan="2">
													<table width="99%" border="0" cellpadding="0"
														...
														<logic:iterate id="obj" property="searchList"
															name="searchCGPolicyForm" type="CGPolicyData">
															<tr>
																...
																<td align="left" class="tblrows"><a
																	href="initViewCGPolicy.do?policyId=<bean:write name="obj" property="policyId"/>"><bean:write
										...
										%> <img src="<%=basePath%>/images/hide.jpg" border="0">
																...
																<td align="center" class="tblrows"><a
																	href="initUpdateCGPolicy.do?policyId=<bean:write name="obj" property="policyId"/>">
