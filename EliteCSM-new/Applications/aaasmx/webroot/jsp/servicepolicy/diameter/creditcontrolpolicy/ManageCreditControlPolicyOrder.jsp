...
$(document).ready(function(){
	 	...
	 	$(".saveorder").click(function(){
	 		saveOrder("creditControlPolicyId", "<%=TableOrderData.CREDITCONTROLPOLICYINST%>", "initSearchCcpolicy");
	 	});
});
							...
							<tr>
								<td width="100%" align="center" valign="middle">
									<table id="listTable" width="97%" cellpadding="0" cellspacing="0" border="0">
										...
										<logic:iterate id="obj" name="manageccordForm" property="policyList" type="CreditControlPolicyData" indexId="policyCount">
										<tr>
											<td align="left" valign="top" class="tblfirstcol" width="5%">
												<%=policyCount+1%>
												<input type="hidden" name="creditControlPolicyId" value='<bean:write name="obj" property="policyId"/>'>
											</td>
										  ...
										  <logic:empty name="manageccordForm" property="policyList">	
											<tr>
								...
								<tr>
									<td class="btns-td" align="left" valign="top">
										<input type="submit" value=" Save " class="light-btn saveorder" /> 
										<input type="button" value=" Cancel " class="light-btn" onclick="javascript:location.href='<%=basePath%>/initSearchCcpolicy.do?/>'" />
										<input type="button" value=" Reset " class="light-btn" onclick="javascript:location.href='<%=basePath %>/manageccPolicyOrder.do?/>'" />
									</td>
								</tr>
								<tr>
									<td colspan="4">&nbsp;</td>
