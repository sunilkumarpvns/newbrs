  							...
  							<tr>
 	  							<td  width="*" class="box"  valign="top">
    								<table width="100%" border="0" cellspacing="0" cellpadding="0">				
										...
										<tr>
											<td valign="top" align="right">
												<%@ include file="ViewNASServicePolicyAuthenticationDetail.jsp" %>
											</td>
										</tr>
										<tr>
											<td valign="top" align="right">
												<%@ include file="ViewNASServicePolicyAuthorizationDetail.jsp" %>
											</td>
										</tr>
										<tr>
											<td valign="top" align="right">
												<%@ include file="ViewNASServicePolicyRFC4372CUIDetail.jsp" %>
											</td>
										</tr>
										<tr>
											<td valign="top" align="right">
												<%@ include file="ViewNASServicePolicyAccountingDetail.jsp" %>
											</td>
										</tr>
										<tr>
											<td valign="top" align="right">
												<%@ include file="ViewNASResponseAttributes.jsp" %>
											</td>
										</tr>
    								</table>
    							</td>	
