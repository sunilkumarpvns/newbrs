...
<%@page import="com.elitecore.elitesm.datamanager.servicepolicy.diameter.eappolicy.data.*" %> 
<%@page import="com.elitecore.elitesm.web.servicepolicy.diameter.eappolicy.forms.SearchEAPPolicyForm"%>
...
<%
	...
	SearchEAPPolicyForm policyForm = (SearchEAPPolicyForm)request.getAttribute("searchEAPPolicyForm");
...
<html:form action="/searchEAPPolicy" >
		
		<html:hidden styleId="action" property="action" />
		<html:hidden name="searchEAPPolicyForm" styleId="pageNumber" property="pageNumber" value="<%=strPageNumber%>"/>
		<html:hidden name="searchEAPPolicyForm" styleId="totalPages" property="totalPages" value="<%=strTotalPages%>"/>
		<html:hidden name="searchEAPPolicyForm" styleId="totalRecords" property="totalRecords" value="<%=strTotalRecords%>"/>
		...
		<tr>
			...
			<td>
   				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					<bean:message bundle="servicePolicyProperties" key="servicepolicy.eappolicy.search" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<bean:message bundle="servicePolicyProperties" key="servicepolicy.eappolicy.name" /></td>
				...
				<tr>
						...
						<bean:message bundle="servicePolicyProperties" key="servicepolicy.status" />
						</td>
						<td align="left" class="labeltext" valign="top" width="5%">
							<html:radio name="searchEAPPolicyForm" styleId="status" property="status" value="Active" />
							<bean:message bundle="servicePolicyProperties" key="servicepolicy.active" />
							<html:radio name="searchEAPPolicyForm" styleId="status" property="status" value="Inactive" />
							<bean:message bundle="servicePolicyProperties" key="servicepolicy.inactive" />
							<html:radio name="searchEAPPolicyForm" styleId="status" property="status" value="All" />
							<bean:message bundle="servicePolicyProperties" key="servicepolicy.all" />
						</td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				...
				<tr>
					...
					<td class="labeltext" valign="middle" colspan="2">
						...
						<%-- <input type="reset" name="c_btnDeletePolicy" onclick="javascript:location.href='<%=basePath%>/initSearchEAPPolicy.do?/>'"
					 	value="Cancel" class="light-btn"> --%>
					 	<input type="button" name="c_btn_manage" onclick="javascript:location.href='<%=basePath%>/manageEAPPolicyOrder.do?/>'" value="Manage Order" class="light-btn">
					 	<input type="button" name="Create" value="   Create   "class="light-btn"onclick="javascript:navigatePageWithStatus('initCreateEAPPolicy.do','name');">
					</td>
				</tr>
					 ...
					 <td align="left" class="labeltext" colspan="5" valign="top">
						<table width="100%" cellpadding="0" cellspacing="0" border="0" >
							<tr>
									...
									<bean:message bundle="servicePolicyProperties" key="servicepolicy.eappolicylst" />
									</td>
									
									<td class="table-header" align="right" class="blue-text" valign="middle" width="50%">
					    				<% if(totalRecord == 0) { %>
							...
							<td class="btns-td" valign="middle"> 
								<input type="button" name="Show"   onclick="show()" value="   Active   " class="light-btn"  >
								<input type="button" name="Hide"  onclick="hide()" value="   Inactive   " class="light-btn">							
							...
							<td class="btns-td" align="right" >
									  	<% if(totalPages >= 1) { %>
										  	<% if(pageNo == 1){ %>
												<a  href="searchEAPPolicy.do?<%=paramString%>&action=list&pageNo=<%= pageNo+1%>"><img  src="<%=basePath%>/images/next.jpg"  name="Image61" onmouseover="MM_swapImage('Image61','','<%=basePath%>/images/next-hover.jpg',1)"  onmouseout="MM_swapImgRestore()"  alt="Next"  border="0" ></a>
												<a  href="searchEAPPolicy.do?<%=paramString%>&action=list&pageNo=<%= totalPages+1%>"><img  src="<%=basePath%>/images/last.jpg"  name="Image612" onmouseover="MM_swapImage('Image612','','<%=basePath%>/images/last-hover.jpg',1)"  onmouseout="MM_swapImgRestore()"  alt="Last"  border="0" ></a>
										  	<% } %>
											<% if(pageNo>1 && pageNo!=totalPages+1) {%>
												<%  if(pageNo-1 == 1){ %>
													<a  href="searchEAPPolicy.do?<%=paramString%>&action=list&pageNo=<%=1%>"><img  src="<%=basePath%>/images/first.jpg" name="Image511" onmouseover="MM_swapImage('Image511','','<%=basePath%>/images/first-hover.jpg',1)"  onmouseout="MM_swapImgRestore()"  alt="First"  border="0" ></a>
													<a  href="searchEAPPolicy.do?<%=paramString%>&action=list&pageNo=<%= pageNo-1%>"><img  src="<%=basePath%>/images/previous.jpg" name="Image5"  onmouseover="MM_swapImage('Image5','','<%=basePath%>/images/previous-hover.jpg',1)"  onmouseout="MM_swapImgRestore()"  alt="Previous"  border="0" ></a>
													<a  href="searchEAPPolicy.do?<%=paramString%>&action=list&pageNo=<%= pageNo+1%>"><img  src="<%=basePath%>/images/next.jpg"  name="Image61" onmouseover="MM_swapImage('Image61','','<%=basePath%>/images/next-hover.jpg',1)"  onmouseout="MM_swapImgRestore()"  alt="Next"  border="0" ></a>
													<a  href="searchEAPPolicy.do?<%=paramString%>&action=list&pageNo=<%= totalPages+1%>"><img  src="<%=basePath%>/images/last.jpg"  name="Image612" onmouseover="MM_swapImage('Image612','','<%=basePath%>/images/last-hover.jpg',1)"  onmouseout="MM_swapImgRestore()"  alt="Last"  border="0" ></a>
						   ...
						   <tr>
								...
								<td align="left" class="tblheader" valign="top" width="20%" >Name</td>								
								<td align="left" class="tblheader" valign="top" width="*">Description</td>
								<td align="left" class="tblheader" valign="top" width="25%">RuleSet</td>
								<td align="center" class="tblheader" valign="top" width="40px">Status</td>
								<td align="center" class="tblheader" valign="top" width="40px">Edit</td>
							</tr>	
							<tr>
							<%if(searchPolicyList != null && searchPolicyList.size() >0){ %>

							<logic:iterate id="obj" property="searchList" name="searchEAPPolicyForm"  type="EAPPolicyData">									
								<tr>
									<td align="center" class="tblfirstcol">
									<input type="checkbox" name="select" value="<bean:write name="obj" property="eapPolicyId"/>" />
									</td>
							   		<td align="center" class="tblfirstcol"><%=((pageNo-1)*pageSize)+count%></td>
							   		<td align="left" class="tblrows"><a href="initViewEAPPolicy.do?policyId=<bean:write name="obj" property="eapPolicyId"/>"><bean:write name="obj" property="name"/></a></td>
							   		<td align="left" class="tblrows"><bean:write name="obj" property="description"/></td>
							   		...
							   		<td align="center" class="tblrows">
											<a href="updateEAPPolicyBasicDetail.do?policyId=<bean:write name="obj" property="eapPolicyId"/>">
