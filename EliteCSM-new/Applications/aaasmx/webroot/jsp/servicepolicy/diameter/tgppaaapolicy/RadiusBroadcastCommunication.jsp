...
<input type="hidden" value="RadiusBroadcastingCommunication" name="handlerJsName" id="handlerJsName" />
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td width="96%" lign="left" class="tbl-header-bold" valign="top">
						...
						<input type="text" id="handlerName_<%=widgetId%>" name="handlerName" class="handler-name-txt" size="25" value="<bean:message bundle='servicePolicyProperties' key='tgppaaapolicy.radiusbroadcast.title' />" onkeyup="expand(this);" onkeypress="keyPressedForHandler(event,this);" onload="expand(this);" disabled="disabled"/>
						<input type="hidden" id="radBroadcasthiddenHandlerName_<%=widgetId%>" name="hiddenHandlerName" class="hidden-handler-name" value="<bean:message bundle='servicePolicyProperties' key='tgppaaapolicy.radiusbroadcast.title' />" />
						<span class="handler-type">[<bean:message bundle='servicePolicyProperties' key='tgppaaapolicy.radiusbroadcast.title' />]</span>
					</td>
...
<table id="radiusBroadcastCommunicationTemplate_<%=widgetId%>" style="display: none">
	<tr>
		...
		<td class="tblrowspolicy" width="15.83%" valign="middle">
			<input class="noborder esiScriptAutocomplete" id="script_<%=widgetId%>" type="text" name="script" style="width: 100%;" maxlength="2000"  <%if("true".equals(request.getParameter("isViewPage").toString())){ %>  disabled=" disabled" <%}%> />
		</td>
