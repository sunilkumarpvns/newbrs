...
<%
	...
	TGPPAAAPolicyForm policyForm = (TGPPAAAPolicyForm)request.getAttribute("policyForm");
...
/* Navigate Records with Active/InActive Status */
...
/* This function allows you to hide selected records */
function hide(){
...
/* This function will remove selected records */
function removeData(){
    var selectVar = false;
    ...
    if(selectVar == false){
        alert('At least select one TGPP AAA Policy for remove process');
    }else{
        var msg;
        msg = '<bean:message bundle="alertMessageResources" key="alert.searchtgpppolicyjsp.delete.query"/>';              
...
/* This function allows you to select unselect record */
function  checkAll(){
...
<html:form action="/searchTGPPAAAPolicy" styleId="searchTGPPAAAPolicy">
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									<td class="table-header" colspan="3">
										<bean:message bundle="servicePolicyProperties" key="tgppaaapolicy.search" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td align="left" class="captiontext" valign="top" width="18%">
										<bean:message bundle="servicePolicyProperties" key="tgppaaapolicy.name" />
								...
								<tr>
									<td align="left" class="captiontext" valign="top" width="18%">
										<bean:message bundle="servicePolicyProperties" key="tgppaaapolicy.status" />
										<ec:elitehelp  header="tgppaaapolicy.status" headerBundle="servicePolicyProperties" text="tgppaaapolicy.status" ></ec:elitehelp>
									</td>
									<td align="left" class="labeltext" valign="top" colspan="2">
										<html:radio name="policyForm" styleId="status" property="status" value="Active" tabindex="2" /> 
										<bean:message bundle="servicePolicyProperties" key="tgppaaapolicy.active" />
										<html:radio name="policyForm" styleId="status" property="status" value="Inactive" tabindex="3" /> 
										<bean:message bundle="servicePolicyProperties" key="tgppaaapolicy.inactive" />
								...
								<tr>
									...
									<td class="labeltext" colspan="2" align="left">
										...
										<input type="button" name="c_btn_manage" onclick="javascript:location.href='<%=basePath%>/manageTGPPAAAServicePolicyOrder.do?/>'" value="Manage Order" class="light-btn" tabindex="6">
										<input type="button" name="Create" value="   Create   " onclick="javascript:navigatePageWithStatus('initCreateTGPPAAAPolicy.do','name');" class="light-btn" tabindex="7">
									</td>
								</tr>
								<tr>
									<td colspan="3">&nbsp;</td>
										...
										<table cellSpacing="0" cellPadding="0" width="99%" border="0">
											<tr>
												<td class="table-header" width="50%"><bean:message
														bundle="servicePolicyProperties" key="tgppaaapolicy.list" />
												</td>
												...
												<td class="btns-td" valign="middle" colspan="2">
													...
													<table width="100%" border="0" cellpadding="0"
														...
														<tr>
															...
															<logic:iterate id="obj" name="policyForm" property="policyList" type="com.elitecore.elitesm.datamanager.servicepolicy.diameter.tgppaaapolicy.data.TGPPAAAPolicyData">
																<tr>
																	<td align="center" class="tblfirstcol">
																		<input type="checkbox" name="select" value="<bean:write name="obj" property="tgppAAAPolicyId"/>" />
																	</td>
																	<td align="center" class="tblrows">
																		<%=((pageNo-1)*pageSize)+count%>
																	</td>
																	<td align="left" class="tblrows">
																		<a href="<%=request.getContextPath()%>/viewTGPPAAAPolicy.do?tgppAAAPolicyId=<%=obj.getTgppAAAPolicyId()%>">
																	...
																	<td align="center" class="tblrows"><a
																		href="<%=request.getContextPath()%>/updateTGPPAAAServicePolicyBasicDetail.do?tgppAAAPolicyId=<%=obj.getTgppAAAPolicyId()%>">
