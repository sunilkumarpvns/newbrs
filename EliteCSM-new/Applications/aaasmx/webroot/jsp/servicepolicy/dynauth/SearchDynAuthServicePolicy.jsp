...
<%@page import="com.elitecore.elitesm.web.servicepolicy.dynauth.forms.SearchDynAuthServicePolicyForm"%>
<%@page import="com.elitecore.elitesm.web.core.system.cache.ConfigManager,com.elitecore.elitesm.datamanager.servicepolicy.dynauth.data.*,com.elitecore.elitesm.util.constants.*"%>
<%@ page import="com.elitecore.elitesm.util.constants.ConfigConstant"%>

<%
	String basePath = request.getContextPath();	
	SearchDynAuthServicePolicyForm policyForm = (SearchDynAuthServicePolicyForm)request.getAttribute("policyForm");
...
<html:form action="/searchDynAuthServicePolicy">

	<html:hidden name="searchDynAuthServicePolicyForm" styleId="action"
		property="action" />
	<html:hidden name="searchDynAuthServicePolicyForm" styleId="pageNumber"
		property="pageNumber" />
	<html:hidden name="searchDynAuthServicePolicyForm" styleId="totalPages"
		property="totalPages" value="<%=strTotalPages%>" />
	<html:hidden name="searchDynAuthServicePolicyForm"
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									<td class="table-header" colspan="3"><bean:message
											...
											key="servicepolicy.dynauthpolicy.search" /></td>
								</tr>
								<tr>
								...
								<tr>
									<td align="left" class="captiontext" valign="top" width="18%">
										<bean:message bundle="servicePolicyProperties"
											key="servicepolicy.dynauthpolicy.name" />
									</td>
								...
								<tr>
									...
									<td align="left" class="labeltext" valign="top" colspan="2">
										<html:radio name="searchDynAuthServicePolicyForm"
											styleId="status" property="status" value="Active"
											tabindex="2" /> <bean:message
											bundle="servicePolicyProperties" key="servicepolicy.active" />
										<html:radio name="searchDynAuthServicePolicyForm"
											styleId="status" property="status" value="Inactive"
											tabindex="3" /> <bean:message
											bundle="servicePolicyProperties" key="servicepolicy.inactive" />
										<html:radio name="searchDynAuthServicePolicyForm"
											styleId="status" property="status" value="All" tabindex="4" />
										<bean:message bundle="servicePolicyProperties"
											key="servicepolicy.all" />
									</td>
								</tr>
								<tr>
									<td colspan="3">&nbsp;</td>
								...
								<tr>
									...
									<td class="labeltext" valign="top" colspan="2"><input
										type="button" name="c_btnCreate" id="c_btnCreate2"
										value=" Search " class="light-btn" onclick="validateSearch()"
										tabindex="5"> <%-- <input type="reset" name="c_btnDeletePolicy" onclick="javascript:location.href='<%=basePath%>/initSearchDynAuthServicePolicy.do?/>'"
					 	value="Cancel" class="light-btn">	 --%> <input type="button"
										name="c_btn_manage"
										onclick="javascript:location.href='<%=basePath%>/manageOrderDynAuth.do?/>'"
										value="Manage Order" class="light-btn" tabindex="6"> <input
										type="button" name="Create" value="   Create   "
										onclick="javascript:navigatePageWithStatus('initAddDynAuthServicePolicy.do','name');"
										...
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td class="table-header" width="50%"><bean:message
														bundle="servicePolicyProperties"
														key="servicepolicy.dynauthpolicy.list" /></td>
											...
											<tr>
												<td class="btns-td" valign="middle"><input
													...
													<input type="button" name="Delete" onclick="removeRecord()"
												...
												<td class="btns-td" align="right">
													...
													href="searchDynAuthServicePolicy.do?<%=paramString%>&action=list&pageNo=<%= pageNo+1%>"><img
													...
													<a
													href="searchDynAuthServicePolicy.do?<%=paramString%>&action=list&pageNo=<%= totalPages+1%>"><img
													...
													<a
													href="searchDynAuthServicePolicy.do?<%=paramString%>&action=list&pageNo=<%=1%>"><img
												...
												<td class="btns-td" valign="middle" colspan="2">
													...
													<table width="99%" border="0" cellpadding="0"
														...
														<tr>
															...
															<logic:iterate id="obj"
																name="searchDynAuthServicePolicyForm"
																property="policyList" type="DynAuthPolicyInstData">
																<tr>
																	<td align="center" class="tblfirstcol"><input
																		type="checkbox" name="select"
																		value="<bean:write name="obj" property="dynAuthPolicyId"/>" />
																	</td>
																	<td align="center" class="tblrows"><%=((pageNo-1)*pageSize)+count%></td>
																	<td align="left" class="tblrows"><a
																		href="<%=request.getContextPath()%>/viewDynAuthServicePolicy.do?dynauthpolicyid=<%=obj.getDynAuthPolicyId()%>"><bean:write
													...
													%> <img src="<%=basePath%>/images/hide.jpg" border="0">
																	...
																	<td align="center" class="tblrows"><a
																		href="<%=request.getContextPath()%>/updateDynAuthServicePolicyBasicDetail.do?dynauthpolicyid=<%=obj.getDynAuthPolicyId()%>">
											...
											<tr>
												<td class="btns-td" valign="middle"><input
													...
													value="   Inactive   " class="light-btn"> <html:button
														property="c_btnDelete" onclick="removeRecord()"
														value="   Delete   " styleClass="light-btn" /></td>
												<td class="btns-td" align="right">
													<% if(totalPages >= 1) { %> <% if(pageNo == 1){ %> 
													<a href="searchDynAuthServicePolicy.do?<%=paramString%>&action=list&pageNo=<%= pageNo+1%>">
