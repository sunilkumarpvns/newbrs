						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top" align="right">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td><%@ include file="ViewConcurrentLoginPolicy.jsp"%>
											</td>
										</tr>
										<tr>
											<td valign="top" colspan="2"><%@ include
													file="UpdateConcurrentLoginPolicyBasicDetail.jsp"%>
											</td>
										</tr>
									</table>
								</td>
								<td width="168" class="grey-bkgd" valign="top"><%@  include
										file="ConcurrentLoginPolicyNavigation.jsp"%>
								</td>
							</tr>
						</table>
					</td>
