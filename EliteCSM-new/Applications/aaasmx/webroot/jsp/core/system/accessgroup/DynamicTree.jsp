...
if(parent.document.forms[0].c_strActionMode.value == "<%=(new Integer(AccessRightActionConstant.UPDATE_ACTION).toString())%>" || parent.document.forms[0].c_strActionMode.value == "<%=(new Integer(AccessRightActionConstant.CREATE_ACTION).toString())%>" ){
	...
	pobj.usecheck = true;
	pobj.useimg = false;
}else if(parent.document.forms[0].c_strActionMode.value == "<%=(new Integer(ChargeHeadActionConstant.CREATE_CHARGE_HEAD_ACTION).toString())%>" || parent.document.forms[0].c_strActionMode.value == "<%=(new Integer(ChargeHeadActionConstant.UPDATE_CHARGE_HEAD_ACTION).toString())%>" ){
	pobj.usecheck = false;
	pobj.useimg = false;
	pobj.useradio = true;
}else{
...
//CreateTreeArray("LINK",TreeNodeArray);
	...
	{
		if(parent.document.forms[0].c_strActionMode.value == "<%=(new Integer(AccessRightActionConstant.VIEW_ACTION).toString())%>")
		{
