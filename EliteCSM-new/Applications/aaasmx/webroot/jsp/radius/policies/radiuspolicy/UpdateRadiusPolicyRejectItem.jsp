...
<% 
	...
	UpdateRadiusPolicyRejectItemForm updateRadiusPolicyRejectItemForm = (UpdateRadiusPolicyRejectItemForm)request.getSession().getAttribute("updateRadiusPolicyRejectItemForm");
%>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	<html:form action="/updateRadiusPolicyRejectItem">

		<html:hidden name="updateRadiusPolicyRejectItemForm" styleId="action"
			property="action" />
		<html:hidden name="updateRadiusPolicyRejectItemForm"
			styleId="radiusPolicyId" property="radiusPolicyId" />
		<tr>
			<td class="tblheader-bold" colspan="3"><bean:message
					bundle="radiusResources" key="radiuspolicy.updaterejectitems" /></td>
		</tr>
		<tr>
				...
				<table width="100%" name="c_tblCrossProductList"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="35%">
							...
							value='<%=(updateRadiusPolicyRejectItemForm.getStrAttributeId() != null) ? updateRadiusPolicyRejectItemForm.getStrAttributeId() : "" %>'
					...
					<tr>
						<td align="left" class="captiontext" valign="top"><bean:message
								bundle="radiusResources" key="radiuspolicy.rejectitems.operator" />
						...
						<td align="left" class="labeltext" valign="top" width="200px">
							<html:select name="updateRadiusPolicyRejectItemForm"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" height="60">
							<%
								...
								name="updateRadiusPolicyRejectItemForm" styleId="parameterValue"
								property="parameterValue" rows="3" rows="3" cols="25"
								style="width:250px" /> <%} %>
						</td>
					...
					<tr>
						...
						<td colspan="2"><html:textarea property="rejectItem"
								styleId="rejectItem" cols="84" rows="6"></html:textarea></td>
					</tr>
				</table>
			</td>
		</tr>
