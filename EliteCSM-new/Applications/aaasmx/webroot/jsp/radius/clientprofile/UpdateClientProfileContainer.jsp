...
<%
    ...
    UpdateClientProfileForm form = (UpdateClientProfileForm)request.getAttribute("updateClientProfileForm");
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top" align="right" width="*">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td><%@ include file="ViewClientProfileBasicDetails.jsp"%>
											</td>
										</tr>
										<% if("basic".equals(viewType)){ %>
										<tr>
											<td valign="top"><%@ include
													file="UpdateClientProfile.jsp"%></td>
										</tr>
										<%}else if("other".equals(viewType)){ %>
										<tr>
											<td valign="top"><%@ include
													file="UpdateClientProfileAdvanceDetails.jsp"%>
											</td>
										</tr>
										<%}%>
									</table>
								...
								<td width="168" class="grey-bkgd" valign="top"><%@  include
										file="ClientProfileNavigation.jsp"%></td>
							</tr>
						</table>
					</td>
				</tr>
