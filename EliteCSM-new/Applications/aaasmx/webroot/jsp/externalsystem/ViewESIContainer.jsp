...
<script>
setTitle('<bean:message bundle="externalsystemResources" key="esi.details"/>');
</script>
    			...
    			<tr>
					...
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">	
							<tr>	
								<td>
									<%@ include file="/jsp/externalsystem/ViewESI.jsp" %>
				  				</td>
							</tr>
    					</table>		
    					</td>	
						<td width="168" class="grey-bkgd" valign="top">
							<%@ include file="/jsp/externalsystem/ESINavigation.jsp" %>
						</td>
					</tr>
				</table>
			</td>
