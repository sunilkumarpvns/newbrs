	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >            						  	
		...
		<tr>
			<td class="tblheader-bold" width="25%" height="20%" colspan="2">
				<bean:message bundle="scriptResources" key="script.scriptfile" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" colspan="2">
				...
				<input type="button" id="submitGroovy" value="Save" class="light-btn" onclick="validateScript()"/>
  ...
  <script type="text/javascript">
	...
	function getReadGroovyMap(){
		...
		<logic:iterate id="obj" name="scriptInstanceForm" property="scriptDataList">
			...
			var scriptFileName = '<bean:write name="obj" property="scriptFileName"/>';
			$('#scriptFileName').html(scriptFileName);
	...
	function validateGroovy(){
		 ...
		 if(isEmpty(fileContent)){
			 alert("Script file cannot be empty");
			 return false;
		 }
