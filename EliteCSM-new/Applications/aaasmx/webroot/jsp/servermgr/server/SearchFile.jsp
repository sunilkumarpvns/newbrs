		...
		<tr>
			<td valign="top" align="right">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td align="left" class="labeltext" valign="top" width="10%"><strong>File
								Name</strong></td>
						<td align="left" class="labeltext" valign="top" width="18%"><html:text
								styleId="filedName" property="filedName" size="30" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="32%">
							<strong>From:</strong>&nbsp;<html:text styleId="dateFrom"
								property="dateFrom" size="15" maxlength="15" readonly="true" />
							<a href="javascript:void(0)"
							onclick="popUpCalendar(this, document.forms[0].dateFrom)"> <img
								src="<%=basePath%>/images/calendar.jpg" border="0" tabindex="6">
						</a> &nbsp;&nbsp; <strong>To:</strong>&nbsp;<html:text
								styleId="dateTo" property="dateTo" size="15" maxlength="15"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="32%"><html:text
								styleId="location" property="location" size="30" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">
							<table border="1" cellSpacing="0" cellPadding="0">
								<tr>
									<td align="left" class="tblheader" valign="top" width="5%">Sr.
										No.</td>
									<td align="left" class="tblheader" valign="top" width="8%">File
										Name</td>
								...
								<tr>
									...
									<td align="left" class="tblrows"><a href=""
										onclick="return popup('<%=basePath%>/viewFile.do?fileName=<%=fileName%>','notes')"><%=fileName%></a></td>
								...
								<tr>
									<td align="right" class="tblrows" colspan="5"><a
										href="<%=basePath%>/searchFileSummary.do?">View Summary</a>&nbsp;</td>
								</tr>

								<% } else {  %>
								<tr>
									<td align="center" class="tblrows" colspan="5">No Records
										Found...</td>
								</tr>
								<% } %>
