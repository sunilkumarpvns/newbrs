...
<html:form action="/listNetServerConfiguration">
	<html:hidden name="listNetServerGlobalConfigurationForm"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="tblheader-bold" colspan="3"><bean:message
								...
								key="servermgr.view.updateserverglobalconfiguration" /></td>
					</tr>
					<tr>
						<td colspan="3">
							<table width="100%" cols="8" id="listTable" type="tbl-list"
								...
								<tr>
									...
									<td align="left" class="tblheader" valign="top" width="25%"><bean:message
											bundle="servermgrResources" key="servermgr.alias" /></td>
...
%>
								<logic:iterate id="netConfigInstanceData"
									name="listNetServerGlobalConfigurationForm"
									...
									<tr>
										...
										<td align="center" class="tblrows"><a
											href="<%=localBasePath%>/updateNetServerConfiguration.do?confInstanceId=<bean:write name="netConfigInstanceData" property="configInstanceId"/>&netServerId=<%=listNetServerGlobalConfigurationForm.getNetServerId()%>"><img
												src="<%=localBasePath%>/images/edit.jpg" border="0" /></a></td>
									</tr>
									<% iIndex += 1; %>
								</logic:iterate>
								<%
