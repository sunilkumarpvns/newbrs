		...
		<tr>
			<td valign="top" align="right">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td align="left" class="labeltext" valign="top" width="5%"><strong>Batch
								Id</strong></td>
						<td align="left" class="labeltext" valign="top" width="18%"><html:text
								size="20" styleId="" property="batchId" /><strong style="">*</strong></td>
					</tr>
					<tr>
						<td align="left" class="labeltext" valign="top" width="5%"><strong>Upload
								File</strong></td>
						<td align="left" class="labeltext" valign="top" width="18%"><html:file
								styleId="" property="batchFile" size="40" /></td>
					</tr>

					<tr>
						<td align="left" class="labeltext" valign="top" width="5%">&nbsp;</td>
						<td align="left" class="labeltext" valign="top" width="18%">
							<input type="button" name="c_btnupladbatch" id="c_btnupladbatch"
							value="Upload" class="light-btn" onclick="validate()" /> <%--						<input type="button" name="c_btnreset" id="c_btnreset" value="Reset" class="light-btn" onclick="clearData()"/>--%>
						</td>
					</tr>
				</table>
			</td>
