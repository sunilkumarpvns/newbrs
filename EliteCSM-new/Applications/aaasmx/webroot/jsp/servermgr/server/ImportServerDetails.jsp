...
<html:form action="/importNetServerConfigurationDetail"
	enctype="multipart/form-data">
	<html:hidden name="importNetServerConfigurationForm"
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="tblheader-bold" colspan="2"><bean:message
								bundle="servermgrResources" key="servermgr.importserverdetails" /></td>
					</tr>
					<tr>
		...
		<tr>
			<td class="btns-td" valign="middle"><input type="button"
				...
				onclick="javascript:location.href='<%=localBasePath%>/viewNetServerInstance.do?netserverid=<bean:write name="importNetServerConfigurationForm" property="netServerId"/>'"
