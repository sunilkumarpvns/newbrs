...
<bean:define id="netStartStopForm" name="netServerStartStopForm"
	scope="request"
	type="com.elitecore.elitesm.web.servermgr.server.forms.NetServerStartStopForm" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<logic:equal name="netServerStartStopForm"
						property="netSeverStatus" value="false">
						<td class="tblheader-bold" colspan="2"><bean:message
								bundle="servermgrResources" key="servermgr.startserverdetails" />
						</td>
					</logic:equal>
					...
					<logic:notEqual name="netStartStopForm" property="netSeverStatus"
						...
						<logic:equal name="netStartStopForm"
							property="netServerRestartStatus" value="false">
							<td class="tblheader-bold" colspan="2"><bean:message
									bundle="servermgrResources" key="servermgr.stopserverdetails" />
							</td>
						</logic:equal>

						<logic:equal name="netStartStopForm"
							property="netServerRestartStatus" value="true">
							<td class="tblheader-bold" colspan="2"><bean:message
									bundle="servermgrResources" key="servermgr.Restartserverstatus" />
							</td>
						</logic:equal>
					</logic:notEqual>
	...
	<tr>
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<logic:equal name="netStartStopForm" property="configInSyncState"
						value="false">
						<td id="notes" class="small-text-grey" height="25%">
							<div id="syncnotediv" style="hight: 25%">
								<font color="#FF1F00">Note: - Server Configurations Found
									Unsynchronized. To Reflect These Changes on Server, Please
									Synchronize Server Configurations.</font>
								<div>
						</td>
					</logic:equal>
				</tr>
				...
				<tr class="captiontext">
					<logic:equal name="netServerStartStopForm"
						...
						<td id="notes" class="small-text-grey" height="25%">
							<div id="notediv" style="hight: 25%">
								Note:- This operation will start the Server using Connection
								Details supplied in Admin Interface.
								<div>
						</td>
					</logic:equal>
					...
					<logic:notEqual name="netStartStopForm" property="netSeverStatus"
						...
						<logic:equal name="netStartStopForm"
							...
							<td id="notes" class="small-text-grey" height="25%">
								<div id="notediv" style="hight: 25%">
									Note:- Restart Operation will Stop Sever, and Start Server
									using Connection Details supplied in Admin Interface.
									<div>
							</td>
						</logic:equal>
						<logic:equal name="netStartStopForm"
							...
							<td id="notes" class="small-text-grey" height="25%">
								<div id="notediv" style="hight: 25%">
									Note:- Server Restart Process is
									Running.....&nbsp;&nbsp;&nbsp;&nbsp;<img
										src="<%=request.getContextPath()%>/images/loading.gif"></img>
									<div>
							</td>
						</logic:equal>
					</logic:notEqual>
	...
	<tr>
		<td class="btns-td" valign="middle"><logic:equal
				name="netServerStartStopForm" property="netSeverStatus"
				value="false">
				<input type="button" name="c_btnStartup" onclick="startServer()"
					id="c_btnStart" value="Start Server" class="light-btn" />
			</logic:equal> <logic:notEqual name="netStartStopForm" property="netSeverStatus"
				value="false">

				<logic:equal name="netStartStopForm"
					property="netServerRestartStatus" value="false">
					<input type="button" name="c_btnShutdown" onclick="stopServer()"
						id="c_btnShutdown" value="Stop Server" class="light-btn">
					<input type="button" name="c_btnRestart" onclick="restartServer()"
						id="c_btnRestart" value="Restart Server" class="light-btn">
			...
			</logic:notEqual> <input type="reset" name="c_btnDeletePolicy" value="Cancel"
			class="light-btn"
			onclick="javascript:location.href='<%=request.getContextPath()%>/viewNetServerInstance.do?netserverid=<%=netServerId%>'">
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
