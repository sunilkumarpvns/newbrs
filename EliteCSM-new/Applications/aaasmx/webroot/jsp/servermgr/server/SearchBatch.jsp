				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="32%">
							...
							onclick="popUpCalendar(this, document.forms[0].dateFrom)"> <img
								...
								property="dateTo" size="15" maxlength="15" readonly="true" /> <a
							href="javascript:void(0)"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="32%"><html:text
								styleId="reason" property="reason" size="25" /></td>
					</tr>
					<tr>
						<td align="left" class="labeltext" valign="top" width="10%">User
							Name</td>
						<td align="left" class="labeltext" valign="top" width="32%">
							<html:select styleId="userName" property="userName"
								style="width:120;">
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="32%">
							...
							class="light-btn" onclick="validateCreate()" /> &nbsp; <input
							type="button" name="clear" value=" Reset " class="light-btn"
							onclick="clearData()" />
						</td>
					</tr>
							...
							<table border="0" cellSpacing="0" cellPadding="0">
								<tr>
									<td align="left" valign="top" width="2%" class="tblheader-bold"><input
										...
										onclick="checkAll()" /></td>
									<td align="left" class="tblheader" valign="top" width="6%">Sr.
										No.</td>
									<td align="left" class="tblheader" valign="top" width="15%">Date
										and Time</td>
									<td align="left" class="tblheader" valign="top" width="10%">Batch
										Id</td>
								...
								<tr>
									<td align="left" class="tblfirstcol"><input
										type="checkbox" name="select" value="<%=batchId%>" /></td>
									...
									<td align="left" class="tblrows"><a href=""
										onclick="return popup('<%=basePath%>/viewBatchInfo.do?batchId=<%=batchId%>&netserverid=<bean:write name="searchBatchForm" property="serverId"/>','notes')">
								...
								<tr>
									<td colspan="8" align="center" class="tblfirstcol"><input
										type="button" name="checkInBatch_btn" value="Check In Batch"
										class="light-btn" onclick="checkInBatch()" /> <input
										type="button" name="undoCheckedOut_btn"
										value="Undo Checked Out" class="light-btn"
										onclick="undoCheckedOut()" /> <input type="button"
										name="updateBatch_btn" value="Update Batch" class="light-btn"
										onclick="updateBatch()" /></td>
								</tr>
								<%--										<tr>--%>
