			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="tblheader-bold" colspan="2"><bean:message
							bundle="servermgrResources" key="servermgr.softrestartdetails" /></td>
				</tr>
				<tr>
	...
	<tr>
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="small-text-grey">Note : This operation will affect
						Soft-Restart of Server.</td>
				</tr>
			</table>
		</td>
	</tr>
