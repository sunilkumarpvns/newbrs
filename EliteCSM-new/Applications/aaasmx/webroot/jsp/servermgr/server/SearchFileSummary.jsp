		...
		<tr>
			<td valign="top" align="right">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="tblheader-bold" colspan="3">CDR File Search
							Summary</td>
					</tr>
					...
					<tr>
						<td align="left" class="labeltext" width="10%"><strong>Group
								Field&nbsp;:&nbsp;</strong> <html:select styleId="groupField"
								property="groupField" name="searchFileSummaryForm">
						...
						<td colspan="2">
							<table border="1" cellSpacing="0" cellPadding="0">
								...
								<tr>
									...
									<%} %>
									<td align="left" class="tblrows"><%=failed%></td>
									<td align="left" class="tblrows"><%=collected%></td>
									<td align="left" class="tblrows"><%=inCollection%></td>
								...
								<% } else {  %>
								<tr>
									<td align="center" class="tblrows" colspan="8">No Records
										Found...</td>
								</tr>
								<% } %>
