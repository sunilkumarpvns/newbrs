	...
	<tr>
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td colspan="1" align="left" class="tblfirstcol" valign="top"><bean:message
							bundle="servermgrResources" key="servermgr.servername" /></td>
					<td colspan="3" align="left" class="tblcol" valign="top"><bean:write
							name="eliteLiveServerDetails" property="name" />&nbsp;</td>
				</tr>
				<tr>
					<td align="left" class="tblfirstcol" valign="top" width="20%"><bean:message
							bundle="servermgrResources" key="servermgr.serveridentification" /></td>
					<td align="left" class="tblcol" valign="top" width="30%"><bean:write
							name="eliteLiveServerDetails" property="identification" />&nbsp;</td>
					<td align="left" class="tblfirstcol" valign="top" width="20%"><bean:message
							bundle="servermgrResources" key="servermgr.serverversion" /></td>
					<td align="left" class="tblcol" valign="top" width="30%"><bean:write
							name="eliteLiveServerDetails" property="version" />&nbsp;</td>
				</tr>
				<tr>
					<td align="left" class="tblfirstcol" valign="top"><bean:message
							bundle="servermgrResources"
							key="servermgr.server.serverstartupdatetime" /></td>
					...
					<td align="left" class="tblfirstcol" valign="top"><bean:message
							bundle="servermgrResources"
							key="servermgr.server.softstartdatetime" /></td>
				...
				<tr>
					<td align="left" class="tblfirstcol" valign="top"><bean:message
							bundle="servermgrResources"
							key="servermgr.server.cachereloaddatetime" /></td>
					...
					<td align="left" class="tblfirstcol" valign="top"><bean:message
							bundle="servermgrResources"
							key="servermgr.server.serverreloaddatetime" /></td>
				...
				<tr>
					<td class="blue-text-bold"><bean:message
						...
						<bean:message bundle="servermgrResources"
							...
							name="netServerInstanceData" property="adminHost" /><br> <bean:message
							bundle="servermgrResources" key="servermgr.admininterfaceport" />
				...
				<tr>
					<td valign="middle" colspan="5">
						<%if(!errorCode.equalsIgnoreCase("0")){%> <input type="button"
						name="c_btnStartup" onclick="startServer()" id="c_btnStart"
						value="Start Server" class="light-btn" /> <%} %> <% if(errorCode.equalsIgnoreCase("0")){ %>
						<input type="button" name="c_btnShutdown" onclick="stopServer()"
						id="c_btnShutdown" value="Stop Server" class="light-btn" /> <input
						type="button" name="c_btnSoftRestart"
						onclick="javascript:location.href='<%=basePath%>/signalSoftRestart.do?netServerId=<%=netServerId %>'"
						id="c_softRestart" value="Soft Restart" class="light-btn" /> <input
						type="button" name="c_btnReloadConfig"
						onclick="javascript:location.href='<%=basePath%>/signalServerReloadConfiguration.do?netServerId=<%=netServerId %>'"
						id="c_btnReloadConfig" value="Reload Configuration"
						class="light-btn" /> <input type="button" name="c_btnReloadCache"
						onclick="javascript:location.href='<%=basePath%>/signalServerReloadCache.do?netServerId=<%=netServerId %>'"
						id="c_btnReloadCache" value="Reload Cache" class="light-btn" /> <%} %>
