...
<%@ page import="com.elitecore.elitesm.web.servermgr.server.forms.ViewUserfileDatasourceUserAccountForm" %>
<%
                  			...
                  			<tr>
			                	 	    ...
			                	 	    <tr>
			                	 	     ...
			                	 	     <tr>
			                	 	      ...
			                	 	      <tr>
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.param4" />
					                        </td>    
 			        		                <td class="tblfirstcol" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="param4" property="param4"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      <tr>
			                	 	   		<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.param5" />
					                        </td>    
 			        		                <td class="tblfirstcol" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="param5" property="param5"/>
 			        		                </td>
			                	 	      </tr>
			                	 	     <tr>
			                	 	   		<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.gracepolicy" />
					                        </td>    
 			        		                <td class="tblfirstcol" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="gracePolicy" property="gracePolicy"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      <tr>
			                	 	   		<td class="topHLine">
			                	 	      ...
			                	 	      <tr>
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.imsi" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="imsi" property="imsi"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      ...
			                	 	      <tr>
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.meid" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="meid" property="meid"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      ...
			                	 	      <tr>
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.msisdn" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="msIsdn" property="msIsdn"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      ...
			                	 	      <tr>
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.mdn" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="mdn" property="mdn"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      ...
			                	 	      <tr>
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.imei" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="imei" property="imei"/>
 			        		                </td>
			                	 	      </tr>
											...
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.deveicevendor" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="deviceVendor" property="deviceVendor"/>
 			        		                </td>
			                	 	      </tr>
											...
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.deveicename" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="deviceName" property="deviceName"/>
 			        		                </td>
			                	 	      </tr>
											...
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.deveiceport" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="devicePort" property="devicePort"/>
 			        		                </td>
			                	 	      </tr>
											...
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.deveicvlan" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="deviceVLAN" property="deviceVLAN"/>
 			        		                </td>
			                	 	      </tr>
											...
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="20%" height="20%" colspan="3" align="left">
					                           	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message bundle="servermgrResources" key="servermgr.userfile.geoLocation" />
					                        </td>    
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="geoLocation" property="geoLocation"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      ...
			                	 	      <tr>
 			        		                ...
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="framedIPV4Address" property="framedIPV4Address"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      ...
			                	 	      <tr>
 			        		                ...
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="framedIPV6Prefix" property="framedIPV6Prefix"/>
 			        		                </td>
			                	 	      </tr>
			                	 	      ...
			                	 	      <tr>
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="framedPool" property="framedPool"/>
 			        		                </td>
			                	 	      </tr>
											...
											<td class="topHLine">
 			        		                ...
 			        		                <td class="topHLine" width="50%" height="20%" colspan="2" align="left">
 			        		                	<html:text name="viewUserfileDatasourceUserAccountForm" styleId="authorizationPolicyGroup" property="authorizationPolicyGroup"/>
 			        		                </td>
			                	 	      </tr>
			                    ...
			                    <tr>
 			        		                ...
 			        		                <td width="50%" colspan="1">
 			        		                	&nbsp;&nbsp;&nbsp;
 			        		                	 <input name="c_btnAdd" type="button" class="light-btn"  onclick="javascript:location.href='<%=basePath%>/listUserfileAccountInformation.do?netserverid=<%=viewUserfileDatasourceUserAccountForm.getNetServerId()%>&selectedFileName=<%=viewUserfileDatasourceUserAccountForm.getFileName()%>'" id="c_btnAdd" value="   Cancel  ">
 			        		                </td>
			                	 	    </tr>  
            		        	</tr>
		                </table>
