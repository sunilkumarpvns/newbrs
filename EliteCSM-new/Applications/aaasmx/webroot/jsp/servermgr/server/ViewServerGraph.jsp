...
<%@page import="com.elitecore.elitesm.web.servermgr.server.forms.ViewServerGraphForm"%>

<%
ViewServerGraphForm charForm = (ViewServerGraphForm)request.getAttribute("viewServerGraph");
	       ...
	       <tr> 
			...
			<tr>
				<td colspan="3">
					...
					<%if(chartList!=null){ %>
					<logic:iterate id="chartTypeBean" name="viewServerGraph" property="chartList" type="com.elitecore.elitesm.web.servermgr.ChartTypeBean">
