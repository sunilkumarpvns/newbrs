...
<%@ page import="com.elitecore.elitesm.web.servermgr.server.forms.ViewSupportedRFCForm"%>
<%
 						...
 						<tr>
 							<td>
 								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									%>
										 <logic:iterate id="liveSNMPRFCdata" name="viewSupportedRFCForm" property="supportedRFC" type="com.elitecore.elitesm.web.servermgr.server.forms.LiveSNMPRFCData">
									<tr>
