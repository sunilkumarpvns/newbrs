			...
			<td valign="top" align="right">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td align="left" class="tblrows" valign="top" width="18%"><html:text
								styleId="purgeDate" property="purgeDate" size="18"
								maxlength="15" readonly="true" /> <a href="javascript:void(0)"
							onclick="popUpCalendar(this, document.forms[0].purgeDate)"> <img
					...
					<tr>
						...
						<td align="left" class="tblrows" valign="top" width="18%"><html:select
								styleId="purgeHour" property="purgeHour" style="width:50;">
							...
							</html:select> Hours &nbsp;&nbsp;&nbsp;&nbsp; <html:select
								styleId="purgeMinute" property="purgeMinute" style="width:50;">
								<html:option value="00">00</html:option>
								<html:option value="01">01</html:option>
								<html:option value="02">02</html:option>
								<html:option value="03">03</html:option>
					...
					<tr>
						...
						<td align="left" class="tblrows" valign="top" width="18%"><input
							type="button" name="btn_purgeNow" value="Purge Now"
							class="light-btn" onclick="purgeNow()" /> <input type="button"
							name="btn_clear" value="Reset" class="light-btn"
							onclick="clearData()" /></td>
					</tr>
				</table>
			</td>
		</tr>
