...
<html:form action="/updateNetServerSynchronizeBackConfigDetail">
	<html:hidden name="updateNetServerSynchronizeBackConfigDetailForm"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="tblheader-bold" colspan="2"><bean:message
								...
								key="servermgr.synchronizebackserverdetails" /></td>
					</tr>
					<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="small-text-grey">Note : All Services and its
							Details within this Server Instance would be Updated.</td>
					</tr>
				</table>
			</td>
		</tr>
