...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="tblheader-bold" colspan="2"><bean:message
							bundle="servermgrResources" key="servermgr.startserverdetails" /></td>
				</tr>
				<tr>
	...
	<tr>
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="small-text-grey">Note: This operation will start
						the Server using Connection Details supplied in Admin Interface.</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td class="btns-td" valign="middle"><input type="button"
			...
			value="Start Server" class="light-btn" /> <input type="reset"
			name="c_btnDeletePolicy" value="Cancel" class="light-btn"
