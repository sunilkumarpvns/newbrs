...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="tblheader-bold" colspan="2"><bean:message
							bundle="servermgrResources" key="servermgr.stopserverdetails" /></td>
				</tr>
				<tr>
	...
	<tr>
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="small-text-grey">Note : This operation will
						terminate the Server.</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td class="btns-td" valign="middle"><input type="button"
			name="c_btnShutdown" onclick="stopServer()" id="c_btnShutdown"
			value="Stop Server" class="light-btn"> <input type="reset"
