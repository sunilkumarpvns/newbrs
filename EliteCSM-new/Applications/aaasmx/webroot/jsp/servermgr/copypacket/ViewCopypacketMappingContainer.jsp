    			...
    			<tr>
					...
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">	
							<tr>	
								<td>
									<%@ include file="/jsp/servermgr/copypacket/ViewCopypacketMappingConfigBasicDetail.jsp" %>
				  				</td>
							</tr>	
							<tr>
								<td valign="top" align="right" >
									<%@ include file="/jsp/servermgr/copypacket/ViewCopypacketMappingConfigDetail.jsp" %>
				  				</td>
							</tr>
    					</table>
    					</td>	
						<td width="168" class="grey-bkgd" valign="top">
							<%@ include file="/jsp/servermgr/copypacket/CopypacketMappingConfigNavigation.jsp" %>
						</td> 
					</tr>
				</table>
			</td>
