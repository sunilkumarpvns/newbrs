...
<script language="javascript">
   function editDetail()
   {
  	  location.href='<%=basePath%>/serverAllCertificates.do?method=initUpdateCrl&crlCertificateId='+'<%=crlCertificateData.getCrlCertificateId()%>';  
   }
   
   function viewDetail()
   {
  	  location.href='<%=basePath%>/serverAllCertificates.do?method=viewCrl&crlCertificateId='+'<%=crlCertificateData.getCrlCertificateId()%>';  
   }  
