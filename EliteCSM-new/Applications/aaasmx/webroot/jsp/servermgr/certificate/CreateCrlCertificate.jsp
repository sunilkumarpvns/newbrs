...
<html:form action="/serverAllCertificates?method=createCrl" enctype="multipart/form-data" styleId="certificateForm">
									...
									<table width="60%" name="c_tblCreateCrlCertificate" id="c_tblCreateCrlCertificate" align="left" cellSpacing="0" cellPadding="0" border="0">
								 		<tr>
											 <td align="left" class="labeltext" valign="top" width="30%">
												...
												text="server.crlcertificate.name" header="servermgr.crlcertificate.name"/>
											</td>
											<td align="left" class="labeltext" valign="top"	nowrap="nowrap">
												<html:text name="serverCertificateForm" property="crlCertificateName" styleId="crlCertificateName" size="30" tabindex="1" maxlength="256" onblur="verifyName();" style="width:250px" />
										...
										<tr>
											<td align="left" class="labeltext" valign="top" width="25%">
												...
												<ec:elitehelp headerBundle="servermgrResources" 
												text="server.crlcertificate.crlcert" header="servermgr.crlcertificate"/>
											</td>
											<td align="left" class="labeltext" valign="top" nowrap="nowrap">
