    			...
    			<tr>
					...
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">	
							<tr>	
								<td>
									<%@ include file="/jsp/servermgr/transmapconf/ViewTranslationMappingConfigBasicDetail.jsp" %>
				  				</td>
							</tr>	
							<tr>
								<td valign="top" align="right">
									<%@ include file="/jsp/servermgr/transmapconf/ViewCrestelRatingTransMapConf.jsp" %>
				  				</td>
							</tr>
    					</table>
    					</td>	
						<td width="168" class="grey-bkgd" valign="top">
							<%@ include file="/jsp/servermgr/transmapconf/TranslationMappingConfigNavigation.jsp" %>
						</td>
					</tr>
				</table>
			</td>
