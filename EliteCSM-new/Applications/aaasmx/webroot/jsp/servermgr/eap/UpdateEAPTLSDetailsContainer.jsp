...
<%@page import="com.elitecore.elitesm.datamanager.servermgr.eap.data.VendorSpecificCertificateData" %>
<%
										...
										<tr>
											<td>
												<table width="100%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td valign="top" colspan="4"><%@ include
																file="ViewEAPBasicInfo.jsp"%></td>
													</tr>
													<tr>
														<td valign="top" colspan="4"><%@ include
																file="UpdateEAPTLSDetails.jsp"%>
														</td>
													</tr>
