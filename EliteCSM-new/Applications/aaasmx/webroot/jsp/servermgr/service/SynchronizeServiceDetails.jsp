...
%>
	...
	<tr>
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				height="15%">
				<tr>
					<td class="tblheader-bold" colspan="2">Synchronize Service
						Details</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left" class="labeltext" valign="top" width="10%">Admin
						IP</td>
	...
	<tr>
		<td valign="top" align="right">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				height="15%">
				<tr>
					<td class="small-text-grey">Note : All Configurations for this
						Service would be Updated.</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td class="btns-td" valign="middle"><input type="button"
			...
			onclick="javascript:location.href='<%=localBasePath%>/jsp/servermgr/ServiceContainer.jsp'"
