...
<%@ page import="com.elitecore.elitesm.datamanager.servermgr.data.NetDriverInstanceData"%>
<%@ page import="com.elitecore.elitesm.web.servermgr.service.forms.ViewNetServiceDriversInstanceForm" %>
<%@ page import="com.elitecore.elitesm.web.servermgr.service.forms.ViewNetServiceDriverDetailForm" %>
...
%>
				<logic:iterate id="netDriverInstanceData" name="viewNetServiceDriverDetailForm" property="netServiceDriverDetailBean" type="com.elitecore.elitesm.web.servermgr.service.forms.NetServiceDriverDetailBean">
                      <tr>
...
<%--	   					<td align="left" class="tblrows"><bean:write name="netDriverInstanceData" property="displayName"/></td>  --%>
						...
						<td align="left" class="tblrows">
						  <logic:iterate id="netDriverTypeData" name="netDriverTypeList" type="com.elitecore.elitesm.datamanager.servermgr.data.INetDriverTypeData"> 				  
