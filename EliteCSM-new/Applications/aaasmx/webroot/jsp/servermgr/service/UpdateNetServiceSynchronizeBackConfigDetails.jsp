...
<html:form action="/updateNetServiceSynchronizeBackConfigDetail">
	<html:hidden name="updateNetServiceSynchronizeBackConfigDetailForm"
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="tblheader-bold" colspan="2"><bean:message
								...
								key="servermgr.synchronizebackservicedetails" /></td>
					</tr>
					<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="small-text-grey">Note : All Drivers and its
							Details within this Service Instance along with it's
							configuration would be Updated.</td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td class="btns-td" valign="middle"><input type="button"
				...
				onclick="javascript:location.href='<%=localBasePath%>/synchronizeBackNetServiceConfig.do?netServiceId=<bean:write name="netServiceInstanceBean" property="netServiceId"/>'"
				id="c_btnSynchronize" value=" Synchronize " class="light-btn">
