...
<jsp:directive.page import="com.elitecore.elitesm.web.servermgr.service.forms.ViewLiveServiceRequiredDetailForm"/>
...
<html:form action="/viewRequiredAttribute">
	...
	<table width="100%" name="c_tblCrossProductLis id="c_tblCrossProductList align="right" border="0">
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
