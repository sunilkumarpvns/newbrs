...
<%@ page import="com.elitecore.elitesm.web.servermgr.server.forms.ViewCSVForm"%>
<%@ page import="java.util.*"%>

<%@ page import="com.elitecore.elitesm.datamanager.servermgr.data.INetServerInstanceData"%>
<%@ page import="com.elitecore.elitesm.datamanager.servermgr.data.INetServiceInstanceData"%>
<%@ page import="com.elitecore.elitesm.web.servermgr.server.forms.LiveCSVData"%>
...
%>	
		...
		%>
										<tr>
											<td align="left" colspan="4">
												<logic:iterate id="liveCSVDataForNoOfRecords" name="viewCSVForm" property="lstNumberOfRecords" type="com.elitecore.elitesm.web.servermgr.server.forms.LiveCSVData">
													<tr>
		...
		<%} %>								
									  ...
									  <logic:iterate id="liveCSVData" name="viewCSVForm" property="listCSV" type="com.elitecore.elitesm.web.servermgr.server.forms.LiveCSVData">
						                <tr>
