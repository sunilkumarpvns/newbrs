	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >            						  	
		...
		<tr>
			<td align="center" colspan="2">
				...
				<input type="button" value="Cancel" class="light-btn" onclick="javascript:location.href='<%=basePath%>/updateRadiusGroovyPlugin.do?pluginInstanceId=<%=updateDiameterGroovyPluginForm.getPluginInstanceId() %>'" />
			</td>
		</tr>
	</table>
