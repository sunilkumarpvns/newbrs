...
<% 
	UpdateDiameterGroovyPluginForm updateDiameterGroovyPluginForm = (UpdateDiameterGroovyPluginForm)request.getSession().getAttribute("updateDiameterGroovyPluginForm");
%>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >            						  	
		...
		<tr>
			<td align="center" colspan="2">
				<input type="button" id="validate-groovy" value=" Back " class="light-btn" onclick="javascript:location.href='<%=basePath%>/<%=updateDiameterGroovyPluginForm.getRedirectUrlForViewFile()%>?pluginInstanceId=<%=updateDiameterGroovyPluginForm.getPluginInstanceId() %>'"  />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
  ...
  <script type="text/javascript">
	...
	function getReadGroovyMap(){
		...
		<logic:iterate id="obj" name="updateDiameterGroovyPluginForm" property="groovyDetailsMap">
			...
			var groovyFileName = '<bean:write name="nestedObject" property="groovyFileName"/>';
			
			$('#pluginFileName').html(groovyFileName);
