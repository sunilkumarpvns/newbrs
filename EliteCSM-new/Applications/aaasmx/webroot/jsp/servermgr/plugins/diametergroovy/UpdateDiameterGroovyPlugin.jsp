...
<%
 	UpdateDiameterGroovyPluginForm updateDiameterGroovyPluginForm = (UpdateDiameterGroovyPluginForm) request
 			.getSession()
 			.getAttribute("updateDiameterGroovyPluginForm");
 %>
...
<html:form action="/updateDiameterGroovyPlugin" styleId="diameterGroovyPlugin" method="post" enctype="multipart/form-data">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >            						  	
		...
		<tr>
			<td class="tblheader-bold" width="25%" height="20%" colspan="3">
				<bean:message bundle="pluginResources" key="plugin.diameter.groovyplugin.uploadedfiles" />
			</td>
		</tr>
		<tr>
			<td width="25%" height="20%" colspan="3">
				<div class="plugin-box" align="center">
					<div class="table-header plugin-table-header-css captiontext" style="background-color: #D9E6F6;">Upload Diameter Groovy Files</div>
 ...
 <script type="text/javascript" src="<%=request.getContextPath()%>/js/plugin/diameter-groovy-plugin-update.js"></script>
 ...
 <script type="text/javascript">
	...
	function verifyName() {
		...
		isValidName = verifyInstanceName('<%=InstanceTypeConstants.PLUGIN%>',searchName,'update','<%=updateDiameterGroovyPluginForm.getPluginInstanceId()%>','verifyNameDiv');
	}
