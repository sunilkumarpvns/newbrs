<%@page import="com.elitecore.elitesm.web.plugins.forms.UpdateDiameterGroovyPluginForm"%>
...
<%
	UpdateDiameterGroovyPluginForm updateDiameterGroovyPluginForm = (UpdateDiameterGroovyPluginForm)request.getAttribute("updateDiameterGroovyPluginForm");
%>
 
 <html:form action="/updateDiameterGroovyPlugin" styleId="diameterGroovyPlugin" method="post" enctype="multipart/form-data">
	<html:hidden name="updateDiameterGroovyPluginForm" property="action" styleId="action" value="update" />
	<html:hidden name="updateDiameterGroovyPluginForm" property="pluginType" styleId="pluginType" />
	<html:hidden name="updateDiameterGroovyPluginForm" property="auditUId" styleId="auditUId" />
	<html:hidden name="updateDiameterGroovyPluginForm" property="pluginInstanceId" styleId="pluginInstanceId" />
	<html:hidden name="updateDiameterGroovyPluginForm" property="groovyDatas" styleId="groovyDatas" />
	<html:hidden name="updateDiameterGroovyPluginForm" property="groovyFileName" styleId="groovyFileName" />
	<html:hidden name="updateDiameterGroovyPluginForm" property="redirectUrlForViewFile" styleId="redirectUrlForViewFile" />
	 ...
	 <table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >            						  	
	     ...
	     <tr>
			...
			<td class="tblcol" width="30%" height="20%" >
				<bean:write name="updateDiameterGroovyPluginForm" property="pluginName" />
			</td>
		 </tr>   
	 	 <tr>
			<td class="tblfirstcol" width="20%" height="20%">
			...
			<td class="tblcol" width="30%" height="20%" >
				<bean:write name="updateDiameterGroovyPluginForm" property="description"/>
			</td>
		</tr>
		<tr>
			<td class="tblfirstcol" width="20%" height="20%">
			...
			<td class="tblcol" width="30%" height="20%" valign="middle">
				<logic:equal name="updateDiameterGroovyPluginForm" property="status" value="1">
				    <img src="<%=basePath%>/images/active.jpg"/>&nbsp;&nbsp;&nbsp;<bean:message bundle="servicePolicyProperties" key="servicepolicy.active" />
				</logic:equal>
				<logic:equal name="updateDiameterGroovyPluginForm" property="status" value="0">
		 ...
		 <tr>
			<td class="tblheader-bold" width="20%" height="20%" colspan="2">
				<bean:message bundle="pluginResources" key="upload.diameter.groovyfiles.view.title" />
			</td>
		</tr>
		<tr>
...
<script type="text/javascript">
	...
	function getReadGroovyMap(){
		...
		<logic:iterate id="obj" name="updateDiameterGroovyPluginForm" property="groovyDetailsMap">
	...
	function viewGroovyFileNew(obj){
		var groovyFileName = $(obj).text();
			...
			if(groovyFileName != null && groovyFileName.length > 0){
				...
				$('#redirectUrlForViewFile').val('initViewDiameterGroovyPlugin.do');
				
				document.forms['diameterGroovyPlugin'].submit();
			}
		}
