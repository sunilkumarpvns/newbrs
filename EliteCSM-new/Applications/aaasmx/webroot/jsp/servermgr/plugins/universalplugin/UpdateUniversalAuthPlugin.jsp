...
<html:form action="/updateUniversalAuthPlugin" styleId="uniPlugin">

	<html:hidden name="updateUniversalAuthPluginForm" property="action" value="update" />
	<html:hidden name="updateUniversalAuthPluginForm" property="universalPluginPolicyJson" styleId="universalPluginPolicyJson" />
	<html:hidden name="updateUniversalAuthPluginForm" property="pluginType" styleId="pluginType" />
	<html:hidden name="updateUniversalAuthPluginForm" property="auditUId" styleId="auditUId" />
	<html:hidden name="updateUniversalAuthPluginForm" property="pluginInstanceId" styleId="pluginInstanceId" />
...
<%@include file="/jsp/servermgr/plugins/universalplugin/UpdatePreAuthPlugin.jsp" %>
<%@include file="/jsp/servermgr/plugins/universalplugin/UpdatePostAuthPlugin.jsp" %>
