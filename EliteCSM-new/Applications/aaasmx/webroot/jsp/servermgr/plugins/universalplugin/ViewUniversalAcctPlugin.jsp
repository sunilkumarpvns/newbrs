<%@page import="com.elitecore.elitesm.web.plugins.forms.UpdateUniversalAcctPluginForm"%>
<%@page import="com.elitecore.elitesm.util.constants.EliteViewCommonConstant"%>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/plugin/universal-acct-plugin-view.js"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/plugin/plugin-button.css" />

<%
	UpdateUniversalAcctPluginForm updateUniversalAcctPluginForm = (UpdateUniversalAcctPluginForm) request.getAttribute("updateUniversalAcctPluginForm"); 
%>
 
 <html:form action="/updateUniversalAcctPlugin" styleId="uniAuthPlugin">
	 ...
	 <table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >            						  	
	     ...
	     <tr>
			...
			<td class="tblcol" width="30%" height="20%" >
				<bean:write name="updateUniversalAcctPluginForm" property="pluginName" />
			</td>
		 </tr>   
	 	 <tr>
			<td class="tblfirstcol" width="20%" height="20%">
			...
			<td class="tblcol" width="30%" height="20%" >
				<bean:write name="updateUniversalAcctPluginForm" property="description"/>
			</td>
		</tr>
		 <tr>
			<td class="tblfirstcol" width="20%" height="20%">
			...
			<td class="tblcol" width="30%" height="20%" valign="middle">
				<logic:equal name="updateUniversalAcctPluginForm" property="status" value="1">
				    <img src="<%=basePath%>/images/active.jpg"/>&nbsp;&nbsp;&nbsp;<bean:message bundle="servicePolicyProperties" key="servicepolicy.active" />
				</logic:equal>
				<logic:equal name="updateUniversalAcctPluginForm" property="status" value="0">
		...
		<% if (updateUniversalAcctPluginForm.getUniversalPluginPolicyJson() != null) { %>
...
<%@include file="/jsp/servermgr/plugins/universalplugin/ViewPreAcctPlugin.jsp" %>
<%@include file="/jsp/servermgr/plugins/universalplugin/ViewPostAcctPlugin.jsp" %>
