	...
	<tr>
		<td colspan="2" valign="top">
			<%
				...
				String viewPluginHistory = navigationBasePath+"/viewUniversalAuthPluginHistory.do?pluginInstanceId="+pluginInstData.getPluginInstanceId()+"&auditUid="+pluginInstData.getAuditUId()+"&name="+pluginInstData.getName();;	
			%>
