														...
														<tr>
															<td colspan="5">
																<table width="100%" cellspacing="0" cellpadding="0" border="0" class="box">
																	<tr>
																		<td class="labeltext" width="25%" style="border-right:1px solid #ccc;font-weight: bold;background-color: #D9E6F6;">
																			<bean:message bundle="pluginResources" key="plugin.universalpolicy.name" />
																		</td>
																		<td class="labeltext" width="25%" style="border-right:1px solid #ccc">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" id="post-param-list-tbl-template" style="display: none;">
	<tr>
		...
		<td class="tbl-plugin-rows" width="20%">
