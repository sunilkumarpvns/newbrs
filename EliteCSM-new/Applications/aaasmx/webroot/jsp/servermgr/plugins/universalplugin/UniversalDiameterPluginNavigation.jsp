...
<%@page import="com.elitecore.elitesm.datamanager.servermgr.plugins.universalplugin.data.UniversalPluginData"%>
	...
	<tr>
		<td colspan="2" valign="top">
			<%
				...
				UniversalPluginData universalPluginData = null;
				
				if(pluginInstData!=null){
					Set universalAuthPluginSet = pluginInstData.getUniversalPluginDetails();
					if(universalAuthPluginSet!=null && !universalAuthPluginSet.isEmpty()){
						Iterator iterator = universalAuthPluginSet.iterator();
						if(iterator.hasNext()){
							universalPluginData = (UniversalPluginData)iterator.next();
						}
					}
				}
				...
				String viewPluginHistory = navigationBasePath+"/viewUniversalDiameterPluginHistory.do?pluginInstanceId="+pluginInstData.getPluginInstanceId()+"&auditUid="+pluginInstData.getAuditUId()+"&name="+pluginInstData.getName();;	
			%>
