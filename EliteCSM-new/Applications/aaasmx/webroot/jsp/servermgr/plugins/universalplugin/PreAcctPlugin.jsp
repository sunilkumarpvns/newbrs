							...
							<table border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									...
									<td width="1%" style="background-color: #D9E6F6;">
										<div class="switch">
										  <input id="preAcctHandlerEnabledDisabled" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" />
										  <label for="preAcctHandlerEnabledDisabled" class="handlerLabel"></label>
										</div>
									</td>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="parameterlist-pre-mapping-table">
								...
								<tr>
									<td class="captiontext">
										...
										<ec:elitehelp  header="plugin.universalpolicy.rejectoncheckitemnotfound" headerBundle="pluginResources" text="plugin.universalpolicy.rejectoncheckitemnotfound" ></ec:elitehelp>
									</td>
									<td class="labeltext">
										<select class="select_width" name="rejectOnCheckedItemNotFound" >
								...
								<tr>
									<td class="captiontext labeltext" colspan="2" style="padding-left: 25px;">
										<input type="button" value="Add Parameter" class="light-btn" onclick="addParameterList('pre-param-list-tbl-mapping','pre-param-list-tbl-template',this);" />
									</td>
								</tr>
								<tr>
	...
	<tr>
		...
		<td class="tbl-plugin-rows" width="18.6%">
			<select name="packet_type" class="full-width noborder">
				<option value="4">Accounting Request</option>
