...
<html:form action="/updateUniversalDiameterPlugin" styleId="uniDiameterPlugin">

	<html:hidden name="updateUniversalDiameterPluginForm" property="action" value="update" />
	<html:hidden name="updateUniversalDiameterPluginForm" property="universalPluginPolicyJson" styleId="universalPluginPolicyJson" />
	<html:hidden name="updateUniversalDiameterPluginForm" property="pluginType" styleId="pluginType" />
	<html:hidden name="updateUniversalDiameterPluginForm" property="auditUId" styleId="auditUId" />
	<html:hidden name="updateUniversalDiameterPluginForm" property="pluginInstanceId" styleId="pluginInstanceId" />
...
<%@include file="/jsp/servermgr/plugins/universalplugin/UpdateUniversalInPlugin.jsp" %>
<%@include file="/jsp/servermgr/plugins/universalplugin/UpdateUniversalOutPlugin.jsp" %>
