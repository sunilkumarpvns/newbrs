							...
							<table border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									...
									<td width="1%" style="background-color: #D9E6F6;">
										<div class="switch">
										  <input id="postAcctHandlerEnabledDisabled" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" />
										  <label for="postAcctHandlerEnabledDisabled" class="handlerLabel"></label>
										</div>
									</td>
	...
	<tr>
		...
		<td class="tbl-plugin-rows" width="18.6%">
			<select name="packet_type" class="full-width noborder">
				<option value="5">Accounting Response</option>
