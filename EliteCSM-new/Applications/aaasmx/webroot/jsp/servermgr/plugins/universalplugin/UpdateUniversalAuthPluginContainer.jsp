    					...
    					<table width="100%" border="0" cellspacing="0" cellpadding="0">				
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">	
									<tr>	
										<td>		
											<%@ include file="/jsp/servermgr/plugins/universalplugin/UpdateUniversalAuthPlugin.jsp"%>
		    							</td>	
									</tr>
								</table>
								</td>
								<td width="168" class="grey-bkgd" valign="top">
									<%@ include file="/jsp/servermgr/plugins/universalplugin/UniversalAuthPluginNavigation.jsp"%>
								</td>
							</tr>
					</table>
				</td>
