							...
							<table border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									...
									<td width="1%" style="background-color: #D9E6F6;">
										<div class="switch">
										  <input id="uniInHandlerEnabledDisabled" name="isHandlerEnabled" class="is-handler-enabled is-handler-enabled-round" type="checkbox" value="true" checked="checked" onclick="changeValueOfFlow(this);" />
										  <label for="uniInHandlerEnabledDisabled" class="handlerLabel"></label>
										</div>
									</td>
