	...
	<tr>
		<td colspan="2" valign="top">
			<%
				...
				String viewPluginHistory = navigationBasePath+"/viewUserStatPostAuthPluginHistory.do?pluginInstanceId="+pluginInstData.getPluginInstanceId()+"&auditUid="+pluginInstData.getAuditUId()+"&name="+pluginInstData.getName();;	
			%>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr id=header1>
					...
					<td class="subLinksHeader" width="13%">
						<a href="javascript:void(0)" onClick="STB('UpdateUserStatPostAuthPlugin');swapImages()">
				...
				<tr id=header1>
					...
					<td class="subLinksHeader" width="13%">
						<a href="javascript:void(0)" onClick="STB('ViewUserStatPostAuthPlugin');swapImages()">
							<img src="<%=navigationBasePath%>/images/sublinks-dnarrow.jpg" border="0" name="arrow">
						</a>
					</td>
				</tr>
