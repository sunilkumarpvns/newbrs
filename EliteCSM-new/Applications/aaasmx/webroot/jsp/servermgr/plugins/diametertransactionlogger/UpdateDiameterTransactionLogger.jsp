...
<html:form action="/updateDiameterTransactionLogger" styleId="diameterTransactionLogger" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	function  validateTransactionLogger(){
		...
		if($('#pluginName').val() == ""){
			...
			document.forms['diameterTransactionLogger'].pluginName.focus();
			return;
