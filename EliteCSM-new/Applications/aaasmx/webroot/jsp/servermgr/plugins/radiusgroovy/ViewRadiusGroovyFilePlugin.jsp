	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >            						  	
		...
		<tr>
			<td align="center" colspan="2">
				<input type="button" id="validate-groovy" value=" Back " class="light-btn" onclick="javascript:location.href='<%=basePath%>/<%=updateRadiusGroovyPluginForm.getRedirectUrlForViewFile()%>?pluginInstanceId=<%=updateRadiusGroovyPluginForm.getPluginInstanceId() %>'"  />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
