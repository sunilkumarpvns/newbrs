...
<% String basePath = request.getContextPath(); %>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td cellpadding="0" cellspacing="0" border="0" width="100%" class="box">
							<div id="main">
								<html:form action="createRadiusGroovyPlugin" styleId="radiusGroovyPlugin" method="post" enctype="multipart/form-data">
					
								<html:hidden name="createRadiusGroovyPluginForm" property="action" value="create" /> 
								<html:hidden name="createRadiusGroovyPluginForm" property="pluginName" styleId="pluginName" />
								<html:hidden name="createRadiusGroovyPluginForm" property="description" styleId="description" />
								<html:hidden name="createRadiusGroovyPluginForm" property="pluginType" styleId="pluginType" />
								<html:hidden name="createRadiusGroovyPluginForm" property="groovyDatas" styleId="groovyDatas" />
								<html:hidden name="createRadiusGroovyPluginForm" property="status" styleId="status" />
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/plugin/radius-groovy-plugin.js"></script>
