    					...
    					<table width="100%" border="0" cellspacing="0" cellpadding="0">				
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">	
									<tr>	
										<td>		
											<%@ include file="/jsp/servermgr/plugins/radiusgroovy/UpdateRadiusGroovyFilePlugin.jsp"%> 
		    							</td>	
									</tr>
								</table>
								</td>
								<td width="168" class="grey-bkgd" valign="top">
									<%@ include file="/jsp/servermgr/plugins/radiusgroovy/RadiusGroovyPluginNavigation.jsp"%>
								</td>
							</tr>
					</table>
				</td>
...
<script>
	setTitle('<bean:message bundle="pluginResources" key="plugin.radius.groovyplugin.title"/>'); 
</script>