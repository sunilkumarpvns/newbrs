				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td cellpadding="0" cellspacing="0" border="0" width="100%" class="box">
							<div id="main">
								<html:form action="createRadiusTransactionLoggerPlugin" styleId="radiusTransactionLogger" method="post">
								...
								<table cellpadding="0" cellspacing="0" border="0" width="100%">
									<tr>
										<td class="table-header" colspan="2">
											<bean:message bundle="pluginResources" key="plugin.radius.transactionlogger.title" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td align="left" class="captiontext padding-top" valign="top">
										...
										<td align="left" class="labeltext padding-top" valign="top" colspan="3">
