...
<%@page import="com.elitecore.elitesm.web.driver.radius.forms.CreateRadiusDetailLocalAcctDriverForm"%>
...
<html:form action="/createRadiusDetailLocalAcctDriver">

	<html:hidden name="createRadiusDetailLocalAcctDriverForm"
		property="action" />
	<html:hidden name="createRadiusDetailLocalAcctDriverForm"
										...
										<td>
											<table cellpadding="0" cellspacing="0" border="0" width="100%">
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:text styleId="eventDateFormat"
															property="eventDateFormat" size="29" tabindex="1"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:select property="useDictionaryValue"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text styleId="location" property="location"
															size="29" tabindex="6" maxlength="50" style="width:250px" /><font
														color="#FF0000"> *</font>
													</td>
												</tr>
											...
											<tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:select property="allocatingProtocol" styleId="allocatingProtocol" style="width:130px" tabindex="17">
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:text styleId="ipaddress" property="ipaddress"
															size="20" tabindex="18" maxlength="50"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:text styleId="remoteLocation"
															property="remoteLocation" size="29" tabindex="19"
															maxlength="50" style="width:250px" />
													</td>
												</tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:text styleId="username" property="userName"
															size="20" tabindex="20" maxlength="50"
															style="width:250px" />
													</td>
												</tr>
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:password styleId="password" property="password" size="20" tabindex="21" maxlength="50" style="width:250px"></html:password>
													</td>
												</tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:select property="postOperation"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:text property="archiveLocation" styleId="archiveLocation" tabindex="23" style="width:250px" maxlength="1024"/>
													</td>
												</tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:text styleId="failOverTime" property="failOverTime"
															size="20" tabindex="24" maxlength="50"
															style="width:250px" />
													</td>
												</tr>
												...
												<tr>
													<td class="btns-td" align="left" colspan="2"><input
														type="button" onclick='addRow("dbMappingTable","mappingtbl");' value=" Add Mapping"
														class="light-btn" style="size: 140px" tabindex="25">
													</td>
												</tr>
												<tr>
													<td class="small-gap" colspan="3">&nbsp;</td>
												...
												<tr>
													<td align="left" class="captiontext" colspan="3" valign="top">
														<table width="97%" id="mappingtbl" cellpadding="0" cellspacing="0">
															<tr>
												...
												<tr>
													...
													<td class="btns-td" valign="middle" colspan="2"><input
														...
														onclick="validateForm()" tabindex="30"> <input
														type="reset" name="c_btnDeletePolicy" tabindex="31"
...
<table style="display: none;" id="dbMappingTable">
	<tr>
		...
		<td class="tblrows">
			<input type="text" name="defaultval" id="defaultval"  maxlength="1000" tabindex="27"  class="noborder" size="28" style="width: 100%" />
