...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	String viewDriverHistory = navigationBasePath+"/viewRadiusDBAuthDriverHistory.do?driverInstanceId="+driverInstance.getDriverInstanceId()+"&auditUid="+driverInstance.getAuditUId()+"&name="+driverInstance.getName();;	
%>
