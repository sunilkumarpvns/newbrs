<%@page import="com.elitecore.elitesm.web.driver.radius.forms.CreateCrestelChargingDriverForm"%>
...
<%
	CreateCrestelChargingDriverForm createCrestelChargingDriverForm = (CreateCrestelChargingDriverForm) request.getAttribute("createCrestelChargingDriverForm");
%>


<html:form action="/createCrestelChargingDriver" styleId="mainform">

	<html:hidden name="createCrestelChargingDriverForm" property="action" />
	<html:hidden name="createCrestelChargingDriverForm" property="driverInstanceName" />
	<html:hidden name="createCrestelChargingDriverForm" property="driverInstanceDesp" />
	<html:hidden name="createCrestelChargingDriverForm" property="driverRelatedId" />
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<tr>
									<td class="table-header">
										<bean:message bundle="driverResources" key="driver.crestel.charging.create" />
									</td>
								</tr>
								<tr>
										...
										<table width="100%" name="c_tblCrossProductList" id="c_tblCrossProductList" align="right" border="0" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td align="left" class="labeltext" valign="top">
													<bean:define id="translationMappingConfDataLst"
														name="createCrestelChargingDriverForm"
											...
											<tr>
												...
												<td align="left" class="labeltext" valign="top"
													nowrap="nowrap">
													<html:text styleId="instanceNumber" tabindex="2" property="instanceNumber" size="30" maxlength="60" style="width:150px" /></td>
											</tr>
											...
											<tr>
												<td align="left" class="captiontext" valign="top" colspan="4"><input type="button" tabindex="3"
											...
											<tr>
												<td align="left" class="captiontext" valign="top"
													...
													<table cellSpacing="0" cellPadding="0" width="70%" border="0" id="mappingtbl">
														...
														<logic:iterate id="obj" name="createCrestelChargingDriverForm" property="defaultCrestelChargingDriverPropsDataList" type="com.elitecore.elitesm.datamanager.servermgr.drivers.chargingdriver.data.CrestelChargingDriverPropsData">
															<tr>
								...
								<tr>
									<td class="btns-td" valign="middle" colspan="4"><input
										...
										class="light-btn" tabindex="4" /> <input type="button"
										name="c_btnCreate" id="c_btnCreate2" tabindex="5"
										value="Create" class="light-btn" tabindex="6"
										onclick="validateForm()"> <input type="reset"
										name="c_btnDeletePolicy" tabindex="7"
