...
<%@ page import="com.elitecore.elitesm.web.driver.radius.forms.UpdateRadiusDetailLocalAcctDriverForm"%>
<%@ page import="java.util.List"%>
<%@ page import="com.elitecore.elitesm.datamanager.servermgr.drivers.data.DriverInstanceData"%>
<%@ page import="com.elitecore.elitesm.util.constants.InstanceTypeConstants"%>

<%
		//String[] attrids = (String[])session.getAttribute("attrid");			
		//String[] defvalue = (String[])session.getAttribute("defVal");
		//String[] usedicval = (String[])session.getAttribute("useDic");
		UpdateRadiusDetailLocalAcctDriverForm updateRadiusDetailLocalAcctDriverForm = (UpdateRadiusDetailLocalAcctDriverForm)request.getAttribute("updateRadiusDetailLocalAcctDriverForm");
...
var isValidName;
 			...
 			if(isNull(document.forms[0].ipaddress.value)){
	 			...
	 			if(validIp==true){
	 				if(isValidAttributeMapping("mappingtbl","attributeidval")){
	 					var maxLimit=1024;
						if(archiveLocation.value.length > maxLimit ){
						    alert( 'Not more than 1024 characters are allow in Archive Location Text Area' );
						    document.forms[0].archiveLocation.focus();
						    return false;
						}else{
	...
	function setColumnsOnAttrIdFields(obj){
		...
		retriveRadiusDictionaryAttributes(attrIdVal,"attributeId"+indexOfId);
		indexOfId++;
	}
	var isValidName;
	function verifyName() {
...
<html:form action="/updateRadiusDetailLocalAcctDriver">
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="65%">
							<html:text tabindex="1" styleId="driverinstname" onkeyup="verifyName();" property="driverInstanceName" size="30" maxlength="60" style="width:250px" /><font color="#FF0000"> *</font>
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="65%">
							<html:text	tabindex="2" styleId="driverinstdesc" property="driverInstanceDesp" size="30" maxlength="60" style="width:250px" /></td>
					</tr>
					<tr>
						<td align="left" class="tblheader-bold" valign="top" colspan="3">
							<bean:message bundle="driverResources" key="driver.detaillocal.details" />
						</td>
					</tr>
					...
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources" key="driver.eventDateFormat" />
								<ec:elitehelp headerBundle="driverResources" 
									text="detaildriver.eventdate" header="driver.eventDateFormat"/>
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:text styleId="eventDateFormat" property="eventDateFormat" size="30" tabindex="3" maxlength="50" style="width:250px" />
						</td>
					</tr>
						...
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.writeAttributes" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.writeAttributes" header="driver.writeAttributes"/>						
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:select property="writeAttributes" styleId="writeattributes" style="width:130px" tabindex="4">
					...
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources" key="driver.usedicval" />
								<ec:elitehelp headerBundle="driverResources" 
									text="detaildriver.usedicval" header="driver.usedicval"/>
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:select property="useDictionaryValue" styleId="useDictionaryValue" style="width:130px" tabindex="5">
						...
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.avpairSeperator" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.avpairseperator" header="driver.avpairSeperator"/> 
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:text styleId="avpairSeperator" property="avpairSeperator" size="20" tabindex="6" maxlength="50" style="width:250px" />
						</td>
					</tr>
					...
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.filename" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.filename" header="driver.filename"/>
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:text styleId="filename" property="fileName" size="20" tabindex="7" maxlength="50" style="width:250px" /><font color="#FF0000"> *</font>
						</td>
					</tr>
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.location" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.location" header="driver.location"/>						
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:text styleId="location" property="location" size="29" tabindex="8" maxlength="50" style="width:250px" /><font color="#FF0000"> *</font>
						</td>
					</tr>
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
						...
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:text styleId="defaultdirname" property="defaultDirName" size="20" tabindex="9" maxlength="50" style="width:250px" />
						</td>
					</tr>
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.prefixFileName" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.prefixFileName" header="driver.prefixFileName"/>
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<%-- 	<html:text styleId="prefixFileName" property="prefixFileName" size="20" maxlength="50" />    --%>
							<input type="text" tabindex="10" name="prefixFileName" id="prefixFileName" size="30"
							value="<%=(updateRadiusDetailLocalAcctDriverForm.getPrefixFileName() != null) ? updateRadiusDetailLocalAcctDriverForm.getPrefixFileName() : ""%>"
						...
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.foldername" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.foldername" header="driver.foldername"/>						
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<%-- 	<html:text styleId="foldername" property="folderName" size="20" maxlength="50" />    --%>
							<input type="text" tabindex="11" name="folderName" id="folderName" size="30"
							value="<%=(updateRadiusDetailLocalAcctDriverForm.getFolderName() != null) ? updateRadiusDetailLocalAcctDriverForm.getFolderName() : ""%>"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="70%">
							<logic:equal value="0" property="sizeBasedRollingUnit" name="updateRadiusDetailLocalAcctDriverForm">
							...
							<logic:notEqual value="0" property="sizeBasedRollingUnit" name="updateRadiusDetailLocalAcctDriverForm">
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="70%">
							<logic:equal value="0" property="timeBasedRollingUnit" name="updateRadiusDetailLocalAcctDriverForm">
							...
							<logic:notEqual value="0" property="timeBasedRollingUnit" name="updateRadiusDetailLocalAcctDriverForm">
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="70%">
							<logic:equal value="0" property="recordBasedRollingUnit" name="updateRadiusDetailLocalAcctDriverForm">
							...
							<logic:notEqual value="0" property="recordBasedRollingUnit" name="updateRadiusDetailLocalAcctDriverForm">
					...
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources" key="driver.detail.pattern" /> 
								<ec:elitehelp headerBundle="driverResources" 
									text="detaildriver.pos" header="driver.detail.pattern"/>
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:select property="pattern" styleId="pattern"
								style="width:130px" tabindex="17">
						...
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.detaillocal.allocatingprotocol" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.protocol" header="driver.detaillocal.allocatingprotocol"/>	
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:select property="allocatingProtocol" styleId="allocatingProtocol" style="width:130px" tabindex="19">
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:text styleId="remoteLocation" property="remoteLocation"
								size="29" tabindex="21" maxlength="50" style="width:250px" />
						</td>
					</tr>
					...
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.username" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.username" header="driver.username"/>
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
					...
					<tr>
						<td align="left" class="captiontext" valign="top" width="25%">
							<bean:message bundle="driverResources"
								key="driver.password" /> 
									<ec:elitehelp headerBundle="driverResources" 
										text="detaildriver.password" header="driver.password"/>
						</td>
						<td align="left" class="labeltext" valign="top" width="75%">
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" width="75%">
							<html:select property="postOperation" styleId="postOperation" style="width:130px" tabindex="24">
					...
					<tr>
						...
						<input type="button" onclick='addRow("dbMappingTable","mappingtbl");' value=" Add Mapping " tabindex="27" class="light-btn"></td>
					</tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="98%">
							...
							<table width="100%" id="mappingtbl" cellpadding="0"
								...
								<tr>
									<td align="left" class="tblheader" valign="top" width="30%">
										<bean:message bundle="driverResources" key="driver.attrids"/> 
											<ec:elitehelp headerBundle="driverResources" 
												text="detaildriver.attributeid" header="driver.attrids"/>
									</td>
									<td align="left" class="tblheader" valign="top" width="30%">
										<bean:message bundle="driverResources" key="driver.defaultvalue"/>
											<ec:elitehelp headerBundle="driverResources" 
												text="detaildriver.defaultvalue" header="driver.defaultvalue"/>
									</td>
									<td align="left" class="tblheader" valign="top" width="30%">
										<bean:message bundle="driverResources" key="driver.usedicvalue" />
											<ec:elitehelp headerBundle="driverResources" 
												text="detaildriver.dicvalue" header="driver.usedicvalue"/>
									</td>
								...
								<logic:iterate id="obj" name="detailLocalDriverDataSet" type="com.elitecore.elitesm.datamanager.servermgr.drivers.detailacctlocal.data.DetailLocalAttrRelationData" scope="session">
									<tr>
										<td class="allborder">
											<input type="text" name="attributeidval" id="attributeidval" tabindex="28" class="noborder" maxlength="1000" size="28" style="width: 100%" onfocus="setColumnsOnAttrIdFields(this);" value='<bean:write name="obj" property="attrIds"/>'/>
										</td>
										<td class="tblrows">
					...
					<tr>
						...
						<td class="btns-td" valign="middle" colspan="2"><input
							...
							<input type="reset" name="c_btnDeletePolicy" tabindex="37"
...
<table style="display: none;" id="dbMappingTable">
	<tr>
		<td class="allborder">
			 <input type="text" name="attributeidval" tabindex="32" id="attributeidval" class="noborder" maxlength="1000" size="28" style="width: 100%" onfocus="setColumnsOnAttrIdFields(this);" />
		</td>
		<td class="tblrows">
			<input type="text" name="defaultval" id="defaultval" tabindex="33"  maxlength="1000" class="noborder" size="28" style="width: 100%" />  
		</td>
		<td class="tblrows">
		<select class="noborder"  name="usedicval" id="usedicval" tabindex="34" style="width: 100%" tabindex="10">
					<option value='True'>True</option>
					<option value='False'>False</option>									
		</select> 	
		</td>
		<td class="tblrows" align="center" colspan="3"><img value="top"
			src="<%=basePath%>/images/minus.jpg" class="delete" tabindex="35"
