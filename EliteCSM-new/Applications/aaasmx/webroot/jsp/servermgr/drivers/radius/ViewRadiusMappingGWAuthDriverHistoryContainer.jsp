						...
						<tr>
							<td valign="top" align="right" width="*">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">	
									<tr>	
										<td>
											<%@ include file="/jsp/servermgr/drivers/radius/ViewRadiusMappingGWAuthDriver.jsp"%>	
										</td>
									</tr>
									<tr>
										<td>
				  			...
				  			<td width="168" class="grey-bkgd" valign="top">
								<%@ include file="/jsp/servermgr/drivers/radius/RadiusMappingGWAuthDriverNavigation.jsp"%>
							</td>
					</tr>
    			</table>
    			</td>	
