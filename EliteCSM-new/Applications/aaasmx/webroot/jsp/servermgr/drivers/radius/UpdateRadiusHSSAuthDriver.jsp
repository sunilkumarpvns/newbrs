<%@page import="com.elitecore.elitesm.web.driver.radius.forms.UpdateRadiusHSSAuthDriverForm"%>
...
<%
	    ...
	    UpdateRadiusHSSAuthDriverForm radiusHSSAuthDriverForm = (UpdateRadiusHSSAuthDriverForm)request.getAttribute("radiusHSSAuthDriverForm");
%>
...
<script language="javascript">
	...
	function addNewRowForPeer(templateTableId, tableId,logicalName,multipleAllowFunctionality){
 	...
 	$(document).ready(function(){
 		<%
		List<DiameterPeerRelData> driverListObj = radiusHSSAuthDriverForm.getDiameterPeerRelDataList();												
...
<html:form action="/initUpdateRadiusHssDriver">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="15%">
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="65%">
								<html:text styleId="driverinstname" onkeyup="verifyName();" property="driverInstanceName"  name="radiusHSSAuthDriverForm" size="30" maxlength="60" style="width:250px" tabindex="1"/>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="65%">
								<html:textarea property="driverInstanceDesc" styleId="driverInstanceDesc" name="radiusHSSAuthDriverForm" style="width:250px" tabindex="2"></html:textarea>
							</td>
						</tr>
						<tr>
							<td align="left" class="tblheader-bold" valign="top" colspan="3">
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								 <html:text styleId="applicationid" name="radiusHSSAuthDriverForm"  property="applicationid"  style="width:250px" tabindex="1" />
								 <font color="#FF0000"> *</font>
							</td>							
						</tr>
					    <tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								 <html:text property="commandCode" name="radiusHSSAuthDriverForm" styleId="commandCode" style="width:250px" tabindex="2" styleClass="commandCode"></html:text>
								 <font color="#FF0000"> *</font>
							</td>							
						</tr>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								 <html:text styleId="requesttimeout" name="radiusHSSAuthDriverForm"  property="requesttimeout"  style="width:250px" tabindex="6" />
							</td>							
						</tr>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="userIdentityAttributes" property="userIdentityAttributes" name="radiusHSSAuthDriverForm"  style="width:250px" tabindex="7" />
							</td>							
						</tr>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="noOfTriplets" property="noOfTriplets" name="radiusHSSAuthDriverForm"  style="width:250px" tabindex="5" />
							</td>							
						</tr>		 		
						 ...
						 <tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:textarea styleId="additionalAttributes" name="radiusHSSAuthDriverForm" tabindex="6" property="additionalAttributes" cols="50" rows="2" style="width:250px"/>
							</td>							
						</tr>
						 <tr>
							<td align="left" class="captiontext" valign="top">
									...
									<tr>
										<td>
											<select class="labeltext" name="selectedPeerIds" id="selectedPeerIds" multiple="true" size="5" style="width: 250px;">
												...
												List<DiameterPeerRelData> driverList = radiusHSSAuthDriverForm.getDiameterPeerRelDataList();												
												if(driverList != null){
						...
						<tr>
							<td align="left" class="tblheader-bold" valign="top" colspan="3">
								<bean:message bundle="driverResources" key="driver.radiushhsfieldmap" />
							</td>
						</tr>
						<tr>
							...
							<td align="left" width="100%" class="captiontext" colspan="3" valign="top">
								<table width="97%" id="mappingtbl" cellpadding="0" cellspacing="0" border="0">
									<tr>
									 ...
									 <logic:iterate id="obj" name="radiusHSSAuthDriverForm" property="hssAuthDriverFieldMapDataList"  type="com.elitecore.elitesm.datamanager.servermanager.drivers.hssdriver.data.HssAuthDriverFieldMapData">
										<tr>
											<td class="allborder">
