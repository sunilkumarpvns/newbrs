									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td valign="top" align="right">
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	<td class="tblfirstcol" height="20%" width="11%">
																		<bean:message bundle="driverResources"
																			key="driver.instname" />
																	</td>
																	<td class="tblfirstcol" colspan="3" height="20%"
																		width="25%"><bean:write
																			name="updateRadiusDCDriverForm"
																...
																<tr>
																	...
																	<td class="tblfirstcol" colspan="3" height="20%"
																		width="25%"><bean:write
																			name="updateRadiusDCDriverForm" property="driverDesp" /></td>
										...
										<tr>
											<td valign="bottom"><%@ include
													file="/jsp/servermgr/drivers/radius/UpdateRadiusDCDriver.jsp"%>
											</td>
										</tr>
									</table>
								</td>
								<td width="168" class="grey-bkgd" valign="top"><%@ include
										file="/jsp/servermgr/drivers/radius/RadiusDCDriverNavigation.jsp"%>
								</td>
							</tr>
						</table>
					</td>
