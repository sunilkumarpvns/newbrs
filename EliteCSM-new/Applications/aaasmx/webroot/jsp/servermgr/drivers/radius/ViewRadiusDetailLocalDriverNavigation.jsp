...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	String viewDetailLocalDriverHistory = navigationBasePath+"/viewRadiusDetailLocalAcctDriverHistory.do?driverInstanceId="+driverInstance.getDriverInstanceId()+"&auditUid="+driverInstance.getAuditUId()+"&name="+driverInstance.getName();;	
%>
					...
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td class="subLinks">
										<a href="<%=viewDetailLocalDriverHistory%>">
