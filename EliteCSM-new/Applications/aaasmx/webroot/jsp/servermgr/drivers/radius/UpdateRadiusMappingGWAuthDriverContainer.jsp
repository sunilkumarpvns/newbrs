									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
															...
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td class="tblfirstcol" colspan="3" height="20%"
																		width="25%"><bean:write
																			name="updateRadiusMappingGWAuthDriverForm"
										...
										<tr>
											<td valign="bottom"><%@ include
													file="/jsp/servermgr/drivers/radius/UpdateRadiusMappingGWAuthDriver.jsp"%>
											</td>
										</tr>
									</table>
								</td>
								<td width="168" class="grey-bkgd" valign="top"><%@ include
										file="/jsp/servermgr/drivers/radius/RadiusMappingGWAuthDriverNavigation.jsp"%>
								</td>
							</tr>
						</table>
					</td>
