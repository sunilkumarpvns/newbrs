<%@page import="com.elitecore.elitesm.datamanager.servermgr.drivers.mapgatewaydriver.data.MappingGatewayAuthDriverData"%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	MappingGatewayAuthDriverData driverInstance = (MappingGatewayAuthDriverData)session.getAttribute("mappingGatewayAuthDriverData");
	...
	String viewMappingGwDriverHistory = navigationBasePath+"/viewRadiusMappingGWAuthDriverHistory.do?driverInstanceId="+driverInstData.getDriverInstanceId()+"&auditUid="+driverInstData.getAuditUId()+"&name="+driverInstData.getName();	
					...
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td class="subLinks">
										<a href="<%=viewMappingGwDriverHistory%>">
