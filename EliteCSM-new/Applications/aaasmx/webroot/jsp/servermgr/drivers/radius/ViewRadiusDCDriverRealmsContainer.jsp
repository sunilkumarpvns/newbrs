  ...
  <tr>
		...
		<td>
   			<table cellpadding="0" cellspacing="0" border="0" width="100%">
      						...
      						<td valign="top" align="right"> 		 
      						  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="15%" >
          						...
          						<tr>
									...
									<td class="tblfirstcol" colspan="3" height="20%" width="25%">
									<bean:write name="viewRadiusDCDriverRealmsForm" property="driverInstanceName"/></td>
								</tr>   
								 <tr>
									<td class="tblfirstcol" height="20%" width="25%">
									<bean:message bundle="driverResources" key="driver.instdesc" /></td>
									<td class="tblfirstcol" colspan="3" height="20%" width="25%">
									<bean:write name="viewRadiusDCDriverRealmsForm" property="driverDesp"/></td>
				...
				<tr>
					<td valign="bottom">
						<%@ include file="/jsp/servermgr/drivers/radius/ViewRadiusDCDriverRealms.jsp"%>
					</td>
				</tr>
    		</table>
    	</td>	
		<td width="168" class="grey-bkgd" valign="top">
			<%@ include file="/jsp/servermgr/drivers/radius/RadiusDCDriverNavigation.jsp"%>
		</td>
    	</tr>
    	</table>
    	</td>
