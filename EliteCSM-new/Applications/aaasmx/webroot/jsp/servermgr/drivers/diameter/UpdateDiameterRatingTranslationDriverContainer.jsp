									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td valign="bottom"><%@ include
													file="/jsp/servermgr/drivers/diameter/UpdateDiameterRatingTranslationDriver.jsp"%>
											</td>
										</tr>
									</table>
								</td>
								<td width="168" class="grey-bkgd" valign="top"><%@ include
										file="/jsp/servermgr/drivers/diameter/DiameterRatingTranslationNavigation.jsp"%>
								</td>
							</tr>
						</table>
					</td>
