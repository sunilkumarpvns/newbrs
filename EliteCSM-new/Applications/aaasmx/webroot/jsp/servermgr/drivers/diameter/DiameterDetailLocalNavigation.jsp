...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	String viewDiameterDetailHistory = navigationBasePath+"/viewDiameterDetailLocalAcctDriverHistory.do?driverInstanceId="+driverInstance.getDriverInstanceId()+"&auditUid="+driverInstance.getAuditUId()+"&name="+driverInstance.getName();;	
...
%>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr id=header1>
					...
					<td class="subLinksHeader" width="13%"><a
						href="javascript:void(0)"
						onClick="STB('ViewDimaeterPolicy');swapImages()"><img
							src="<%=navigationBasePath%>/images/sublinks-dnarrow.jpg"
							border="0" name="arrow"></a></td>
				</tr>
				<tr valign="top">
					<td colspan="2" id="backgr1">
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="subLinks"><a href="<%=viewDriverInstance%>"><bean:message
												bundle="driverResources" key="driver.viewdriver" /></a></td>
								</tr>
								<tr>
									<td class="subLinks">
										<a href="<%=viewDiameterDetailHistory%>">
