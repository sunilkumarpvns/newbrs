...
<tr>
	...
	String viewDriverHistory = navigationBasePath+"/viewDiameterClassicCSVAcctDriverHistory.do?driverInstanceId="+driverInstance.getDriverInstanceId()+"&auditUid="+driverInstance.getAuditUId()+"&name="+driverInstance.getName();	
