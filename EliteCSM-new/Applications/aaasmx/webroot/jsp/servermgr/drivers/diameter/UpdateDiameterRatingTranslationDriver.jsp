...
<%@page import="com.elitecore.elitesm.web.driver.diameter.forms.UpdateDiameterRatingTranslationDriverForm"%>
...
<html:form action="/updateDiameterRatingTranslationDriver">
	<html:hidden name="updateDiameterRatingTranslationDriverForm"
		property="action" />
	<html:hidden name="updateDiameterRatingTranslationDriverForm"
				...
				<table width="100%" name="c_tblCrossProductList" id="c_tblCrossProductList" align="right" border="0">
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top">
							<bean:define id="translationMappingConfDataList"
								name="updateDiameterRatingTranslationDriverForm"
								property="translationMappingConfDataList"></bean:define> 
								<html:select
									name="updateDiameterRatingTranslationDriverForm" tabindex="4"
					...
					<tr>
						...
						<td align="left" class="labeltext" valign="top" nowrap="nowrap">
							<html:text styleId="instanceNumber" tabindex="3" property="instanceNumber" size="30" maxlength="60" style="width:250px" />
						</td>
					</tr>
					...
					<tr>
						<td align="left" class="captiontext" valign="top" colspan="4">
							<input type="button" class="light-btn" tabindex="5"
					...
					<tr>
						<td align="left" class="labeltext" valign="top" colspan="4">
							...
							<table cellSpacing="0" cellPadding="0" width="70%" border="0" id="mappingtbl" class="captiontext">
								<tr>
								...
								<logic:iterate id="obj" name="diameterRatingTranslationData" property="jndiPropValMapList" type="com.elitecore.elitesm.datamanager.servermgr.drivers.ratingdriver.data.RatingDriverPropsData">
										<tr>
