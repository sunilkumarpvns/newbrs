...
<html:form action="/createDiameterDBAcctDriver" styleId="mainform">

	<html:hidden name="createDiameterDBAcctDriverForm" property="action" />
	<html:hidden name="createDiameterDBAcctDriverForm"
								...
								<table cellpadding="0" cellspacing="0" border="0" width="100%">
									<tr>
										<td class="table-header" colspan="4">
											<bean:message bundle="driverResources" key="driver.createdbacctDriver" />
										</td>
									</tr>
									<tr>
										<td colspan="4">
											<table width="100%" name="c_tblCrossProductList" id="c_tblCrossProductList" align="right" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td align="left" class="tblheader-bold" valign="top" colspan="3">
														<bean:message bundle="driverResources" key="driver.diameter.dbacctdetails" />
													</td>
												</tr>
												<tr>
													<td align="left" class="captiontext" valign="top" width="30%">
														<bean:message bundle="driverResources" key="driver.dbauthdriver.ds" /> 
														<ec:elitehelp headerBundle="driverResources"  text="dbacctdriver.ds" header="driver.dbauthdriver.ds"/>
													</td>
													<td align="left" class="labeltext" valign="top" width="75%">
														<html:select tabindex="1" property="databaseId" styleId="databaseId" style="width:130px" onchange="setColumnsForTables()">
															<html:option value="0">Select</html:option>
															<html:optionsCollection name="createDiameterDBAcctDriverForm" property="databaseDSList" label="name" value="databaseId" />
														</html:select>
												...
												<tr>
													<td align="left" class="captiontext" valign="top" width="30%">
														...
														<ec:elitehelp headerBundle="driverResources" text="dbacctdriver.dstype" header="driver.dsType"/> 
													</td>
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:select tabindex="2" property="datasourceType" styleId="dstype" style="width:130px">
												...
												<tr>
													<td align="left" class="captiontext" valign="top" width="30%">
														...
														<ec:elitehelp headerBundle="driverResources" text="dbacctdriver.querytimeout" header="driver.querytimeout"/>
													</td>
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="3" styleId="querytimeout" property="dbQueryTimeout" size="20" maxlength="50" style="width:250px" />
														<font color="#FF0000"> *</font>
													</td>
												</tr>
												...
												<tr>
													<td align="left" class="captiontext" valign="top" width="35%">
														...
														<ec:elitehelp headerBundle="driverResources" text="dbacctdriver.maxquerytimeout" header="driver.querytimeoutcount"/>
													</td>
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="4" styleId="timeoutcount" property="maxQueryTimeoutCount" size="20" maxlength="50" style="width:250px" />
														<font color="#FF0000"> *</font>
													</td>
												</tr>
								...
								maxlength="50" />
												...
												<tr>
													<td align="left" class="captiontext" valign="top" width="30%">
														...
														<ec:elitehelp headerBundle="driverResources"  text="dbacctdriver.multivalDelimeter" header="driver.multivalDelimeter"/>
													</td>
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="5" styleId="multivalDelimeter" property="multivalDelimeter" size="20" maxlength="50" style="width:250px" />
													</td>
												</tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="6" styleId="cdrtablename"
															property="cdrTablename" size="20" maxlength="128"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="7" styleId="cdrIdDbField"
															property="cdrIdDbField" size="20" maxlength="50"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="8" styleId="cdrIdSeqName"
															property="cdrIdSeqName" size="20" maxlength="50"
															style="width:250px" /><font color="#FF0000"> *</font>
													</td>
												</tr>
												<tr>
													<td align="left" class="captiontext" valign="top" width="30%">
														<bean:message bundle="driverResources"
															key="driver.storestprec" /> 
																<ec:elitehelp headerBundle="driverResources" 
																	text="dbacctdriver.storeInterimRec" header="driver.storestprec"/>
													</td>
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:select tabindex="9" property="storeStopRec"
															styleId="storestprec" value="true" style="width:130px">
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="10" styleId="interimtblnm"
															property="interimTablename" size="20" maxlength="50"
															onblur="setColumnsOnIntrimCDRTextFields()"
															style="width:250px" />
															<font color="#FF0000"> *</font>
													</td>
												</tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="11" styleId="interimCdrIdDbField"
															property="interimCdrIdDbField" size="20" maxlength="50"
															style="width:250px" />
															<font color="#FF0000"> *</font>
													</td>
												</tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="12" styleId="interimCdrIdSeqName"
															property="interimCdrIdSeqName" size="20" maxlength="50"
															style="width:250px" />
															<font color="#FF0000"> *</font>
													</td>
												</tr>
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:select tabindex="13" property="storeInterimRec"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:select tabindex="14" property="removeInterimOnStop"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="15" styleId="callStartFieldName"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="16" styleId="callEndFieldName"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="17" styleId="createDateFieldName"
													...
													<td align="left" class="captiontext" valign="top" width="30%">
														<bean:message bundle="driverResources"
															key="driver.dbDateField" /> 
																<ec:elitehelp headerBundle="driverResources" 
																	text="driver.dbDateField" 
																		header="driver.dbDateField"/>
													</td>
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:text tabindex="19" styleId="dbDateField"
												...
												<tr>
													...
													<td align="left" class="labeltext" valign="top" width="70%">
														<html:select tabindex="20" property="enabled"
												...
												<tr>
													<td align="left" class="tblheader-bold" valign="top" colspan="3">
														<bean:message bundle="driverResources" key="driver.diameter.dbacctmapdetails" />
													</td>
												</tr>
												<tr>
													<td align="left" class="captiontext" valign="top"
														colspan="2" id="button"><input type="button"
														tabindex="21" onclick='addRow("dbMappingTable","mappingtbl");' value=" Add Mapping "
									...
									<tr>
										...
										<td class="btns-td" valign="middle"><input type="button"
											value="Previous " tabindex="22" onclick="history.go(-1)"
											class="light-btn" /> <input type="button" name="c_btnCreate"
											tabindex="23" id="c_btnCreate2" value="Create"
											class="light-btn" onclick="validateForm()"> <input
											type="reset" name="c_btnDeletePolicy" tabindex="24"
