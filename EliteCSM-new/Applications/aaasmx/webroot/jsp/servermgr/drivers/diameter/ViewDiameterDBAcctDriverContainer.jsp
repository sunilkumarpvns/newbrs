						...
						<tr>
							<td valign="top" align="right" width="*">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">	
									<tr>	
										<td>
      						  				<%@ include file="/jsp/servermgr/drivers/diameter/ViewDiameterDBAcctDriver.jsp"%>
										</td>
    								</tr>
								</table>
				  			</td>
				  			<td width="168" class="grey-bkgd" valign="top">
								<%@ include file="/jsp/servermgr/drivers/diameter/DiameterDBAcctDriverNavigation.jsp"%>
							</td>
						</tr>
    				</table>
    				</td>	
