...
<html:form action="/updateDiameterDBAcctDriver">
				...
				height="15%">
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="65%"><html:text
								styleId="driverinstname" onkeyup="verifyName();" property="driverInstanceName" size="30"
								maxlength="60" style="width:250px" tabindex="1"/><font color="#FF0000"> *</font>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:select property="databaseId" styleId="databaseId" onchange="setColumnsForTables()" style="width:130px" tabindex="3">
								<html:option value="0">Select</html:option>
								<html:optionsCollection name="updateDiameterDBAcctDriverForm" property="databaseDSList" label="name" value="databaseId"/>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:select property="datasourceType" styleId="dstype" style="width:130px" tabindex="4">
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="querytimeout" property="dbQueryTimeout" size="20" tabindex="5"
								maxlength="50" style="width:250px"/><font color="#FF0000"> *</font>
							</td>							
						</tr>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="timeoutcount" property="maxQueryTimeoutCount" size="20" tabindex="6"
								maxlength="50" style="width:250px"/><font color="#FF0000"> *</font>
							</td>							
						</tr>					
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.multivalDelimeter" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.multivalDelimeter" header="driver.multivalDelimeter"/> 
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="multivalDelimeter" property="multivalDelimeter" size="20" tabindex="7"
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="cdrtablename" property="cdrTablename" size="20"
								maxlength="128" onblur="setColumnsOnCDRTextFields();" style="width:250px" tabindex="8" /><font color="#FF0000"> *</font>
							</td>							
						</tr>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="cdrIdDbField" property="cdrIdDbField" size="20"
								maxlength="50" style="width:250px" tabindex="9"/><font color="#FF0000"> *</font>
							</td>							
						</tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="cdrIdSeqName" property="cdrIdSeqName" size="20"
								maxlength="50" style="width:250px" tabindex="10"/><font color="#FF0000"> *</font>
							</td>							
						</tr>
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.storestprec" />
								 	<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.storestprec" header="dbacctdriver.storestprec"/>
		
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">								
								<html:select property="storeStopRec" styleId="storestprec" style="width:130px" tabindex="11">								
						...
						<tr>
							<td align="left" class="tblheader-bold" valign="top" colspan="3">
							<bean:message bundle="driverResources" key="driver.interimcdrconf" />
							
							</td>
						</tr>						
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.interimTblnm" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.interimTblnm" header="driver.interimTblnm"/>						 
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="interimtblnm" property="interimTablename" size="20" tabindex="12"
								maxlength="50" onblur="setColumnsOnIntrimCDRTextFields();" style="width:250px"/>
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.interimCdrIdDbField" />
							 		<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.interimCdrIdDbField" header="driver.interimCdrIdDbField"/>
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="interimCdrIdDbField" property="interimCdrIdDbField" size="20" tabindex="13"
								maxlength="50" style="width:250px"/>
								<font color="#FF0000"> *</font>
							</td>							
						</tr>
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.interimCdrIdSeqName" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.interimCdrIdSeqName" header="driver.interimCdrIdSeqName"/>
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="interimCdrIdSeqName" property="interimCdrIdSeqName" size="20" tabindex="14"
								maxlength="50" style="width:250px"/>
								<font color="#FF0000"> *</font>
							</td>							
						</tr>
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.storeInterimRec" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.storeInterimRec" 
											header="driver.storeInterimRec"/>
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">								
								<html:select property="storeInterimRec" styleId="storeInterimRec" style="width:130px" tabindex="15">								
								<html:option value="true">True</html:option>
								<html:option value="false">False</html:option>								
								</html:select>
							</td>							
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.removeInterimOnStop" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.removeInterimOnStop" 
											header="driver.removeInterimOnStop"/>							
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">								
								<html:select property="removeInterimOnStop" styleId="removeInterimOnStop" style="width:130px" tabindex="16">								
								<html:option value="true">True</html:option>
								<html:option value="false">False</html:option>								
								</html:select>
							</td>							
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.callStartFieldName" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.callStartFieldName" header="driver.callStartFieldName"/>								
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="callStartFieldName" property="callStartFieldName" size="20" tabindex="17"
								maxlength="50" style="width:250px"/><font color="#FF0000"> *</font>
							</td>							
						</tr>
								<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.callEndFieldName" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.callEndFieldName" header="driver.callEndFieldName"/>
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="callEndFieldName" property="callEndFieldName" size="20" tabindex="18"
								maxlength="50" style="width:250px"/><font color="#FF0000"> *</font>
							</td>							
						</tr>
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.createDateFieldName" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.createDateFieldName" header="driver.createDateFieldName"/>
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="createDateFieldName" property="createDateFieldName" size="20" tabindex="19"
								maxlength="50" style="width:250px"/><font color="#FF0000"> *</font>
							</td>							
						</tr>
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.lastModifiedDateFieldName" />
									<ec:elitehelp headerBundle="driverResources" 
										text="dbacctdriver.lastModifiedDateFieldName" 
											header="driver.lastModifiedDateFieldName"/>
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="lastModifiedDateFieldName" property="lastModifiedDateFieldName" size="20" tabindex="20"
								maxlength="50" style="width:250px"/><font color="#FF0000"> *</font>
							</td>							
						</tr>
						...
						<tr>
							<td align="left" class="captiontext" valign="top">
								<bean:message bundle="driverResources" key="driver.dbDateField" />
									<ec:elitehelp headerBundle="driverResources" 
										text="driver.dbDateField" header="driver.dbDateField"/>
							</td>
							<td align="left" class="labeltext" valign="top" width="70%">
								<html:text styleId="dbDateField" property="dbDateField" size="20" tabindex="21"
								maxlength="50" style="width:250px"/>
							</td>							
						</tr>
						...
						<tr>
							...
							<td align="left" class="labeltext" valign="top" width="70%">								
								<html:select property="enabled" styleId="enabled" style="width:130px" tabindex="22">								
								<html:option value="true">True</html:option>
								<html:option value="false">False</html:option>								
								</html:select>
						...
						<tr>
							<td align="left" class="tblheader-bold" valign="top" colspan="3">
							<bean:message bundle="driverResources" key="driver.diameter.dbacctmapdetails" /></td>
						</tr>	
						
						<tr>							
							<td align="left" class="labeltext" valign="top" colspan="2"><input
								type="button" onclick='addRow("dbMappingTable","mappingtbl");' value=" Add " class="light-btn" tabindex="23"></td>
						</tr>

			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
					 <td colspan="3" valign="top" class="box">
					<table width="100%" id="mappingtbl" cellpadding="0" cellspacing="0">
									<tr>										
				...
				<tr>
					...
					<td class="btns-td" valign="middle" colspan="2"><input tabindex="24"
						type="button" name="c_btnCreate" id="c_btnCreate2"
						value=" Update " class="light-btn" onclick="validateForm()">
					<input type="reset" name="c_btnDeletePolicy" tabindex="25" onclick="javascript:window.location.href='<%=basePath%>/initSearchDriver.do?'" value="Cancel" class="light-btn" tabindex="7"/>
				</tr>
			</table>
