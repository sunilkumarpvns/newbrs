...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	String viewAcctDriverHistory = navigationBasePath+"/viewDiameterDBAcctDriverHistory.do?driverInstanceId="+driverInstance.getDriverInstanceId()+"&auditUid="+driverInstance.getAuditUId()+"&name="+driverInstance.getName();;	
