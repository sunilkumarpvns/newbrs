...
/**
 * The class is used for representing SNMP metadata for the "DbpAppAdvFromPeerEntry" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.3.3.1.
 */
public class DbpAppAdvFromPeerEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "DbpAppAdvFromPeerEntry".
     */
    public DbpAppAdvFromPeerEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpInt(node.getDbpAppAdvFromPeerType());
     ...
     */
    protected void setInstance(DbpAppAdvFromPeerEntryMBean var) {
        node = var;
    }
    ...
    protected DbpAppAdvFromPeerEntryMBean node;
