...
/**
 * The class is used for representing "DbpPeerVendorStorageType".
 */
public class EnumDbpPeerVendorStorageType extends Enumerated implements Serializable {
    ...
    public EnumDbpPeerVendorStorageType(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpPeerVendorStorageType(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpPeerVendorStorageType() throws IllegalArgumentException {
        super();
    }

    public EnumDbpPeerVendorStorageType(String x) throws IllegalArgumentException {
        super(x);
    }
