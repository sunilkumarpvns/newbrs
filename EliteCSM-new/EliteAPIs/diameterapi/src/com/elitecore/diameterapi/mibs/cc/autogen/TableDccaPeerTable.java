...
/**
 * The class is used for implementing the "DccaPeerTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.4006.2.1.2.1.
 */
public class TableDccaPeerTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDccaPeerTable".
     ...
     */
    public TableDccaPeerTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDccaPeerTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DccaPeerEntryMBean"
            // interface.
            //
            final Object entry =
                 createDccaPeerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DccaPeerTable");
    }
    ...
    public synchronized void addEntry(DccaPeerEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DccaPeerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DccaPeerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DccaPeerEntryMBean[] result = new DccaPeerEntryMBean[array.length];
    ...
    public void removeEntry(DccaPeerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableDccaPeerTable:name=com.elitecore.diameterapi.mibs.cc.autogen.DccaPeerEntry" + ",DccaPeerIndex=" + _keyDccaPeerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DccaPeerEntry".
     */
    public SnmpIndex buildSnmpIndex(DccaPeerEntryMBean entry)
        throws SnmpStatusException {
    ...
    /**
     * Factory method for "DccaPeerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DccaPeerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DccaPeerEntryMBean"
     * interface.
    ...
    public Object createDccaPeerEntryMBean(SnmpMibSubRequest req,
        ...
        // interface.
        //
        DccaPeerEntry entry = new DccaPeerEntry(theMib);
