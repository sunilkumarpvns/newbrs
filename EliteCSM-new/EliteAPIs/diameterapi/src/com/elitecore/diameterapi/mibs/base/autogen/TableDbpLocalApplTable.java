...
/**
 * The class is used for implementing the "DbpLocalApplTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.1.7.
 */
public class TableDbpLocalApplTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDbpLocalApplTable".
     ...
     */
    public TableDbpLocalApplTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDbpLocalApplTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DbpLocalApplEntryMBean"
            // interface.
            //
            final Object entry =
                 createDbpLocalApplEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DbpLocalApplTable");
    }
    ...
    public synchronized void addEntry(DbpLocalApplEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DbpLocalApplEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DbpLocalApplEntryMBean[] result = new DbpLocalApplEntryMBean[array.length];
    ...
    public void removeEntry(DbpLocalApplEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyDbpLocalApplIndex = oid.toLong().toString();
            return new ObjectName("TableDbpLocalApplTable:name=com.elitecore.diameterapi.mibs.base.autogen.DbpLocalApplEntry" + ",DbpLocalApplIndex=" + _keyDbpLocalApplIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DbpLocalApplEntry".
     */
    public SnmpIndex buildSnmpIndex(DbpLocalApplEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpGauge(entry.getDbpLocalApplIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "DbpLocalApplEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDbpLocalApplIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpGauge.appendToOid(new SnmpGauge(aDbpLocalApplIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "DbpLocalApplEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DbpLocalApplEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DbpLocalApplEntryMBean"
     * interface.
    ...
    public Object createDbpLocalApplEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDbpLocalApplIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DbpLocalApplEntry entry = new DbpLocalApplEntry(theMib);
        entry.DbpLocalApplIndex = aDbpLocalApplIndex;
        return entry;
    }
