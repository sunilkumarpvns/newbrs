 ...
 */
public class TableDccaPerPeerStatsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDccaPerPeerStatsTable".
     ...
     */
    public TableDccaPerPeerStatsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDccaPerPeerStatsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DccaPerPeerStatsEntryMBean"
            // interface.
            //
            final Object entry =
                 createDccaPerPeerStatsEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DccaPerPeerStatsTable");
    }
    ...
    public synchronized void addEntry(DccaPerPeerStatsEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DccaPerPeerStatsEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DccaPerPeerStatsEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DccaPerPeerStatsEntryMBean[] result = new DccaPerPeerStatsEntryMBean[array.length];
    ...
    public void removeEntry(DccaPerPeerStatsEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableDccaPerPeerStatsTable:name=com.elitecore.diameterapi.mibs.cc.autogen.DccaPerPeerStatsEntry" + ",DccaPeerIndex=" + _keyDccaPeerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DccaPerPeerStatsEntry".
     */
    public SnmpIndex buildSnmpIndex(DccaPerPeerStatsEntryMBean entry)
        throws SnmpStatusException {
     ...
     * Build index for "DccaPerPeerStatsEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDccaPeerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
    ...
    /**
     * Factory method for "DccaPerPeerStatsEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DccaPerPeerStatsEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DccaPerPeerStatsEntryMBean"
     * interface.
    ...
    public Object createDccaPerPeerStatsEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDccaPeerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DccaPerPeerStatsEntry entry = new DccaPerPeerStatsEntry(theMib);
