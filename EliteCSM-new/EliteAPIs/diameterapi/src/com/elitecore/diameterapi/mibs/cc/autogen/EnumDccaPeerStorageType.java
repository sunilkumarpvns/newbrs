...
/**
 * The class is used for representing "DccaPeerStorageType".
 */
public class EnumDccaPeerStorageType extends Enumerated implements Serializable {
    ...
    public EnumDccaPeerStorageType(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerStorageType(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerStorageType() throws IllegalArgumentException {
        super();
    }

    public EnumDccaPeerStorageType(String x) throws IllegalArgumentException {
        super(x);
    }
