...
/**
 * The class is used for implementing the "DbpAppAdvFromPeerTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.3.3.
 */
public class TableDbpAppAdvFromPeerTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDbpAppAdvFromPeerTable".
     ...
     */
    public TableDbpAppAdvFromPeerTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDbpAppAdvFromPeerTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DbpAppAdvFromPeerEntryMBean"
            // interface.
            //
            final Object entry =
                 createDbpAppAdvFromPeerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong(),
                    oid1.toLong(),
                    oid2.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DbpAppAdvFromPeerTable");
    }
    ...
    public synchronized void addEntry(DbpAppAdvFromPeerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DbpAppAdvFromPeerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DbpAppAdvFromPeerEntryMBean[] result = new DbpAppAdvFromPeerEntryMBean[array.length];
    ...
    public void removeEntry(DbpAppAdvFromPeerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyDbpAppAdvFromPeerVendorId = oid.toLong().toString();
            oid = (SnmpOid) v.elementAt(2);
            String _keyDbpAppAdvFromPeerIndex = oid.toLong().toString();
            return new ObjectName("TableDbpAppAdvFromPeerTable:name=com.elitecore.diameterapi.mibs.base.autogen.DbpAppAdvFromPeerEntry" + ",DbpPeerIndex=" + _keyDbpPeerIndex + ",DbpAppAdvFromPeerVendorId=" + _keyDbpAppAdvFromPeerVendorId + ",DbpAppAdvFromPeerIndex=" + _keyDbpAppAdvFromPeerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DbpAppAdvFromPeerEntry".
     */
    public SnmpIndex buildSnmpIndex(DbpAppAdvFromPeerEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[3];
        SnmpValue val = null;
        val = new SnmpGauge(entry.getDbpPeerIndex());
        oids[0] = val.toOid();
        val = new SnmpGauge(entry.getDbpAppAdvFromPeerVendorId());
        oids[1] = val.toOid();
        val = new SnmpGauge(entry.getDbpAppAdvFromPeerIndex());
        oids[2] = val.toOid();
     ...
     * Build index for "DbpAppAdvFromPeerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDbpPeerIndex, Long aDbpAppAdvFromPeerVendorId, Long aDbpAppAdvFromPeerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpGauge.appendToOid(new SnmpGauge(aDbpPeerIndex).toOid(), oid);
            SnmpGauge.appendToOid(new SnmpGauge(aDbpAppAdvFromPeerVendorId).toOid(), oid);
            SnmpGauge.appendToOid(new SnmpGauge(aDbpAppAdvFromPeerIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "DbpAppAdvFromPeerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DbpAppAdvFromPeerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DbpAppAdvFromPeerEntryMBean"
     * interface.
    ...
    public Object createDbpAppAdvFromPeerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDbpPeerIndex, Long  aDbpAppAdvFromPeerVendorId, Long  aDbpAppAdvFromPeerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DbpAppAdvFromPeerEntry entry = new DbpAppAdvFromPeerEntry(theMib);
        entry.DbpPeerIndex = aDbpPeerIndex;
        entry.DbpAppAdvFromPeerVendorId = aDbpAppAdvFromPeerVendorId;
        entry.DbpAppAdvFromPeerIndex = aDbpAppAdvFromPeerIndex;
        return entry;
    }
