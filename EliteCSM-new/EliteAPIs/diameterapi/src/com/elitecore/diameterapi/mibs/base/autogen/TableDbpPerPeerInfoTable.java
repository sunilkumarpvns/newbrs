...
/**
 * The class is used for implementing the "DbpPerPeerInfoTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.4.5.1.
 */
public class TableDbpPerPeerInfoTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDbpPerPeerInfoTable".
     ...
     */
    public TableDbpPerPeerInfoTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDbpPerPeerInfoTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DbpPerPeerInfoEntryMBean"
            // interface.
            //
            final Object entry =
                 createDbpPerPeerInfoEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DbpPerPeerInfoTable");
    }
    ...
    public synchronized void addEntry(DbpPerPeerInfoEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DbpPerPeerInfoEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DbpPerPeerInfoEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DbpPerPeerInfoEntryMBean[] result = new DbpPerPeerInfoEntryMBean[array.length];
    ...
    public void removeEntry(DbpPerPeerInfoEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableDbpPerPeerInfoTable:name=com.elitecore.diameterapi.mibs.base.autogen.DbpPerPeerInfoEntry" + ",DbpPeerIndex=" + _keyDbpPeerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DbpPerPeerInfoEntry".
     */
    public SnmpIndex buildSnmpIndex(DbpPerPeerInfoEntryMBean entry)
        throws SnmpStatusException {
     ...
     * Build index for "DbpPerPeerInfoEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDbpPeerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
    ...
    /**
     * Factory method for "DbpPerPeerInfoEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DbpPerPeerInfoEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DbpPerPeerInfoEntryMBean"
     * interface.
    ...
    public Object createDbpPerPeerInfoEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDbpPeerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DbpPerPeerInfoEntry entry = new DbpPerPeerInfoEntry(theMib);
