 ...
 */
public class CommandCodeStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "CommandCodeStatisticsTableMeta".
     ...
     */
    public CommandCodeStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "CommandCodeStatisticsEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("CommandCodeStatisticsEntry")
     * @param tableName Name of the table in which the entries are registered ("CommandCodeStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "CommandCodeStatisticsEntry" conceptual row (CommandCodeStatisticsEntryMeta)
     * 
     **/
    protected CommandCodeStatisticsEntryMeta createCommandCodeStatisticsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new CommandCodeStatisticsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createCommandCodeStatisticsEntryMetaNode("CommandCodeStatisticsEntry", "CommandCodeStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof CommandCodeStatisticsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "CommandCodeStatisticsTable" + "\" must implement the \"" + 
                           "CommandCodeStatisticsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        CommandCodeStatisticsEntryMBean entry = (CommandCodeStatisticsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private CommandCodeStatisticsEntryMeta node;
