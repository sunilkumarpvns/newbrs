 ...
 */
public class DbpRealmMessageRouteTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpRealmMessageRouteTableMeta".
     ...
     */
    public DbpRealmMessageRouteTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpRealmMessageRouteEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpRealmMessageRouteEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpRealmMessageRouteTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpRealmMessageRouteEntry" conceptual row (DbpRealmMessageRouteEntryMeta)
     * 
     **/
    protected DbpRealmMessageRouteEntryMeta createDbpRealmMessageRouteEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpRealmMessageRouteEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpRealmMessageRouteEntryMetaNode("DbpRealmMessageRouteEntry", "DbpRealmMessageRouteTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpRealmMessageRouteEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpRealmMessageRouteTable" + "\" must implement the \"" + 
                           "DbpRealmMessageRouteEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        DbpRealmMessageRouteEntryMBean entry = (DbpRealmMessageRouteEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private DbpRealmMessageRouteEntryMeta node;
