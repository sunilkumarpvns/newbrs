...
/**
 * The class is used for representing SNMP metadata for the "DccaPeerVendorEntry" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.4006.2.1.2.2.1.
 */
public class DccaPeerVendorEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "DccaPeerVendorEntry".
     */
    public DccaPeerVendorEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpInt(node.getDccaPeerVendorRowStatus());

            case 3:
                return new SnmpInt(node.getDccaPeerVendorStorageType());

            case 2:
                return new SnmpGauge(node.getDccaPeerVendorId());
        ...
        switch((int)var) {
            case 4:
                if (x instanceof SnmpInt) {
                    try  {
                        node.setDccaPeerVendorRowStatus( new EnumDccaPeerVendorRowStatus (((SnmpInt)x).toInteger()));
            ...
            case 3:
                if (x instanceof SnmpInt) {
                    try  {
                        node.setDccaPeerVendorStorageType( new EnumDccaPeerVendorStorageType (((SnmpInt)x).toInteger()));
                    } catch(IllegalArgumentException e)  {
                        throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
                    }
                    return new SnmpInt(node.getDccaPeerVendorStorageType());
            ...
            case 2:
                if (x instanceof SnmpGauge) {
                    node.setDccaPeerVendorId(((SnmpGauge)x).toLong());
                    return new SnmpGauge(node.getDccaPeerVendorId());
                } else {
                    throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
                }
    ...
    public void check(SnmpValue x, long var, Object data)
        ...
        switch((int) var) {
            case 3:
                if (x instanceof SnmpInt) {
                    try  {
                        node.checkDccaPeerVendorStorageType( new EnumDccaPeerVendorStorageType (((SnmpInt)x).toInteger()));
                    } catch(IllegalArgumentException e)  {
                        throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
                    }
                } else {
            ...
            case 2:
                if (x instanceof SnmpGauge) {
                    node.checkDccaPeerVendorId(((SnmpGauge)x).toLong());
                } else {
                    throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
                }
                break;
     ...
     */
    protected void setInstance(DccaPeerVendorEntryMBean var) {
        node = var;
    }
    ...
    public  String getRowStatusName()  {
        return new String ("DccaPeerVendorRowStatus");
    }
    ...
    public  int getRowStatus(Object userData)
        ...
        //
        // vb.oid = new SnmpOid("1.3.6.1.2.1.4006.2.1.2.2.1.4");
    ...
    protected DccaPeerVendorEntryMBean node;
