 ...
 */
public class DbpAppAdvToPeerTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpAppAdvToPeerTableMeta".
     ...
     */
    public DbpAppAdvToPeerTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpAppAdvToPeerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpAppAdvToPeerEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpAppAdvToPeerTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpAppAdvToPeerEntry" conceptual row (DbpAppAdvToPeerEntryMeta)
     * 
     **/
    protected DbpAppAdvToPeerEntryMeta createDbpAppAdvToPeerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpAppAdvToPeerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpAppAdvToPeerEntryMetaNode("DbpAppAdvToPeerEntry", "DbpAppAdvToPeerTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpAppAdvToPeerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpAppAdvToPeerTable" + "\" must implement the \"" + 
                           "DbpAppAdvToPeerEntryMBean" + "\" interface.");
    ...
    public  SnmpValue setRowStatus(SnmpOid rowOid, int status, Object userData)
            throws SnmpStatusException {
        DbpAppAdvToPeerEntryMBean entry = (DbpAppAdvToPeerEntryMBean) getEntry(rowOid);
        synchronized (this) {
    ...
    public  int mapRowStatus(SnmpOid rowOid, SnmpVarBind vbstatus, Object userData)
            throws SnmpStatusException {
        DbpAppAdvToPeerEntryMBean entry = null;
        try  {
            entry = (DbpAppAdvToPeerEntryMBean) getEntry(rowOid);
     ...
     */
    private DbpAppAdvToPeerEntryMeta node;
