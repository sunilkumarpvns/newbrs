 ...
 */
public class PeerInfoTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "PeerInfoTableMeta".
     ...
     */
    public PeerInfoTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "PeerInfoEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("PeerInfoEntry")
     * @param tableName Name of the table in which the entries are registered ("PeerInfoTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "PeerInfoEntry" conceptual row (PeerInfoEntryMeta)
     * 
     **/
    protected PeerInfoEntryMeta createPeerInfoEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new PeerInfoEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createPeerInfoEntryMetaNode("PeerInfoEntry", "PeerInfoTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof PeerInfoEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "PeerInfoTable" + "\" must implement the \"" + 
                           "PeerInfoEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        PeerInfoEntryMBean entry = (PeerInfoEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private PeerInfoEntryMeta node;
