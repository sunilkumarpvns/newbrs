 ...
 */
public class AppWiseStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "AppWiseStatisticsTableMeta".
     ...
     */
    public AppWiseStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "AppWiseStatisticsEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("AppWiseStatisticsEntry")
     * @param tableName Name of the table in which the entries are registered ("AppWiseStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "AppWiseStatisticsEntry" conceptual row (AppWiseStatisticsEntryMeta)
     * 
     **/
    protected AppWiseStatisticsEntryMeta createAppWiseStatisticsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new AppWiseStatisticsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createAppWiseStatisticsEntryMetaNode("AppWiseStatisticsEntry", "AppWiseStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof AppWiseStatisticsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "AppWiseStatisticsTable" + "\" must implement the \"" + 
                           "AppWiseStatisticsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        AppWiseStatisticsEntryMBean entry = (AppWiseStatisticsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private AppWiseStatisticsEntryMeta node;
