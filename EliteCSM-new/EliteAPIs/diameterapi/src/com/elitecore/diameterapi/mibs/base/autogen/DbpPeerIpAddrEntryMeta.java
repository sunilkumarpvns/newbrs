...
/**
 * The class is used for representing SNMP metadata for the "DbpPeerIpAddrEntry" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.3.2.1.
 */
public class DbpPeerIpAddrEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "DbpPeerIpAddrEntry".
     */
    public DbpPeerIpAddrEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpString(node.getDbpPeerIpAddress());

            case 2:
                return new SnmpInt(node.getDbpPeerIpAddressType());
     ...
     */
    protected void setInstance(DbpPeerIpAddrEntryMBean var) {
        node = var;
    }
    ...
    protected DbpPeerIpAddrEntryMBean node;
