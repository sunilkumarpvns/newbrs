 ...
 */
public class DbpPeerVendorTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpPeerVendorTableMeta".
     ...
     */
    public DbpPeerVendorTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpPeerVendorEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpPeerVendorEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpPeerVendorTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpPeerVendorEntry" conceptual row (DbpPeerVendorEntryMeta)
     * 
     **/
    protected DbpPeerVendorEntryMeta createDbpPeerVendorEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpPeerVendorEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpPeerVendorEntryMetaNode("DbpPeerVendorEntry", "DbpPeerVendorTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpPeerVendorEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpPeerVendorTable" + "\" must implement the \"" + 
                           "DbpPeerVendorEntryMBean" + "\" interface.");
    ...
    public  SnmpValue setRowStatus(SnmpOid rowOid, int status, Object userData)
            throws SnmpStatusException {
        DbpPeerVendorEntryMBean entry = (DbpPeerVendorEntryMBean) getEntry(rowOid);
        synchronized (this) {
    ...
    public  int mapRowStatus(SnmpOid rowOid, SnmpVarBind vbstatus, Object userData)
            throws SnmpStatusException {
        DbpPeerVendorEntryMBean entry = null;
        try  {
            entry = (DbpPeerVendorEntryMBean) getEntry(rowOid);
     ...
     */
    private DbpPeerVendorEntryMeta node;
