...
/**
 * The class is used for representing SNMP metadata for the "ResultCodeStatisticsEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.5.102.3.3.1.1.
 */
public class ResultCodeStatisticsEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "ResultCodeStatisticsEntry".
     */
    public ResultCodeStatisticsEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpString(node.getRcwCompstIndexValue());

            case 5:
                return new SnmpString(node.getRcwApplicationName());

            case 4:
                return new SnmpString(node.getRcwPeerIdentity());

            case 3:
                return new SnmpCounter(node.getRcwTx());

            case 2:
                return new SnmpCounter(node.getRcwRx());
     ...
     */
    protected void setInstance(ResultCodeStatisticsEntryMBean var) {
        node = var;
    }
    ...
    protected ResultCodeStatisticsEntryMBean node;
