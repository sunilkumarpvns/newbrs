...
/**
 * The class is used for representing SNMP metadata for the "PeerIpAddrEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.5.102.2.1.1.
 */
public class PeerIpAddrEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "PeerIpAddrEntry".
     */
    public PeerIpAddrEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpString(node.getPeerIpAddrPeerIdentity());

            case 5:
                return new SnmpCounter(node.getReconnectionCount());

            case 4:
                return new SnmpInt(node.getPeerStatus());

            case 3:
                return new SnmpString(node.getPeerLocalIpAddress());

            case 2:
                return new SnmpString(node.getPeerRemoteIpAddress());

            case 1:
                throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
            case 7:
                return new SnmpString(node.getPeerIpAddrCompsIndexValue());
     ...
     */
    protected void setInstance(PeerIpAddrEntryMBean var) {
        node = var;
    }
    ...
    protected PeerIpAddrEntryMBean node;
