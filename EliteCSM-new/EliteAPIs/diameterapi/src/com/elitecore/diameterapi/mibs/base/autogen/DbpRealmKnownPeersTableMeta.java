 ...
 */
public class DbpRealmKnownPeersTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpRealmKnownPeersTableMeta".
     ...
     */
    public DbpRealmKnownPeersTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpRealmKnownPeersEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpRealmKnownPeersEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpRealmKnownPeersTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpRealmKnownPeersEntry" conceptual row (DbpRealmKnownPeersEntryMeta)
     * 
     **/
    protected DbpRealmKnownPeersEntryMeta createDbpRealmKnownPeersEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpRealmKnownPeersEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpRealmKnownPeersEntryMetaNode("DbpRealmKnownPeersEntry", "DbpRealmKnownPeersTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpRealmKnownPeersEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpRealmKnownPeersTable" + "\" must implement the \"" + 
                           "DbpRealmKnownPeersEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        DbpRealmKnownPeersEntryMBean entry = (DbpRealmKnownPeersEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private DbpRealmKnownPeersEntryMeta node;
