 ...
 */
public class TableDbpPeerTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDbpPeerTable".
     ...
     */
    public TableDbpPeerTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDbpPeerTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DbpPeerEntryMBean"
            // interface.
            //
            final Object entry =
                 createDbpPeerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DbpPeerTable");
    }
    ...
    public synchronized void addEntry(DbpPeerEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DbpPeerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DbpPeerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DbpPeerEntryMBean[] result = new DbpPeerEntryMBean[array.length];
    ...
    public void removeEntry(DbpPeerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableDbpPeerTable:name=com.elitecore.diameterapi.mibs.base.autogen.DbpPeerEntry" + ",DbpPeerIndex=" + _keyDbpPeerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DbpPeerEntry".
     */
    public SnmpIndex buildSnmpIndex(DbpPeerEntryMBean entry)
        throws SnmpStatusException {
    ...
    /**
     * Factory method for "DbpPeerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DbpPeerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DbpPeerEntryMBean"
     * interface.
    ...
    public Object createDbpPeerEntryMBean(SnmpMibSubRequest req,
        ...
        // interface.
        //
        DbpPeerEntry entry = new DbpPeerEntry(theMib);
