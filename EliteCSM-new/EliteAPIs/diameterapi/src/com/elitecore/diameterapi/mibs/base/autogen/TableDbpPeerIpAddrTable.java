...
/**
 * The class is used for implementing the "DbpPeerIpAddrTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.3.2.
 */
public class TableDbpPeerIpAddrTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDbpPeerIpAddrTable".
     ...
     */
    public TableDbpPeerIpAddrTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDbpPeerIpAddrTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DbpPeerIpAddrEntryMBean"
            // interface.
            //
            final Object entry =
                 createDbpPeerIpAddrEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong(),
                    oid1.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DbpPeerIpAddrTable");
    }
    ...
    public synchronized void addEntry(DbpPeerIpAddrEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DbpPeerIpAddrEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DbpPeerIpAddrEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DbpPeerIpAddrEntryMBean[] result = new DbpPeerIpAddrEntryMBean[array.length];
    ...
    public void removeEntry(DbpPeerIpAddrEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyDbpPeerIpAddressIndex = oid.toLong().toString();
            return new ObjectName("TableDbpPeerIpAddrTable:name=com.elitecore.diameterapi.mibs.base.autogen.DbpPeerIpAddrEntry" + ",DbpPeerIndex=" + _keyDbpPeerIndex + ",DbpPeerIpAddressIndex=" + _keyDbpPeerIpAddressIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DbpPeerIpAddrEntry".
     */
    public SnmpIndex buildSnmpIndex(DbpPeerIpAddrEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpGauge(entry.getDbpPeerIndex());
        oids[0] = val.toOid();
        val = new SnmpGauge(entry.getDbpPeerIpAddressIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "DbpPeerIpAddrEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDbpPeerIndex, Long aDbpPeerIpAddressIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpGauge.appendToOid(new SnmpGauge(aDbpPeerIndex).toOid(), oid);
            SnmpGauge.appendToOid(new SnmpGauge(aDbpPeerIpAddressIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "DbpPeerIpAddrEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DbpPeerIpAddrEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DbpPeerIpAddrEntryMBean"
     * interface.
    ...
    public Object createDbpPeerIpAddrEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDbpPeerIndex, Long  aDbpPeerIpAddressIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DbpPeerIpAddrEntry entry = new DbpPeerIpAddrEntry(theMib);
        entry.DbpPeerIndex = aDbpPeerIndex;
        entry.DbpPeerIpAddressIndex = aDbpPeerIpAddressIndex;
        return entry;
    }
