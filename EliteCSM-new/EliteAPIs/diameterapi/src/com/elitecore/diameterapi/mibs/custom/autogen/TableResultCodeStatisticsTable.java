...
/**
 * The class is used for implementing the "ResultCodeStatisticsTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.5.102.3.3.1.
 */
public class TableResultCodeStatisticsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableResultCodeStatisticsTable".
     ...
     */
    public TableResultCodeStatisticsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableResultCodeStatisticsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "ResultCodeStatisticsEntryMBean"
            // interface.
            //
            final Object entry =
                 createResultCodeStatisticsEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong(),
                    oid1.toLong(),
                    oid2.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("ResultCodeStatisticsTable");
    }
    ...
    public synchronized void addEntry(ResultCodeStatisticsEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(ResultCodeStatisticsEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized ResultCodeStatisticsEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        ResultCodeStatisticsEntryMBean[] result = new ResultCodeStatisticsEntryMBean[array.length];
    ...
    public void removeEntry(ResultCodeStatisticsEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyResultCode = oid.toLong().toString();
            return new ObjectName("TableResultCodeStatisticsTable:name=com.elitecore.diameterapi.mibs.custom.autogen.ResultCodeStatisticsEntry" + ",PeerIndex=" + _keyPeerIndex + ",ApplicationID=" + _keyApplicationID + ",ResultCode=" + _keyResultCode);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "ResultCodeStatisticsEntry".
     */
    public SnmpIndex buildSnmpIndex(ResultCodeStatisticsEntryMBean entry)
        throws SnmpStatusException {
        ...
        oids[1] = val.toOid();
        val = new SnmpGauge(entry.getResultCode());
        oids[2] = val.toOid();
     ...
     * Build index for "ResultCodeStatisticsEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aPeerIndex, Long aApplicationID, Long aResultCode)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpGauge.appendToOid(new SnmpGauge(aPeerIndex).toOid(), oid);
            SnmpGauge.appendToOid(new SnmpGauge(aApplicationID).toOid(), oid);
            SnmpGauge.appendToOid(new SnmpGauge(aResultCode).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "ResultCodeStatisticsEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "ResultCodeStatisticsEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "ResultCodeStatisticsEntryMBean"
     * interface.
    ...
    public Object createResultCodeStatisticsEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aPeerIndex, Long  aApplicationID, Long  aResultCode)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        ResultCodeStatisticsEntry entry = new ResultCodeStatisticsEntry(theMib);
        entry.PeerIndex = aPeerIndex;
        entry.ApplicationID = aApplicationID;
        entry.ResultCode = aResultCode;
        return entry;
    }
