 ...
 */
public class TableDccaPeerVendorTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDccaPeerVendorTable".
     ...
     */
    public TableDccaPeerVendorTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDccaPeerVendorTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DccaPeerVendorEntryMBean"
            // interface.
            //
            final Object entry =
                 createDccaPeerVendorEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong(),
                    oid1.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DccaPeerVendorTable");
    }
    ...
    public synchronized void addEntry(DccaPeerVendorEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DccaPeerVendorEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DccaPeerVendorEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DccaPeerVendorEntryMBean[] result = new DccaPeerVendorEntryMBean[array.length];
    ...
    public void removeEntry(DccaPeerVendorEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyDccaPeerIndex = oid.toLong().toString();
            oid = (SnmpOid) v.elementAt(1);
            String _keyDccaPeerVendorIndex = oid.toLong().toString();
            return new ObjectName("TableDccaPeerVendorTable:name=com.elitecore.diameterapi.mibs.cc.autogen.DccaPeerVendorEntry" + ",DccaPeerIndex=" + _keyDccaPeerIndex + ",DccaPeerVendorIndex=" + _keyDccaPeerVendorIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DccaPeerVendorEntry".
     */
    public SnmpIndex buildSnmpIndex(DccaPeerVendorEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpGauge(entry.getDccaPeerIndex());
        oids[0] = val.toOid();
        val = new SnmpGauge(entry.getDccaPeerVendorIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "DccaPeerVendorEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDccaPeerIndex, Long aDccaPeerVendorIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpGauge.appendToOid(new SnmpGauge(aDccaPeerIndex).toOid(), oid);
            SnmpGauge.appendToOid(new SnmpGauge(aDccaPeerVendorIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "DccaPeerVendorEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DccaPeerVendorEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DccaPeerVendorEntryMBean"
     * interface.
    ...
    public Object createDccaPeerVendorEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDccaPeerIndex, Long  aDccaPeerVendorIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DccaPeerVendorEntry entry = new DccaPeerVendorEntry(theMib);
        entry.DccaPeerIndex = aDccaPeerIndex;
        entry.DccaPeerVendorIndex = aDccaPeerVendorIndex;
        return entry;
    }
