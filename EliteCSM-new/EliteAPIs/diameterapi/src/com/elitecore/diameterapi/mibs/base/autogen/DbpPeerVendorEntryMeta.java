...
/**
 * The class is used for representing SNMP metadata for the "DbpPeerVendorEntry" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.3.4.1.
 */
public class DbpPeerVendorEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "DbpPeerVendorEntry".
     */
    public DbpPeerVendorEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpInt(node.getDbpPeerVendorRowStatus());

            case 3:
                return new SnmpInt(node.getDbpPeerVendorStorageType());

            case 2:
                return new SnmpInt(node.getDbpPeerVendorId());
        ...
        switch((int)var) {
            case 4:
                if (x instanceof SnmpInt) {
                    try  {
                        node.setDbpPeerVendorRowStatus( new EnumDbpPeerVendorRowStatus (((SnmpInt)x).toInteger()));
            ...
            case 3:
                if (x instanceof SnmpInt) {
                    try  {
                        node.setDbpPeerVendorStorageType( new EnumDbpPeerVendorStorageType (((SnmpInt)x).toInteger()));
                    } catch(IllegalArgumentException e)  {
                        throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
                    }
                    return new SnmpInt(node.getDbpPeerVendorStorageType());
            ...
            case 2:
                if (x instanceof SnmpInt) {
                    try  {
                        node.setDbpPeerVendorId( new EnumDbpPeerVendorId (((SnmpInt)x).toInteger()));
                    } catch(IllegalArgumentException e)  {
                        throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
                    }
                    return new SnmpInt(node.getDbpPeerVendorId());
    ...
    public void check(SnmpValue x, long var, Object data)
        ...
        switch((int) var) {
            case 3:
                if (x instanceof SnmpInt) {
                    try  {
                        node.checkDbpPeerVendorStorageType( new EnumDbpPeerVendorStorageType (((SnmpInt)x).toInteger()));
                    } catch(IllegalArgumentException e)  {
                        throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
                    }
                } else {
            ...
            case 2:
                if (x instanceof SnmpInt) {
                    try  {
                        node.checkDbpPeerVendorId( new EnumDbpPeerVendorId (((SnmpInt)x).toInteger()));
                    } catch(IllegalArgumentException e)  {
                        throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
                    }
                } else {
     ...
     */
    protected void setInstance(DbpPeerVendorEntryMBean var) {
        node = var;
    }
    ...
    public  String getRowStatusName()  {
        return new String ("DbpPeerVendorRowStatus");
    }
    ...
    public  int getRowStatus(Object userData)
            throws SnmpStatusException {
        final  SnmpValue x = get(4, userData);
        final  SnmpVarBind vb = new SnmpVarBind();

        // We know we won't need the OID.
        //
        // vb.oid = new SnmpOid("1.3.6.1.2.1.119.1.3.4.1.4");
    ...
    protected DbpPeerVendorEntryMBean node;
