...
/**
 * The class is used for representing "DbpAppAdvToPeerRowStatus".
 */
public class EnumDbpAppAdvToPeerRowStatus extends Enumerated implements Serializable {
    ...
    public EnumDbpAppAdvToPeerRowStatus(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpAppAdvToPeerRowStatus(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpAppAdvToPeerRowStatus() throws IllegalArgumentException {
        super();
    }

    public EnumDbpAppAdvToPeerRowStatus(String x) throws IllegalArgumentException {
        super(x);
    }
