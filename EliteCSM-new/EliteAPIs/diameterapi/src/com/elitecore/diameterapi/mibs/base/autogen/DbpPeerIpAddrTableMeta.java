 ...
 */
public class DbpPeerIpAddrTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpPeerIpAddrTableMeta".
     ...
     */
    public DbpPeerIpAddrTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpPeerIpAddrEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpPeerIpAddrEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpPeerIpAddrTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpPeerIpAddrEntry" conceptual row (DbpPeerIpAddrEntryMeta)
     * 
     **/
    protected DbpPeerIpAddrEntryMeta createDbpPeerIpAddrEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpPeerIpAddrEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpPeerIpAddrEntryMetaNode("DbpPeerIpAddrEntry", "DbpPeerIpAddrTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpPeerIpAddrEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpPeerIpAddrTable" + "\" must implement the \"" + 
                           "DbpPeerIpAddrEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        DbpPeerIpAddrEntryMBean entry = (DbpPeerIpAddrEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private DbpPeerIpAddrEntryMeta node;
