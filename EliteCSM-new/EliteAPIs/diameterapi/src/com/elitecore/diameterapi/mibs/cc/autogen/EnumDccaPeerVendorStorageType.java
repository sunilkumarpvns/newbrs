...
/**
 * The class is used for representing "DccaPeerVendorStorageType".
 */
public class EnumDccaPeerVendorStorageType extends Enumerated implements Serializable {
    ...
    public EnumDccaPeerVendorStorageType(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerVendorStorageType(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerVendorStorageType() throws IllegalArgumentException {
        super();
    }

    public EnumDccaPeerVendorStorageType(String x) throws IllegalArgumentException {
        super(x);
    }
