...
/**
 * The class is used for implementing the "DbpRealmMessageRouteTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.119.1.6.1.
 */
public class TableDbpRealmMessageRouteTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDbpRealmMessageRouteTable".
     ...
     */
    public TableDbpRealmMessageRouteTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDbpRealmMessageRouteTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DbpRealmMessageRouteEntryMBean"
            // interface.
            //
            final Object entry =
                 createDbpRealmMessageRouteEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DbpRealmMessageRouteTable");
    }
    ...
    public synchronized void addEntry(DbpRealmMessageRouteEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DbpRealmMessageRouteEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DbpRealmMessageRouteEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DbpRealmMessageRouteEntryMBean[] result = new DbpRealmMessageRouteEntryMBean[array.length];
    ...
    public void removeEntry(DbpRealmMessageRouteEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableDbpRealmMessageRouteTable:name=com.elitecore.diameterapi.mibs.base.autogen.DbpRealmMessageRouteEntry" + ",DbpRealmMessageRouteIndex=" + _keyDbpRealmMessageRouteIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DbpRealmMessageRouteEntry".
     */
    public SnmpIndex buildSnmpIndex(DbpRealmMessageRouteEntryMBean entry)
        throws SnmpStatusException {
     ...
     * Build index for "DbpRealmMessageRouteEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDbpRealmMessageRouteIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
    ...
    /**
     * Factory method for "DbpRealmMessageRouteEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DbpRealmMessageRouteEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DbpRealmMessageRouteEntryMBean"
     * interface.
    ...
    public Object createDbpRealmMessageRouteEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDbpRealmMessageRouteIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DbpRealmMessageRouteEntry entry = new DbpRealmMessageRouteEntry(theMib);
