 ...
 */
public class PeerIpAddrTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "PeerIpAddrTableMeta".
     ...
     */
    public PeerIpAddrTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "PeerIpAddrEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("PeerIpAddrEntry")
     * @param tableName Name of the table in which the entries are registered ("PeerIpAddrTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "PeerIpAddrEntry" conceptual row (PeerIpAddrEntryMeta)
     * 
     **/
    protected PeerIpAddrEntryMeta createPeerIpAddrEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new PeerIpAddrEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createPeerIpAddrEntryMetaNode("PeerIpAddrEntry", "PeerIpAddrTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof PeerIpAddrEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "PeerIpAddrTable" + "\" must implement the \"" + 
                           "PeerIpAddrEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        PeerIpAddrEntryMBean entry = (PeerIpAddrEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private PeerIpAddrEntryMeta node;
