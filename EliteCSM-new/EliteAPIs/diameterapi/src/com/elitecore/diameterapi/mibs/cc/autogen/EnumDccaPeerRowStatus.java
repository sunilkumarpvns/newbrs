...
/**
 * The class is used for representing "DccaPeerRowStatus".
 */
public class EnumDccaPeerRowStatus extends Enumerated implements Serializable {
    ...
    public EnumDccaPeerRowStatus(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerRowStatus(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerRowStatus() throws IllegalArgumentException {
        super();
    }

    public EnumDccaPeerRowStatus(String x) throws IllegalArgumentException {
        super(x);
    }
