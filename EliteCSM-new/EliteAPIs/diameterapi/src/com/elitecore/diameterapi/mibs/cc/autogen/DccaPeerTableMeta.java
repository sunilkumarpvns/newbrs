 ...
 */
public class DccaPeerTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DccaPeerTableMeta".
     ...
     */
    public DccaPeerTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DccaPeerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DccaPeerEntry")
     * @param tableName Name of the table in which the entries are registered ("DccaPeerTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DccaPeerEntry" conceptual row (DccaPeerEntryMeta)
     * 
     **/
    protected DccaPeerEntryMeta createDccaPeerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DccaPeerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDccaPeerEntryMetaNode("DccaPeerEntry", "DccaPeerTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DccaPeerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DccaPeerTable" + "\" must implement the \"" + 
                           "DccaPeerEntryMBean" + "\" interface.");
    ...
    public  SnmpValue setRowStatus(SnmpOid rowOid, int status, Object userData)
            throws SnmpStatusException {
        DccaPeerEntryMBean entry = (DccaPeerEntryMBean) getEntry(rowOid);
        synchronized (this) {
    ...
    public  int mapRowStatus(SnmpOid rowOid, SnmpVarBind vbstatus, Object userData)
            throws SnmpStatusException {
        DccaPeerEntryMBean entry = null;
        try  {
            entry = (DccaPeerEntryMBean) getEntry(rowOid);
     ...
     */
    private DccaPeerEntryMeta node;
