 ...
 */
public class DbpAppAdvFromPeerTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpAppAdvFromPeerTableMeta".
     ...
     */
    public DbpAppAdvFromPeerTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpAppAdvFromPeerEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpAppAdvFromPeerEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpAppAdvFromPeerTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpAppAdvFromPeerEntry" conceptual row (DbpAppAdvFromPeerEntryMeta)
     * 
     **/
    protected DbpAppAdvFromPeerEntryMeta createDbpAppAdvFromPeerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpAppAdvFromPeerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpAppAdvFromPeerEntryMetaNode("DbpAppAdvFromPeerEntry", "DbpAppAdvFromPeerTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpAppAdvFromPeerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpAppAdvFromPeerTable" + "\" must implement the \"" + 
                           "DbpAppAdvFromPeerEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        DbpAppAdvFromPeerEntryMBean entry = (DbpAppAdvFromPeerEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private DbpAppAdvFromPeerEntryMeta node;
