 ...
 */
public class DbpPerPeerInfoTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpPerPeerInfoTableMeta".
     ...
     */
    public DbpPerPeerInfoTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpPerPeerInfoEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpPerPeerInfoEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpPerPeerInfoTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpPerPeerInfoEntry" conceptual row (DbpPerPeerInfoEntryMeta)
     * 
     **/
    protected DbpPerPeerInfoEntryMeta createDbpPerPeerInfoEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpPerPeerInfoEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpPerPeerInfoEntryMetaNode("DbpPerPeerInfoEntry", "DbpPerPeerInfoTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpPerPeerInfoEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpPerPeerInfoTable" + "\" must implement the \"" + 
                           "DbpPerPeerInfoEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        DbpPerPeerInfoEntryMBean entry = (DbpPerPeerInfoEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private DbpPerPeerInfoEntryMeta node;
