 ...
 */
public class DbpLocalApplTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DbpLocalApplTableMeta".
     ...
     */
    public DbpLocalApplTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DbpLocalApplEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DbpLocalApplEntry")
     * @param tableName Name of the table in which the entries are registered ("DbpLocalApplTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DbpLocalApplEntry" conceptual row (DbpLocalApplEntryMeta)
     * 
     **/
    protected DbpLocalApplEntryMeta createDbpLocalApplEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DbpLocalApplEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDbpLocalApplEntryMetaNode("DbpLocalApplEntry", "DbpLocalApplTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DbpLocalApplEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DbpLocalApplTable" + "\" must implement the \"" + 
                           "DbpLocalApplEntryMBean" + "\" interface.");
    ...
    public  SnmpValue setRowStatus(SnmpOid rowOid, int status, Object userData)
            throws SnmpStatusException {
        DbpLocalApplEntryMBean entry = (DbpLocalApplEntryMBean) getEntry(rowOid);
        synchronized (this) {
    ...
    public  int mapRowStatus(SnmpOid rowOid, SnmpVarBind vbstatus, Object userData)
            throws SnmpStatusException {
        DbpLocalApplEntryMBean entry = null;
        try  {
            entry = (DbpLocalApplEntryMBean) getEntry(rowOid);
     ...
     */
    private DbpLocalApplEntryMeta node;
