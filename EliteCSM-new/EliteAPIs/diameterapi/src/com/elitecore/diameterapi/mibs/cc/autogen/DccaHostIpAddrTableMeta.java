 ...
 */
public class DccaHostIpAddrTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DccaHostIpAddrTableMeta".
     ...
     */
    public DccaHostIpAddrTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DccaHostIpAddrEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DccaHostIpAddrEntry")
     * @param tableName Name of the table in which the entries are registered ("DccaHostIpAddrTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DccaHostIpAddrEntry" conceptual row (DccaHostIpAddrEntryMeta)
     * 
     **/
    protected DccaHostIpAddrEntryMeta createDccaHostIpAddrEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DccaHostIpAddrEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDccaHostIpAddrEntryMetaNode("DccaHostIpAddrEntry", "DccaHostIpAddrTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DccaHostIpAddrEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DccaHostIpAddrTable" + "\" must implement the \"" + 
                           "DccaHostIpAddrEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        DccaHostIpAddrEntryMBean entry = (DccaHostIpAddrEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private DccaHostIpAddrEntryMeta node;
