...
/**
 * The class is used for implementing the "DccaHostIpAddrTable" group.
 * The group is defined with the following oid: 1.3.6.1.2.1.4006.2.1.1.2.
 */
public class TableDccaHostIpAddrTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDccaHostIpAddrTable".
     ...
     */
    public TableDccaHostIpAddrTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDccaHostIpAddrTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DccaHostIpAddrEntryMBean"
            // interface.
            //
            final Object entry =
                 createDccaHostIpAddrEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DccaHostIpAddrTable");
    }
    ...
    public synchronized void addEntry(DccaHostIpAddrEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DccaHostIpAddrEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DccaHostIpAddrEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DccaHostIpAddrEntryMBean[] result = new DccaHostIpAddrEntryMBean[array.length];
    ...
    public void removeEntry(DccaHostIpAddrEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyDccaHostIpAddrIndex = oid.toLong().toString();
            return new ObjectName("TableDccaHostIpAddrTable:name=com.elitecore.diameterapi.mibs.cc.autogen.DccaHostIpAddrEntry" + ",DccaHostIpAddrIndex=" + _keyDccaHostIpAddrIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DccaHostIpAddrEntry".
     */
    public SnmpIndex buildSnmpIndex(DccaHostIpAddrEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpGauge(entry.getDccaHostIpAddrIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "DccaHostIpAddrEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aDccaHostIpAddrIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpGauge.appendToOid(new SnmpGauge(aDccaHostIpAddrIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "DccaHostIpAddrEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DccaHostIpAddrEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DccaHostIpAddrEntryMBean"
     * interface.
    ...
    public Object createDccaHostIpAddrEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aDccaHostIpAddrIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DccaHostIpAddrEntry entry = new DccaHostIpAddrEntry(theMib);
        entry.DccaHostIpAddrIndex = aDccaHostIpAddrIndex;
        return entry;
    }
