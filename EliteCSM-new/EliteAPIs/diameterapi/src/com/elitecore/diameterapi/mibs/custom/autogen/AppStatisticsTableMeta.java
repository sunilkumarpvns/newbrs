 ...
 */
public class AppStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "AppStatisticsTableMeta".
     ...
     */
    public AppStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "ApplicationStatisticsEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("ApplicationStatisticsEntry")
     * @param tableName Name of the table in which the entries are registered ("AppStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "ApplicationStatisticsEntry" conceptual row (ApplicationStatisticsEntryMeta)
     * 
     **/
    protected ApplicationStatisticsEntryMeta createApplicationStatisticsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new ApplicationStatisticsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createApplicationStatisticsEntryMetaNode("ApplicationStatisticsEntry", "AppStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof ApplicationStatisticsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "AppStatisticsTable" + "\" must implement the \"" + 
                           "ApplicationStatisticsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        ApplicationStatisticsEntryMBean entry = (ApplicationStatisticsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private ApplicationStatisticsEntryMeta node;
