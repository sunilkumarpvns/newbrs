 ...
 */
public class ResultCodeStatisticsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "ResultCodeStatisticsTableMeta".
     ...
     */
    public ResultCodeStatisticsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "ResultCodeStatisticsEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("ResultCodeStatisticsEntry")
     * @param tableName Name of the table in which the entries are registered ("ResultCodeStatisticsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "ResultCodeStatisticsEntry" conceptual row (ResultCodeStatisticsEntryMeta)
     * 
     **/
    protected ResultCodeStatisticsEntryMeta createResultCodeStatisticsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new ResultCodeStatisticsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createResultCodeStatisticsEntryMetaNode("ResultCodeStatisticsEntry", "ResultCodeStatisticsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof ResultCodeStatisticsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "ResultCodeStatisticsTable" + "\" must implement the \"" + 
                           "ResultCodeStatisticsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        ResultCodeStatisticsEntryMBean entry = (ResultCodeStatisticsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private ResultCodeStatisticsEntryMeta node;
