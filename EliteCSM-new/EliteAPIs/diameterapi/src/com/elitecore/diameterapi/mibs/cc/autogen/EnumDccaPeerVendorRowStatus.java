...
/**
 * The class is used for representing "DccaPeerVendorRowStatus".
 */
public class EnumDccaPeerVendorRowStatus extends Enumerated implements Serializable {
    ...
    public EnumDccaPeerVendorRowStatus(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerVendorRowStatus(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDccaPeerVendorRowStatus() throws IllegalArgumentException {
        super();
    }

    public EnumDccaPeerVendorRowStatus(String x) throws IllegalArgumentException {
        super(x);
    }
