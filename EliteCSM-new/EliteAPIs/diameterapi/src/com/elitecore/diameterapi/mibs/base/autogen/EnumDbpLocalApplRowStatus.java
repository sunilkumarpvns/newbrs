...
/**
 * The class is used for representing "DbpLocalApplRowStatus".
 */
public class EnumDbpLocalApplRowStatus extends Enumerated implements Serializable {
    ...
    public EnumDbpLocalApplRowStatus(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpLocalApplRowStatus(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpLocalApplRowStatus() throws IllegalArgumentException {
        super();
    }

    public EnumDbpLocalApplRowStatus(String x) throws IllegalArgumentException {
        super(x);
    }
