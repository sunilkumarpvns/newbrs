...
/**
 * The class is used for representing "DbpLocalApplStorageType".
 */
public class EnumDbpLocalApplStorageType extends Enumerated implements Serializable {
    ...
    public EnumDbpLocalApplStorageType(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpLocalApplStorageType(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumDbpLocalApplStorageType() throws IllegalArgumentException {
        super();
    }

    public EnumDbpLocalApplStorageType(String x) throws IllegalArgumentException {
        super(x);
    }
