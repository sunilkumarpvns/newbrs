...
public enum ResultCode {
	...
	// 3GPP VendorId(21067) Result Codes */
	DIAMETER_REQUESTED_SERVICE_NOT_AUTHORIZED(5063, ResultCodeCategory.RC5XXX, DiameterConstants.VENDOR_3GPP_ID),// 3GPP TS 29.214
	DIAMETER_IP_CAN_SESSION_NOT_AVAILABLE(5065, ResultCodeCategory.RC5XXX, DiameterConstants.VENDOR_3GPP_ID); // 3GPP TS 29.214
