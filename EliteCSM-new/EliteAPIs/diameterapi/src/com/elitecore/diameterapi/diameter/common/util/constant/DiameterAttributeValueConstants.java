...
public class DiameterAttributeValueConstants {
	 ...
	 //436
	 public static final int DIAMETER_REQUESTED_ACTION_DIRECT_DEBITING = 0; 
	 public static final int DIAMETER_REQUESTED_ACTION_REFUND_ACCOUNT = 1; 
	 public static final int DIAMETER_REQUESTED_ACTION_CHECK_BALANCE =2; 
	 public static final int DIAMETER_REQUESTED_ACTION_PRICE_ENQUIRY=3; 			
	 ...
	 public static final int DIAMETER_MULTIPLE_SERVICE_INDICATOR_NOT_SUPPORTED=0;
	 public static final int DIAMETER_MULTIPLE_SERVICE_INDICATOR_SUPPORTED=1;
	 ...
	 //1019 Charging-Rule-Base-Name-Status
	 public static final int TGPP_CHARGING_RULE_BASE_NAME_STATUS_ACTIVE = 0;
	 public static final int TGPP_CHARGING_RULE_BASE_NAME_STATUS_INACTIVE = 1;
	 public static final int TGPP_CHARGING_RULE_BASE_NAME_STATUS_TEMPORARILY_INACTIVE = 2;
	 
	 //1006 Event-Trigger
	 public static final int TGPP_OUT_OF_CREDIT = 15;
	 public static final int TGPP_R11_EVENT_TRIGGER_USAGE_REPORT_ID = 33;
	 ...
	 //10415:512 Flow-Usage
	 public static final int TGPP_FLOW_USAGE_NO_INFORMATION = 0;
	 public static final int TGPP_FLOW_USAGE_NO_RTCP = 1;
	 public static final int TGPP_FLOW_USAGE_NO_AF_SIGNALLING = 2;
	...
	//10415:2904 SL-Request-Type
	 ...
	 //10415:1024 NETWORK_REQUEST_SUPPORTED
	public static final long NETWORK_REQUEST_SUPPORTED = 1;
	public static final long NETWORK_REQUEST_NOT_SUPPORTED = 0;
	
	//10415:1023 BEARER-CONTROL-MODE
	public static final long UE_ONLY = 0;
	public static final long UE_NW = 2;
	
	
	//10415:523 SIP-Forking-Indication
	public static final long SIP_FORKING_INDICATION_SINGLE_DIALOGUE = 0;
	public static final long SIP_FORKING_INDICATION_SEVERAL_DIALOGUES = 1;
	...
	//21067:65630 EC_SESSION_STATUS
	 public static final String EC_SESSON_STATUS_INACTIVE = "INACTIVE";
	 public static final String EC_SESSON_STATUS_ACTIVE = "ACTIVE";
	 public static final String EC_SESSON_STATUS_DELETED = "DELETED";
	 
	//10415:872 Reporting-Reason 
	public static final int REPORTING_REASON_THRESHOLD = 0;
	public static final int REPORTING_REASON_QHT = 1;
	public static final int REPORTING_REASON_FINAL = 2;
	public static final int REPORTING_REASON_QUOTA_EXHAUSTED = 3;
	public static final int REPORTING_REASON_VALIDITY_TIME = 4;
	public static final int REPORTING_REASON_OTHER_QUOTA_TYPE = 5;
	public static final int REPORTING_REASON_RATING_CONDITION_CHANGE = 6;
	public static final int REPORTING_REASON_FORCED_REAUTHORISATION = 7;
	public static final int REPORTING_REASON_POOL_EXHAUSTED = 8;
