...
/**
 * 
 * Incorporates DBSESSION Keyword in Copy Packet Response Translation. 
 * <p>
 ...
 *
 */
public class DBSessionResponseKeywordValueProvider extends KeywordValueProvider {
	
	private static final String MODULE = "DBSESSION-RES-KEYWORD-VAL-PROVIDR";

	/**
	 * Creates a new instance of {@link DBSessionResponseKeywordValueProvider} with column name as a parameter 
	 * 
	 * @param columnName for the required session value
	 * @throws NullPointerException in case of value passed is null
	 */
	public DBSessionResponseKeywordValueProvider(@Nonnull String columnName) {
	...
	protected final ValueProvider getValueProvider(TranslatorParams params)
		...
		DiameterRequest diameterRequest = (DiameterRequest) params.getParam(TranslatorConstants.SOURCE_REQUEST);
