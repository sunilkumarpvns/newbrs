...
public class ReceiveRequestContextImpl implements ReceivePacketContext {
	...
	public ReceiveRequestContextImpl(ExecutionContext context) {
	...
	public Optional<DiameterPacket> getReceivedPacketDetail() {
		...
		Optional<Object> optional =  get(ReceivePacketContext.RCVD_REQ);
	...
	public ExecutionContext copy() {
		ReceiveRequestContextImpl executionContext = new ReceiveRequestContextImpl(this.executionContext.copy());
