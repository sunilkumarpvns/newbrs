...
public abstract class ToStringStyle implements Serializable {
	...
	/**
	 * The default toString style. Using the <code>Person</code> example from
	...
	/**
	 * The no field names toString style. Using the <code>Person</code> example
	...
	/**
	 * The simple toString style. Using the <code>Person</code> example from
	 * {@link ToStringBuilder}, the output would look like this:
	 * 
	 * <pre>
	 * John Doe,33,false
	...
	/**
	 * The no class name toString style. Using the <code>Person</code> example
	 * from {@link ToStringBuilder}, the output would look like this:
	 * 
	 * <pre>
	...
	public static class CustomToStringStyle extends ToStringStyle {
		...
		public CustomToStringStyle() {
			...
			this.setContentStart(" ");
			this.setFieldSeparator(SystemUtils.LINE_SEPARATOR + getSpaces(2));
			this.setFieldSeparatorAtStart(true);
			this.setContentEnd(SystemUtils.LINE_SEPARATOR);
		}
	...
	/**
	 * <p>
	 * <code>ToStringStyle</code> that does not print out the classname and
	 * identity hashcode but prints content start and field names.
	 * </p>
	 * 
	 * <p>
	 * This is an inner class rather than using
    ...
    public static final String getSpaces(int noOfSpace) {
    	
    	StringBuffer stringBuffer = new StringBuffer(noOfSpace);
    ...
    public static final String getTabs(int noOfTabs) {
    	
    	StringBuffer stringBuffer = new StringBuffer(noOfTabs);
