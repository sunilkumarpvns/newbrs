...
public class RnCABMFOperationReserveAndReportTest {
    ...
    @Test
    public void test_report_and_reserve_balance() throws OperationFailedException {
        ...
        tblmRnCBalanceEntity.setReservationTime((long) random.nextInt());
        hibernateSessionFactory.save(tblmRnCBalanceEntity);

        rncAbmfOperation.reportAndReserveBalance(rncNonMonetaryBalance.getSubscriberIdentity(), Arrays.asList(rncNonMonetaryBalance), transactionFactory);
        ...
        expectedRnCBalanceEntity.setReservationTime(tblmRnCBalanceEntity.getReservationTime() + rncNonMonetaryBalance.getReservationTime());
    ...
    @Test
    public void test_clear_parameters_works_for_report_and_reserve_balance() throws OperationFailedException {
        ...
        RnCNonMonetaryBalance anotherRnCNonMonitoryBalance = createRnCNonMonetaryBalances(id);

        rncAbmfOperation.reportAndReserveBalance(rncNonMonetaryBalance.getSubscriberIdentity(), Arrays.asList(rncNonMonetaryBalance, anotherRnCNonMonitoryBalance), transactionFactory);

        List<TblmRnCBalanceEntity>  actualEntities = hibernateSessionFactory.get(TblmRnCBalanceEntity.class);

        TblmRnCBalanceEntity expectedRnCBalanceEntity = new TblmRnCBalanceEntity();
        expectedRnCBalanceEntity.setId(id);
        expectedRnCBalanceEntity.setDailyLimit(rncBalanceEntity.getDailyLimit() + rncNonMonetaryBalance.getDailyLimit() + anotherRnCNonMonitoryBalance.getDailyLimit());
        expectedRnCBalanceEntity.setWeeklyLimit(rncBalanceEntity.getWeeklyLimit() + rncNonMonetaryBalance.getWeeklyLimit() + anotherRnCNonMonitoryBalance.getWeeklyLimit());
        expectedRnCBalanceEntity.setBillingCycleTotal(rncBalanceEntity.getBillingCycleTotal());
        expectedRnCBalanceEntity.setBillingCycleAvailable(rncBalanceEntity.getBillingCycleAvailable() - rncNonMonetaryBalance.getBillingCycleAvailable() - anotherRnCNonMonitoryBalance.getBillingCycleAvailable());
        expectedRnCBalanceEntity.setReservationTime(rncBalanceEntity.getReservationTime() + rncNonMonetaryBalance.getReservationTime() + anotherRnCNonMonitoryBalance.getReservationTime());
        expectedRnCBalanceEntity.setLastUpdateTime(actualEntities.get(0).getLastUpdateTime());
    ...
    @Test
    public void test_report_and_Reserve_balance_should_always_end_transaction() throws Exception {
    ...
    @Test
    public void test_reportAndReserve_Balance_should_generate_DB_HIGH_QUERY_RESPONSE_TIME_alert_when_execution_time_is_high() throws Exception{
       
    	TransactionFactory transactionFactory = setUpMockToGenerateHIGHRESPONSEAlertForReportAndReserveBalance();
    ...
    private TransactionFactory setUpMockToGenerateHIGHRESPONSEAlertForReportAndReserveBalance() throws Exception{
    ...
    @Test
    public void test_reportAndReserve_Balance_should_generate_QUERY_TIMEOUT_alert_when_query_timeout_time_is_high() throws Exception {
    	
        TransactionFactory transactionFactory = setUpMockToGenerateQUERYTIMEOUTAlertForReportAndReserveUsage();
        RnCNonMonetaryBalance rncNonMonetaryBalance = createRnCNonMonetaryBalances();
    ...
    private TransactionFactory setUpMockToGenerateQUERYTIMEOUTAlertForReportAndReserveUsage() throws Exception{
    ...
    @Test
    public void test_reportAndReserve_Balance_should_generate_DB_NO_CONNECTION_alert_when_connection_not_found() throws Exception {
    ...
    public void test_reportAndReserve_balance_should_throw_operation_failed_exception_when_any_exception_is_thrown(String whenToThrow,
    ...
    @Test
    public void test_reportAndReserveBalance_should_throw_OperationFailedException_when_DB_is_down() throws Exception {
    ...
    @Test
    public void test_report_and_reserve_balance_should_throw_OpeartionFailedException_when_transaction_factory_is_not_alive() throws OperationFailedException {
        ...
        expectedException.expect(OperationFailedException.class);
        expectedException.expectMessage("Unable to perform report and reserve rnc balance operation for subscriber ID: " + subscriberId + ". Reason: Datasource not available");
        
        try {
            rncAbmfOperation.reportAndReserveBalance(subscriberId, Arrays.asList(rncNonMonetaryBalance), transactionFactory);
        } catch (OperationFailedException e) {
    ...
    @Test
    public void test_report_an_reserve_balance_should_throw_OpeartionFailedException_when_transaction_is_null() throws OperationFailedException {
    ...
    @Test
    public void test_report_and_reserve_balance_mark_Dead_when_sql_exception_is_not_thrown_due_to_QUERY_TIME_OUT_ERROR() throws Exception {
    ...
    @Test
    public void test_report_and_reserve_balance_markDead_is_called_when_sql_exception_is_thrown_due_to_QUERY_TIME_OUT_ERROR() throws Exception {
    ...
    @Test
    public void test_report_and_reserve_balance_incrementAndGet_is_set_to_zero() throws Exception {
    ...
    @Test
    public void test_report_and_reserve_balance_alert_is_generated_when_sql_exception_is_thrown_due_to_QUERY_TIME_OUT_ERROR() throws Exception {
    ...
    @Test
    public void test_report_and_reserve_balance_alert_is_generated_when_transaction_exception_is_generated() throws Exception {
    ...
    @Test
    public void test_report_and_reserve_balance_OperationFailedException_is_thrown_when_any_exception_is_generated() throws Exception {
