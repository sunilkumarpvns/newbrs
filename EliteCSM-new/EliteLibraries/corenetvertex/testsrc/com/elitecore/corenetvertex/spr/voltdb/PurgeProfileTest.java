...
public class PurgeProfileTest {
    ...
    public class GenerateAlertWhen {
        ...
        public void queryRespnseTimeisHigh() throws Exception {
            ...
            try {
                voltDBSPInterface.purgeProfile(profileData.getSubscriberIdentity());
    ...
    public void returnZeroIfSubscriberDoesNotExistInRepository() throws OperationFailedException {
        ...
        Assert.assertEquals(0,voltDBSPInterface.purgeProfile(UNKNOWN_SUBSCRIBER));
    }


    @Test
    public void returnZeroIfSubscriberIsNotInDeletedState() throws OperationFailedException {
        SPRInfo existProfile = createProfile("aditya").getSPRInfo();
        voltDBSPInterface.addProfile(existProfile);
        Assert.assertEquals(0,voltDBSPInterface.purgeProfile("aditya"));
    }


    @Test
    public void canPurgeWhenSubscriberExistInDeletedState() throws OperationFailedException {
        SPRInfo existProfile = createProfile("aditya").getSPRInfo();
        voltDBSPInterface.addProfile(existProfile);
        voltDBSPInterface.markForDeleteProfile(existProfile.getSubscriberIdentity());
        Assert.assertEquals(1,voltDBSPInterface.purgeProfile("aditya"));
    }


    @Test(expected = UnsupportedOperationException.class)
    public void purgeWithTransactionThrowsUnSupportedOperationException() throws OperationFailedException, TransactionException {
        voltDBSPInterface.purgeProfile(createProfile().getSPRInfo().getSubscriberIdentity(),Mockito.mock(Transaction.class));
    }
