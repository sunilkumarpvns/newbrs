...
public class RnCABMFOperationReportBalanceTest {
    ...
    public void test_report_balance() throws OperationFailedException {
        ...
        rncAbmfOperation.reportBalance(rncNonMonetaryBalance.getSubscriberIdentity(), Arrays.asList(rncNonMonetaryBalance), transactionFactory);
    ...
    public void test_clear_parameters_works_for_report_balance() throws OperationFailedException {
        ...
        rncAbmfOperation.reportBalance(rncNonMonetaryBalance.getSubscriberIdentity(),Arrays.asList(rncNonMonetaryBalance, anotherRnCNonMonetaryBalance), transactionFactory);
        List<TblmRnCBalanceEntity>  actualEntities = hibernateSessionFactory.get(TblmRnCBalanceEntity.class);
    ...
    public void test_reportBalance_should_throw_OpeartionFailedException_when_transaction_factory_is_not_alive() throws OperationFailedException {
        ...
        expectedException.expect(OperationFailedException.class);
        expectedException.expectMessage("Unable to perform report rnc balance operation for subscriber ID: " + subscriberId + ". Reason: Datasource not available");
        
        try {
            rncAbmfOperation.reportBalance(subscriberId, Arrays.asList(rncNonMonetaryBalance), transactionFactory);
        } catch (OperationFailedException e) {
