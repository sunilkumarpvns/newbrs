...
@Entity
@Table(name = "TBLM_DATA_BALANCE_HISTORY")
@com.elitecore.corenetvertex.spr.Table(name="TBLM_DATA_BALANCE_HISTORY")
public class TblmDataBalanceHistoryEntity {
    private String id;
    ...
    public TblmDataBalanceHistoryEntity(){
        //Purposefully Empty
    }
    public TblmDataBalanceHistoryEntity(String id,
										String subscriberId,
										String packageId,
    ...
    public boolean equals(Object o) {
        ...
        TblmDataBalanceHistoryEntity that = (TblmDataBalanceHistoryEntity) o;
    ...
    public static String createTableQuery() {
        return QueryBuilder.buildCreateQuery(TblmDataBalanceHistoryEntity.class);
    }
    public static String dropTableQuery() {
        return QueryBuilder.buildDropQuery(TblmDataBalanceHistoryEntity.class);
    }

	public TblmDataBalanceHistoryEntity copy() {
		TblmDataBalanceHistoryEntity copy = new TblmDataBalanceHistoryEntity();
		copy.setId(getId());
		...
		copy.setCarryForwardStatus(getCarryForwardStatus());
		copy.setCarryForwardVolume(getCarryForwardVolume());
		copy.setCarryForwardTime(getCarryForwardTime());
		return copy;
	}
