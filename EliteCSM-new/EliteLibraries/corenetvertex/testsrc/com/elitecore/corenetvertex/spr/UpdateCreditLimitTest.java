...
public class UpdateCreditLimitTest {
    ...
    @Test
    public void test_update_credit_limit_should_always_end_transaction() throws Exception {
        ...
        monetaryABMFOperation.updateCreditLimit(SUBSCRIBERID, monetaryBalance, transactionFactory);
        Connection connection = getConnection();
        assertTrue(connection.isClosed());
    }

    @Test
    public void test_update_credit_limit_should_generate_DB_HIGH_QUERY_RESPONSE_TIME_alert_when_execution_time_is_high() throws Exception{
    ...
    @Test
    public void test_update_credit_limit_should_generate_QUERY_TIMEOUT_alert_when_query_timeout_time_is_high() throws Exception {
    ...
    @Test
    public void test_update_credit_limit_should_generate_DB_NO_CONNECTION_alert_when_connection_not_found() throws Exception {
    ...
    public void test_update_credit_limit_should_throw_operation_failed_exception_when_any_exception_is_thrown(String whenToThrow,
    ...
    @Test
    public void test_update_credit_limit_should_throw_OperationFailedException_when_DB_is_down() throws Exception {
    ...
    private MonetaryBalance createmonetaryBalance() {
        MonetaryBalance monetaryBalance = new MonetaryBalance(UUID.randomUUID().toString(),"1", "1"
                ,1,1,1,2000, 1000, currentTime, currentTime,"INR", MonetaryBalanceType.DEFAULT.name(), currentTime, currentTime + 60000, "", "");
    ...
    @Test
    public void test_update_credit_limit() throws OperationFailedException {
        ...
        dataBalanceEntity.setCreditLimit(random.nextLong());
        ...
        expectedDataBalanceEntity.setCreditLimit(monetaryBalance.getCreditLimit());
        expectedDataBalanceEntity.setNextBillingCycleCreditLimit(monetaryBalance.getNextBillingCycleCreditLimit());
        expectedDataBalanceEntity.setCreditLimitUpdateTime(new Timestamp(monetaryBalance.getCreditLimitUpdateTime()));
