...
public class ReserveMonetaryBalanceTest {
    ...
    public void test_reserve_balance_should_always_end_transaction() throws Exception {
        ...
        monetaryABMFOperation.reserveBalance(SUBSCRIBERID, lstmonetaryBalance, transactionFactory);
    ...
    public void test_reserve_balance() throws OperationFailedException {
        ...
        monetaryABMFOperation.reserveBalance(SUBSCRIBERID, Arrays.asList(monetaryBalance), transactionFactory);
        ...
        expectedDataBalanceEntity.setAvailBalance(dataBalanceEntity.getAvailBalance());
