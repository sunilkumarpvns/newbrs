...
public class TopUpSubscriptionOpertaionSubscribeQuotaTopUpByIdTest {
    ...
    public void test_should_throw_OperationFailedException_when_DB_is_down() throws Exception {
        ...
        try {
            operation.subscribeQuotaTopUpById(createSprInfo("101"), "102", quotaTopUp.getId(), null, null, null, null, 0,null,"param1", "param2", transactionFactory);
    ...
    public void test_should_throw_OperationFailedException_when_starttime_is_more_or_equal_endtime(
        ...
        try {
            operation.subscribeQuotaTopUpById(createSprInfo("101"), "102", quotaTopUp.getId(), state, startTime, endTime, null, 0,null,"param1", "param2", transactionFactory);
    ...
    public void test_should_throw_OperationFailedException_when_invalid_subscriptionState_provided(
        ...
        try {
            operation.subscribeQuotaTopUpById(createSprInfo("101"), "102", quotaTopUp.getId(), subscriptionStatusValue, startTime, endTime, null, 0,null,"param1", "param2", transactionFactory);
        } catch (OperationFailedException e) {
            assertSame(ResultCode.INVALID_INPUT_PARAMETER, e.getErrorCode());
            throw e;
        }
    ...
    public void test_should_status_STARTED_when_subscription_state_not_provided() throws Exception {
        ...
        operation.subscribeQuotaTopUpById(createSprInfo(subscriberIdentity), "102", quotaTopUp.getId(), STATUS_NOT_PROVIDED, startTime, endTime, null, 0,null,"param1", "param2", transactionFactory);
    ...
    @Test
    public void test_should_throw_OperationFailedException_when_quotaTopUp_not_found_for_provided_addonId() throws Exception {
        TopUpSubscriptionOperation operation = getNewSubscriptionOperation();
        ...
        try {
            operation.subscribeQuotaTopUpById(createSprInfo("101"), "102", addonId, state, startTime, endTime, null, 0,null,"param1", "param2", transactionFactory);
        } catch (OperationFailedException e) {
    ...
    public void test_should_add_subscription_provided() throws Exception {
        ...
        operation.subscribeQuotaTopUpById(createSprInfo(subscriberId), subscriberId, quotaTopUp.getId(),
    ...
    public void test_should_throw_exception_when_multiple_subscription_is_not_allowed_and_existing_subscription_found() throws Exception {
        ...
        operation.subscribeQuotaTopUpById(createSprInfo(data.getSubscriberId()), data.getSubscriberId(), data.getAddonId(),
    ...
    public void test_should_subscribe_when_multiple_subscription_is_not_allowed_and_existing_subscription_found_with_REJECTED_and_UNSUBSCRIBED(
        ...
        operation.subscribeQuotaTopUpById(createSprInfo(newAddonSubscription.getSubscriberId()), newAddonSubscription.getSubscriberId(), newAddonSubscription.getAddonId(),
    ...
    public void test_should_subscribe_when_multiple_subscription_is_not_allowed_and_existing_subscription_expired_subscription_found() throws Exception {
        ...
        operation.subscribeQuotaTopUpById(createSprInfo(newAddonSubscription.getSubscriberId()), newAddonSubscription.getSubscriberId(), quotaTopUp.getId(),
                Integer.valueOf(newAddonSubscription.getStatus()), null, null,
                null,0,null, newAddonSubscription.getParam1(), newAddonSubscription.getParam2(), transactionFactory);
    ...
    public void test_should_generate_DB_NO_CONNECTION_alert_when_connection_not_found() throws Exception {
        ...
        TransactionFactory transactionFactory = setUpMockTogenerateDB_NO_CONNECTION_alertForSubscribeByQuotaTopUpId();
        String subscriberId = "501";
        MockQuotaTopUp quotaTopUp = createMockQuotaTopUp();
        ...
        TopUpSubscriptionOperation operation = new TopUpSubscriptionOperation(alertListener, policyRepository,  null,null, null);
    ...
    private TransactionFactory setUpMockTogenerateDB_NO_CONNECTION_alertForSubscribeByQuotaTopUpId() throws TransactionException {
    ...
    public void test_should_generate_DB_HIGH_QUERY_RESPONSE_TIME_alert_when_execution_time_is_high() throws Exception {
        TransactionFactory transactionFactory = setUpMockToGenerateHIGHRESPONSEAlertForSubscriberByQuotaTopUpId();
        AlertListener alertListener = mock(AlertListener.class);
    ...
    private TransactionFactory setUpMockToGenerateHIGHRESPONSEAlertForSubscriberByQuotaTopUpId() throws Exception {
        TransactionFactory transactionFactory = spy(this.transactionFactory);
        Transaction transaction = mock(Transaction.class);
        ...
        ResultSet resultCode = mock(ResultSet.class);
    ...
    public void test_should_generate_QUERYTIMEOUT_alert() throws Exception {
        ...
        TransactionFactory transactionFactory = setUpMockToGenerateQUERYTIMEOUTalertForSubscribeQuotaTopUpById();
        String subscriberId = "501";
        MockQuotaTopUp quotaTopUp = createMockQuotaTopUp();
        SubscriptionData data = new SubscriptionData(subscriberId, quotaTopUp.getId(), null, null, "2",null, "1", null,null);
    ...
    private TransactionFactory setUpMockToGenerateQUERYTIMEOUTalertForSubscribeQuotaTopUpById() throws Exception {
        TransactionFactory transactionFactory = spy(this.transactionFactory);
        Transaction transaction = mock(Transaction.class);
        PreparedStatement preparedStatement = mock(PreparedStatement.class);
    ...
    public void test_should_generate_DB_HIGH_QUERY_RESPONSE_TIME_alert_when_execution_time_is_high_for_checking_existing_subscription() throws Exception {
        ...
        operation.subscribeQuotaTopUpById(createSprInfo(data.getSubscriberId()), data.getSubscriberId(), quotaTopUp.getId(),
                Integer.valueOf(data.getStatus()), null, null,
                null, 0,null,data.getParam1(), data.getParam2(), transactionFactory);
    ...
    public void test_should_always_end_transaction() throws Exception {
        ...
        operation.subscribeQuotaTopUpById(createSprInfo(subscriberId), "102", quotaTopUp.getId(),
                null, null, null,
                null, 0,null,null, null, transactionFactory);
