...
public class SubscriberValidityAddMonetaryBalanceTest {
    ...
    public void testwhenUpdatedProfilewithExpiryDateIsPresentSubscriberValidityisUpdated() throws Exception {
        ...
        subscriberRepository.addMonetaryBalance(SUBSCRIBERID,
                new SubscriberMonetaryBalanceWrapper(createMonetaryBalance(), null, null, null,null,null),
                null, requestIpAddress, updatedProfile, null);
    ...
    public void testwhenMonetaryBalanceIsPresentSubscriberValidityisUpdated() throws Exception {
        ...
        subscriberRepository.addMonetaryBalance(SUBSCRIBERID,
                new SubscriberMonetaryBalanceWrapper(createMonetaryBalance(), null, null, null, null,null),
                null, requestIpAddress, null, null);
        verify(monetaryABMFOperation, times(1)).addMonetaryBalance(any(MonetaryBalance.class), any(Transaction.class));
        verify(balanceEDListener, times(1)).addMonetaryEDR(any(SubscriberMonetaryBalanceWrapper.class), anyString(), anyString());
    }
