...
public class ReportAndReserveMonetaryBalanceTest {
    ...
    public void test_report_and_Reserve_balance_should_always_end_transaction() throws Exception {
        ...
        monetaryABMFOperation.reportAndReserveBalance(SUBSCRIBERID, lstmonetaryBalance, transactionFactory);
    ...
    @Test
    public void test_reportAndReserveBalance_should_generate_QUERY_TIMEOUT_alert_when_query_timeout_time_is_high() throws Exception {
    ...
    @Test
    public void test_reportAndReserve_Balance_should_throw_OperationFailedException_when_DB_is_down() throws Exception {
    ...
    @Test
    public void test_reportAndReserve_balance() throws OperationFailedException {
        ...
        monetaryABMFOperation.reportAndReserveBalance(SUBSCRIBERID, Arrays.asList(monetaryBalance), transactionFactory);
        ...
        expectedDataBalanceEntity.setAvailBalance(dataBalanceEntity.getAvailBalance() - monetaryBalance.getAvailBalance());
        expectedDataBalanceEntity.setInitialBalance(dataBalanceEntity.getInitialBalance());
        expectedDataBalanceEntity.setTotalReservation(dataBalanceEntity.getTotalReservation() + monetaryBalance.getTotalReservation());
        expectedDataBalanceEntity.setValidFromDate(dataBalanceEntity.getValidFromDate());
        expectedDataBalanceEntity.setValidToDate(dataBalanceEntity.getValidToDate());
    ...
    private MonetaryBalance createmonetaryBalance() {
        MonetaryBalance monetaryBalance = new MonetaryBalance(UUID.randomUUID().toString(),"1",
                "1"
                ,1,1,1,0,0, currentTime,
                currentTime,"INR", MonetaryBalanceType.DEFAULT.name(), currentTime, 0,"", "");
