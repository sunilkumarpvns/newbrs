...
public class SubscriptionOperationSubscribeAddOnbyIdTest {
	...
	public void test_should_throw_OperationFailedException_when_DB_is_down() throws Exception {
		...
		ProductOffer addOn = createProductOffer();

		try {
			operation.subscribeAddOnProductOfferById(new SubscriptionParameter(createSprInfo("101"), "102", addOn.getId(), null, null,  null, null, null, null, null, "param1", "param2", null,null), transactionFactory, null);
	...
	private ProductOffer getProductOffer(AddOn addOn) {
		...
		return new ProductOffer(
                ...
                (Objects.nonNull(productOfferData.isFnFOffer()) && productOfferData.isFnFOffer().booleanValue()),productOfferData.getParam1(),
                productOfferData.getParam2(), policyRepository,null,null,new HashMap<>(),productOfferData.getCurrency()
		);
	}
	...
	public void test_should_throw_OperationFailedException_when_starttime_is_more_or_equal_endtime(
		...
		try {
			operation.subscribeAddOnProductOfferById(new SubscriptionParameter(createSprInfo("101"), "102", addOn.getId(), state, null,  null, null, startTime, endTime, null, "param1", "param2", null,null), transactionFactory, null);
	 ...
	 * 	STARTED(2)
	 * 
	 * Other than these state for subscribeAddOnId() will throw OperationFailedException
	 */
	...
	public void test_should_throw_OperationFailedException_when_invalid_subscriptionState_provided(
		...
		try {
			operation.subscribeAddOnProductOfferById(new SubscriptionParameter(createSprInfo("101"), "102", addOn.getId(), subscriptionStatusValue, null,  null, null, startTime, endTime, null, "param1", "param2", null,null), transactionFactory, null);
		} catch (OperationFailedException e) {
			assertSame(ResultCode.INVALID_INPUT_PARAMETER, e.getErrorCode());
			throw e;
		}
	...
	public void test_should_status_STARTED_when_subscription_state_not_provided() throws Exception {
		...
		operation.subscribeAddOnProductOfferById(new SubscriptionParameter(createSprInfo(subscriberIdentity), "102", addOn.getId(), STATUS_NOT_PROVIDED, null,  null, null, startTime, endTime, null, "param1", "param2", null,null), transactionFactory, null);
	...
	@Test
	public void test_should_throw_OperationFailedException_when_addon_not_found_for_provided_addonId() throws Exception {
		SubscriptionOperationImpl operation = getNewSubscriptionOperation();
		final String addonId = "1";
		final Long startTime = null;
		final Long endTime = null;
		final Integer state = null;
		
		expectedException.expectMessage("Package not found for ID: " + addonId);
		expectedException.expect(OperationFailedException.class);
		when(policyRepository.getAddOnById(addonId)).thenReturn(null);
		
		try {
			operation.subscribeAddOnProductOfferById(new SubscriptionParameter(createSprInfo("101"), "102", addonId, state, null,  null, null, startTime, endTime, null, "param1", "param2", null,null), transactionFactory, null);
		} catch (OperationFailedException e) {
	...
	public void test_should_throw_OperationFailedException_when_endtime_is_past_time() throws Exception {
		...
		ProductOffer addOn = createProductOffer();
		when(addOn.getValidityPeriodUnit()).thenReturn(null);
	...
	public void test_should_add_subscription_provided() throws Exception {
		SubscriptionOperationTestSuite.SubscriptionOperationExt operation = getNewSubscriptionOperation();
		...
		operation.subscribeAddOnProductOfferById(
				new SubscriptionParameter(createSprInfo(subscriberId), subscriberId, productOffer.getId(), status, null,  null, null, startTime, endTime, null, null, null, null,null), transactionFactory, null);
	...
	public void test_should_throw_exception_when_multiple_subscription_is_not_allowed_and_existing_subscription_found() throws Exception {
		...
		operation.subscribeAddOnProductOfferById(data.getSubscriberId(), data.getSubscriberId(), data.getAddonId(),
	...
	public void test_should_subscribe_when_multiple_subscription_is_not_allowed_and_existing_subscription_found_with_REJECTED_and_UNSUBSCRIBED(
		...
		operation.subscribeAddOnProductOfferById(newAddonSubscription.getSubscriberId(), newAddonSubscription.getSubscriberId(), newAddonSubscription.getAddonId(),
	...
	public void test_should_subscribe_when_multiple_subscription_is_not_allowed_and_existing_subscription_expired_subscription_found() throws Exception {
		...
		operation.subscribeAddOnProductOfferById(newAddonSubscription.getSubscriberId(), newAddonSubscription.getSubscriberId(), addOn.getId(),
				Integer.valueOf(newAddonSubscription.getStatus()), null, null,
				newAddonSubscription.getParam1(), newAddonSubscription.getParam2(), transactionFactory, null);
	...
	public void test_should_generate_DB_HIGH_QUERY_RESPONSE_TIME_alert_when_execution_time_is_high() throws Exception {
		TransactionFactory transactionFactory = setUpMockToGenerateHIGHRESPONSEAlertForSubscriberByAddOnId();
		AlertListener alertListener = mock(AlertListener.class);
		...
		operation.subscribeAddOnProductOfferById(
				new SubscriptionParameter(createSprInfo(data.getSubscriberId()), data.getSubscriberId(), productOffer.getId(), Integer.valueOf(data.getStatus()), null,  null, null, null, null, null, data.getParam1(), data.getParam2(), null,null), transactionFactory, null);
		
		verify(alertListener, only())
				.generateSystemAlert(Mockito.anyString(), Mockito.eq(Alerts.HIGH_QUERY_RESPONSE_TIME), Mockito.anyString(), Mockito.anyString());
	}
	
	private TransactionFactory setUpMockToGenerateHIGHRESPONSEAlertForSubscriberByAddOnId() throws Exception {
		TransactionFactory transactionFactory = spy(this.transactionFactory);
		Transaction transaction = mock(Transaction.class);
	...
	public void test_should_generate_QUERYTIMEOUT_alert() throws Exception {
		...
		TransactionFactory transactionFactory = setUpMockToGenerateQUERYTIMEOUTalertForSubscribeAddonById();
		String subscriberId = "501";
		ProductOffer productOffer = createProductOffer();
		SubscriptionData data = new SubscriptionData(subscriberId, productOffer.getDataServicePkgData().getId(), null, null, "2",null, "1", null,productOffer.getId());
	...
	private TransactionFactory setUpMockToGenerateQUERYTIMEOUTalertForSubscribeAddonById() throws Exception {
		TransactionFactory transactionFactory = spy(this.transactionFactory);
		Transaction transaction = mock(Transaction.class);
		PreparedStatement preparedStatement = mock(PreparedStatement.class);
	...
	public void test_should_generate_DB_HIGH_QUERY_RESPONSE_TIME_alert_when_execution_time_is_high_for_checking_existing_subscription() throws Exception {
		...
		operation.subscribeAddOnProductOfferById(data.getSubscriberId(), data.getSubscriberId(), addOn.getId(),
				Integer.valueOf(data.getStatus()), null, null,
				data.getParam1(), data.getParam2(), transactionFactory, null);
	...
	public void test_should_always_end_transaction() throws Exception {
		...
		operation.subscribeAddOnProductOfferById(
				new SubscriptionParameter(createSprInfo(subscriberId), "102", addOn.getId(), null, null, null,  null, null, null, null, null, null, null,null), transactionFactory, null);
