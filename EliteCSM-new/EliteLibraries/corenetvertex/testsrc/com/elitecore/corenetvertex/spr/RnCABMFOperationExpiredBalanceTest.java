...
public class RnCABMFOperationExpiredBalanceTest {
    ...
    @Test
    public void expiredBalanceGeneratesDBHIGHQUERYRESPONSETIMEAlertWhenExecutionTimeIsHigh() throws Exception{

        TransactionFactory transactionFactory = setUpMockToGenerateHIGHRESPONSEAlertForDirectDebitBalance();
        rncAbmfOperation.expireNonMonetaryBalance(SUBSCRIBER_ID, null, transactionFactory);
    ...
    @Test
    public void expiredBalanceGeneratesQUERYTIMEOUTAlertWhenQueryTimeoutTimeIsHigh() throws Exception {
    ...
    @Test
    public void expiredBalanceForRnCProductOffer() throws OperationFailedException {

        rncAbmfOperation.expireNonMonetaryBalance(SUBSCRIBER_ID, PRODUCT_OFFER_ID, transactionFactory);
        ...
        Assert.assertTrue(nonMonetaryBalance.getBalanceById("1").getBalanceExpiryTime() < System.currentTimeMillis());
    }
    ...
    private class RnCABMFOperationHelper {
        ...
        public void createPackages(){
            ...
            nonMonetaryRateCard = new NonMonetaryRateCard("1", null, null, null, 0,0, 0, null, 0,0, null, null, null, null,1, RenewalIntervalUnit.MONTH, CommonStatusValues.DISABLE.isBooleanValue());
            ...
            rnCPackage = new RnCPackage(RNC_PACKAGE_ID, "pkgName", null, null, rcgList, null,null, null, PkgMode.LIVE, null, null, null , null, ChargingType.SESSION,currency);
        }
