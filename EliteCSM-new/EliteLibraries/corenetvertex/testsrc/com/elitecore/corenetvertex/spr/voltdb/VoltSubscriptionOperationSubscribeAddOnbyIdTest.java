...
public class VoltSubscriptionOperationSubscribeAddOnbyIdTest {
    ...
    public void addSubscriptionProvidedByIdSuccessfullyOnValidSubscription() throws Exception {
        ...
        List<Subscription> expectedAddonSubscription = voltSubscriptionOperation.subscribeAddOnById(createSPRInfo(subscriberId), subscriberId, addon.getId(),
                status, startTime, endTime, CommonConstants.DEFAULT_SUBSCRIPTION_PRIORITY,
                null, null,null, voltDBClient, null);
    ...
    public void throwOperationFailedExceptionWhenInvalidSubscriptionStateProvided(
        ...
        try {
            voltSubscriptionOperation.subscribeAddOnById(createSPRInfo("101"), "102", addOn.getId(), subscriptionStatusValue, startTime, endTime,CommonConstants.DEFAULT_SUBSCRIPTION_PRIORITY, "param1", "param2",null, voltDBClient, null);
    ...
    public void throwOperationFailedExceptionWhenStarttimeIsMoreOrEqualEndtime(
        ...
        try {
            voltSubscriptionOperation.subscribeAddOnById(createSPRInfo("101"), "102", addOn.getId(), state, startTime, endTime,CommonConstants.DEFAULT_SUBSCRIPTION_PRIORITY, "param1", "param2",null, voltDBClient, null);
        } catch (OperationFailedException e) {
            assertSame(ResultCode.INVALID_INPUT_PARAMETER, e.getErrorCode());
