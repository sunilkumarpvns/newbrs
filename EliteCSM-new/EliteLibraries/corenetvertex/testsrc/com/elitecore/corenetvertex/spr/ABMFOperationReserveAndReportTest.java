...
public class ABMFOperationReserveAndReportTest {
    ...
    public void test_report_and_reserve_balance() throws OperationFailedException {
        ...
        abmfOperation.reportAndReserveBalance(serviceRgNonMonitoryBalance.getSubscriberIdentity(), Arrays.asList(serviceRgNonMonitoryBalance), transactionFactory);
    ...
    public void test_clear_parameters_works_for_report_and_reserve_balance() throws OperationFailedException {
        ...
        abmfOperation.reportAndReserveBalance(serviceRgNonMonitoryBalance.getSubscriberIdentity(), Arrays.asList(serviceRgNonMonitoryBalance, anotherServiceRgNonMonitoryBalance), transactionFactory);

        List<TblmDataBalanceEntity>  actualEntities = hibernateSessionFactory.get(TblmDataBalanceEntity.class);

        TblmDataBalanceEntity expectedDataBalanceEntity = new TblmDataBalanceEntity();
        expectedDataBalanceEntity.setId(id);
    ...
    public void test_report_and_reserve_balance_should_throw_OpeartionFailedException_when_transaction_factory_is_not_alive() throws OperationFailedException {
        ...
        expectedException.expect(OperationFailedException.class);
        expectedException.expectMessage("Unable to perform report and reserve balance operation for subscriber ID: " + subscriberId + ". Reason: Datasource not available");
        try {
            abmfOperation.reportAndReserveBalance(subscriberId, Arrays.asList(serviceRgNonMonitoryBalance), transactionFactory);
        } catch (OperationFailedException e) {
