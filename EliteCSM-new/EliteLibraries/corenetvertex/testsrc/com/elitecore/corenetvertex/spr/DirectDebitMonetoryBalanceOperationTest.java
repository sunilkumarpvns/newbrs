...
public class DirectDebitMonetoryBalanceOperationTest {
    ...
    public void test_direct_debit_balance_should_always_end_transaction() throws Exception {
        ...
        monetaryABMFOperation.directDebitBalance(SUBSCRIBERID, lstmonetaryBalance, transactionFactory);
        Connection connection = getConnection();
        assertTrue(connection.isClosed());
    }

    @Test
    public void test_directDebit_Balance_should_generate_DB_HIGH_QUERY_RESPONSE_TIME_alert_when_execution_time_is_high() throws Exception{
    ...
    @Test
    public void test_directDebitBalance_should_generate_QUERY_TIMEOUT_alert_when_query_timeout_time_is_high() throws Exception {
    ...
    @Test
    public void test_directDebit_Balance_should_generate_DB_NO_CONNECTION_alert_when_connection_not_found() throws Exception {
    ...
    public void test_directDebit_balance_should_throw_operation_failed_exception_when_any_exception_is_thrown(String whenToThrow,
    ...
    @Test
    public void test_directDebit_Balance_should_throw_OperationFailedException_when_DB_is_down() throws Exception {
    ...
    @Test
    public void test_directDebit_balance() throws OperationFailedException {
        ...
        monetaryABMFOperation.directDebitBalance(SUBSCRIBERID, Arrays.asList(monetaryBalance), transactionFactory);
