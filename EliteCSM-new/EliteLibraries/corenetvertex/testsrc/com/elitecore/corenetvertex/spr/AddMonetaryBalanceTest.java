...
public class AddMonetaryBalanceTest {
    ...
    @Test
    public void test_add_balance_should_always_end_transaction() throws Exception {
    ...
    @Test
    public void test_addBalance_should_generate_QUERY_TIMEOUT_alert_when_query_timeout_time_is_high() throws Exception {
    ...
    @Test
    public void test_addBalance_should_generate_DB_NO_CONNECTION_alert_when_connection_not_found() throws Exception {
    ...
    public void test_addbalance_should_throw_operation_failed_exception_when_any_exception_is_thrown(String whenToThrow,
    ...
    @Test
    public void test_addBalance_should_throw_OperationFailedException_when_DB_is_down() throws Exception {
    ...
    @Test
    public void test_add_balance() throws OperationFailedException, SQLException, TransactionException {
        ...
        expectedDataBalanceEntity.setId(monetaryBalance.getId());
        expectedDataBalanceEntity.setSubscriberId(monetaryBalance.getSubscriberId());
        expectedDataBalanceEntity.setServiceId(monetaryBalance.getServiceId());
        expectedDataBalanceEntity.setAvailBalance(monetaryBalance.getAvailBalance());
        expectedDataBalanceEntity.setInitialBalance(monetaryBalance.getInitialBalance());
        expectedDataBalanceEntity.setTotalReservation(monetaryBalance.getTotalReservation());
        expectedDataBalanceEntity.setValidFromDate(new Timestamp(monetaryBalance.getValidFromDate()));
        expectedDataBalanceEntity.setValidToDate(new Timestamp(monetaryBalance.getValidToDate()));
        expectedDataBalanceEntity.setCurrency(monetaryBalance.getCurrency());
