...
@Entity
@Table(name = "TBLM_RNC_BALANCE")
@com.elitecore.corenetvertex.spr.Table(name="TBLM_RNC_BALANCE")
public class TblmRnCBalanceEntity {
    private String id;
    ...
    public TblmRnCBalanceEntity(){
        //Purposefully Empty
    }
    public TblmRnCBalanceEntity(String id,
                                 String subscriberId,
                                 String packageId,
