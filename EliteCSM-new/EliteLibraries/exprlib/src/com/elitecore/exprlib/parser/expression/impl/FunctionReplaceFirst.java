...
public class FunctionReplaceFirst extends AbstractStringFunctionExpression {

	private static final long serialVersionUID = 1L;
	public FunctionReplaceFirst(){
	}	
	...
	public String getStringValue(ValueProvider valueProvider)throws InvalidTypeCastException,IllegalArgumentException, MissingIdentifierException {
		if(argumentList.size()!=3)
			throw new IllegalArgumentException("Number of parameter mismatch ,REPLACEFIRST function has 3 arguments 1)actual string    2)regx   3)replacement ");
