...
public class FunctionLogeTest {
	...
	public void test_getLongValue_must_not_throw_any_exception() 
		...
		assertEquals((long)Math.log(10), 
				compiler.parseExpression("loge(\"10\")")
	...
	public Object[] dataprovider_for_invalid_loge_expressions() {
		...
		return $(
				$("loge(\"0\")", "loge function requires non-zero positive argument"),
				$("loge(\"-1\")", "loge function requires non-zero positive argument"),
				$("loge(\"10\", \"2\")", "loge function requires only one argument, Syntax: loge(<arg>)"),
				$("loge()", "loge function requires only one argument, Syntax: loge(<arg>)")
				);
	}
