...
public final class ExecutionList {
  ...
  private static final String MODULO = "EXECUTOR-LST";
/**
  ...
  private static void executeListener(Runnable runnable, Executor executor) {
    try {
      ...
      LogManager.getLogger().error(MODULO, "RuntimeException while executing runnable "
          + runnable + " with executor " + executor);
      LogManager.getLogger().trace(MODULO, e);
    }
  }
