...
public class KpiTestingTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "KpiTestingTableMeta".
     ...
     */
    public KpiTestingTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "KpiCounterEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("KpiCounterEntry")
     * @param tableName Name of the table in which the entries are registered ("KpiTestingTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "KpiCounterEntry" conceptual row (KpiCounterEntryMeta)
     * 
     **/
    protected KpiCounterEntryMeta createKpiCounterEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new KpiCounterEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createKpiCounterEntryMetaNode("KpiCounterEntry", "KpiTestingTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof KpiCounterEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "KpiTestingTable" + "\" must implement the \"" + 
                           "KpiCounterEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        KpiCounterEntryMBean entry = (KpiCounterEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private KpiCounterEntryMeta node;
