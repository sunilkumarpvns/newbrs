...
public class ASN1Counter32Attribute extends BaseASN1Attribute {

	private int integerValue=0;
	//private int tag = (ASN_UNIVERSAL | ASN_PRIMITIVE | ASN_INTEGER);
	private int length;
	private byte bValue[];
	//private static final String MODULE = "ASN1Counter32Attribute - SNMP";

	public ASN1Counter32Attribute() {
	}

	public ASN1Counter32Attribute(int i) {
		setValue(i);
	}
