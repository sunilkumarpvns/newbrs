...
public class GsmMilenageOpc1 extends BaseGSMA3A8 {
	byte m_opc[];
	...
	public Object clone() throws CloneNotSupportedException {
		GsmMilenageOpc1 gsmMilenageOpc1 = null;
		gsmMilenageOpc1 = (GsmMilenageOpc1) super.clone();
		if(m_opc != null){
			gsmMilenageOpc1.m_opc = new byte[m_opc.length];
			System.arraycopy(m_opc, 0, gsmMilenageOpc1.m_opc, 0, m_opc.length);
		}
		return gsmMilenageOpc1;
	}
}
