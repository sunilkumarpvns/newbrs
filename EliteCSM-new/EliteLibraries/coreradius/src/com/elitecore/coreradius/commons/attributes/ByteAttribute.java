...
public class ByteAttribute extends BaseRadiusAttribute{

	private static final long serialVersionUID = 1L;

	public ByteAttribute(AttributeId attributeDetail) {
	 ...
	 * @throws IllegalArgumentException if the value passed cannot be converted to ByteAttribute.
	 */
	public void setStringValue(String value) {
        ...
        if (value == null) {
            ...
            if (longValue >= 0) {
                ...
                try {
                    setIntValue(Integer.parseInt(taglessValue));
                }catch(NumberFormatException numberFormatExp) {
                    throw new IllegalArgumentException("Cannot convert " + taglessValue + " to ByteAttribute.",numberFormatExp);
                }
            }
        }
	}
	 ...
	 * Returns string equivalent value of this attribute from the dictionary. 
	 * If the value cannot be located from the available dictionary, the numeric
	 * value will be returned. Same as @see ByteAttribute#getStringValue().
	 * 
	 * @return Returns string equivalent value.
	 */
		...
		if (value == null) {
            ...
            try {
	            ...
	            if (longValue >= 0) {
	            	...
	            	throw new IllegalArgumentException("Cannot convert " + value + " to ByteAttribute.",numberFormatExp);
	            }
            }
        }
	}
