 ...
 */
public class TableJvmMemMgrPoolRelTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableJvmMemMgrPoolRelTable".
     ...
     */
    public TableJvmMemMgrPoolRelTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableJvmMemMgrPoolRelTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "JvmMemMgrPoolRelEntryMBean"
            // interface.
            //
            final Object entry =
                 createJvmMemMgrPoolRelEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("JvmMemMgrPoolRelTable");
    }
    ...
    public synchronized void addEntry(JvmMemMgrPoolRelEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(JvmMemMgrPoolRelEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized JvmMemMgrPoolRelEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        JvmMemMgrPoolRelEntryMBean[] result = new JvmMemMgrPoolRelEntryMBean[array.length];
    ...
    public void removeEntry(JvmMemMgrPoolRelEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyJvmMemManagerIndex = oid.toInteger().toString();
            oid = (SnmpOid) v.elementAt(1);
            String _keyJvmMemPoolIndex = oid.toInteger().toString();
            return new ObjectName("TableJvmMemMgrPoolRelTable:name=com.elitecore.core.serverx.snmp.mib.jvm.autogen.JvmMemMgrPoolRelEntry" + ",JvmMemManagerIndex=" + _keyJvmMemManagerIndex + ",JvmMemPoolIndex=" + _keyJvmMemPoolIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "JvmMemMgrPoolRelEntry".
     */
    public SnmpIndex buildSnmpIndex(JvmMemMgrPoolRelEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getJvmMemManagerIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getJvmMemPoolIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "JvmMemMgrPoolRelEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aJvmMemManagerIndex, Integer aJvmMemPoolIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aJvmMemManagerIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aJvmMemPoolIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "JvmMemMgrPoolRelEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "JvmMemMgrPoolRelEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "JvmMemMgrPoolRelEntryMBean"
     * interface.
    ...
    public Object createJvmMemMgrPoolRelEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aJvmMemManagerIndex, Integer  aJvmMemPoolIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        JvmMemMgrPoolRelEntry entry = new JvmMemMgrPoolRelEntry(theMib);
        entry.JvmMemManagerIndex = aJvmMemManagerIndex;
        entry.JvmMemPoolIndex = aJvmMemPoolIndex;
        return entry;
    }
