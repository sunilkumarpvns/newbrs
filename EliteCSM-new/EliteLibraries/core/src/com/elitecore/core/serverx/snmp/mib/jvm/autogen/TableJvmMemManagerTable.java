 ...
 */
public class TableJvmMemManagerTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableJvmMemManagerTable".
     ...
     */
    public TableJvmMemManagerTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableJvmMemManagerTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "JvmMemManagerEntryMBean"
            // interface.
            //
            final Object entry =
                 createJvmMemManagerEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("JvmMemManagerTable");
    }
    ...
    public synchronized void addEntry(JvmMemManagerEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(JvmMemManagerEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized JvmMemManagerEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        JvmMemManagerEntryMBean[] result = new JvmMemManagerEntryMBean[array.length];
    ...
    public void removeEntry(JvmMemManagerEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableJvmMemManagerTable:name=com.elitecore.core.serverx.snmp.mib.jvm.autogen.JvmMemManagerEntry" + ",JvmMemManagerIndex=" + _keyJvmMemManagerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "JvmMemManagerEntry".
     */
    public SnmpIndex buildSnmpIndex(JvmMemManagerEntryMBean entry)
        throws SnmpStatusException {
     ...
     * Build index for "JvmMemManagerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aJvmMemManagerIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
    ...
    /**
     * Factory method for "JvmMemManagerEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "JvmMemManagerEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "JvmMemManagerEntryMBean"
     * interface.
    ...
    public Object createJvmMemManagerEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aJvmMemManagerIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        JvmMemManagerEntry entry = new JvmMemManagerEntry(theMib);
