...
/**
 * The class is used for implementing the "PrTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.2.
 */
public class TablePrTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TablePrTable".
     ...
     */
    public TablePrTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TablePrTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "PrEntryMBean"
            // interface.
            //
            final Object entry =
                 createPrEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("PrTable");
    }
    ...
    public synchronized void addEntry(PrEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(PrEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized PrEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        PrEntryMBean[] result = new PrEntryMBean[array.length];
    ...
    public void removeEntry(PrEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyPrIndex = oid.toInteger().toString();
            return new ObjectName("TablePrTable:name=com.elitecore.core.serverx.snmp.mib.os.autogen.PrEntry" + ",PrIndex=" + _keyPrIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "PrEntry".
     */
    public SnmpIndex buildSnmpIndex(PrEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getPrIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "PrEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aPrIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aPrIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "PrEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "PrEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "PrEntryMBean"
     * interface.
    ...
    public Object createPrEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aPrIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        PrEntry entry = new PrEntry(theMib);
        entry.PrIndex = aPrIndex;
        return entry;
    }
