 ...
 */
public class IpAddrTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "IpAddrTableMeta".
     ...
     */
    public IpAddrTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "IpAddrEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("IpAddrEntry")
     * @param tableName Name of the table in which the entries are registered ("IpAddrTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "IpAddrEntry" conceptual row (IpAddrEntryMeta)
     * 
     **/
    protected IpAddrEntryMeta createIpAddrEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new IpAddrEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createIpAddrEntryMetaNode("IpAddrEntry", "IpAddrTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof IpAddrEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "IpAddrTable" + "\" must implement the \"" + 
                           "IpAddrEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        IpAddrEntryMBean entry = (IpAddrEntryMBean) getEntry(rowOid);
        synchronized (this) {
