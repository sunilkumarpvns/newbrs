...
/**
 * The class is used for implementing the "FileTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.15.
 */
public class TableFileTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableFileTable".
     ...
     */
    public TableFileTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableFileTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "FileEntryMBean"
            // interface.
            //
            final Object entry =
                 createFileEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("FileTable");
    }
    ...
    public synchronized void addEntry(FileEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(FileEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized FileEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        FileEntryMBean[] result = new FileEntryMBean[array.length];
    ...
    public void removeEntry(FileEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyFileIndex = oid.toInteger().toString();
            return new ObjectName("TableFileTable:name=com.elitecore.core.serverx.snmp.mib.os.autogen.FileEntry" + ",FileIndex=" + _keyFileIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "FileEntry".
     */
    public SnmpIndex buildSnmpIndex(FileEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getFileIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "FileEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aFileIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aFileIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "FileEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "FileEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "FileEntryMBean"
     * interface.
    ...
    public Object createFileEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aFileIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        FileEntry entry = new FileEntry(theMib);
        entry.FileIndex = aFileIndex;
        return entry;
    }
