 ...
 */
public class TableJvmMemPoolTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableJvmMemPoolTable".
     ...
     */
    public TableJvmMemPoolTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableJvmMemPoolTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "JvmMemPoolEntryMBean"
            // interface.
            //
            final Object entry =
                 createJvmMemPoolEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("JvmMemPoolTable");
    }
    ...
    public synchronized void addEntry(JvmMemPoolEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(JvmMemPoolEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized JvmMemPoolEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        JvmMemPoolEntryMBean[] result = new JvmMemPoolEntryMBean[array.length];
    ...
    public void removeEntry(JvmMemPoolEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableJvmMemPoolTable:name=com.elitecore.core.serverx.snmp.mib.jvm.autogen.JvmMemPoolEntry" + ",JvmMemPoolIndex=" + _keyJvmMemPoolIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "JvmMemPoolEntry".
     */
    public SnmpIndex buildSnmpIndex(JvmMemPoolEntryMBean entry)
        throws SnmpStatusException {
     ...
     * Build index for "JvmMemPoolEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aJvmMemPoolIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
    ...
    /**
     * Factory method for "JvmMemPoolEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "JvmMemPoolEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "JvmMemPoolEntryMBean"
     * interface.
    ...
    public Object createJvmMemPoolEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aJvmMemPoolIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        JvmMemPoolEntry entry = new JvmMemPoolEntry(theMib);
