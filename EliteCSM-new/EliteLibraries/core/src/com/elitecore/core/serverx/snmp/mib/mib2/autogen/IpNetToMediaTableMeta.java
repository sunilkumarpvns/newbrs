 ...
 */
public class IpNetToMediaTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "IpNetToMediaTableMeta".
     ...
     */
    public IpNetToMediaTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "IpNetToMediaEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("IpNetToMediaEntry")
     * @param tableName Name of the table in which the entries are registered ("IpNetToMediaTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "IpNetToMediaEntry" conceptual row (IpNetToMediaEntryMeta)
     * 
     **/
    protected IpNetToMediaEntryMeta createIpNetToMediaEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new IpNetToMediaEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createIpNetToMediaEntryMetaNode("IpNetToMediaEntry", "IpNetToMediaTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof IpNetToMediaEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "IpNetToMediaTable" + "\" must implement the \"" + 
                           "IpNetToMediaEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        IpNetToMediaEntryMBean entry = (IpNetToMediaEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private IpNetToMediaEntryMeta node;
