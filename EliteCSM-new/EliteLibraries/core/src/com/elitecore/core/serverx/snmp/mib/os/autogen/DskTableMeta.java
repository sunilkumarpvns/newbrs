 ...
 */
public class DskTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "DskTableMeta".
     ...
     */
    public DskTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "DskEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("DskEntry")
     * @param tableName Name of the table in which the entries are registered ("DskTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "DskEntry" conceptual row (DskEntryMeta)
     * 
     **/
    protected DskEntryMeta createDskEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new DskEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createDskEntryMetaNode("DskEntry", "DskTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof DskEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "DskTable" + "\" must implement the \"" + 
                           "DskEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        DskEntryMBean entry = (DskEntryMBean) getEntry(rowOid);
        synchronized (this) {
