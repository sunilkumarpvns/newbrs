 ...
 */
public class IpRouteTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "IpRouteTableMeta".
     ...
     */
    public IpRouteTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "IpRouteEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("IpRouteEntry")
     * @param tableName Name of the table in which the entries are registered ("IpRouteTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "IpRouteEntry" conceptual row (IpRouteEntryMeta)
     * 
     **/
    protected IpRouteEntryMeta createIpRouteEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new IpRouteEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createIpRouteEntryMetaNode("IpRouteEntry", "IpRouteTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof IpRouteEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "IpRouteTable" + "\" must implement the \"" + 
                           "IpRouteEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        IpRouteEntryMBean entry = (IpRouteEntryMBean) getEntry(rowOid);
        synchronized (this) {
