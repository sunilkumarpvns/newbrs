 ...
 */
public class TcpConnTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TcpConnTableMeta".
     ...
     */
    public TcpConnTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "TcpConnEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("TcpConnEntry")
     * @param tableName Name of the table in which the entries are registered ("TcpConnTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "TcpConnEntry" conceptual row (TcpConnEntryMeta)
     * 
     **/
    protected TcpConnEntryMeta createTcpConnEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new TcpConnEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createTcpConnEntryMetaNode("TcpConnEntry", "TcpConnTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof TcpConnEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "TcpConnTable" + "\" must implement the \"" + 
                           "TcpConnEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        TcpConnEntryMBean entry = (TcpConnEntryMBean) getEntry(rowOid);
        synchronized (this) {
