...
/**
 * The class is used for implementing the "MrTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.102.
 */
public class TableMrTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableMrTable".
     ...
     */
    public TableMrTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableMrTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "MrEntryMBean"
            // interface.
            //
            final Object entry =
                 createMrEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toString());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("MrTable");
    }
    ...
    public synchronized void addEntry(MrEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(MrEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized MrEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        MrEntryMBean[] result = new MrEntryMBean[array.length];
    ...
    public void removeEntry(MrEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyMrIndex = oid.toString().toString();
            return new ObjectName("TableMrTable:name=com.elitecore.core.serverx.snmp.mib.os.autogen.MrEntry" + ",MrIndex=" + _keyMrIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "MrEntry".
     */
    public SnmpIndex buildSnmpIndex(MrEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpOid(entry.getMrIndex());
        oids[0] = val.toOid();
    ...
    public SnmpOid buildOidFromIndex(SnmpIndex index)
        ...
        try {
            Vector v = index.getComponents();
            SnmpOid.appendToOid((SnmpOid)v.elementAt(0), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     * Build index for "MrEntry".
     */
    public SnmpOid buildOidFromIndexVal(String aMrIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpOid.appendToOid(new SnmpOid(aMrIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public SnmpIndex buildSnmpIndex(long[] index, int start)
        ...
        SnmpOid[] oids = new SnmpOid[1];
        int pos = start;
        oids[0] = SnmpOid.toOid(index, pos);
        return new SnmpIndex(oids);
    }


    /**
     * Factory method for "MrEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "MrEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "MrEntryMBean"
     * interface.
    ...
    public Object createMrEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, String  aMrIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        MrEntry entry = new MrEntry(theMib);
        entry.MrIndex = aMrIndex;
        return entry;
    }
