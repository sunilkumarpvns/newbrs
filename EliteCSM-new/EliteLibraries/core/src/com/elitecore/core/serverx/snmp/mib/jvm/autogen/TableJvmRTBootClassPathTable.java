 ...
 */
public class TableJvmRTBootClassPathTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableJvmRTBootClassPathTable".
     ...
     */
    public TableJvmRTBootClassPathTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableJvmRTBootClassPathTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "JvmRTBootClassPathEntryMBean"
            // interface.
            //
            final Object entry =
                 createJvmRTBootClassPathEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("JvmRTBootClassPathTable");
    }
    ...
    public synchronized void addEntry(JvmRTBootClassPathEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(JvmRTBootClassPathEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized JvmRTBootClassPathEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        JvmRTBootClassPathEntryMBean[] result = new JvmRTBootClassPathEntryMBean[array.length];
    ...
    public void removeEntry(JvmRTBootClassPathEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyJvmRTBootClassPathIndex = oid.toInteger().toString();
            return new ObjectName("TableJvmRTBootClassPathTable:name=com.elitecore.core.serverx.snmp.mib.jvm.autogen.JvmRTBootClassPathEntry" + ",JvmRTBootClassPathIndex=" + _keyJvmRTBootClassPathIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "JvmRTBootClassPathEntry".
     */
    public SnmpIndex buildSnmpIndex(JvmRTBootClassPathEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getJvmRTBootClassPathIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "JvmRTBootClassPathEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aJvmRTBootClassPathIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aJvmRTBootClassPathIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "JvmRTBootClassPathEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "JvmRTBootClassPathEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "JvmRTBootClassPathEntryMBean"
     * interface.
    ...
    public Object createJvmRTBootClassPathEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aJvmRTBootClassPathIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        JvmRTBootClassPathEntry entry = new JvmRTBootClassPathEntry(theMib);
        entry.JvmRTBootClassPathIndex = aJvmRTBootClassPathIndex;
        return entry;
    }
