 ...
 */
public class TableJvmRTLibraryPathTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableJvmRTLibraryPathTable".
     ...
     */
    public TableJvmRTLibraryPathTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableJvmRTLibraryPathTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "JvmRTLibraryPathEntryMBean"
            // interface.
            //
            final Object entry =
                 createJvmRTLibraryPathEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("JvmRTLibraryPathTable");
    }
    ...
    public synchronized void addEntry(JvmRTLibraryPathEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(JvmRTLibraryPathEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized JvmRTLibraryPathEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        JvmRTLibraryPathEntryMBean[] result = new JvmRTLibraryPathEntryMBean[array.length];
    ...
    public void removeEntry(JvmRTLibraryPathEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyJvmRTLibraryPathIndex = oid.toInteger().toString();
            return new ObjectName("TableJvmRTLibraryPathTable:name=com.elitecore.core.serverx.snmp.mib.jvm.autogen.JvmRTLibraryPathEntry" + ",JvmRTLibraryPathIndex=" + _keyJvmRTLibraryPathIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "JvmRTLibraryPathEntry".
     */
    public SnmpIndex buildSnmpIndex(JvmRTLibraryPathEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getJvmRTLibraryPathIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "JvmRTLibraryPathEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aJvmRTLibraryPathIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aJvmRTLibraryPathIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "JvmRTLibraryPathEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "JvmRTLibraryPathEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "JvmRTLibraryPathEntryMBean"
     * interface.
    ...
    public Object createJvmRTLibraryPathEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aJvmRTLibraryPathIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        JvmRTLibraryPathEntry entry = new JvmRTLibraryPathEntry(theMib);
        entry.JvmRTLibraryPathIndex = aJvmRTLibraryPathIndex;
        return entry;
    }
