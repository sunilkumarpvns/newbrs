 ...
 */
public class TableJvmRTInputArgsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableJvmRTInputArgsTable".
     ...
     */
    public TableJvmRTInputArgsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableJvmRTInputArgsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "JvmRTInputArgsEntryMBean"
            // interface.
            //
            final Object entry =
                 createJvmRTInputArgsEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("JvmRTInputArgsTable");
    }
    ...
    public synchronized void addEntry(JvmRTInputArgsEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(JvmRTInputArgsEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized JvmRTInputArgsEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        JvmRTInputArgsEntryMBean[] result = new JvmRTInputArgsEntryMBean[array.length];
    ...
    public void removeEntry(JvmRTInputArgsEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyJvmRTInputArgsIndex = oid.toInteger().toString();
            return new ObjectName("TableJvmRTInputArgsTable:name=com.elitecore.core.serverx.snmp.mib.jvm.autogen.JvmRTInputArgsEntry" + ",JvmRTInputArgsIndex=" + _keyJvmRTInputArgsIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "JvmRTInputArgsEntry".
     */
    public SnmpIndex buildSnmpIndex(JvmRTInputArgsEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getJvmRTInputArgsIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "JvmRTInputArgsEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aJvmRTInputArgsIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aJvmRTInputArgsIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "JvmRTInputArgsEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "JvmRTInputArgsEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "JvmRTInputArgsEntryMBean"
     * interface.
    ...
    public Object createJvmRTInputArgsEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aJvmRTInputArgsIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        JvmRTInputArgsEntry entry = new JvmRTInputArgsEntry(theMib);
        entry.JvmRTInputArgsIndex = aJvmRTInputArgsIndex;
        return entry;
    }
