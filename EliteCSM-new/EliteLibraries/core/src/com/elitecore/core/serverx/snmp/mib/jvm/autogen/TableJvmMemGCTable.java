 ...
 */
public class TableJvmMemGCTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableJvmMemGCTable".
     ...
     */
    public TableJvmMemGCTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableJvmMemGCTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "JvmMemGCEntryMBean"
            // interface.
            //
            final Object entry =
                 createJvmMemGCEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("JvmMemGCTable");
    }
    ...
    public synchronized void addEntry(JvmMemGCEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(JvmMemGCEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized JvmMemGCEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        JvmMemGCEntryMBean[] result = new JvmMemGCEntryMBean[array.length];
    ...
    public void removeEntry(JvmMemGCEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            return new ObjectName("TableJvmMemGCTable:name=com.elitecore.core.serverx.snmp.mib.jvm.autogen.JvmMemGCEntry" + ",JvmMemManagerIndex=" + _keyJvmMemManagerIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "JvmMemGCEntry".
     */
    public SnmpIndex buildSnmpIndex(JvmMemGCEntryMBean entry)
        throws SnmpStatusException {
    ...
    /**
     * Factory method for "JvmMemGCEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "JvmMemGCEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "JvmMemGCEntryMBean"
     * interface.
    ...
    public Object createJvmMemGCEntryMBean(SnmpMibSubRequest req,
        ...
        // interface.
        //
        JvmMemGCEntry entry = new JvmMemGCEntry(theMib);
