...
/**
 * The class is used for implementing the "LogMatchTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.16.2.
 */
public class TableLogMatchTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableLogMatchTable".
     ...
     */
    public TableLogMatchTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableLogMatchTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "LogMatchEntryMBean"
            // interface.
            //
            final Object entry =
                 createLogMatchEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("LogMatchTable");
    }
    ...
    public synchronized void addEntry(LogMatchEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(LogMatchEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized LogMatchEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        LogMatchEntryMBean[] result = new LogMatchEntryMBean[array.length];
    ...
    public void removeEntry(LogMatchEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyLogMatchIndex = oid.toInteger().toString();
            return new ObjectName("TableLogMatchTable:name=com.elitecore.core.serverx.snmp.mib.os.autogen.LogMatchEntry" + ",LogMatchIndex=" + _keyLogMatchIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "LogMatchEntry".
     */
    public SnmpIndex buildSnmpIndex(LogMatchEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getLogMatchIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "LogMatchEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aLogMatchIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aLogMatchIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "LogMatchEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "LogMatchEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "LogMatchEntryMBean"
     * interface.
    ...
    public Object createLogMatchEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aLogMatchIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        LogMatchEntry entry = new LogMatchEntry(theMib);
        entry.LogMatchIndex = aLogMatchIndex;
        return entry;
    }
