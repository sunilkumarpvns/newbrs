 ...
 */
public class TableEgpNeighTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableEgpNeighTable".
     ...
     */
    public TableEgpNeighTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableEgpNeighTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "EgpNeighEntryMBean"
            // interface.
            //
            final Object entry =
                 createEgpNeighEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toString());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("EgpNeighTable");
    }
    ...
    public synchronized void addEntry(EgpNeighEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(EgpNeighEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized EgpNeighEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        EgpNeighEntryMBean[] result = new EgpNeighEntryMBean[array.length];
    ...
    public void removeEntry(EgpNeighEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyEgpNeighAddr = oid.toString().toString();
            return new ObjectName("TableEgpNeighTable:name=com.elitecore.core.serverx.snmp.mib.mib2.autogen.EgpNeighEntry" + ",EgpNeighAddr=" + _keyEgpNeighAddr);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "EgpNeighEntry".
     */
    public SnmpIndex buildSnmpIndex(EgpNeighEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpIpAddress(entry.getEgpNeighAddr());
        oids[0] = val.toOid();
     ...
     * Build index for "EgpNeighEntry".
     */
    public SnmpOid buildOidFromIndexVal(String aEgpNeighAddr)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpIpAddress.appendToOid(new SnmpIpAddress(aEgpNeighAddr).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "EgpNeighEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "EgpNeighEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "EgpNeighEntryMBean"
     * interface.
    ...
    public Object createEgpNeighEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, String  aEgpNeighAddr)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        EgpNeighEntry entry = new EgpNeighEntry(theMib);
        entry.EgpNeighAddr = aEgpNeighAddr;
        return entry;
    }
