 ...
 */
public class AtTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "AtTableMeta".
     ...
     */
    public AtTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "AtEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("AtEntry")
     * @param tableName Name of the table in which the entries are registered ("AtTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "AtEntry" conceptual row (AtEntryMeta)
     * 
     **/
    protected AtEntryMeta createAtEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new AtEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createAtEntryMetaNode("AtEntry", "AtTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof AtEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "AtTable" + "\" must implement the \"" + 
                           "AtEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        AtEntryMBean entry = (AtEntryMBean) getEntry(rowOid);
        synchronized (this) {
