 ...
 */
public class FileTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "FileTableMeta".
     ...
     */
    public FileTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "FileEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("FileEntry")
     * @param tableName Name of the table in which the entries are registered ("FileTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "FileEntry" conceptual row (FileEntryMeta)
     * 
     **/
    protected FileEntryMeta createFileEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new FileEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createFileEntryMetaNode("FileEntry", "FileTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof FileEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "FileTable" + "\" must implement the \"" + 
                           "FileEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        FileEntryMBean entry = (FileEntryMBean) getEntry(rowOid);
        synchronized (this) {
