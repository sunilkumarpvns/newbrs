...
/**
 * The class is used for implementing the "LaTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.10.
 */
public class TableLaTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableLaTable".
     ...
     */
    public TableLaTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableLaTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "LaEntryMBean"
            // interface.
            //
            final Object entry =
                 createLaEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("LaTable");
    }
    ...
    public synchronized void addEntry(LaEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(LaEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized LaEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        LaEntryMBean[] result = new LaEntryMBean[array.length];
    ...
    public void removeEntry(LaEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyLaIndex = oid.toInteger().toString();
            return new ObjectName("TableLaTable:name=com.elitecore.core.serverx.snmp.mib.os.autogen.LaEntry" + ",LaIndex=" + _keyLaIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "LaEntry".
     */
    public SnmpIndex buildSnmpIndex(LaEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getLaIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "LaEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aLaIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aLaIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "LaEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "LaEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "LaEntryMBean"
     * interface.
    ...
    public Object createLaEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aLaIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        LaEntry entry = new LaEntry(theMib);
        entry.LaIndex = aLaIndex;
        return entry;
    }
