 ...
 */
public class UdpTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "UdpTableMeta".
     ...
     */
    public UdpTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "UdpEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("UdpEntry")
     * @param tableName Name of the table in which the entries are registered ("UdpTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "UdpEntry" conceptual row (UdpEntryMeta)
     * 
     **/
    protected UdpEntryMeta createUdpEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new UdpEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createUdpEntryMetaNode("UdpEntry", "UdpTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof UdpEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "UdpTable" + "\" must implement the \"" + 
                           "UdpEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        UdpEntryMBean entry = (UdpEntryMBean) getEntry(rowOid);
        synchronized (this) {
