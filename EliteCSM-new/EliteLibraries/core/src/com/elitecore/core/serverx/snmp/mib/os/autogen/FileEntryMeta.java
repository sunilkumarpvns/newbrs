...
/**
 * The class is used for representing SNMP metadata for the "FileEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.15.1.
 */
public class FileEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "FileEntry".
     */
    public FileEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpInt(node.getFileMax());

            case 3:
                return new SnmpInt(node.getFileSize());

            case 2:
                return new SnmpString(node.getFileName());

            case 101:
                return new SnmpString(node.getFileErrorMsg());

            case 100:
                return new SnmpInt(node.getFileErrorFlag());

            case 1:
                return new SnmpInt(node.getFileIndex());
     ...
     */
    protected void setInstance(FileEntryMBean var) {
        node = var;
    }
