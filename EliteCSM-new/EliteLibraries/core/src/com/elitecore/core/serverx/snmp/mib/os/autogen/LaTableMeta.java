 ...
 */
public class LaTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "LaTableMeta".
     ...
     */
    public LaTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "LaEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("LaEntry")
     * @param tableName Name of the table in which the entries are registered ("LaTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "LaEntry" conceptual row (LaEntryMeta)
     * 
     **/
    protected LaEntryMeta createLaEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new LaEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createLaEntryMetaNode("LaEntry", "LaTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof LaEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "LaTable" + "\" must implement the \"" + 
                           "LaEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        LaEntryMBean entry = (LaEntryMBean) getEntry(rowOid);
        synchronized (this) {
