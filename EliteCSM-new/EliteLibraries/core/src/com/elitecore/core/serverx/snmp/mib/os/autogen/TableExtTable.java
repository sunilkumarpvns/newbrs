 ...
 */
public class TableExtTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableExtTable".
     ...
     */
    public TableExtTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableExtTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "ExtEntryMBean"
            // interface.
            //
            final Object entry =
                 createExtEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("ExtTable");
    }
    ...
    public synchronized void addEntry(ExtEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(ExtEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized ExtEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        ExtEntryMBean[] result = new ExtEntryMBean[array.length];
    ...
    public void removeEntry(ExtEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyExtIndex = oid.toInteger().toString();
            return new ObjectName("TableExtTable:name=com.elitecore.core.serverx.snmp.mib.os.autogen.ExtEntry" + ",ExtIndex=" + _keyExtIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "ExtEntry".
     */
    public SnmpIndex buildSnmpIndex(ExtEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getExtIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "ExtEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aExtIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aExtIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "ExtEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "ExtEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "ExtEntryMBean"
     * interface.
    ...
    public Object createExtEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aExtIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        ExtEntry entry = new ExtEntry(theMib);
        entry.ExtIndex = aExtIndex;
        return entry;
    }
