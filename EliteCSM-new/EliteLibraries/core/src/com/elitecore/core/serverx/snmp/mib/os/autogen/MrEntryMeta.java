...
/**
 * The class is used for representing SNMP metadata for the "MrEntry" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.102.1.
 */
public class MrEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "MrEntry".
     */
    public MrEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 2:
                return new SnmpString(node.getMrModuleName());

            case 1:
                return new SnmpOid(node.getMrIndex());
     ...
     */
    protected void setInstance(MrEntryMBean var) {
        node = var;
    }
