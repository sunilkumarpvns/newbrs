...
/**
 * The class is used for implementing the "DskTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.2021.9.
 */
public class TableDskTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableDskTable".
     ...
     */
    public TableDskTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableDskTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "DskEntryMBean"
            // interface.
            //
            final Object entry =
                 createDskEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("DskTable");
    }
    ...
    public synchronized void addEntry(DskEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(DskEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized DskEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        DskEntryMBean[] result = new DskEntryMBean[array.length];
    ...
    public void removeEntry(DskEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyDskIndex = oid.toInteger().toString();
            return new ObjectName("TableDskTable:name=com.elitecore.core.serverx.snmp.mib.os.autogen.DskEntry" + ",DskIndex=" + _keyDskIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "DskEntry".
     */
    public SnmpIndex buildSnmpIndex(DskEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getDskIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "DskEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aDskIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aDskIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "DskEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "DskEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "DskEntryMBean"
     * interface.
    ...
    public Object createDskEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aDskIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        DskEntry entry = new DskEntry(theMib);
        entry.DskIndex = aDskIndex;
        return entry;
    }
