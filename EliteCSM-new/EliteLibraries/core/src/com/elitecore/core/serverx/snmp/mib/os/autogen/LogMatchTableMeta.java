 ...
 */
public class LogMatchTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "LogMatchTableMeta".
     ...
     */
    public LogMatchTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "LogMatchEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("LogMatchEntry")
     * @param tableName Name of the table in which the entries are registered ("LogMatchTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "LogMatchEntry" conceptual row (LogMatchEntryMeta)
     * 
     **/
    protected LogMatchEntryMeta createLogMatchEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new LogMatchEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createLogMatchEntryMetaNode("LogMatchEntry", "LogMatchTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof LogMatchEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "LogMatchTable" + "\" must implement the \"" + 
                           "LogMatchEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        LogMatchEntryMBean entry = (LogMatchEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private LogMatchEntryMeta node;
