...
/**
 * The class is used for representing SNMP metadata for the "AlertInfoGroup" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.6.2.
 */
public class AlertInfoGroupMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "AlertInfoGroup".
     */
    public AlertInfoGroupMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
     ...
     */
    protected void setInstance(AlertInfoGroupMBean var) {
        node = var;
    }
    ...
    protected AlertInfoGroupMBean node;
