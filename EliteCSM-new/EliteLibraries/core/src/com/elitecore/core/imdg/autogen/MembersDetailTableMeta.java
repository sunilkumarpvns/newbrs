 ...
 */
public class MembersDetailTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "MembersDetailTableMeta".
     ...
     */
    public MembersDetailTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "MembersDetailEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("MembersDetailEntry")
     * @param tableName Name of the table in which the entries are registered ("MembersDetailTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "MembersDetailEntry" conceptual row (MembersDetailEntryMeta)
     * 
     **/
    protected MembersDetailEntryMeta createMembersDetailEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new MembersDetailEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createMembersDetailEntryMetaNode("MembersDetailEntry", "MembersDetailTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof MembersDetailEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "MembersDetailTable" + "\" must implement the \"" + 
                           "MembersDetailEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        MembersDetailEntryMBean entry = (MembersDetailEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private MembersDetailEntryMeta node;
