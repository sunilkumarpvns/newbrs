...
/**
 * The class is used for implementing the "MembersDetailTable" group.
 * The group is defined with the following oid: 1.3.6.1.4.1.21067.6.11.1.
 */
public class TableMembersDetailTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableMembersDetailTable".
     ...
     */
    public TableMembersDetailTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableMembersDetailTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "MembersDetailEntryMBean"
            // interface.
            //
            final Object entry =
                 createMembersDetailEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toLong());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("MembersDetailTable");
    }
    ...
    public synchronized void addEntry(MembersDetailEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(MembersDetailEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized MembersDetailEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        MembersDetailEntryMBean[] result = new MembersDetailEntryMBean[array.length];
    ...
    public void removeEntry(MembersDetailEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyMemberID = oid.toLong().toString();
            return new ObjectName("TableMembersDetailTable:name=com.elitecore.core.imdg.autogen.MembersDetailEntry" + ",MemberID=" + _keyMemberID);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    /**
     * Build index for "MembersDetailEntry".
     */
    public SnmpIndex buildSnmpIndex(MembersDetailEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpGauge(entry.getMemberID());
        oids[0] = val.toOid();
     ...
     * Build index for "MembersDetailEntry".
     */
    public SnmpOid buildOidFromIndexVal(Long aMemberID)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpGauge.appendToOid(new SnmpGauge(aMemberID).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    /**
     * Factory method for "MembersDetailEntry" entry MBean class.
     * 
     * You can redefine this method if you need to replace the default
     * generated MBean class with your own customized class.
     * 
     * @return An instance of the MBean class generated for the
     *         "MembersDetailEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "MembersDetailEntryMBean"
     * interface.
    ...
    public Object createMembersDetailEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Long  aMemberID)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        MembersDetailEntry entry = new MembersDetailEntry(theMib);
        entry.MemberID = aMemberID;
        return entry;
    }
