...
public class XMLWriter extends Writer{
	...
	public void write(ConfigurationContext configurationContext, Configurable configurable) throws StoreConfigurationException {
		...
		String relativeConfigurationPath = StringUtility.getDelimiterSeparatedString(xmlProperties.configDirectories(), File.separator);
		String relativeSchemaPath = StringUtility.getDelimiterSeparatedString(xmlProperties.schemaDirectories(), File.separator);
