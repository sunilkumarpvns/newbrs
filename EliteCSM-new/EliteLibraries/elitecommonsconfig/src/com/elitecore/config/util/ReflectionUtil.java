...
public class ReflectionUtil {
	...
	public static Class<?> getClassAnnotatedWith(Class<?> classToQuery, Class<? extends Annotation> annotationClass) {

		if (classToQuery.isAnnotationPresent(annotationClass)) {
			return classToQuery;
		}
		return null;
