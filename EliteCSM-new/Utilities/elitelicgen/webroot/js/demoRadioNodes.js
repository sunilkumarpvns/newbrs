...
foldersTree = gFld("MLLN Problem Category", "")
foldersTree.treeID = "checkboxTree"
aux1 = insFld(foldersTree, gFld("NetWork Problem",""))
aux1.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"
aux11 = insFld(aux1, gFld("Modem Problem",""))
aux11.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"
aux12 = insFld(aux1, gFld("Cable Problem",""))
aux12.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"

//aux3 = insFldDoc(auxparentfolderObject, gLnk("R", itemLabel, "javascript:parent.op()"))

aux2 = insFld(aux1, gFld("Bill", ""))
aux2.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX1></td>"
aux21 = insFld(aux2, gFld("Payment",""))
aux21.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"
aux211 = insFld(aux21, gFld("Interest Calculation",""))
aux211.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"
aux212 = insFld(aux21, gFld("Late Charges",""))
aux212.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"

aux22 = insFld(aux2, gFld("Billing",""))
aux22.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"
aux221 = insFld(aux22, gFld("Address Problem",""))
aux221.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"
aux222 = insFld(aux22, gFld("Wrong Bill",""))
aux222.prependHTML ="<td valign=middle><input type=radio name=BOX6 id=BOX6></td>"
