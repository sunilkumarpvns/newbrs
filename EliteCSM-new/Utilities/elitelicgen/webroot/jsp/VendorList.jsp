...
<html>
<head>
<title>EliteAAA License Generator</title>
...
function combineSelectedItems()
{
    ...
    var field = window.opener.document.getElementById("vendors");
...
<td>
	<table width="100%"   border="1" align="center" cellpadding="0" cellspacing="0">
		<form action="" >
	      <tr>
            <td height="16%" colspan="4"  class="tblheader-bold">Vendor List</td>
          </tr>
		  <tr>
            <td height="19%" colspan="4" class="tblrows">&nbsp;</td>
          </tr>
          <%
             SortedMap vendorList =(SortedMap)request.getSession().getAttribute("VendorList");
	         Set s=vendorList.entrySet();
              ...
              Map.Entry it =(Map.Entry)i.next();
  			  Integer vendorId = (Integer)it.getKey();
              String vendorName = (String)it.getValue();
              
           %>
          <tr>
           <!-- <td width="2%" height="25%" class="tblcol" >&nbsp;</td> -->
          	<td width="2%" height="25%" class="tblcol" align="left" >
          	<input name="choice" id="choice" type="checkbox" value="<%=vendorId+"-"+vendorName%>"><%=vendorName%></input></td>
		 </tr>
		<%} %>
		  <tr>
