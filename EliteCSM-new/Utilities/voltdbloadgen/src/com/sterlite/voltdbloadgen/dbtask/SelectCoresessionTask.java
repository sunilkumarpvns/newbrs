...
public class SelectCoresessionTask implements java.util.concurrent.Callable<Integer> {

    private int id;
    private Client client;
    private final String procedure = "VoltSelectCoreSessionById";
    ...
    public SelectCoresessionTask(int id, Client client, java.util.concurrent.atomic.AtomicInteger counter,
