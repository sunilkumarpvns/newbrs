...
public class SelectCoresessionByIPv4Task implements java.util.concurrent.Callable<Integer> {

    private int id;
    private Client client;
    private final String procedure = "VoltSelectCoreSessionByIPv4";
    ...
    public SelectCoresessionByIPv4Task(int id, Client client, java.util.concurrent.atomic.AtomicInteger counter,
    ...
    public Integer call() {
        ...
        for (int i = 1; i <= executionCount; i++) {
            ...
            try {
                ...
                client.callProcedure(/*NULL_CALL_BACK,*/ procedure, coreSessionId);
