...
public class BusServiceImpl implements BusService {
	private static final String TRANSACTION_FEE="20";
	@Autowired
	private B2BSearchServiceClient searchServiceClient;
	private static Logger logger = Logger.getLogger(BusServiceImpl.class);

	@Override
	public Response searchBus(final String source,final String destination, String doj, String drj) {
	...
	public double getTotalBaseFare(com.brs.searchservice.models.model.Fare modelFare, String doj) throws ParseException{
	...
	public double getDiscount(String doj, Fare fare)throws ParseException {
		double discount = 0.0;
		String day = getDayOfWeek(doj);
	...
	private String getDayOfWeek(String givendate)throws ParseException {
		String day = null;
		Date date = null;
		int dayOfWeek = 0;
